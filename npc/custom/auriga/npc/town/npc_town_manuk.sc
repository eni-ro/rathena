...
// 猫の手職員
//------------------------------------------------------------
manuk,108,357,4	script	猫の手職員	421,{
	if(CATHAND_POINT == 0) {
		mes "[猫の手職員]";
		mes "ご利用ありがとうございます。";
		mes "猫の手サービスでございます。";
...
// マヌク商人
//------------------------------------------------------------
man_in01,286,16,1	script	マヌク商人	454,{
...
manuk,218,163,3	script	巨人の戦士	450,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[巨人の戦士]";
		mes "∵∬∈ ∠ ∽∈⊃ ∑ ∫";
		mes "∑⊇⊃ ⊃ ∀∩∫ ∃ ";
...
manuk,266,199,5	script	巨人の戦士	450,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[巨人の戦士]";
		mes "∈∀∪ ⊂ ∽∀∑ ∧ ?";
		mes "∧∫∪ ∈ ∬∀∪ ⊂ ";
...
manuk,256,143,3	script	巨人の戦士	450,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[巨人の戦士]";
		mes "⊂∫ ⊆ ∧∃⊇ ∬ ∽";
		mes "∀∑∈ ∈ ∽⊂∑ ∀ ￢";
...
man_in01,346,135,0	script	工員	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[工員]";
		mes "Π∫〓　∫　Π∫∃　⊇　〓∽∀";
		mes "〓∩∬　〓　∀⊆〓　Σ　";
...
man_in01,393,134,3	script	工員	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[工員]";
		mes "∈⊃⊆　⊃　⊆〓∩";
		mes "∧∪⊃　∩";
...
man_in01,377,143,5	script	工員	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[工員]";
		mes "〓∽∋　Σ　∩∪∧";
		mes "∪　∠⊆∩　Σ　Π　Σ ";
...
man_in01,333,128,5	script	工員	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[工員]";
		mes "⊆〓〓　⊃　〓∩Π";
		mes "∠　∩Π⊇";
...
man_in01,336,128,5	script	工員	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[工員]";
		mes "〓∩∧ ⊇ ∈⊃";
		close;
...
man_in01,283,288,3	script	工員	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[工員]";
		mes "∫Π⊂　∫ 〓∫∃";
		mes "∧　∽⊆∈　∠　∽Σ　∠";
