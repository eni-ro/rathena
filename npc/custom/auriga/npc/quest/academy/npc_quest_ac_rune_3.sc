...
hu_in01,309,27,4	script	タラシー博士	923,{
...
hu_in01,305,27,4	script	ライラ#AC	69,{
	set .@novice, callfunc("AC_GetNovice");
	switch(AC_QUEST_LV_3){
	case 0:
		goto L_QUEST01;
...
hu_in01,308,27,4	script	#AC_BOM	139,{
OnEvent:
	disablenpc "ライラ#AC";
	enablenpc "ライラ#AC2";
...
hu_in01,305,27,4	script	ライラ#AC2	740,{
OnInit:
	disablenpc;
}
gef_fild07,179,242,4	script	#AC_POMPOM	1083,{
}
gef_fild07,179,241,4	script	ポムポム草#AC	111,{
...
moc_pryd01,193,193,0	script	#AC_RAIRAI	1081,{
}
moc_pryd01,193,192,0	script	ライライ草#AC	111,{
...
pay_dun00,154,172,0	script	#AC_KINOKO1	1084,{
}
pay_dun00,154,171,0	script	黒い変なキノコ#AC	111,{
...
pay_fild02,52,125,0	script	#AC_KINOKO2	1085,{
}
pay_fild02,52,124,0	script	あやしいキノコ#AC	111,{
...
prt_sewb3,184,17,0	script	#AC_MINMIN	1080,{
}
prt_sewb3,184,16,0	script	ミンミン草#AC	111,{
...
hu_in01,113,313,4	script	アムロン	47,{
	set .@novice, callfunc("AC_GetNovice");
	if(!AC_QUEST_ST_3) goto L_OTHER;
	switch(AC_QUEST_LV_3){
	case 1:
...
prt_sewb1,301,206,4	script	チスロー#AC	896,{
...
iz_dun00,351,45,4	script	ツイーフラ#AC	96,{
...
prt_sewb2,159,182,4	script	メルシーちゃん#AC	876,{
...
iz_dun01,129,79,4	script	ザーパフ#AC	887,{
