...
// ブレイド 2～4時 15～17時
prt_fild05,360,252,3	script	ブレイド#Valentine1	733,{
...
// ブレイド 4～7時 17～19時
prt_fild08,162,367,5	script	ブレイド#Valentine2	733,{
...
// ブレイド 8～10時 21～23時
prontera,116,69,3	script	ブレイド#Valentine3	733,{
...
// ブレイド 12～15時
prontera,58,70,3	script	ブレイド#Valentine4	733,{
	...
	function PatternB {	//case1～9
		...
		case 5:
			if(rand(3)==0) {
				...
				mes "いいじゃないですか。";
				next;
				if(getarg(1)==3) monster "prt_castle",167,164,"あれ",1051,1,"Thiefbug#Valentine";
				if(getarg(1)==5) monster "prt_castle",33,165,"あれ",1051,1,"Thiefbug#Valentine";
				mes "^8C1010-カサカサ-";
...
// スプラキ 2～4時 11～13時
prt_castle,133,99,3	script	スプラキ#Valentine1	90,{
...
// スプラキ 4～6時 15～17時
prt_castle,33,106,3	script	スプラキ#Valentine2	90,{
...
// スプラキ 7～9時 21～23時
prt_castle,169,168,3	script	スプラキ#Valentine3	90,{
...
// スプラキ 9～11時
prt_church,92,115,7	script	スプラキ#Valentine4	90,{
...
// スプラキ 13～15時
prt_castle,32,168,3	script	スプラキ#Valentine5	90,{
...
// スプラキ 17～19時
prt_castle,172,102,3	script	スプラキ#Valentine6	90,{
...
// スプラキ 19～21時
prt_castle,165,28,3	script	スプラキ#Valentine7	90,{
...
//==============================================================
alberta,26,243,3	script	ショコラ=バシニオ	96,{
	if((Weight*100/MaxWeight) >= 90) {
		mes "[ショコラ=バシニオ]";
		mes "お客様、荷物をたくさん";
		mes "お持ちのようですね。";
...
prt_in,41,40,3	script	助手パティシエ	86,{
...
alberta,26,243,4	script	チョコレート商人	58,{	//男女購入可能
	mes "[マルコ=バジニオ]";
...
alberta,29,243,4	script	チョコレート商人の恋人	53,{
...
prt_castle,42,35,3	script	王宮デザート職人	47,{
	if(Sex) {
		mes "[シャルル=オルレアン]";
