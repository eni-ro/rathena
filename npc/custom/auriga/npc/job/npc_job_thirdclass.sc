...
function	script	jobchenge3rd_func	{
	...
	if(Upper == UPPER_BABY) {
		...
		if(getequipid2(14) == 20307) nude 14;
...
prontera,163,178,3		duplicate(3rdRentalGear)	魔導ギア管理兵#pro		105
dicastes01,187,203,3	duplicate(3rdRentalGear)	魔導ギア管理兵#dicas	105
mora,91,112,3			duplicate(3rdRentalGear)	魔導ギア管理兵#mora		105
ecl_in01,41,25,5		duplicate(3rdRentalGear)	魔導ギア管理兵#ecl		105

//==========================================
// ルーン原石販売員 - ルーンナイト
//------------------------------------------

prontera,168,228,3	script	ルーン原石販売員#pro	853,{
	mes "[ルーン原石販売員]";
	mes "あなたはもしかして、";
	mes "ルーン原石をお求めですかな!?";
	mes "　";
...
prt_in,109,68,4		substore(AlloyTrapShopper)	トラップ専門家	66
mid_camp,129,284,4	substore(AlloyTrapShopper)	トラップ専門家	66
payon,123,109,4		substore(AlloyTrapShopper)	トラップ専門家	66
ra_in,263,281,4		substore(AlloyTrapShopper)	トラップ専門家	66
lighthalzen,337,240,4	substore(AlloyTrapShopper)	トラップ専門家	66
...
morocc,190,96,4	duplicate(3rdPoisonShopper)	毒製造キット販売員#moc	877
lhz_in02,16,205,4	duplicate(3rdPoisonShopper)	毒製造キット販売員#lhz	877
...
prt_in,175,137,4	substore(MechanicShopper)	闇販売員	49
mid_camp,184,263,4	substore(MechanicShopper)	闇販売員	49
einbroch,122,250,4	substore(MechanicShopper)	闇販売員	49
ra_in,257,266,4		substore(MechanicShopper)	闇販売員	49
lhz_in03,181,17,4	substore(MechanicShopper)	闇販売員	49
...
comodo,196,162,3	shop	カリブ#comodo	479,11513:-1,6144:-1
...
gef_tower,105,172,5	script	ポイント商人	700,{
	mes "[ポイント商人]";
	mes "こんにちは。";
	mes "ここでは鉱石をさらに砕いた";
	mes "触媒として使用する";
...
comodo,106,213,5	shop	南国の果物商人	724,6258:-1

alde_alche,31,186,3	script	製造本販売員#alde	883,{
	mes "[製造本販売員]";
	mes "こんにちは！";
	mes "私はジェネティックの";
...
s_atelier,17,110,1	substore(PaintingShopper)	販売員#sc_prt	67
s_atelier,137,60,3	substore(PaintingShopper)	販売員#sc_ra	70
s_atelier,114,117,1	substore(PaintingShopper)	販売員#sc_yuno	92
s_atelier,15,65,5	substore(PaintingShopper)	販売員#sc_lgt	89
