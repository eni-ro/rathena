...
// リカラー リボンのヘアバンド
//------------------------------------------------------------
morocc_in,137,102,5	script	研修生	82,{
	mes "[エルゴ]";
	mes "いらっしゃいませ！";
...
// フラワーヴェール
//------------------------------------------------------------
in_orcs01,119,106,3	script	#オークレディ	1273,{}
in_orcs01,119,105,3	script	オークレディ	111,{
...
// 肉球のヘアピン
//------------------------------------------------------------
gef_fild05,80,149,3	script	ミュー	877,{
	mes "[ミュー]";
	mes "にゃ～。";
	next;
	if(checkquest2(7054)) {
		if(checkquest2(7055) & 0x4) {
			mes "[ミュー]";
...
// お知らせ看板
//------------------------------------------------------------
alberta,226,67,6	script	放浪の芸術家チハノ	881,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　危険です。";
		mes "　所持アイテムを減らしてから、";
...
alberta,226,66,6	script	愛猫アフケー	876,{
	mes "[アフケー]";
	mes "ニャー。";
	next;
	mes "[放浪の芸術家チハノ]";
