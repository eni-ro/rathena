...
//                                                 by Pneuma
//お世話になったあの人に   -----------------------------------
aldeba_in,171,171,4	script	ミザリー#aldeba_in	68,{
...
//-------------------------------------------------------
xmas_in,173,171,4	script	トイーヒ#xmas_in	908,{
...
//------------------------------------------------------
payon,165,99,4	script	ライアス	807,{
...
//------------------------------------------------------
yuno_in04,39,126,4	script	マッズイ	886,{
	set .@novice, callfunc("AC_GetNovice");
	switch(AC_QUEST_LV_2){
	case 0:
		goto L_OTHER;
...
//---------------------------------------------------------------
lighthalzen,51,161,0	script		木#AC_QUE02	111,{
	mes "‐木に沢山の葉っぱが生えている‐";
...
einbroch,111,261,0	script	ドブの泥#AC_QUE02	111,{
	mes "‐ドブの中にぎっしりと";
	mes "泥が詰まっている‐";
...
einbech,130,247,3	script	ドルドイ#AC_QUE02	848,{
	mes "[ドルドイ]";
	mes "悪いが仕事中なので、";
	mes "話しかけないでもらえるかい？";
...
izlu2dun,136,50,4	script	ンライバ#AC_QUE02	88,{
...
izlu2dun,58,165,0	script	落し物#AC_QUE02	111,{
	mes "‐財布らしきものが落ちている‐";
...
alb2trea,105,95,4	script	アイリン#AC_QUE02	96,{
