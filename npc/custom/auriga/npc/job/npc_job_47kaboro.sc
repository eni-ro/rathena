...
que_ng,28,156,0	script	はじめ#ko	139,1,1,{
...
que_ng,21,76,0	script	絵がかざってある壁#ko	844,{
...
job_ko,25,115,4	script	謎の老人#ko	588,{
	switch(CHANGE_KO) {
	case 1:
		cutin "job_ko03",2;
	...
	case 6:
		set .@test1,checkquest2(5136);
		set .@test2,checkquest2(5137);
		set .@test3,checkquest2(5138);
		if(.@test1) {
			set .@test$,"知識";
			if(.@test1 & 0x1) {
				set .@x,72;
...
job_ko,81,124,4	script	クウガ・カイ#ko	730,{
	if(checkquest2(5136)) {
		if(checkquest2(5136) & 0x8) {
			mes "[クウガ・カイ]";
			mes "さあ、外に出してやろう。";
			mes "ギオン様に結果を報告するように。";
			close2;
...
function	script	jobchenge_ko_func	{
	...
	warp "job_ko",.@to_x[CHANGE_KO_NOW],.@to_y[CHANGE_KO_NOW];
	end;
}

job_ko,57,16,4	script	道標#ko_00	858,1,1,{
	mes "‐スタート地点";
...
job_ko,49,16,4	script	道標#ko_01	858,1,1,{
	mes "‐1番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,41,16,4	script	道標#ko_02	858,1,1,{
	mes "‐2番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,33,16,4	script	道標#ko_03	858,1,1,{
	mes "‐3番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,25,16,4	script	道標#ko_04	858,1,1,{
	mes "‐4番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,17,16,4	script	道標#ko_05	858,1,1,{
	mes "‐5番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,17,24,4	script	道標#ko_06	858,1,1,{
	mes "‐6番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,17,32,4	script	道標#ko_07	858,1,1,{
	mes "‐7番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,17,40,4	script	道標#ko_08	858,1,1,{
	mes "‐8番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,17,48,4	script	道標#ko_09	858,1,1,{
	mes "‐9番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,17,56,4	script	道標#ko_10	858,1,1,{
	mes "‐10番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,22,60,4	script	道標#ko_11	858,1,1,{
	mes "‐11番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,30,60,4	script	道標#ko_12	858,1,1,{
	mes "‐12番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,38,60,4	script	道標#ko_13	858,1,1,{
	mes "‐13番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,46,60,4	script	道標#ko_14	858,1,1,{
	mes "‐14番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,54,60,4	script	道標#ko_15	858,1,1,{
	mes "‐15番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,62,60,4	script	道標#ko_16	858,1,1,{
	mes "‐16番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,62,51,4	script	道標#ko_17	858,1,1,{
	mes "‐17番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,62,43,4	script	道標#ko_18	858,1,1,{
	mes "‐18番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,62,35,4	script	道標#ko_19	858,1,1,{
	mes "‐19番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,62,27,4	script	道標#ko_20	858,1,1,{
	mes "‐20番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,57,23,4	script	道標#ko_21	858,1,1,{
	mes "‐21番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,49,23,4	script	道標#ko_22	858,1,1,{
	mes "‐22番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,41,23,4	script	道標#ko_23	858,1,1,{
	mes "‐23番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,33,23,4	script	道標#ko_24	858,1,1,{
	mes "‐24番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
OnTouch:
	...
	if((.@dice1+.@dice2) >= 9) {
		...
		case 1: set CHANGE_KO_NOW,25; warp "job_ko",30,23; break;
		case 2: set CHANGE_KO_NOW,26; warp "job_ko",25,28; break;
		case 3: set CHANGE_KO_NOW,27; warp "job_ko",25,35; break;
		case 4: set CHANGE_KO_NOW,28; warp "job_ko",25,43; break;
		case 5: set CHANGE_KO_NOW,29; warp "job_ko",25,52; break;
		case 6: set CHANGE_KO_NOW,30; warp "job_ko",33,52; break;
		}
		end;
	}
	else {
...
job_ko,25,23,4	script	道標#ko_25	858,1,1,{
	mes "‐25番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,25,32,4	script	道標#ko_26	858,1,1,{
	mes "‐26番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,25,40,4	script	道標#ko_27	858,1,1,{
	mes "‐27番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,25,48,4	script	道標#ko_28	858,1,1,{
	mes "‐28番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,30,52,4	script	道標#ko_29	858,1,1,{
	mes "‐29番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,38,52,4	script	道標#ko_30	858,1,1,{
	mes "‐30番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,46,52,4	script	道標#ko_31	858,1,1,{
	mes "‐31番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,54,52,4	script	道標#ko_32	858,1,1,{
	mes "‐32番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
OnTouch:
	...
	case 1: set CHANGE_KO_NOW,33; warp "job_ko",54,48; break;
	case 2: set CHANGE_KO_NOW,34; warp "job_ko",54,40; break;
	case 3: set CHANGE_KO_NOW,35; warp "job_ko",54,31; break;
	case 4: set CHANGE_KO_NOW,36; warp "job_ko",47,31; break;
	case 5: set CHANGE_KO_NOW,37; warp "job_ko",38,31; break;
	case 6: set CHANGE_KO_NOW,38; warp "job_ko",33,35; break;
	}
	end;
}

job_ko,54,43,4	script	道標#ko_33	858,1,1,{
	mes "‐33番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,54,35,4	script	道標#ko_34	858,1,1,{
	mes "‐34番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,49,31,4	script	道標#ko_35	858,1,1,{
	mes "‐35番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,41,31,4	script	道標#ko_36	858,1,1,{
	mes "‐36番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,33,31,4	script	道標#ko_37	858,1,1,{
	mes "‐37番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,33,40,4	script	道標#ko_38	858,1,1,{
	mes "‐38番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,38,44,4	script	道標#ko_39	858,1,1,{
	mes "‐39番マス";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,46,41,4	script	道標#ko_40	858,1,1,{
	mes "‐ゴール";
	mes "　^1A95E6他の文字は小さくて見えない。";
	mes "　もっと近づいてみよう^000000‐";
	close;
...
job_ko,127,125,4	script	ヒョウ#ko	730,{
	if(checkquest2(5138)) {
		if(checkquest2(5138) & 0x8) {
			mes "[ヒョウ]";
			mes "そうそう";
			mes "ギオン様に報告するのを";
			mes "忘れないでくださいね。";
		...
		if(checkquest2(5145)) {
			...
			case 2:
				...
				mes "いい結果が得られたみたいですね。";
				next;
				if(getequipid2(4) != 13074 && getequipid2(4) != 13312) {
					mes "[ヒョウ]";
					mes "おや……。";
					next;
					mes "[ヒョウ]";
		...
		mes "新しい武器の試作品は";
		mes "完成しましたか？";
		if(checkquest2(5143) || checkquest2(5144))
			set .@str$,"はい、完成しました";
		next;
...
job_ko,117,128,0	script	タンス#ko	844,{
	mes "‐見たところ";
	mes "　普通のタンスのようだが……‐";
	next;
...
job_ko,131,124,0	script	製作道具#ko_01	844,{
	if(!(checkquest2(5142) & 0x1)) {
		mes "‐製作道具だ。";
		mes "　今は使う必要がない‐";
		close;
	}
...
job_ko,129,129,0	duplicate(製作道具#ko_01)	製作道具#ko_02	844
job_ko,116,124,0	duplicate(製作道具#ko_01)	製作道具#ko_03	844

job_ko,121,121,0	script	精錬装置#ko_01	844,{
	if(!checkquest2(5143) && !checkquest2(5144)) {
		mes "‐精錬を自動で行ってくれる装置だ。";
		mes "　しかし今は使う必要がないだろう‐";
		close;
	...
	mes "‐武器を分析しています‐";
	next;
	if(getequiprefinerycnt2(4) >= 10) {
		// 未調査
		mes "‐この武器はこれ以上精錬できません‐";
		close;
	}
	if(getequippercentrefinery2(4) < 100) {
	...
	if(getequippercentrefinery2(4) > rand(100)) {
		successrefitem2 4;
		mes "‐精錬に成功しました‐";
		close;
	}
...
job_ko,127,121,0	duplicate(精錬装置#ko_01)	精錬装置#ko_02	844

job_ko,148,46,4	script	導き手 ギオン#ko	588,{
	switch(CHANGE_KO) {
	case 10:
		cutin "job_ko01",2;
		mes "[導き手 ギオン]";
	...
	case 11:
		...
		cutin "job_ko04",2;
		mapannounce "job_ko","導き手 ギオン : 一族" +strcharinfo(0)+ "が" +(Sex? "影狼": "朧")+ "の道を進むこととなった。かの者に祝福あれ！",0;
		mes "[導き手 ギオン]";
...
job_ko,151,47,4	script	クウガ・カイ#ko2	730,{
	mes "[クウガ・カイ]";
	mes "貴様もここまで来たか……";
	close;
}

job_ko,145,47,6	script	ヒョウ#ko2	730,{
	mes "[ヒョウ]";
	mes "やあ、いよいよですね。";
	close;
}

job_ko,0,0,0	script	ko_test_mon	139,{
OnTimer300000:
	initnpctimer;
	killmonster "job_ko","ko_test_mon::OnKilled1";
	set .@r,rand(getarraysize(.mobid));
	areamonster "job_ko",128,26,168,66,"一族の過去",.mobid[.@r],1,"ko_test_mon::OnKilled1";
	end;
OnInit:
	...
	for(set .@i,110; .@i<=171; set .@i,.@i+1) {
		...
		monster "job_ko",.@i,50,.mobname$[.@r2],.mobid[.@r1],1,"ko_test_mon::OnKilled2";
	}
	for(set .@i,31; .@i<=81; set .@i,.@i+1) {
		set .@r1,rand(getarraysize(.mobid));
		set .@r2,rand(getarraysize(.mobname$));
		monster "job_ko",140,.@i,.mobname$[.@r2],.mobid[.@r1],1,"ko_test_mon::OnKilled2";
	}
	initnpctimer;
	end;
OnKilled1:
...
OnKilled2:
	...
	set .@r1,rand(getarraysize(.mobid));
	set .@r2,rand(getarraysize(.mobname$));
	monster "job_ko",.@x,.@y,.mobname$[.@r2],.mobid[.@r1],1,"ko_test_mon::OnKilled2";
	if(!rand(3))
		warp "job_ko",16,113;
	end;
}

que_ng,75,23,3	script	鍛冶師 テーネ#ko	762,{
	mes "[鍛冶師 テーネ]";
	mes "ご機嫌麗しゅうございます。";
	mes "鍛冶師でもっとも礼儀正しいと";
	mes "言われているテーネでございます。";
...
que_ng,21,72,6	script	防具職人 ギヨ#kaboro	934,{
	mes "[ギヨ]";
	mes "勝利とは何だと考えている？";
	mes "敵を倒す事……";
	mes "確かにその通りだ。";
...
que_ng,23,70,3	script	武器職人 キー#kaboro	939,{
	mes "[キー]";
	mes "攻撃は最大の防御";
	mes "という言葉がある。";
	mes "強力な武器こそ、";
