...
// 転職カプラ	<3次職対応版>
//-----------------------------------------------------------------------------
prontera,161,192,5	script	転職カプラ	114,{
	cutin "kafra_04",2;
	mes "[転職カプラ]";
	mes "いらっしゃいませ。";
	...
	switch(Job) {
		case Job_Novice:
			setarray .@job_id,Job_Swordman,Job_Mage,Job_Archer,Job_Acolyte,Job_Merchant,Job_Thief;
			if(Upper != UPPER_HIGH) {
		...
		case Job_SuperNovice:
			setarray .@job_id,Job_Super_Novice_E;
			break;
		case Job_Ninja:
			if(Sex) {
