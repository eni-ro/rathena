...
izlude,116,129,4	script	ツーニャ#01	555,{
	function PowerOfDHA {
	...
	case 2:
		...
		next;
		set .@part,select(
				getequipid2(1)? "^nItemID^"+getequipid2(1): "",
				getequipid2(2)? "^nItemID^"+getequipid2(2): "",
				getequipid2(3)? "^nItemID^"+getequipid2(3): "",
				getequipid2(4)? "^nItemID^"+getequipid2(4): "",
				getequipid2(5)? "^nItemID^"+getequipid2(5): "",
				getequipid2(6)? "^nItemID^"+getequipid2(6): "",
				getequipid2(7)? "^nItemID^"+getequipid2(7): "",
				getequipid2(8)? "^nItemID^"+getequipid2(8): "",
				getequipid2(9)? "^nItemID^"+getequipid2(9): "",
				getequipid2(10)? "^nItemID^"+getequipid2(10): "",
				"やっぱりやめる");
		if(.@part == 11) {
			mes "[ツーニャ]";
			mes "また来るニャ。";
		...
		set .@max,getiteminfo(getequipid2(.@part),10);
		if(.@max == 0) {
			emotion 1;
			mes "[ツーニャ]";
			mes "そのアイテムに";
		...
		set .@cardid,getequipcardid2(.@part,.@slot);
		if(.@cardid == 0) {
			emotion 1;
			mes "[ツーニャ]";
			mes "そこにカードは無いニャよ？";
		...
		successremovecards2 .@part,.@slot+1;
		misceffect 567,"";
		mes "[ツーニャ]";
		mes "ふぃ～";
		mes "いい仕事したニャ！";
