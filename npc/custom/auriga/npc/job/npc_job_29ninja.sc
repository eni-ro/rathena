...
// ショップ
//------------------------------------------
que_ng,73,26,5	shop	ブンレイ	83,2117:-1,2171:-1,15053:-1,7521:-1,7522:-1,7523:-1,7524:-1,6512:-1,6513:-1,6514:-1,6515:-1
que_ng,72,31,3	shop	ブンジ		83,13250:-1,13251:-1,13252:-1,13253:-1,13254:-1,6493:-1
prontera,178,244,3	shop	アマツ貿易商人	83,13250:-1,13251:-1,13252:-1,13253:-1,13254:-1,6493:-1,2117:-1,2171:-1,15053:-1,7521:-1,7522:-1,7523:-1,7524:-1,6512:-1,6513:-1,6514:-1,6515:-1

//==========================================
// 案内員
//------------------------------------------
alberta,30,65,3	script	アカギ	730,{
	if(Job == Job_Ninja) {
		mes "[アカギ]";
		mes "元気にしているか？";
		mes "任務はいつ、どこで";
...
alberta,168,138,3	script	船長	99,{
...
// 試験申請
//------------------------------------------
que_ng,30,65,3	script	クウガ・カイ	730,{
...
// 転職試験
//------------------------------------------
einbroch,184,194,3	script	青年	881,{
	if(Job == Job_Ninja || Job == Job_Kagerou || Job == Job_Oboro) {
		mes "[ヒョウ]";
		mes "忍者になれましたね。";
		mes "これから、多くの困難が";
...
prontera,178,240,3	duplicate(カシン#ng)	カシン#prt	83
que_ng,72,29,3		duplicate(カシン#ng)	カシン#que	83
...
payon,210,44,3	duplicate(カイバラ#ng)	カイバラ#pay	847
que_ng,72,34,3	duplicate(カイバラ#ng)	カイバラ#que	847
...
geffen,63,70,3	duplicate(テツ#ng)	テツ#gef	709
que_ng,22,62,3	duplicate(テツ#ng)	テツ#que	709

//==========================================
// 手甲[1]製作
//------------------------------------------
que_ng,28,50,3	script	ボシュ	709,{
	if(BaseLevel < 20) {
		mes "[ボシュ]";
		mes "私は忍者の若者達に";
		mes "最高の防具を作ってあげている。";
