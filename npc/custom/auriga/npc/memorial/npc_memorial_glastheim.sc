...
// ダンジョン生成NPC
//------------------------------------------------------------
glast_01,204,273,3	script	フギン	755,{
	if(BaseLevel < 130) {
		mes "[フギン]";
		mes "ふむ、君では力不足だね。";
		next;
	...
	if(checkquest2(12322))
		delquest 12322;
	if(checkquest2(12317)) {
		if(!(checkquest2(12317) & 0x2)) {
			mes "[フギン]";
			mes "おっと";
			mes "君はまだ次元旅行の後遺症が";
			mes "残っているようだ。";
...
1@gl_k,2,1,0	script	#0統制_bc	139,{
}

1@gl_k,145,104,6	script	カーリッツバーグ騎士#1	655,{
	mes "[カーリッツバーグ騎士]";
	mes "もうすぐ勤務交代の時間なのに、";
	mes "何か問題が起きたみたいで";
	mes "交代の人が来ないんです。";
...
1@gl_k,145,99,6		script	白の騎士#3	657,{
	mes "[白の騎士]";
...
1@gl_k,145,94,6		script	カーリッツバーグ騎士#5	655,{
	mes "[カーリッツバーグ騎士]";
	mes "昨夜の夢が気になります。";
	mes "お母さんが夢に出てきたんです。";
	mes "何かあるのかな……";
...
1@gl_k,145,89,6		script	白の騎士#7	657,{
	mes "[白の騎士]";
	mes "ここでの私語はなるべく控えて下さい。";
	close;
}

1@gl_k,145,84,6		script	カーリッツバーグ騎士#9	655,{
	mes "[カーリッツバーグ騎士]";
	mes "静粛にして下さい。";
	close;
}

1@gl_k,145,79,6		script	白の騎士#11	657,{
	mes "[白の騎士]";
	mes "失礼ですが、バルムント様とは";
	mes "どのような関係ですか。";
...
1@gl_k,145,74,6		script	カーリッツバーグ騎士#13	655,{
	mes "[カーリッツバーグ騎士]";
	mes "城の中の気配が何か";
	mes "怪しくありませんか？";
	mes "少し前から何かの気配が";
...
1@gl_k,145,69,6		script	白の騎士#15	657,{
	mes "[白の騎士]";
	mes "勤務中の私語は";
	mes "好ましくありません。";
	close;
...
1@gl_k,145,64,6		script	カーリッツバーグ騎士#17	655,{
	mes "[カーリッツバーグ騎士]";
	mes "……。";
	close;
}

1@gl_k,145,59,6		script	白の騎士#19	657,{
	mes "[白の騎士]";
	mes "私に何か御用ですか？";
	close;
}

1@gl_k,145,54,6		script	カーリッツバーグ騎士#21	655,{
	mes "[カーリッツバーグ騎士]";
	mes "……。";
	close;
}

1@gl_k,154,104,3	script	カーリッツバーグ騎士#2	655,{
	mes "[カーリッツバーグ騎士]";
	mes "ふふ、私とお話したいんですか？";
	close;
}

1@gl_k,154,99,3		script	白の騎士#4	657,{
	mes "[白の騎士]";
	mes "もうすぐ交代の時間だというのに";
	mes "交代の者が来ないのです。";
	mes "何か問題が起きたのでしょうか？";
...
1@gl_k,154,94,3		script	カーリッツバーグ騎士#6	655,{
	mes "[カーリッツバーグ騎士]";
...
1@gl_k,154,89,3		script	白の騎士#8	657,{
	mes "[白の騎士]";
	mes "ここでの私語は控えて下さい。";
	close;
}

1@gl_k,154,84,3		script	カーリッツバーグ騎士#10	655,{
	mes "[カーリッツバーグ騎士]";
	mes "静かにしなさい。";
	close;
}

1@gl_k,154,79,3		script	白の騎士#12	657,{
	mes "[白の騎士]";
	mes "失礼ですが、バルムント様とは";
	mes "どのような関係ですか。";
	mes "人とのかかわりをあまり持たない方だと";
...
1@gl_k,154,74,3		script	カーリッツバーグ騎士#14	655,{
	mes "[カーリッツバーグ騎士]";
	mes "城の中の気配が何か";
	mes "怪しくありませんか？";
	mes "少し前から何かの気配が";
...
1@gl_k,154,69,3		script	白の騎士#16	657,{
	mes "[白の騎士]";
	mes "勤務中の私語は";
	mes "好ましくありません。";
	close;
...
1@gl_k,154,64,3		script	カーリッツバーグ騎士#18	655,{
	mes "[カーリッツバーグ騎士]";
	mes "……。";
	close;
}

1@gl_k,154,59,3		script	白の騎士#20	657,{
	mes "[白の騎士]";
	mes "私に何か御用ですか？";
	close;
}

1@gl_k,154,54,3		script	カーリッツバーグ騎士#22	655,{
	mes "[カーリッツバーグ騎士]";
	mes "……。";
	close;
}

1@gl_k,149,41,5	script	バルムント#0	654,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		cutin "GL_BARMUND1",2;
		if(OLDGLAST_QUE >= 1) {
			mes "‐難しい顔をした男が立っている‐";
			...
			if(select("急ぐ","会話をする") == 1) {
				...
				mes "ヒメルメズの事を知らせろ。";
				mes "私もすぐに向かう！";
				unittalk getcharid(3), "バルムント : 急げ！　ハインリヒ卿の所に行って ヒメルメズの事を知らせろ。私もすぐに向かう！";
				close2;
		...
		mes "協力者というのは君なのか？";
		unittalk getcharid(3), "バルムント : ヘリコがよこした協力者というのは君なのか？";
		next;
		mes "‐ヘリコという人物がよこした";
		mes "　協力者を待っているようだ。";
		mes "　ヘリコという人物は知らないが";
		...
		mes "ついて話さなければならないのだ。";
		unittalk getcharid(3), "バルムント : そうか。早速で悪いが時間がない。ハインリヒ卿にヒメルメズの侵略について話さなければならないのだ。";
		next;
		menu "ヒメルメズ？",-;
		mes "["+strcharinfo(0)+"]";
		mes "ヒメルメズとは誰ですか？";
		...
		mes "ヘリコはそんなことも";
		mes "教えてくれなかったのか？";
		unittalk getcharid(3), "バルムント : ヘリコはそんなことも教えてくれなかったのか？";
		next;
		cutin "GL_BARMUND2",2;
		mes "[バルムント]";
		...
		unittalk getcharid(3), "バルムント : 死人を治める者、亡者のヴァルキリー。彼女は今ここに隠してあるユミルの心臓を手に入れるつもりだ。";
		next;
		mes "[バルムント]";
		mes "おそらく、目的の為ならこの城ごと";
		mes "破壊してしまうだろう。";
		unittalk getcharid(3), "バルムント : おそらく、目的の為ならこの城ごと破壊してしまうだろう。";
		next;
		mes "[バルムント]";
		mes "急げ！　ハインリヒ卿の所に行って";
		mes "ヒメルメズの事を知らせろ。";
...
1@gl_k,152,97,3	script	バルムント#1	654,{
	end;
OnTalk1:
	unittalk getcharid(3), "バルムント : 冗談ではありません、ハインリヒ卿。私の考えが正しければ、もうすぐ彼女がここに来るはずです。";
	end;
OnTalk2:
	unittalk getcharid(3), "バルムント : 私と一緒に来たこの者は信用できる人物です。ヒメルメズがここにあるユミルの心臓の欠片を手に入れる前に、安全な場所に隠さなければなりません。";
	end;
OnTalk3:
	unittalk getcharid(3), "バルムント : 貴様、いつの間に！";
	end;
OnTalk4:
	unittalk getcharid(3), "バルムント : ハインリヒ卿、お気をたしかに。彼らはすでに魔物化しています。彼らに安息を与えてやるのが司令官の務めです。";
	end;
OnTalk5:
	unittalk getcharid(3), "バルムント : 彼らはもう、人間には戻れないのです。";
	end;
OnTalk6:
	unittalk getcharid(3), "バルムント : 今は君の力が必要だ。よろしく頼む。";
	end;
OnTalk7:
	unittalk getcharid(3), "バルムント : ではハインリヒ卿、急いでヒメルメズの後を追いましょう。";
	end;
}

1@gl_k,149,100,5	script	ハインリヒ#1	652,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		...
		mes "一緒に来た冒険者の方ですね。";
		mes "この城の中で何か問題でも？";
		unittalk getcharid(3), "ハインリヒ : あなたは確か、バルムント様と一緒に来た冒険者の方ですね。この城の中で何か問題でも？";
		next;
		menu "ユミルの心臓が狙われています",-;
		mes "["+strcharinfo(0)+"]";
		mes "ヒメルメズというヴァルキリーが、";
		...
		mes "そんなモノがここにあるわけ";
		mes "ないじゃないですか。";
		unittalk getcharid(3), "ハインリヒ : ははは、冗談はやめてください。そのようなモノがここにあるわけないじゃないですか。";
		next;
		...
		mes "いくら貴方の頼みといえど……";
		mes "いや、しかし……。";
		unittalk getcharid(3), "ハインリヒ : これはバルムント様……。いくら貴方の頼みといえど……いや、しかし……。";
		next;
		cutin "GL_BARMUND2",2;
		mes "[バルムント]";
		mes "私と一緒に来たこの者は";
		...
		mes "この城にはユミルの心臓の欠片が";
		mes "隠されています。";
		unittalk getcharid(3), "ハインリヒ : ……確かに、この城にはユミルの心臓の欠片が隠されています。";
		next;
		mes "[ハインリヒ]";
		mes "ですが、国王様が不在の今、";
		mes "そのような推測だけで";
		mes "ユミルの心臓を動かすわけには";
		mes "いきません。";
		unittalk getcharid(3), "ハインリヒ : ですが、国王様が不在の今、そのような推測だけでユミルの心臓を動かすわけにはいきません。";
		close2;
		cutin "gl_heinrich1",255;
...
OnTimer134000:
	...
	hideonnpc getmdnpcname("ハインリヒ#2");
	killmonster getmdmapname("1@gl_k"),getmdnpcname("ハインリヒ#1")+"::OnKilled";
	end;
OnTimer143000:
...
1@gl_k,149,89,1	script	ヒメルメズ#1	650,{
	end;
OnTalk1:
	unittalk getcharid(3), "女性 : あら、お邪魔だったかしら？　お客様が訪ねて来たのに、誰も気づいてくれなかったから寂しくて。";
	end;
OnTalk2:
	unittalk getcharid(3), "ヒメルメズ : 私の名前はリサ・カン・ヒメルメズ。死人を治める者、亡者のヴァルキリー、そう呼ばれてるみたいね。";
	end;
OnTalk3:
	unittalk getcharid(3), "ヒメルメズ : あなたがハインリヒ？　へぇ～、本当に今でも若い姿のままなのね。";
	end;
OnTalk4:
	unittalk getcharid(3), "ヒメルメズ : それに、とっても紳士的なのね。でも、あなたの主君の行方を聞いても涼しい顔をしていられるかしら？";
	end;
OnTalk5:
	unittalk getcharid(3), "ヒメルメズ : 気になるの？　空席の玉座を欲しがりもしないで、永々と王の帰還を待っているのね……本当に不思議な男。";
	end;
OnTalk6:
	unittalk getcharid(3), "ヒメルメズ : その純粋さ、嫌いじゃないわ。もっと違う場所で出逢えたら良かったのに。残念ね。";
	end;
OnTalk7:
	unittalk getcharid(3), "ヒメルメズ : そうね。そう……あなたのご主人は、ルーンミッドガッツ王家に招待されているのよね。";
	end;
OnTalk8:
	unittalk getcharid(3), "ヒメルメズ : でも変じゃない？　王が出発してからどれだけの時間が経ったかしら？";
	end;
OnTalk9:
	unittalk getcharid(3), "ヒメルメズ : さあね～？　ゆっくり説明してあげたいけど、私の用を終わらせないと。";
	end;
OnTalk10:
	unittalk getcharid(3), "ヒメルメズ : 私は紅茶をいただいてくるわ。この城に隠された最高の紅茶を……ね。";
	end;
}

1@gl_k,149,97,5	script	ハインリヒ#2	652,{
	end;
OnTalk1:
	unittalk getcharid(3), "ハインリヒ : 誰だ！";
	end;
OnTalk2:
	unittalk getcharid(3), "ハインリヒ : ほう、物騒な二つ名と違って美しいレディだ。ですが、ここには貴女のお気に召すような紅茶はありませんよ。";
	end;
OnTalk3:
	unittalk getcharid(3), "ハインリヒ : ……何だと？";
	end;
OnTalk4:
	unittalk getcharid(3), "ハインリヒ : 戯言を……私の主はルーンミッドガッツ王家の招待に応じただけだ。";
	end;
OnTalk5:
	unittalk getcharid(3), "ハインリヒ : ……貴様……王の身に何が起きた！";
	end;
OnTalk6:
	unittalk getcharid(3), "ハインリヒ : ……しまった！　奴はユミルの心臓の欠片がある場所を把握している！";
	end;
OnTalk7:
	unittalk getcharid(3), "ハインリヒ : カーリッツバーグ騎士団と白衣の騎士団は今すぐ奴を追え！";
	end;
OnTalk8:
	unittalk getcharid(3), "ハインリヒ : ……おい、どうした！　なぜ追わない！";
	end;
OnTalk9:
	unittalk getcharid(3), "ハインリヒ : ま、まさかこんなことが……私の部下たちが……あ、ありえない！";
	end;
OnTalk10:
	unittalk getcharid(3), "ハインリヒ : ……。";
	end;
OnTalk11:
	unittalk getcharid(3), "ハインリヒ : ……そうですね。すみません……。";
	end;
OnTalk12:
	unittalk getcharid(3), "ハインリヒ : すまない、すべて私の責任だ……。せめて安らかに眠ってくれ……。";
	end;
}

1@gl_k,149,100,5	script	ハインリヒ#3	652,{
	end;
OnTalk1:
	unittalk getcharid(3), "ハインリヒ : ……バルムント様のおっしゃる通りです。悲しんでいる場合ではありません。";
	end;
OnTalk2:
	unittalk getcharid(3), "ハインリヒ : 冒険者の方にお願いがあります。";
	end;
OnTalk3:
	unittalk getcharid(3), "ハインリヒ : まだこの周辺に生存者がいるかもしれません。生存者を探して助けてあげて下さい。";
	end;
OnTalk4:
	unittalk getcharid(3), "ハインリヒ : それから……ヒメルメズは生きている人間を魔物に変える能力を持っているようです。";
	end;
OnTalk5:
	unittalk getcharid(3), "ハインリヒ : 魔物と化した者は、どうか……あなたの手で……";
	end;
OnTalk6:
	unittalk getcharid(3), "ハインリヒ : ……私は、バルムント様と共にヒメルメズの後を追います。";
	end;
}

1@gl_k,96,80,0	warp	#2統制	2,2,1@gl_k,80,80
1@gl_k,95,80,0	script	#2統制_mobdead	139,{
OnStart:
	set .@map$,getmdmapname("1@gl_k");
...
OnTimer1000:
	...
	killmonster getmdmapname("1@gl_k"),getmdnpcname("#2統制_mobdead")+"::OnKilled";
	hideoffnpc getmdnpcname("アコライト志望生ドムン#");
	end;
}

1@gl_k,90,80,0	warp	#2統制2	2,2,1@gl_k,105,80
1@gl_k,80,80,0	script	#2ドムンの叫び	139,1,1,{
	hideonnpc;
	initnpctimer;
...
1@gl_k,17,51,3	script	アコライト志望生ドムン#	706,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		mes "[アコライト志望生ドムン]";
		mes "助けて下さい！　助けて下さい！";
		unittalk getcharid(3), "アコライト志望生ドムン : 助けて下さい！　助けて下さい！";
		next;
		menu "大丈夫？",-;
		mes "["+strcharinfo(0)+"]";
		mes "大丈夫？";
		...
		mes "みんな怪物になってしまいました。";
		mes "僕は何もできなくて……。";
		unittalk getcharid(3), "アコライト志望生ドムン : 家令様が……修道士様が……みんな怪物になってしまいました。僕は何もできなくて……。";
		next;
		mes "[アコライト志望生ドムン]";
		mes "ただ、ここに隠れているしか……";
		mes "何も、何もできませんでした……。";
		unittalk getcharid(3), "アコライト志望生ドムン : ただ、ここに隠れているしか……何も、何もできませんでした……。";
		next;
		menu "しっかりして！",-;
		mes "["+strcharinfo(0)+"]";
		mes "しっかりして！";
		...
		mes "中央ホールですか？";
		mes "ひとりで？　どうやって？";
		unittalk getcharid(3), "アコライト志望生ドムン : 中央ホールですか？　ひとりで？　どうやって？";
		next;
		mes "‐ふと足元を見ると";
		mes "　犠牲となった人の持ち物らしき";
		mes "　1本のメイスが転がっていた‐";
		...
		mes "わかりました。";
		mes "や、やってみます。";
		unittalk getcharid(3), "アコライト志望生ドムン : わかりました。や、やってみます。";
		close2;
		hideonnpc;
...
1@gl_k,224,82,3		script	息絶えた男#1	849,5,5,{
	if(sc_ison(4) || sc_ison(5) || sc_ison(119) || sc_ison(402) || sc_ison(438))
		end;
	set .@num,rand(3,7);
	set .@dummy,getmapxy(.@map$,.@x,.@y,BL_NPC);
	misceffect 124;
	hideonnpc;
...
1@gl_k,233,123,4	duplicate(息絶えた男#1)	息絶えた男#2	849,5,5
1@gl_k,258,150,2	duplicate(息絶えた男#1)	息絶えた男#3	849,5,5
1@gl_k,255,157,5	duplicate(息絶えた男#1)	息絶えた男#4	849,5,5
1@gl_k,280,167,4	duplicate(息絶えた男#1)	息絶えた男#5	849,5,5
1@gl_k,293,161,2	duplicate(息絶えた男#1)	息絶えた男#6	849,5,5
1@gl_k,249,101,3	duplicate(息絶えた男#1)	息絶えた男#7	849,5,5
1@gl_k,241,86,6		duplicate(息絶えた男#1)	息絶えた男#8	849,5,5
1@gl_k,246,62,8		duplicate(息絶えた男#1)	息絶えた男#9	849,5,5
1@gl_k,240,43,7		duplicate(息絶えた男#1)	息絶えた男#10	849,5,5
1@gl_k,271,19,1		duplicate(息絶えた男#1)	息絶えた男#11	849,5,5
1@gl_k,282,48,5		duplicate(息絶えた男#1)	息絶えた男#12	849,5,5
1@gl_k,285,81,7		duplicate(息絶えた男#1)	息絶えた男#13	849,5,5
1@gl_k,276,106,8	duplicate(息絶えた男#1)	息絶えた男#14	849,5,5
1@gl_k,261,164,8	duplicate(息絶えた男#1)	息絶えた男#15	849,5,5
1@gl_k,269,173,8	duplicate(息絶えた男#1)	息絶えた男#16	849,5,5
1@gl_k,252,120,8	duplicate(息絶えた男#1)	息絶えた男#17	849,5,5
1@gl_k,225,63,8		duplicate(息絶えた男#1)	息絶えた男#18	849,5,5
1@gl_k,227,39,8		duplicate(息絶えた男#1)	息絶えた男#19	849,5,5
1@gl_k,226,27,8		duplicate(息絶えた男#1)	息絶えた男#20	849,5,5
1@gl_k,223,17,9		duplicate(息絶えた男#1)	息絶えた男#21	849,5,5
1@gl_k,230,50,10	duplicate(息絶えた男#1)	息絶えた男#22	849,5,5
1@gl_k,235,16,11	duplicate(息絶えた男#1)	息絶えた男#23	849,5,5
1@gl_k,226,96,12	duplicate(息絶えた男#1)	息絶えた男#24	849,5,5
1@gl_k,222,119,13	duplicate(息絶えた男#1)	息絶えた男#25	849,5,5
1@gl_k,251,20,14	duplicate(息絶えた男#1)	息絶えた男#26	849,5,5

1@gl_k,202,79,0		warp	#3統制	2,2,1@gl_k,215,79
1@gl_k,202,80,0		script	#3統制_mobdead	139,{
OnStart:
	set .@map$,getmdmapname("1@gl_k");
...
OnKilled:
	set .@count,66 - getmapmobs(getmdmapname("1@gl_k"),getmdnpcname("#3統制_mobdead")+"::OnKilled");
	if(.@count >= 56) {
		initnpctimer;
...
OnTimer1000:
	stopnpctimer;
	announce "ヒメルメズの魔力でモンスター化した人々が消えていく……付近の生存者を探そう。",0x9,0xffff00;
	killmonster getmdmapname("1@gl_k"),getmdnpcname("#3統制_mobdead")+"::OnKilled";
	hideoffnpc getmdnpcname("鍛冶屋デストロイヤー#1");
	end;
}

1@gl_k,206,79,0		warp	#3統制2	2,2,1@gl_k,195,79

1@gl_k,215,79,0		script	#3デストロイヤーの叫び	139,1,1,{
	hideonnpc;
	initnpctimer;
...
1@gl_k,291,145,3	script	鍛冶屋デストロイヤー#1	726,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		mes "[鍛冶屋デストロイヤー]";
		mes "いやああ！　来ないで！";
		misceffect 102;
		unittalk getcharid(3), "鍛冶屋デストロイヤー : いやああ！　来ないで！";
		next;
		menu "安心して下さい",-;
		mes "["+strcharinfo(0)+"]";
		mes "安心して下さい！　人間です。";
		...
		mes "[鍛冶屋デストロイヤー]";
		mes "生き残ったのは私だけです……。";
		unittalk getcharid(3), "鍛冶屋デストロイヤー : 生き残ったのは私だけです……。";
		next;
		menu "ここは危険です",-;
		mes "["+strcharinfo(0)+"]";
		mes "ここは危険です。";
		...
		mes "はい、動けます。";
		mes "この子の為にも私が動かなくちゃ。";
		unittalk getcharid(3), "鍛冶屋デストロイヤー : はい、動けます。この子の為にも私が動かなくちゃ。";
		next;
		menu "どうかご無事で",-;
		mes "["+strcharinfo(0)+"]";
		mes "無事にその子とここから";
		...
		mes "いいえ、本当に助かりました。";
		mes "ありがとうございます。";
		unittalk getcharid(3), "鍛冶屋デストロイヤー : いいえ、本当に助かりました。ありがとうございます。";
		close2;
		hideonnpc;
...
1@gl_k,215,216,0	script	#4ヒメルメズの囁き	139,1,1,{
	hideonnpc;
	initnpctimer;
...
1@gl_k,227,216,0	warp	#4統制	2,2,1@gl_k,215,216

1@gl_k,202,80,0		script	#4統制_mobdead	139,{
OnStart:
	set .@map$,getmdmapname("1@gl_k");
...
OnKilled:
	set .@count,92 - getmapmobs(getmdmapname("1@gl_k"),getmdnpcname("#4統制_mobdead")+"::OnKilled");
	if(.@count >= 86) {
		initnpctimer;
	}
	end;
OnTimer1000:
	killmonster getmdmapname("1@gl_k"),getmdnpcname("#4統制_mobdead")+"::OnKilled";
...
1@gl_k,222,216,0	warp	#4統制2	2,2,1@gl_k,235,216

1@gl_k,150,257,0	script	#ヒメルon	139,6,6,{
	if(OLDGLAST_QUE >= 1) {
		mes "‐大階段の前には";
		mes "　余裕の笑みを浮かべた";
		mes "　ヒメルメズがいた‐";
...
1@gl_k,150,257,3	script	ヒメルメズ#2	650,{
	cutin "GL_HIMEL2",2;
	mes "[ヒメルメズ]";
	mes "そんな不安な眼で私を見つめる";
	mes "必要はないわ。";
...
OnTalk1:
	unittalk getcharid(3), "ヒメルメズ : ここまで辿りつくなんて、運がいいわね。それとも、それだけの力を持っていたのかしら。";
	end;
OnTalk2:
	unittalk getcharid(3), "ヒメルメズ : あ～ら、追いつかれちゃったわ。でも、ここまで来るのに随分苦労したみたいね～、おほほ。";
	end;
OnTalk3:
	unittalk getcharid(3), "ヒメルメズ : うふふ、あなたの苦しむ姿……本当に、よかったわ。ん～、でもね、楽しみはまだ始まったばかりなのよ。";
	end;
OnTalk4:
	unittalk getcharid(3), "ヒメルメズ : 私が一人で来たと思っているの？　おほほ、それじゃあ、あなたたちは私のオモチャと遊んでいなさい。";
	end;
OnTalk5:
	unittalk getcharid(3), "ヒメルメズ : では私はこれで。ハインリヒ……あなたとはもう一度会いたいわ。また機会があれば、ね。";
	end;
}

1@gl_k,144,258,6	script	ハインリヒ#4	652,{
	cutin "GL_HEINRICH1",2;
	mes "[ハインリヒ]";
	mes "ヒメルメズ……";
	mes "私の部下たちを手にかけた罪、";
...
OnTalk1:
	unittalk getcharid(3), "ハインリヒ : ヒメルメズ！　貴様、ここにいたか！";
	end;
OnTalk2:
	unittalk getcharid(3), "ハインリヒ : よくも部下たちを……その罪、命をもって償ってもらう！";
	end;
OnTalk3:
	unittalk getcharid(3), "ハインリヒ : こ……これは！";
	end;
OnTalk4:
	unittalk getcharid(3), "ハインリヒ : 待て！　ヒメルメズ!!";
	end;
OnTalk5:
	unittalk getcharid(3), "ハインリヒ : 冒険者の方も力を貸して下さい。私とバルムント卿はヒメルメズを追います！";
	end;
}

1@gl_k,156,258,3	script	バルムント#2	654,{
	if(checkquest2(12318) & 0x4) {
		cutin "GL_BARMUND1",2;
		mes "[バルムント]";
		mes "あの強力なモンスターを相手に";
		mes "よく無事でいてくれた。";
...
OnTalk1:
	unittalk getcharid(3), "バルムント : ハインリヒ卿！　何か、強大な力がこちらに向かって来ています！";
	end;
OnTalk2:
	unittalk getcharid(3), "バルムント : 大丈夫か？　こちらもちょっと問題があってな……まずは私に話しかけてくれ。";
	end;
}

1@gl_k,3,1,1	script	#ボス統制	844,{
OnStart:
	monster getmdmapname("1@gl_k"),150,259,"誘いの魔眼#1",2475,1,getmdnpcname("#ボス統制")+"::OnKilled";
	end;
OnKilled:
...
1@gl_k,150,284,0	script	#2階入り口	45,2,2,{
	if(checkquest2(12318) & 0x4) {
		mes "[バルムント]";
		mes "おい、どこへ行くんだ。";
		mes "まずは私に詳しい話を";
	...
	warp getmdmapname("2@gl_k"),150,46;
	end;
}
1@gl_k,103,203,0	warp	#秘密部屋出入り口	2,2,1@gl_k,103,227

1@gl_k,269,267,3	script	怪しい亀裂#1	844,{
	if(checkquest2(12322)) {
		mes "‐亀裂の奥に隠し通路を";
		mes "　見つけた‐";
		close2;
		warp getmdmapname("1@gl_k"),149,198;
		end;
	}
	mes "‐怪しい亀裂がある‐";
	close;
...
1@gl_k,165,136,3	script	ガラスケース#2	844,{
	if(checkquest2(12322)) {
		initnpctimer;
		misceffect 234;
...
OnTimer1000:
	...
	for(set .@i,0; .@i<getarraysize(.@gain); set .@i,.@i+1) {
		...
		set .@y,136+rand(5)+2;
		if(rand(1000) < .@rate[.@i])
			dropitem getmdmapname("1@gl_k"),.@x,.@y,.@gain[.@i],1,0;
	}
	stopnpctimer;
	end;
}

1@gl_k,159,136,3	script	ガラスケース#3	844,{
	if(checkquest2(12322)) {
		initnpctimer;
		misceffect 234;
		hideonnpc getmdnpcname(strnpcinfo(0));
...
1@gl_k,153,136,3	script	ガラスケース#4	844,{
	if(checkquest2(12322)) {
		initnpctimer;
		misceffect 234;
		hideonnpc getmdnpcname(strnpcinfo(0));
...
1@gl_k,147,136,3	script	ガラスケース#5	844,{
	if(checkquest2(12322)) {
		initnpctimer;
		misceffect 234;
		hideonnpc getmdnpcname(strnpcinfo(0));
...
1@gl_k,141,136,3	script	ガラスケース#6	844,{
	if(checkquest2(12322)) {
		initnpctimer;
		misceffect 234;
		hideonnpc getmdnpcname(strnpcinfo(0));
...
1@gl_k,135,136,3	script	ガラスケース#7	844,{
	if(checkquest2(12322)) {
		initnpctimer;
		misceffect 234;
		hideonnpc getmdnpcname(strnpcinfo(0));
...
1@gl_k,129,136,3	script	ガラスケース#8	844,{
	if(checkquest2(12322)) {
		initnpctimer;
		misceffect 234;
		hideonnpc getmdnpcname(strnpcinfo(0));
...
// 古のグラストヘイム2F
//------------------------------------------------------------
2@gl_k,149,32,0	warp	#1統制	2,2,1@gl_k,150,270

2@gl_k,150,66,0	script	#ハインon	139,10,10,{
	if(OLDGLAST_QUE >= 2) {
		mes "‐ハインリヒとバルムントが";
		mes "　何やら話をしている‐";
		next;
...
2@gl_k,148,67,1	script	ハインリヒ#21	652,{
	cutin "GL_HEINRICH1",2;
	mes "[ハインリヒ]";
	mes "周囲がヒメルメズの結界で";
	mes "閉ざされているのか……。";
...
OnTalk1:
	unittalk getcharid(3), "ハインリヒ : ……くっ、この結界は、私の剣ではどうやっても破壊できないのか……。";
	end;
OnTalk2:
	unittalk getcharid(3), "ハインリヒ : むう……おお、冒険者の方。よくぞご無事で。";
	end;
OnTalk3:
	unittalk getcharid(3), "ハインリヒ : 結界に邪魔され、先に進むことができないのです。";
	end;
OnTalk4:
	unittalk getcharid(3), "ハインリヒ : そんなこと、許されるはずがないだろう！";
	end;
OnTalk5:
	unittalk getcharid(3), "ハインリヒ : 私はすでに多くの部下をこの手にかけた。また、罪もない者を斬れというのか！";
	end;
OnTalk6:
	unittalk getcharid(3), "ハインリヒ : ……。";
	end;
...
2@gl_k,151,71,7	script	バルムント#21	654,{
	cutin "GL_BARMUND2",2;
	mes "[バルムント]";
	mes "いったい、私はこんなことを";
	mes "何度繰り返したのか……";
...
OnTalk1:
	unittalk getcharid(3), "バルムント : ヒメルメズの結界は、物理的なダメージを受け付けないようですね。";
	end;
OnTalk2:
	unittalk getcharid(3), "バルムント : ヒメルメズによって今通った階段の時空が歪められ、ここに出たのだが……。";
	end;
OnTalk3:
	unittalk getcharid(3), "バルムント : 私の魔法をもう1度試してみます。ハインリヒ卿、下がってください。";
	end;
OnTalk4:
	unittalk getcharid(3), "バルムント : 結界の一部は壊れましたが、やはりこれ以上は無理なようですね。";
	end;
OnTalk5:
	unittalk getcharid(3), "バルムント : 実は、以前にもこのような結界を見たことがあるのですが……";
	end;
OnTalk6:
	unittalk getcharid(3), "バルムント : その時、ヒメルメズはアンデッド化した人の中に埋め込んだ結界石で結界を維持していました。";
	end;
OnTalk7:
	unittalk getcharid(3), "バルムント : おそらく、この結界もそうやって維持されているのでしょう。";
	end;
OnTalk8:
	unittalk getcharid(3), "バルムント : 他の結界を壊すには彼らの中から結界石を持った者を倒すしかありません。";
	end;
OnTalk9:
	unittalk getcharid(3), "バルムント : しかし、私たちにはそれを見分けることはできない。つまり見かけたものすべてを浄化していくしかありません……。";
	end;
OnTalk10:
	unittalk getcharid(3), "バルムント : ハインリヒ卿……。";
	end;
OnTalk11:
	unittalk getcharid(3), "バルムント : あなたは優し過ぎます。";
	end;
OnTalk12:
	unittalk getcharid(3), "バルムント : 私たちが相手にする存在は、すでに人間ではありません。";
	end;
OnTalk13:
	unittalk getcharid(3), "バルムント : 彼らが魔物である事を否定したからといって、彼らが再び人間に戻ることはありません。";
	end;
OnTalk14:
	unittalk getcharid(3), "バルムント : 君も戦力を整えたら、私たちについてきてくれ。";
	end;
OnTalk15:
	unittalk getcharid(3), "バルムント : 東西のエリアを探索して結界石を持った魔物を倒すぞ。";
	end;
OnTalk16:
	unittalk getcharid(3), "バルムント : 辛い戦いになるだろうが……頼んだぞ。";
	end;
}

2@gl_k,145,123,0	warp	#22統制		2,2,2@gl_k,126,123
2@gl_k,136,122,0	warp	#22統制2	2,2,2@gl_k,150,116

2@gl_k,118,141,0	script	#2-1	139,5,5,{
OnStart:
OnTouch:
	setarray .x[1],116,126,129, 87, 62, 60, 36;
	setarray .y[1],139, 79, 52, 46,115, 80,136;
	set .@map$,getmdmapname("2@gl_k");
	set .@id,substr2(strnpcinfo(2),2,3);
...
2@gl_k,128,81,0	duplicate(#2-1)	#2-2	139,5,5
2@gl_k,131,54,0	duplicate(#2-1)	#2-3	139,5,5
2@gl_k,89,48,0	duplicate(#2-1)	#2-4	139,5,5
2@gl_k,64,117,0	duplicate(#2-1)	#2-5	139,5,5
2@gl_k,62,82,0	duplicate(#2-1)	#2-6	139,5,5
2@gl_k,38,138,0	duplicate(#2-1)	#2-7	139,5,5

2@gl_k,1,1,0	script	#22統制_mobdead	139,{
OnStart:
	set .@map$,getmdmapname("2@gl_k");
...
OnKilled1:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#22統制_mobdead")+"::OnKilled1");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x1)) {
...
OnKilled2:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#22統制_mobdead")+"::OnKilled2");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x2)) {
...
OnKilled3:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#22統制_mobdead")+"::OnKilled3");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x4)) {
...
OnKilled4:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#22統制_mobdead")+"::OnKilled4");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x8)) {
...
OnKilled5:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#22統制_mobdead")+"::OnKilled5");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
...
OnKilled6:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#22統制_mobdead")+"::OnKilled6");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
...
OnKilled7:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#22統制_mobdead")+"::OnKilled7");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
...
OnTimer1000:
	...
	set .@r,rand(1,7);
	areamonster getmdmapname("2@gl_k"),.x[.@r],.y[.@r],.x[.@r]+5,.y[.@r]+5,"苦痛のロイヤルナイト",2473,1,getmdnpcname("#22統制_mobdead")+"::OnKilled8";
...
2@gl_k,154,101,0	warp	#23統制		2,2,2@gl_k,174,101
2@gl_k,165,101,0	warp	#23統制2	2,2,2@gl_k,150,111

2@gl_k,171,120,0	script	#3-1	139,5,5,{
OnStart:
OnTouch:
...
2@gl_k,232,133,0	duplicate(#3-1)	#3-2	139,5,5
2@gl_k,256,149,0	duplicate(#3-1)	#3-3	139,5,5
2@gl_k,212,106,0	duplicate(#3-1)	#3-4	139,5,5
2@gl_k,243,73,0		duplicate(#3-1)	#3-5	139,5,5
2@gl_k,229,26,0		duplicate(#3-1)	#3-6	139,5,5
2@gl_k,181,34,0		duplicate(#3-1)	#3-7	139,5,5

2@gl_k,2,1,0	script	#23統制_mobdead	139,{
OnStart:
	set .@map$,getmdmapname("2@gl_k");
...
OnKilled1:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#23統制_mobdead")+"::OnKilled1");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x1)) {
...
OnKilled2:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#23統制_mobdead")+"::OnKilled2");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x2)) {
...
OnKilled3:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#23統制_mobdead")+"::OnKilled3");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x4)) {
...
OnKilled4:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#23統制_mobdead")+"::OnKilled4");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x8)) {
...
OnKilled5:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#23統制_mobdead")+"::OnKilled5");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x10)) {
...
OnKilled6:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#23統制_mobdead")+"::OnKilled6");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x20)) {
...
OnKilled7:
	set .@count,getmapmobs(getmdmapname("2@gl_k"),getmdnpcname("#23統制_mobdead")+"::OnKilled7");
	set .flag,.flag+1;
	if(!rand(35) || .flag >= 35)
		initnpctimer;
	if(.@count <= 0 && !(.area&0x40)) {
...
OnTimer1000:
	...
	set .@r,rand(1,7);
	areamonster getmdmapname("2@gl_k"),.x[.@r],.y[.@r],.x[.@r]+5,.y[.@r]+5,"呪われたロイヤルナイト",2474,1,getmdnpcname("#23統制_mobdead")+"::OnKilled8";
	announce "バルムント : この邪悪な気は……！　強大な力を持った魔物が近くにいるぞ！",0x9,0xffff44,0x190,15;
	end;
OnKilled8:
...
2@gl_k,153,214,3	script	腐敗した死体#20	849,5,5,{
	if(sc_ison(4) || sc_ison(5) || sc_ison(119) || sc_ison(402) || sc_ison(438))
		end;
	set .@num,rand(3,7);
	set .@dummy,getmapxy(.@map$,.@x,.@y,BL_NPC);
	...
	hideonnpc;
	initnpctimer;
	killmonster getmdmapname("2@gl_k"),getmdnpcname(strnpcinfo(0))+"::OnKilled";
...
2@gl_k,155,195,4	duplicate(腐敗した死体#20)	腐敗した死体#21	849,5,5
2@gl_k,154,188,2	duplicate(腐敗した死体#20)	腐敗した死体#22	849,5,5
2@gl_k,143,195,5	duplicate(腐敗した死体#20)	腐敗した死体#23	849,5,5
2@gl_k,132,214,4	duplicate(腐敗した死体#20)	腐敗した死体#24	849,5,5
2@gl_k,125,208,2	duplicate(腐敗した死体#20)	腐敗した死体#25	849,5,5
2@gl_k,114,210,3	duplicate(腐敗した死体#20)	腐敗した死体#26	849,5,5
2@gl_k,137,182,6	duplicate(腐敗した死体#20)	腐敗した死体#27	849,5,5
2@gl_k,138,246,8	duplicate(腐敗した死体#20)	腐敗した死体#28	849,5,5
2@gl_k,132,260,7	duplicate(腐敗した死体#20)	腐敗した死体#29	849,5,5
2@gl_k,128,251,1	duplicate(腐敗した死体#20)	腐敗した死体#30	849,5,5
2@gl_k,179,260,3	duplicate(腐敗した死体#20)	腐敗した死体#31	849,5,5
2@gl_k,170,261,4	duplicate(腐敗した死体#20)	腐敗した死体#32	849,5,5
2@gl_k,177,219,2	duplicate(腐敗した死体#20)	腐敗した死体#33	849,5,5
2@gl_k,190,214,5	duplicate(腐敗した死体#20)	腐敗した死体#34	849,5,5
2@gl_k,201,214,4	duplicate(腐敗した死体#20)	腐敗した死体#35	849,5,5
2@gl_k,143,260,4	duplicate(腐敗した死体#20)	腐敗した死体#1	849,5,5
2@gl_k,145,236,4	duplicate(腐敗した死体#20)	腐敗した死体#2	849,5,5
2@gl_k,141,222,2	duplicate(腐敗した死体#20)	腐敗した死体#3	849,5,5
2@gl_k,147,203,5	duplicate(腐敗した死体#20)	腐敗した死体#4	849,5,5
2@gl_k,167,225,4	duplicate(腐敗した死体#20)	腐敗した死体#5	849,5,5
2@gl_k,172,233,2	duplicate(腐敗した死体#20)	腐敗した死体#6	849,5,5
2@gl_k,176,244,3	duplicate(腐敗した死体#20)	腐敗した死体#7	849,5,5
2@gl_k,184,248,6	duplicate(腐敗した死体#20)	腐敗した死体#8	849,5,5
2@gl_k,193,228,8	duplicate(腐敗した死体#20)	腐敗した死体#9	849,5,5
2@gl_k,206,250,7	duplicate(腐敗した死体#20)	腐敗した死体#10	849,5,5
2@gl_k,130,249,1	duplicate(腐敗した死体#20)	腐敗した死体#11	849,5,5
2@gl_k,122,236,5	duplicate(腐敗した死体#20)	腐敗した死体#12	849,5,5
2@gl_k,130,228,7	duplicate(腐敗した死体#20)	腐敗した死体#13	849,5,5
2@gl_k,106,226,8	duplicate(腐敗した死体#20)	腐敗した死体#14	849,5,5
2@gl_k,104,245,8	duplicate(腐敗した死体#20)	腐敗した死体#15	849,5,5
2@gl_k,131,187,8	duplicate(腐敗した死体#20)	腐敗した死体#16	849,5,5
2@gl_k,121,197,8	duplicate(腐敗した死体#20)	腐敗した死体#17	849,5,5
2@gl_k,107,194,8	duplicate(腐敗した死体#20)	腐敗した死体#18	849,5,5
2@gl_k,92,187,8		duplicate(腐敗した死体#20)	腐敗した死体#19	849,5,5

2@gl_k,150,163,0	warp	#24統制		2,2,2@gl_k,150,179
2@gl_k,150,167,0	warp	#24統制2	2,2,2@gl_k,150,149

2@gl_k,150,180,0	script	#ゲルon	139,1,1,{
	hideonnpc;
...
2@gl_k,158,252,1	script	ヒメルメズ#22	650,3,3,{
	if(OLDGLAST_QUE >= 2) {
		mes "‐ハインリヒ達と共に";
		mes "　ヒメルメズに追いついた‐";
		next;
...
2@gl_k,153,250,8	script	ハインリヒ#23	652,{
	cutin "GL_HEINRICH1",2;
	mes "[ハインリヒ]";
	mes "何を企んでいるのだ、ヒメルメズ！";
	close2;
...
OnTalk1:
	unittalk getcharid(3), "ハインリヒ : ゲルハルト!";
	end;
OnTalk2:
	unittalk getcharid(3), "ハインリヒ : ゲルハルトに何をした！　ヒメルメズ！";
	end;
OnTalk3:
	unittalk getcharid(3), "ハインリヒ : ヒメルメズ！　ユミルの心臓の欠片を見つけたならば、もうここに用は無いはずだ！";
	end;
OnTalk4:
	unittalk getcharid(3), "ハインリヒ : ゲルハルトを離せ！　これ以上の犠牲は必要ないだろう！";
	end;
OnTalk5:
	unittalk getcharid(3), "ハインリヒ : ヒメルメズ！　貴様、絶対に許さんぞ！";
	end;
OnTalk6:
	unittalk getcharid(3), "ハインリヒ : このまま逃がすとでも思っているのか！　ヒメルメズ!!";
	end;
}

2@gl_k,162,250,1	script	バルムント#23	654,{
	cutin "GL_BARMUND2",2;
	mes "[バルムント]";
	mes "この拘束からは永遠に";
	mes "抜け出す事はできないのだろうか……。";
...
OnTalk1:
	unittalk getcharid(3), "バルムント : ハインリヒ卿！　……仕方ない、残った私たちだけでアムダライスを止めなければ！";
	end;
}

2@gl_k,158,255,1	script	ゲルハルト#23	651,{
	mes "[ゲルハルト]";
	mes "うう……くっ！";
	mes "司令官を連れて……";
	mes "早くここから逃げて下さい！";
	close;
OnTalk1:
	unittalk getcharid(3), "ゲルハルト : くっ！　逃げて下さい！　これ以上は耐えられません！";
	end;
OnTalk2:
	unittalk getcharid(3), "ゲルハルト : 司令官……急いでここから逃げ……。";
	end;
OnTalk3:
	unittalk getcharid(3), "ゲルハルト : どれほど私の体を汚そうとも、私の魂まで汚せると思うなよ！　ヒメルメズ！";
	end;
}

2@gl_k,158,252,4	script	ヒメルメズ#23	650,{
	cutin "GL_HIMEL2",2;
	mes "[ヒメルメズ]";
...
OnTalk1:
	unittalk getcharid(3), "ヒメルメズ : 素晴らしい！　ここまで来れるとは思っていなかったわ。";
	end;
OnTalk2:
	unittalk getcharid(3), "ヒメルメズ : ふふふ、ユミルの心臓の欠片はすでに見つけたわよ。ハインリヒ。";
	end;
OnTalk3:
	unittalk getcharid(3), "ヒメルメズ : 彼の邪魔さえなければもっと早かったのだけれど。";
	end;
OnTalk4:
	unittalk getcharid(3), "ヒメルメズ : 本当にそう思っているの？　口が達者なのは王も兵士も変わらないのね……。";
	end;
OnTalk5:
	unittalk getcharid(3), "ヒメルメズ : 嫌よ。";
	end;
OnTalk6:
	unittalk getcharid(3), "ヒメルメズ : 彼が最後の部下なんでしょう？";
	end;
OnTalk7:
	unittalk getcharid(3), "ヒメルメズ : 彼、かなりの腕前だったわ。";
	end;
OnTalk8:
	unittalk getcharid(3), "ヒメルメズ : 私の新しいアムダライスの素体にぴったりな程にね。";
	end;
OnTalk9:
	unittalk getcharid(3), "ヒメルメズ : あ～ら怖い。";
	end;
OnTalk10:
	unittalk getcharid(3), "ヒメルメズ : まあ、あなたとはもう少し話したいこともあるし、次の機会にまた会いましょう。";
	end;
OnTalk11:
	unittalk getcharid(3), "ヒメルメズ : けど、今は生まれ変わった部下とお喋りでもしていなさい。";
	end;
}

2@gl_k,150,247,5	script	バルムントの幻影#バフ1::バルムントの幻影#1	654,3,3,{
	end;
OnTouch:
...
OnStart:
	hideoffnpc;
	initnpctimer;
	unittalk getcharid(3), "バルムントの幻影 : アムダライスが強力な魔法を使用するぞ！　私の近くまで下がれ！";
	end;
OnTimer12000:
	stopnpctimer;
	hideonnpc;
...
2@gl_k,165,247,3	script	バルムントの幻影#バフ2::バルムントの幻影#2	654,3,3,{
	end;
OnTouch:
	sc_start SC_GLASTHEIM_STATE,30000,25;		//SI_GLASTHEIM_STATE
	end;
OnStart:
	hideoffnpc;
	initnpctimer;
	unittalk getcharid(3), "バルムントの幻影 : 今は攻撃のチャンスだ！　私の近くに来て強化を受けるんだ！";
	end;
OnTimer12000:
	stopnpctimer;
	hideonnpc;
...
2@gl_k,150,232,8	script	バルムントの幻影#バフ3::バルムントの幻影#3	654,3,3,{
	end;
OnTouch:
	sc_start SC_GLASTHEIM_STATE,30000,25;		//SI_GLASTHEIM_STATE
	end;
OnStart:
	hideoffnpc;
	initnpctimer;
	unittalk getcharid(3), "バルムントの幻影 : アムダライスの召喚した魔物にやられる前に、私の近くに来て態勢を立て直すんだ！";
	end;
OnTimer12000:
	stopnpctimer;
	hideonnpc;
...
2@gl_k,165,232,2	script	バルムントの幻影#バフ4::バルムントの幻影#4	654,3,3,{
	end;
OnTouch:
	sc_start SC_GLASTHEIM_STATE,30000,25;		//SI_GLASTHEIM_STATE
	end;
OnStart:
	hideoffnpc;
	initnpctimer;
	unittalk getcharid(3), "バルムントの幻影 : アムダライスの力にやられたくなければ、私の近くで補助を受けるんだ！";
	end;
OnTimer12000:
	stopnpctimer;
	hideonnpc;
...
OnTimer62000:
	killmonster getmdmapname("2@gl_k"),getmdnpcname("#2ボス統制")+"::OnKilled";
	initnpctimer;
	end;
OnKilled:
	end;
...
2@gl_k,4,1,0	script	#2ボス統制_bc	844,{
OnStart:
	if(rand(2)) {
...
2@gl_k,5,1,0	script	#アムダ統制	844,{
OnStart:
	set .mob,callmonster(getmdmapname("2@gl_k"),158,255,"アムダライス#1",2476,getmdnpcname("#アムダ統制")+"::OnKilled");
	set .maxhp,getunitdata(.mob,UMOB_HP);
	end;
OnCasting:
	set .@hp,getunitdata(.mob,UMOB_HP) / .maxhp * 100;
	if(.@hp < 20) {
...
OnKilled:
	killmonster getmdmapname("2@gl_k"),getmdnpcname("#ゲルon")+"::OnKilled";
...
2@gl_k,158,241,1	script	フギン#21	755,{
	if(checkquest2(12319)) {
		if(checkquest2(12319) & 0x4) {
			if(checkitemblank() < 2) {
				mes "[フギン]";
				mes "渡したい物があったが、";
				mes "荷物が溢れそうだな。";
		...
		misceffect 134,"";
		close2;
		warp getmdmapname("2@gl_k"),159,245;
		end;
	}
	mes "[フギン]";
	mes "もうすぐ時間の狭間が歪曲され";
