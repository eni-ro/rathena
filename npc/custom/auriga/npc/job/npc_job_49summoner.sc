...
//------------------------------------------------------------
// do_tu01a
do_tu01a,100,320,75,55	monster	エッグリン	3495,30,5000,0,0
do_tu01a,100,320,75,55	monster	グラスファブル	3497,30,5000,0,0
//------------------------------------------------------------
// do_tu04a
do_tu04a,0,0,0,0	monster	スウィートフロッグ	3499,40,5000,0,0
do_tu04a,0,0,0,0	monster	ハンターウルフ	3500,30,5000,0,0
do_tu04a,0,0,0,0	monster	ワイルドホーネット	3498,30,5000,0,0
do_tu04a,0,0,0,0	monster	リーフルナティック	3496,40,5000,0,0
do_tu04a,0,0,0,0	monster	偵察バジルリスク	3502,10,5000,0,0
//------------------------------------------------------------
// do_tu06a
do_tu06a,0,0,0,0	monster	偵察バジルリスク	3502,40,5000,0,0
do_tu06a,0,0,0,0	monster	トランススポア	3501,30,5000,0,0
//------------------------------------------------------------
// do_tu07a
do_tu07a,0,0,0,0	monster	偵察バジルリスク	3502,80,5000,0,0
//------------------------------------------------------------

//------------------------------------------------------------
// チュートリアルNPC
//------------------------------------------------------------
new_do1,90,247,0	script	object01#new_do1	139,30,3,{
	mes "[シェレ]";
	mes "そっちじゃないわ。";
	mes "こっちに来てちょうだい。";
...
new_do1,95,264,4	script	シェレ#new_do1	10165,{
	if(DORAM_1QUE == 100) {
		...
		mes "あなたの活躍、期待してるわ！";
		set DORAM_1QUE,100;
		savepoint "lasagna",299,239;
		warp "lasagna",298,238;
		end;
	}
	//setquest 102845;
	//compquest 102845;
...
do_tu05a,137,98,4	script	シェレ#do_tu01a	10165,{
	mes "[シェレ]";
	mes "あら、チュートリアルの";
	mes "終了をご希望かしら？";
	while(1) {
		...
		case 2:
			...
			close2;
			if(DORAM_1QUE <= 1)
				warp "do_tu01a",29,281;
			else if(DORAM_1QUE <= 24)
				warp "do_tu01a",60,320;
			else if(DORAM_1QUE <= 26)
				warp "do_tu02a",224,124;
			else if(DORAM_1QUE <= 34)
				warp "do_tu02a",235,196;
			else if(DORAM_1QUE <= 35)
				warp "do_tu02a",203,322;
			else if(DORAM_1QUE <= 37)
				warp "do_tu05a",186,55;
...
do_tu01a,134,381,0	script	warp01#do_tu01a	45,2,2,{
	mes "^ff0000【インフォメーション】";
	mes "進行中のチュートリアルから";
	mes "離れてしまいました。";
	mes "進行中のチュートリアルの";
	...
	if(DORAM_1QUE <= 1)
		...
		warp "do_tu02a",153,58;
	end;
}

do_tu01a,29,283,0	script	object01#do_tu01a	139,1,1,{
	if(DORAM_1QUE == 0) {
		initnpctimer;
...
do_tu01a,35,288,3	script	自警団員アジェニャー#do	10162,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
	switch(DORAM_1QUE) {
	case 0:
	case 1:
		if(checkquest2(98400)) {
			delquest 98400;
			getexp 2,10;
		}
		mes "[自警団員アジェニャー]";
		...
		case 2:
			...
			case 1:
				warp "do_tu01a",60,319;
				end;
			case 2:
				close;
			}
		case 3:
			warp "do_tu05a",136,95;
			end;
		}
		mes "[自警団員アジェニャー]";
...
do_tu01a,60,322,3	script	自警団員アリオ#do_tu01a	10154,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
	while(1) {
		...
		case 14:
			...
			if(getequiprefinerycnt2(4) < 4) {
				mes "[自警団員アリオ]";
				mes "おいおい、";
				if(getequiprefinerycnt2(4) == 0) {
					mes "精錬してもらってないじゃないか。";
					mes "ちゃんと精錬してもらってから";
					mes "声をかけてくれ。";
				}
...
do_tu01a,52,323,4	script	旅の行商人#do_tu01a	10163,{
	if(DORAM_1QUE < 18) {
		mes "[旅の行商人]";
		mes "オイラは旅の行商人さ。";
		mes "でも、キミには何も売れないよ。";
...
do_tu01a,66,323,4	script	旅の鍛冶屋#do_tu01a	10163,{
	if(DORAM_1QUE < 14) {
		mes "[旅の鍛冶屋]";
		mes "オレは旅の鍛冶屋だ。";
		mes "残念だがアリオの兄ちゃんの";
	...
	if(select("^nItemID^"+ getequipid2(4),"やめる") == 2) {
		mes "[旅の鍛冶屋]";
		mes "ん？　精錬しないのか？";
		close;
	}
...
do_tu02a,150,54,0	warp	warp01#do_tu02a	2,2,do_tu01a,131,378
do_tu02a,358,91,0	warp	warp02#do_tu02a	2,2,do_tu04a,20,98
do_tu02a,205,327,0	script	warp03#do_tu02a	45,2,2,{
	switch(DORAM_1QUE) {
	case 33:
		mes "‐近くに座っている";
		mes "　船員のドラムに話しかけよう‐";
...
do_tu02a,153,58,0	script	object01#do_tu02a	139,3,3,{
	if(DORAM_1QUE == 23) {
		mes "^009eff【インフォメーション】";
		mes "クエストウィンドウには";
		mes "行き先や目標が書いてあります。";
...
do_tu02a,224,126,5	script	治療師ハル#do_tu02a	10164,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
...
do_tu02a,235,198,3	script	ペロン団長#do_tu02a	10152,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
...
do_tu02a,203,324,5	script	エッグリン#do_tu02a	10157,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
...
do_tu03a,59,90,5	script	ペロン団長#do_tu03e	10152,{
	switch(DORAM_1QUE) {
	case 29:
		if(checkquest2(98417)) {
			delquest 98417;
			getexp 157,2400;
		}
		mes "[????]";
...
do_tu03a,64,92,3	script	ジンドウ#do_tu03e	10159,{
	if(DORAM_1QUE == 30) {
		delitem 25044, 1;
		getitem 25043, 1;
		set DORAM_1QUE,31;
...
do_tu03a,61,91,5	script	バジルリスク捕虜#do_tu0	10158,{
	emotion 9;
	mes "[バジルリスク捕虜]";
	mes "……。";
	close;
...
do_tu04a,16,98,0	warp	warp01#do_tu04a	2,2,do_tu02a,355,92
do_tu04a,348,244,0	script	warp02#do_tu04a	45,2,2,{
	if(DORAM_1QUE < 38) {
		mes "‐なにやら危なそうな気がする。";
		mes "　今はまだ先に進むのはやめよう‐";
		close;
	}
	warp "do_tu06a",24,143;
	end;
}

do_tu04a,20,98,0	script	object01#do_tu04a	139,3,3,{
	if(DORAM_1QUE == 27) {
		mes "^009eff【インフォメーション】";
		mes "クエストウィンドウには";
		mes "行き先や目標が書いてあります。";
...
do_tu04a,340,251,3	script	大きなトゲの生えた枝#do	111,{
	if(DORAM_1QUE == 27) {
		getitem 25044,1;
		set DORAM_1QUE,28;
		misceffect 5;
...
do_tu05a,59,62,0	warp	warp01#do_tu05a	2,2,do_tu02a,205,324
do_tu05a,50,60,0	script	warp02#do_tu05a	45,2,2,{
	if(DORAM_1QUE <= 35) {
		mes "‐「船長室」と書いてある。";
		mes "　まずは食堂に行こう‐";
		close;
...
do_tu05a,36,60,0	warp	warp03#do_tu05a	2,2,do_tu05a,54,60
do_tu05a,143,60,0	warp	warp04#do_tu05a	2,2,do_tu05a,165,60
do_tu05a,159,60,0	warp	warp05#do_tu05a	2,2,do_tu05a,138,60
do_tu05a,186,57,3	script	料理長#do_tu05a	548,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
...
do_tu05a,122,61,5	script	船員#do_tu05a_01	559,{
	mes "[船員]";
	mes "新大陸は初めてですか？";
	mes "一度も行って見たことない場所に";
	mes "行く気分はどうですか？";
...
do_tu05a,169,70,3	script	船員#do_tu05a_02	545,{
	mes "[船員]";
	mes "ミッドガルドも発見されたけど、";
	mes "他にもあるかな？";
	mes "地図にもない場所。";
...
do_tu05a,166,68,6	script	船員#do_tu05a_03	544,{
	mes "[船員]";
	mes "ステルロー一等航海士なら";
	mes "地図にもない新大陸への航路を";
	mes "また見つけ出しそうな気がする。";
...
do_tu05a,181,61,5	script	甲板長#do_tu05a	421,{
	mes "[甲板長]";
	mes "ここの料理長、顔はこええが";
	mes "料理の腕は確かなんだぜ。";
	close;
...
do_tu05a,181,58,3	script	操舵手#do_tu05a	561,{
	mes "[操舵手]";
	mes "エッグリンのやろう。";
	mes "まーたサボってやがるな。";
	close;
...
do_tu05a,26,64,5	script	ガムベリー船長#do_tu05a	10153,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
...
do_tu05a,24,62,5	script	ステルロー#do_tu05a	10156,{
	if(DORAM_1QUE < 38) {
		mes "[ステルロー]";
		mes "俺はステルロー。";
		mes "この船の航海士をやっている。";
...
do_tu05a,30,57,0	script	object01#do_tu05a	139,11,11,{
	if(DORAM_1QUE == 42) {
		cloakoffnpc "甲板長#do_tu05a_2";
		cloakoffnpc "操舵手#do_tu05a_2";
	}
...
do_tu05a,22,60,5	script	甲板長#do_tu05a_2	421,{
	mes "[甲板長]";
	mes "時間が経ち過ぎると";
	mes "積み荷が駄目になっちまうからな。";
	mes "早く何とかしてほしいもんだぜ。";
...
do_tu05a,21,56,3	script	操舵手#do_tu05a_2	561,{
	mes "[操舵手]";
	mes "いつになったら";
	mes "出航できるのかねえ。";
	close;
...
do_tu06a,18,143,0	warp	warp01#do_tu06a	2,2,do_tu04a,344,243
do_tu06a,29,146,5	script	自警団員#do_tu06a	10162,5,5,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
	if(DORAM_1QUE == 38) {
		if(checkquest2(98425)) {
			delquest 98425;
			getexp 430,4000;
		}
		mes "[自警団員]";
...
do_tu06a,153,103,3	script	自警団員#do_tu06a_2	10162,5,5,{
	if(distance2(getcharid(3)) > 5) {
		npctalk "‐もっと近づいてから話しかけよう‐";
		end;
	}
	if(DORAM_1QUE == 39) {
		if(checkquest2(98426)) {
			delquest 98426;
			getexp 475,6000;
		}
		mes "[自警団員]";
		...
		if(!checkquest2(98427))
			setquest 98427;
		warp "do_tu07a",190,20;
		end;
	}
	mes "^ff0000【インフォメーション】";
	mes "進行中のチュートリアルから";
...
do_tu07a,190,15,0	warp	warp01#do_tu07a	2,2,do_tu06a,153,98
do_tu07a,190,20,0	script	object01#do_tu07a	139,4,4,{
	if(DORAM_1QUE == 39) {
		mes "^009eff【インフォメーション】";
		mes "クエストウィンドウには";
		mes "行き先や目標が書いてあります。";
...
do_tu07a,159,156,5	script	自警団員#do_tu07a	10162,5,5,{
	if(DORAM_1QUE < 42) {
		mes "[自警団員]";
		mes "だいぶバジルリスクが増えたな……。";
		next;
...
do_tu07a,162,158,3	script	タルトゥーフィ#do_tu07a	10161,5,5,{
	if(DORAM_1QUE == 39) {
		if(checkquest2(98427)) {
			delquest 98427;
			getexp 524,8000;
...
do_tu07a,247,194,0	script	object02#do_tu07a	139,{}

do_tu02a,226,181,3	script	カルルー#do_tu02a	548,{
	mes "[カルルー]";
	mes "カルーニャミルクの";
	mes "主な材料を知っているか？";
	mes "カルーニャという特別な貝を";
...
do_tu02a,225,290,5	script	作業班長#do_tu02a	421,{
	mes "[作業班長]";
	mes "この仕事をやったことある？";
	mes "すぐに覚えられる簡単な事だ。";
	mes "コンキリナ号のガムベリー船長は";
...
do_tu02a,139,299,3	script	イワシ漁船船長#do_tu02a	561,{
	mes "[イワシ漁船船長]";
	mes "イワシ産業が";
	mes "以前より落ち込んでいても";
	mes "人手は常に不足している。";
...
do_tu02a,263,156,5	script	おばあちゃん#do_tu02a	554,{
	mes "[おばあちゃん]";
	mes "昔のラザーニャは凄かった。";
	mes "道も住民もボロボロ。";
	mes "当時は暗黒期と呼ばれているよ。";
...
do_tu02a,244,231,3	script	イワシ漁船員#do_tu02a	544,{
	mes "[イワシ漁船員]";
	mes "この黄色いチーズ道に沿って";
	mes "歩いて行けば、";
	mes "私たちの故郷が現れる。";
...
do_tu02a,260,134,3	script	ラスムス#do_tu02a	546,{
	mes "[ラスムス]";
	mes "赤い毛糸は君が行きたい場所に";
	mes "連れていってくれるし、";
	mes "黄色い道は君を家に";
...
do_tu02a,141,166,5	script	クルメ#do_tu02a	555,{
	mes "[クルメ]";
	mes "道を歩いていると悟ることがある。";
	mes "この世界のどこからでも";
	mes "ミートソースの匂いが";
...
do_tu02a,233,174,5	script	酔っ払い#do_tu02a_01	561,{
	mes "[飲み手]";
	mes "カルーニャミルクは";
	mes "ゆっくり混ぜてから飲まなきゃ。";
	mes "最近ここに来た流れ者たちは";
...
do_tu02a,236,173,3	script	酔っ払い#do_tu02a_02	561,{
	mes "[飲み手]";
	mes "カルーニャミルクは";
	mes "よく振ってから飲むのが一番だ。";
	mes "発酵されたカルーニャが";
...
do_tu02a,200,278,5	script	心配そうなドラム#do_tu0	559,{
	emotion 54;
	mes "[心配そうなドラム]";
	mes "最近、不法にイワシを獲る漁船に";
	mes "騙されて乗せられるドラムが";
...
do_tu02a,202,276,5	script	浮かれたドラム#do_tu02a	560,{
	emotion 18;
	mes "[浮かれたドラム]";
	mes "やった！";
	mes "豪華クルーズ旅行が当たったぞ！";
...
do_tu02a,209,301,3	script	ムスタチ#do_tu02a	10167,{
	mes "[ムスタチ]";
	mes "新大陸に旅立つ前に";
	mes "身だしなみを整えてみては？";
	close;
...
do_tu02a,236,179,5	script	ニャンクン#do_tu02a	10163,{
	mes "[ニャンクン]";
	mes "困った事があるなら";
	mes "自警団に頼んでみたら？";
	close;
...
do_tu02a,229,197,5	script	トス#do_tu02a	10164,{
	emotion 22;
	mes "[トス]";
...
do_tu02a,228,193,5	script	ポルト#do_tu02a	10163,{
	emotion 32;
	mes "[ポルト]";
	mes "ここに来たなら";
	mes "カルーニャミルクは";
...
do_tu02a,226,196,5	script	アラム#do_tu02a	10166,{
	emotion 7;
	mes "[アラム]";
	mes "きょろきょろしないの！";
	mes "田舎者丸出しじゃない！";
...
do_tu02a,227,187,1	script	ヴォンゴロ#do_tu02a	544,{
	mes "[ヴォンゴロ]";
	mes "こんにちは。";
	mes "パブ「オーブン」へようこそ。";
	mes "注文は決まりましたか？";
...
do_tu02a,232,187,6	script	フェットゥチーニャ#do_t	545,{
	mes "[フェットゥチーニャ]";
	mes "ここで働いてそれなりに経つけど、";
	mes "未だに下っ端なので皿洗いは";
	mes "すべて私の担当です。";
...
do_tu02a,232,181,5	script	リンギュイーネ#do_tu02a	559,{
	mes "[リンギュイーネ]";
	mes "ここは自警団本部ですが、";
	mes "冒険者が立ち寄っていく";
	mes "パブでもあります。";
...
do_tu02a,211,186,5	script	乗船案内員#do_tu02a	559,{
	mes "[乗船案内員]";
	mes "こんにちは！";
	mes "新大陸に旅立つ船はここから北の";
	mes "船着き場に停泊していますよ。";
...
do_tu02a,222,187,3	script	ボス#do_tu02a	548,{
	mes "[ボス]";
	mes "なんだ？";
	mes "あんたもカルーニャミルクかい？";
	close;
...
do_tu02a,202,291,3	script	自警団案内員#do_tu02a01	10162,{
	mes "[自警団案内員]";
	mes "港町ラザーニャへようこそ！";
	mes "助けが必要な時は";
	mes "いつでもファルファーレ自警団を";
...
do_tu02a,174,160,3	script	自警団案内員#do_tu02a02	10162,{
	mes "[自警団案内員]";
	mes "こんにちは。";
	mes "良い天気ですにゃ。";
	close;
...
do_tu02a,233,197,5	script	自警団員オリオ#do_tu02a	10155,{
	mes "[自警団員オリオ]";
	mes "この方はファルファーレ自警団の";
	mes "団長であるペロン様だ！";
	close;
...
do_tu02a,77,263,5	script	タルリー#do_tu02a	10166,{
	mes "[タルリー]";
	mes "早く仕事を仕上げないと……";
	mes "待ち合わせに間に合わないわ。";
	close;
...
do_tu02a,191,174,3	script	ゴルリ#do_tu02a	547,{
	emotion 45;
	mes "[ゴルリ]";
	mes "良い天気だにゃあ。";
	close;
