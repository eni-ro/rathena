...
// ショップ
//------------------------------------------------------------
que_ng,179,91,3	shop	武器商人・シバス	900,13150:-1,13102:-1,13151:-1,13154:-1,13155:-1,13163:-1,13165:-1,13168:-1
que_ng,180,79,3	shop	武器商人・ウィコ	900,13200:-1,13201:-1,13202:-1
alberta,176,81,3	shop	貿易商人	900,13200:-1,13201:-1,13202:-1,13150:-1,13102:-1,13151:-1,13154:-1,13155:-1,13163:-1,13165:-1,13168:-1

//============================================================
// 試験申請
//------------------------------------------------------------
que_ng,152,167,3	script	マスターミラー	901,{
...
// 転職試験
//------------------------------------------------------------
payon,184,65,3	script	ファンソプル	866,{
	if(Job == Job_Gunslinger) {
		mes "[ファンソプル]";
		mes "うむ……久しぶりじゃの。";
		mes "賢い野獣になるのじゃぞ。";
...
que_ng,187,156,3	duplicate(SphereShop)	弾丸屋・トニー	86
izlude,171,133,3	duplicate(SphereShop)	トニー	86
...
que_ng,187,149,3	duplicate(SphereCaseShop)	弾丸ケース屋・ケニー	83
izlude,171,127,3	duplicate(SphereCaseShop)	弾丸ケース屋・ケニー	83
...
// GUN_1QUE -> 0～5
//------------------------------------------------------------
que_ng,182,85,3	script	ガリスン	109,{
	if(Job != Job_Gunslinger) {
		mes "[ガリスン]";
		mes "あなたはガンスリンガーでは";
		mes "ありませんね。";
...
lighthalzen,322,247,5	script	ラベ	86,{
	switch(GUN_1QUE) {
	default:
		mes "[ラベ]";
		mes "ウググ……";
...
// GUN_2QUE -> 0～9
//------------------------------------------------------------
que_ng,149,178,4	script	研究所企画者	744,{
	switch(GUN_2QUE) {
	case 0:
		mes "[エイ]";
		mes "あ、こんにちは。";
...
lighthalzen,205,284,5	script	ヘリスン	85,{
	switch(GUN_2QUE) {
	default:
		mes "[ヘリスン]";
		mes "あー……退屈だー";
...
// GUN_3QUE -> 0～2
//------------------------------------------------------------
que_ng,185,180,3	script	ベネッサ	726,{
	switch(GUN_3QUE) {
	case 0:
		mes "[ベネッサ]";
		mes "は！　いやぁ！";
...
// GUN_4QUE -> 0～5
//------------------------------------------------------------
que_ng,187,163,3	script	イングリッド	744,{
	switch(GUN_4QUE) {
	case 0:
		mes "[イングリッド]";
		mes "こんにちは！";
