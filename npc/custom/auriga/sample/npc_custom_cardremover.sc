...
prt_in,28,73,4	script	賢い老女	78,{
	...
	case 1:
		...
		set .@part,select("やっぱりやめます",
		                  getequipname2(1),getequipname2(2),getequipname2(3),getequipname2(4),getequipname2(5),
		                  getequipname2(6),getequipname2(7),getequipname2(8),getequipname2(9),getequipname2(10))-1;
		if(.@part == 0)
			break;
