//==============================================================================
// Ragnarok Online NewYearEvent2007 Script     by Blaze
//==============================================================================
...
amatsu,123,96,3	script	旅行客	726,{
	...
	case 5:
		...
		mes "私はあんまりカプラサービスを";
		mes "利用してないから、";
		mes "何をしてるかは気にしなかったけど……";
		mes "気になるならちょっと行ってみたら？";
		next;
		mes "[リン]";
		mes "他は……";
		mes "う～ん……そうねぇ……";
...
// バースリーが欲しい物
//==============================================================
ama_in01,181,128,3	script	バースリー	1102,1,1,{
OnTouch:
	mes "[バースリー]";
	mes "はぁ…………";
	mes "また呼ばれんかったか……";
	...
	mes "はぁ…………";
	next;
	switch(select("サンタのぼうしをあげる","ルイーゼのサンタ帽をあげる","トナカイの鼻をあげる","真っ赤な袋をあげる","なぐさめる")) {
	case 1:
		set .@itemid,2236;
		break;
	case 2:
	...
	mes "リクエストに答えてやるぞ？";
	next;
	switch(select("Strの料理","Agiの料理","Vitの料理","Intの料理","Dexの料理","Lukの料理","やっぱり断る")) {
	case 1:
		set .@dishid,12043;
		break;
	case 2:
	...
	mes "お前の持っているのを交換じゃ。";
	next;
	if(checkweight(.@dishid,1) == 0) {
		mes "[バースリー]";
		mes "なんじゃお前……";
		mes "よく見ると、荷物で一杯じゃないか。";
		mes "一度整理してみたらどうだい？";
		close;
	}
	delitem .@itemid,1;
...
// おもち販売
//==============================================================
amatsu,170,114,4	script	餅つきオジサン	63,{
	mes "[餅つきオジサン]";
	mes "よう！新年あけましてめでたいな～。";
	mes "わっはっは。";
	next;
...
amatsu,210,86,3	script	ヴァレス	807,{
	mes "[ヴァレス]";
	mes "あけましておめでとうございます。";
	mes "お正月は心機一転、";
	mes "おもちを販売しています。";
	mes "よろしければいかがでしょうか？";
	next;
	switch(select("くださいと言う","断る","どうしておもちを売っているか聞く")) {
	case 1:
		mes "[ヴァレス]";
		mes "では、こちらに購入する数を";
		mes "書いてください。";
	...
	case 3:
		...
		mes "以前、実家に帰る途中に";
		mes "立ち寄ったプロンテラで、";
		mes "おもちが高額で取引されているのを";
		mes "知ったんです。";
		next;
		mes "[ヴァレス]";
		mes "私が出しているお店では";
		mes "あまり稼ぎにならず、";
		mes "ミーナにばかり負担を掛けています。";
		mes "ミーナの為にもなんとかしようと思い、";
		mes "今年はおもちを販売してみました。";
		next;
		mes "[ヴァレス]";
		mes "良かったら一つ買っていってください。";
		mes "モチ米を50Zenyで取り寄せ、";
		mes "一流の職人と言われる……";
		mes "えーっと……";
		mes "ホルグ……さんだったかな？";
		mes "その方におもちをついてもらいました。";
		next;
		mes "[ヴァレス]";
		mes "その方から聞いたのですが、";
		mes "おもちをつくことを「精錬」";
		mes "というのですね、知りませんでした。";
		next;
		mes "[ミーナ]";
		mes "（お兄ちゃん、それ違うよ……）";
		next;
		mes "[ヴァレス]";
		mes "おもち一個につき精錬費が";
		mes "合計700Zeny必要だったので、";
		mes "手数料と合わせて一個1,000Zenyで";
		mes "販売しています。";
		mes "とっても美味しいですよ。";
		close;
	}
...
// 破魔矢販売NPC
//==============================================================
amatsu,46,132,5	script	破魔矢巫女さん#arrow	769,{
	mes "[巫女]";
	mes "明けましておめでとうございます。";
	mes "こちらでは、お正月の縁起物の";
	mes "破魔矢を販売しております。";
...
amatsu,46,135,5	duplicate(破魔矢巫女さん#arrow)	破魔矢巫女さん	769

//==============================================================
//おみくじNPC
//==============================================================
amatsu,44,105,5	script	おみくじ巫女さん#chance	769,{
	mes "[巫女]";
	mes "明けましておめでとうございます。";
	mes "せっかくアマツへ";
	mes "初詣にいらしたのですから";
...
amatsu,44,115,5	duplicate(おみくじ巫女さん#chance)	おみくじ巫女さん	769
