...
//==============================================================================
//タナトスタワー入り口管理人
hu_fild01,140,163,5	script	入り口管理人	852,3,3,{
	mes "[カテ]";
	mes "こんにちは。";
	mes "私は、この「タナトスタワー」の";
...
//タナトスタワーガイド
tha_t01,149,78,4	script	ガイド	90,{
	if(THA_1QUE) {
		mes "[ティーチェ]";
		mes "詳細に関しては、";
		mes "2層と私のそばにいるガイドが";
...
//報酬ガイド
tha_t01,140,78,4	script	ガイド	831,{
	if(THA_1QUE) {
		mes "[リエ]";
		mes "こんにちは～。";
		mes "何をお手伝いしましょうか～？";
...
//ゲートガイド
tha_t02,231,161,5	script	ゲートガイド	874,{
	if(THA_1QUE) {
...
tha_t02,227,163,0	script	thawarp1	45,1,1,{
	if(THA_1QUE)
...
// アビスレイク
//==============================================================================
hu_fild05,168,304,0	script	柱	111,{
	mes "-柱の表面に、";
	mes "何かが通り抜けたかのような";
	mes "小さい穴がある-";
	mes "-その柱の模様は、竜に似ている-";
...
hu_fild05,196,210,0	script	abysswarp	45,1,1,{
...
hu_fild05,171,211,0	script	柱	111,{
	mes "-湖で見た柱と似ている-";
	mes "-穴が青く輝いている-";
	next;
