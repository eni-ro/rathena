...
gef_tower,111,37,4	script	ギルド関係者	70,{
	if(Upper == UPPER_HIGH) {
		mes "[カトリーヌ]";
		mes "うん？";
		mes "こんな所まで何かご用かしら？";
...
//==============================================================
gef_tower,107,36,4	script	白い毛の犬	81,{
	if(Job == Job_Wizard) {
		mes "[マリア]";
		mes "ここに居るより外に出て、君が";
		mes "どれくらい強くなったか試して";
...
gef_tower,102,24,8	script	陰気なウィザード	735,{
...
job_wiz,50,165,4	script	戦闘進行要員::WZ_ChatRoom	700,{
	mes "[戦闘進行要員]";
	mes "戦闘試験場へようこそ。";
	mes "試験を受ける方は、試験待合室";
	mes "へお入りください。";
...
//==============================================================
job_wiz,0,0,0	script	WZ_Water1	-1,{
	end;
OnStart:
	set .count,7;
	monster "job_wiz",118,174,"--ja--",1074,1,"WZ_Water1::OnKilled";
	monster "job_wiz",118,165,"--ja--",1067,1,"WZ_Water1::OnKilled";
	monster "job_wiz",109,165,"--ja--",1066,1,"WZ_Water1::OnKilled";
	monster "job_wiz",109,174,"--ja--",1158,1,"WZ_Water1::OnKilled";
	monster "job_wiz",126,157,"--ja--",1242,1,"WZ_Water1::OnKilled";
	monster "job_wiz",101,157,"--ja--",1141,1,"WZ_Water1::OnKilled";
	monster "job_wiz",98,170,"--ja--",1138,1,"WZ_Water1::OnKilled";
	initnpctimer;
	end;
OnKilled:
	set .count,.count-1;
...
OnTimer183000:
	announce "水の部屋: 終了",9;
	killmonster "job_wiz","WZ_Water1::OnKilled";
	end;
OnTimer184000:
	announce "水の部屋: " +$@wz_tester$+ "様、モンスター排除失敗",9;
	areawarp "job_wiz",95,150,135,190,"geffen",120,110;
	end;
OnTimer185000:
...
//==============================================================
job_wiz,0,0,0	script	WZ_Water2	-1,{
	end;
OnStart:
	set .count,5;
	monster "job_wiz",114,171,"--ja--",1068,1,"WZ_Water2::OnKilled";
	monster "job_wiz",116,169,"--ja--",1068,1,"WZ_Water2::OnKilled";
	monster "job_wiz",114,167,"--ja--",1068,1,"WZ_Water2::OnKilled";
	monster "job_wiz",112,169,"--ja--",1068,1,"WZ_Water2::OnKilled";
	monster "job_wiz",114,169,"--ja--",1170,1,"WZ_Water2::OnKilled";
	initnpctimer;
	end;
OnKilled:
	set .count,.count-1;
	if(.count <= 0) {
		...
		areawarp "job_wiz",95,150,135,190,"job_wiz",116,97;
...
OnTimer60000:
	announce "水の部屋: 終了",9;
	killmonster "job_wiz","WZ_Water2::OnKilled";
	end;
OnTimer61000:
	announce "水の部屋: " +$@wz_tester$+ "様、モンスター排除失敗",9;
	areawarp "job_wiz",98,154,129,185,"geffen",120,110;
	end;
OnTimer62000:
	announce "水の部屋: 次の方、入場してください",9;
	end;
...
//==============================================================
job_wiz,0,0,0	script	WZ_Earth1	-1,{
	end;
OnStart:
	if( attachrid(getcharid(3,$@wz_tester$)) )
		percentheal 100,100;
	set .count,8;
	monster "job_wiz",120,102,"--ja--",1127,1,"WZ_Earth1::OnKilled";
	monster "job_wiz",120,102,"--ja--",1105,1,"WZ_Earth1::OnKilled";
	monster "job_wiz",124,98,"--ja--",1023,1,"WZ_Earth1::OnKilled";
	monster "job_wiz",120,93,"--ja--",1121,1,"WZ_Earth1::OnKilled";
	monster "job_wiz",111,93,"--ja--",1166,1,"WZ_Earth1::OnKilled";
	monster "job_wiz",107,98,"--ja--",1060,1,"WZ_Earth1::OnKilled";
	monster "job_wiz",111,102,"--ja--",1057,1,"WZ_Earth1::OnKilled";
	monster "job_wiz",111,102,"--ja--",1103,1,"WZ_Earth1::OnKilled";
	initnpctimer;
	end;
OnKilled:
	set .count,.count-1;
...
OnTimer183000:
	announce "地の部屋: 終了",9;
	killmonster "job_wiz","WZ_Earth1::OnKilled";
	end;
OnTimer184000:
	announce "地の部屋: " +$@wz_tester$+ "様、モンスター排除失敗",9;
	areawarp "job_wiz",95,75,135,120,"geffen",120,110;
	end;
OnTimer185000:
	mapannounce "job_wiz","地の部屋: 次の方、入場してください",9;
	end;
OnTimer186000:
	stopnpctimer;
	enablewaitingroomevent "WZ_ChatRoom";
...
//==============================================================
job_wiz,0,0,0	script	WZ_Earth2	-1,{
	end;
OnStart:
	set .count,7;
	monster "job_wiz",116,100,"--ja--",1020,1,"WZ_Earth2::OnKilled";
	monster "job_wiz",118,99,"--ja--",1020,1,"WZ_Earth2::OnKilled";
	monster "job_wiz",118,95,"--ja--",1020,1,"WZ_Earth2::OnKilled";
	monster "job_wiz",116,94,"--ja--",1020,1,"WZ_Earth2::OnKilled";
	monster "job_wiz",114,95,"--ja--",1020,1,"WZ_Earth2::OnKilled";
	monster "job_wiz",114,99,"--ja--",1020,1,"WZ_Earth2::OnKilled";
	monster "job_wiz",116,97,"--ja--",1118,1,"WZ_Earth2::OnKilled";
	initnpctimer;
	end;
OnKilled:
	set .count,.count-1;
...
OnTimer60000:
	announce "地の部屋: 終了",9;
	killmonster "job_wiz","WZ_Earth2::OnKilled";
	end;
OnTimer61000:
	announce "地の部屋: " +$@wz_tester$+ "様、モンスター排除失敗",9;
	areawarp "job_wiz",95,75,135,120,"geffen",120,110;
...
//==============================================================
job_wiz,0,0,0	script	WZ_Fire1	-1,{
	end;
OnStart:
	if( attachrid(getcharid(3,$@wz_tester$)) )
		percentheal 100,100;
	set .count,7;
	monster "job_wiz",51,103,"--ja--",1119,1,"WZ_Fire1::OnKilled";
	monster "job_wiz",51,92,"--ja--",1033,1,"WZ_Fire1::OnKilled";
	monster "job_wiz",40,92,"--ja--",1019,1,"WZ_Fire1::OnKilled";
	monster "job_wiz",40,103,"--ja--",1001,1,"WZ_Fire1::OnKilled";
	monster "job_wiz",58,110,"--ja--",1178,1,"WZ_Fire1::OnKilled";
	monster "job_wiz",37,89,"--ja--",1058,1,"WZ_Fire1::OnKilled";
	monster "job_wiz",33,110,"ゴブリン",1123,1,"WZ_Fire1::OnKilled";
	initnpctimer;
	end;
OnKilled:
	set .count,.count-1;
...
OnTimer183000:
	announce "火の部屋: 終了",9;
	killmonster "job_wiz","WZ_Fire1::OnKilled";
	end;
OnTimer184000:
	announce "火の部屋: " +$@wz_tester$+ "様、モンスター排除失敗",9;
	areawarp "job_wiz",25,75,65,120,"geffen",120,110;
	end;
OnTimer185000:
...
//==============================================================
job_wiz,0,0,0	script	WZ_Fire2	-1,{
	end;
OnStart:
	set .count,3;
	monster "job_wiz",43,99,"--ja--",1129,1,"WZ_Fire2::OnKilled";
	monster "job_wiz",45,99,"--ja--",1129,1,"WZ_Fire2::OnKilled";
	monster "job_wiz",44,99,"--ja--",1277,1,"WZ_Fire2::OnKilled";
	initnpctimer;
	end;
OnKilled:
	set .count,.count-1;
	if(.count <= 0) {
		...
		areawarp "job_wiz",30,82,61,113,"gef_tower",110,33;
		sleep 1000;
