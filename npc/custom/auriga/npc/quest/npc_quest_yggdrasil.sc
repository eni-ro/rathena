...
//------------------------------------------------------------
mid_camp,197,237,3	script	機械工学者	869,{
	if(ASH_1QUE < 100) {
		mes "[機械工学者]";
		mes "ふ～、";
		mes "分かっていたことだけど、";
...
mid_campin,168,82,3	script	言語学者	935,{
	switch(YGG_1QUE) {
	case 0:
		mes "[ディクショナリー]";
		mes "はじめまして。";
...
mid_camp,147,256,3	script	魔法学者	735,{
	switch(YGG_1QUE) {
	case 0:
	case 1:
	case 2:
...
spl_fild02,27,218,0	script	埋もれた宝石#ygg_red	844,{
	if(YGG_1QUE < 5) {
		mes "‐盛り上がっている土の塊に";
		mes "　赤い宝石が埋もれている。";
		mes "　気のせいか黒い物体が大量に";
...
OnStart:
	initnpctimer;
	monster "spl_fild02",25,220,"盗蟲",1051,3,"YggWiseRing_Red::OnKilled";
...
man_fild02,310,371,0	script	埋もれた宝石#ygg_blue	844,{
	if(YGG_1QUE < 5) {
		mes "‐盛り上がっている土の塊に";
		mes "　青い宝石が埋もれている。";
		mes "　気のせいか黒い物体が大量に";
...
OnStart:
	initnpctimer;
	monster "man_fild02",310,371,"盗蟲",1051,3,"YggWiseRing_Blue::OnKilled";
...
// YGG_2QUE -> 0～27
//------------------------------------------------------------
spl_in01,32,306,3	script	警備兵#ygg	447,2,2,{
...
spl_fild02,45,214,0	script	草	844,{
	if(YGG_2QUE == 2) {
...
spl_fild02,122,106,0	script	草	844,{
	if(YGG_2QUE == 3) {
		cutin "ep13_plant01",2;
		mes "‐草が生えている‐";
		next;
...
spl_fild02,329,191,0	script	草	844,{
...
spl_fild02,328,323,0	script	何かの跡	844,{
	if(YGG_2QUE == 2) {
		mes "‐足跡が沢山あるが、";
		mes "　特におかしな点は見当たらない‐";
		close;
...
spl_fild01,341,109,0	script	何かの跡	844,{
...
spl_fild01,375,109,4	script	巨大な木の根	111,{
	if(YGG_2QUE < 5) {
		mes "‐今まで見たことがないような";
		mes "　巨大な木の根がある‐";
		close;
...
nyd_dun01,58,223,0	script	サファ族の石像#ygg	844,{
	switch(YGG_2QUE) {
	case 6:
		mes "‐巨大な木の根や枝が";
		mes "　無数に壁から飛び出ており、";
...
nyd_dun_jp,58,223,0	duplicate(サファ族の石像#ygg)	サファ族の石像#ygg2	844

nyd_dun01,55,223,5	script	スノーレン#ygg	454,{
OnInit:
	hideonnpc;
	end;
}

nyd_dun_jp,58,223,0	duplicate(スノーレン#ygg)	スノーレン#ygg2	844

nyd_dun01,62,233,0	script	木のつる#ygg	844,2,2,{
	mes "‐上の方から光が差している。";
	mes "　そこから";
	mes "　木のつるが下りてきている。";
	mes "　このつるを上れば";
...
nyd_dun_jp,62,233,0	duplicate(木のつる#ygg)	木のつる#ygg2	844,2,2

manuk,278,177,5	script	村人#ygg	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[村人]";
		mes "∫∑?";
		mes "∫∀￢　∧ ∋⊃!";
...
manuk,281,177,3	duplicate(村人#ygg)	村人#ygg2	449

man_in01,175,59,5	script	スノーレン	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[スノーレン]";
		mes "∫∑?";
		mes "∫∀￢　∧　∋⊃!";
...
man_in01,22,126,3	script	ラフィネ族	441,{
	if(!equippeditem(2782)) {
		if(YGG_2QUE <= 18) {
			mes "‐意識がないようだ";
			mes "　体中の包帯が痛々しい‐";
...
man_in01,17,128,5	script	スノーレン	454,{
	if(!equippeditem(2782)) {
		mes "[スノーレン]";
		mes "￢∽∝...";
		mes "⊃∵∮ ∪ ";
...
man_in01,19,126,3	script	ルイク	450,{
	if(!equippeditem(2782)) {
		mes "[ルイク]";
		mes "∮⊆∑　?~!　∧∧";
		mes "?∽?　∋.　";
...
man_in01,71,125,0	script	テラがいた場所	139,3,3,{
	mes "‐テラは解放された‐";
	close;
}

spl_in02,239,93,3	script	テラ	441,{
	if(!equippeditem(2782)) {
		mes "[テラ]";
		mes "ModBurDana...?";
		mes "Mu　AnduWehFus";
...
spl_in02,236,92,5	script	アーク	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[アーク]";
...
spl_fild01,357,44,0	script	葉っぱ	844,{
	mes "‐葉っぱが大量に散らばっている‐";
	if(YGG_2QUE == 14) {
		next;
		mes "‐よく見ると、";
...
spl_fild01,312,79,0	script	葉っぱ	844,{
	mes "‐葉っぱが大量に散らばっている‐";
	if(YGG_2QUE == 15) {
		next;
		mes "‐よく見ると、";
...
spl_fild01,329,29,0	script	葉っぱ	844,{
	mes "‐葉っぱが大量に散らばっている‐";
	if(YGG_2QUE == 16) {
		next;
		mes "‐よく見ると、";
...
// YGG_3QUE -> 0～9
//------------------------------------------------------------
mid_camp,283,198,5	script	バゼット	883,{
	if(YGG_1QUE < 100) {
		mes "[何かに没頭している男]";
		mes "これは興味深い話だな。";
		mes "……";
...
man_in01,360,137,5	script	修理員	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[修理員]";
		mes "∪∧∪　∮　∽∬∩　⊇";
		mes "∪⊃∋　⊃　∀∋∮　∮";
...
man_in01,68,187,0	script	ボルガ料理長	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[ボルガ料理長]";
		mes "∽⊂∈　⊆　∫∬";
		mes "∮∝∬　∫　⊃∵";
...
man_in01,76,184,3	script	料理人	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[料理人]";
		mes "∃∧?　∃　∪∝∪　⊃　∀";
		close;
...
man_in01,227,280,5	script	科学者	449,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[科学者]";
		mes "∀∫⊃　∋　∮∠∧";
		mes "∧　∋￢　∩　∩　∩";
...
splendide,121,259,3	script	妖精	436,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精]";
		mes "VaFuloDor An ";
...
splendide,163,264,3	script	妖精	438,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精]";
...
// YGG_4QUE -> 0～2
//------------------------------------------------------------
mid_camp,192,239,4	script	指名手配書	857,{
...
nyd_dun02,144,103,3	script	怪しい男#ygg_dan01	456,3,3,{
	end;
OnTouch:
	emotion 0,"";
	emotion 23;
	hideonnpc "怪しい男#ygg_dan01";
	monster "nyd_dun02",144,103,"ダンデリオンのメンバー",2026,1,"ygg_dandelion::OnKilled";
	end;
}

nyd_dun02,206,114,5	script	怪しい男#ygg_dan02	456,3,3,{
	end;
OnTouch:
	emotion 0,"";
	emotion 23;
	hideonnpc "怪しい男#ygg_dan02";
	monster "nyd_dun02",206,114,"ダンデリオンのメンバー",2026,1,"ygg_dandelion::OnKilled";
	end;
OnInit:
	hideonnpc "怪しい男#ygg_dan02";
	end;
...
// YGG_5QUE -> 0～3
//------------------------------------------------------------
mid_camp,146,306,3	script	ファインデル	982,{
	if(YGG_2QUE < 23) {	// 二つの種族クエスト
		mes "‐二人が言い争っている‐";
		next;
		mes "[ファインデル]";
...
nyd_dun01,258,134,0	script	ドラコの卵#ygg_egg01	463,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため、";
		mes "　アイテムを拾うことができない。";
		mes "　種類数を減らしてからまた調べよう‐";
...
nyd_dun01,100,210,0	duplicate(ドラコの卵#ygg_egg01)	ドラコの卵#ygg_egg02	463
nyd_dun01,74,68,0	duplicate(ドラコの卵#ygg_egg01)	ドラコの卵#ygg_egg03	463
nyd_dun01,98,142,0	duplicate(ドラコの卵#ygg_egg01)	ドラコの卵#ygg_egg04	463
nyd_dun01,244,157,0	duplicate(ドラコの卵#ygg_egg01)	ドラコの卵#ygg_egg05	463
nyd_dun01,59,185,0	duplicate(ドラコの卵#ygg_egg01)	ドラコの卵#ygg_egg06	463

nyd_dun02,68,256,0	script	ドラコの卵#ygg_egg11	463,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため、";
		mes "　アイテムを拾うことができない。";
		mes "　種類数を減らしてからまた調べよう‐";
...
nyd_dun02,202,166,0	duplicate(ドラコの卵#ygg_egg11)	ドラコの卵#ygg_egg12	463
nyd_dun02,200,165,0	duplicate(ドラコの卵#ygg_egg11)	ドラコの卵#ygg_egg13	463

nyd_dun02,201,166,0	script	ドラコの卵#ygg_egg16	463,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため、";
		mes "　アイテムを拾うことができない。";
		mes "　種類数を減らしてからまた調べよう‐";
...
nyd_dun02,203,167,0	duplicate(ドラコの卵#ygg_egg16)	ドラコの卵#ygg_egg17	463
nyd_dun02,201,164,0	duplicate(ドラコの卵#ygg_egg16)	ドラコの卵#ygg_egg18	463
...
// YGG_6QUE -> 0～
//------------------------------------------------------------
spl_in01,97,313,3	script	ヤイ職人	446,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[ヤイ職人]";
		mes "Yur,Dur　AnoVa?";
		mes "Wha?　Dieb　OsaDur　..";
...
// YGG_7QUE -> 0～
//------------------------------------------------------------
spl_in01,30,324,3	script	グレヌイユ	446,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精]";
...
spl_in02,139,65,3	script	フラーワリ	438,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精]";
		mes "NeiKoFulo　An";
		mes "DielOdesMush　Or";
...
splendide,160,265,3	script	環境浄化装置#ygg	844,{
...
splendide,262,262,3	duplicate(環境浄化装置#ygg)	環境浄化装置	844
splendide,262,187,3	duplicate(環境浄化装置#ygg)	環境浄化装置	844
splendide,164,82,3	duplicate(環境浄化装置#ygg)	環境浄化装置	844
splendide,171,116,3	duplicate(環境浄化装置#ygg)	環境浄化装置	844
splendide,134,280,3	duplicate(環境浄化装置#ygg)	環境浄化装置	844

splendide,205,139,5	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "CyaResehr";
		close;
...
splendide,181,135,5	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
...
splendide,139,178,5	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "CyaResehr";
		close;
...
splendide,164,188,5	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "CyaResehr";
		close;
...
splendide,177,257,5	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "CyaResehr";
		close;
...
splendide,124,212,5	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "CyaResehr";
		close;
...
splendide,196,153,5	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "CyaResehr";
		close;
...
// YGG_8QUE -> 0～2
//------------------------------------------------------------
manuk,252,116,3	script	ストルム	450,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[強そうな巨人]";
		mes "∃∝∪?　∀　⊃∝?";
		mes "∽∫∠　∃　?";
...
// YGG_9QUE -> 0～2
//------------------------------------------------------------
man_in01,378,276,3	script	工学者	453,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[工学者]";
		mes "∫∑?";
		mes "∫∀￢　∧　∋⊃!";
...
// YGG_10QUE -> 0～4, 100
//------------------------------------------------------------
man_in01,372,221,5	script	学者	449,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[学者]";
		mes "∀∬∩　∫　∮∈∪　∪　∪∬";
		mes "￢∋￢　⊆∀?∪?￢∈∮";
...
// NYD_1QUE -> 0～14
//------------------------------------------------------------
mid_camp,271,299,3	script	マグニファ	755,{
	switch(NYD_1QUE) {
	case 2:
		mes "[マグニファ]";
		mes "はじめまして。";
...
prt_in,171,94,3	script	ナオミ	893,{
	if(NYD_1QUE == 3) {
		mes "‐百冊はあるであろう";
...
splendide,198,178,3	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
...
splendide,240,164,3	script	兵士	461,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
...
spl_in01,109,60,5	script	レビオルディル	435,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[レビオルディル]";
		mes "ThusDurnah　Ra";
		mes "SharVeldIyaz　U";
...
spl_in01,104,56,5	script	アリオス	437,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[アリオス]";
		mes "AmanVilShar　Ie";
		mes "DorLuShar Mu Re";
...
spl_in01,101,52,5	script	護衛兵#1	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[護衛兵]";
		mes "ThusDurnah　Ra";
...
spl_in01,118,52,5	script	護衛兵#2	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[護衛兵]";
		mes "ThusDurnah　Ra";
		mes "SharVeldIyaz　U　UorAmanDur";
...
man_in01,311,57,3	script	エトル	453,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[エトル]";
		mes "∋￢⊇ ∧ ∝∪∝ ∑ ∠∮∫ ∫ ? ∫ ";
		close;
...
man_in01,286,61,5	script	護衛兵#1	450,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[護衛兵]";
		mes "∵∝∩ ∃ ∵⊇";
		close;
...
man_in01,295,61,3	script	護衛兵#2	450,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[護衛兵]";
		mes "∵∝∩ ∃";
		close;
...
man_in01,291,62,3	script	ラフィネ族の捕虜	437,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[ラフィネ族の捕虜]";
...
nyd_dun02,178,255,0	script	装置#nyd_out	844,3,3,{
	mes "‐何かの装置がある。";
...
nyd_dun02,139,274,0	script	装置#nyd_in	844,3,3,{
	if(.work) {
		mes "‐何かの装置がある。";
		mes "　今動作中のようだ。";
		mes "　動作が終るまで少し待とう‐";
...
spl_fild03,226,151,0	duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild03,268,230,0	duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild03,293,253,0	duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild03,165,100,0	duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild03,317,190,0	duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild01,41,118,0		duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild01,317,361,0	duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild01,55,269,0		duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild01,332,131,0	duplicate(魚の群れ#Ygg)	魚の群れ#2	844
spl_fild01,170,74,0		duplicate(魚の群れ#Ygg)	魚の群れ#2	844
...
man_fild02,146,81,0		duplicate(不思議な岩#Ygg)	不思議な岩#Ash31	844
man_fild02,140,148,0	duplicate(不思議な岩#Ygg)	不思議な岩#Ash32	844
man_fild02,88,263,0		duplicate(不思議な岩#Ygg)	不思議な岩#Ash33	844
man_fild02,146,365,0	duplicate(不思議な岩#Ygg)	不思議な岩#Ash34	844
man_fild02,336,305,0	duplicate(不思議な岩#Ygg)	不思議な岩#Ash35	844
man_fild02,248,124,0	duplicate(不思議な岩#Ygg)	不思議な岩#Ash36	844
man_fild02,285,115,0	duplicate(不思議な岩#Ygg)	不思議な岩#Ash37	844
man_fild02,346,116,0	duplicate(不思議な岩#Ygg)	不思議な岩#Ash38	844
man_fild02,358,174,0	duplicate(不思議な岩#Ygg)	不思議な岩#Ash39	844
man_fild02,241,227,0	duplicate(不思議な岩#Ygg)	不思議な岩#Ash40	844

manuk,304,195,5	script	青年	454,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[青年]";
		mes "∀Π〓　〓 ⊆∀∫";
		mes "Σ　⊂〓⊂　⊃　";
...
splendide,218,193,3	script	妖精	441,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[疲れたように見える妖精]";
		mes "OdesKoUor　Ko";
		mes "NuffSharUden　";
...
splendide,180,223,3	script	怒れる妖精	440,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[カルルア]";
...
splendide,125,227,3	script	妖精	444,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[プルロア]";
		mes "AnuFuloUor　Ko";
		mes "CyaWosnes";
