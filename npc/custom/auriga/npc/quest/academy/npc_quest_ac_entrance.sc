...
// 受付員
ac_cl_room,43,41,4	script	受付員エーラ#エーラ	90,{
	...
	if(AC_PASSPORT<2 && !checkquest2(201040)){
		mes "[エーラ]";
		mes "新人さんですね。";
		mes "冒険者アカデミーへようこそ！";
	...
	if(!checkquest2(100056) && !checkquest2(201036) && !checkquest2(201815)){
		next;
		cutin "jp_quest_help01.bmp", 255;
		mes "[エーラ]";
		mes "あ！　そうでした。";
	...
	function	getcombathan	{
		if(MaxWeight - Weight < 2000){
			...
			mes "話しかけてください‐";
			close2;
			if(!checkquest2(100056)) setquest 100056;
			cutin "jp_quest_help01.bmp", 255;
			end;
		}
		if(checkitemblank() < 3){
...
ac_cl_room,44,16,0	script	#講習1_warp1	45,1,1,{
	if(AC_PASSPORT<2) {
		mes "[エーラ]";
		mes "入学希望者の方ですね！";
		mes "まずはこちらで";
	...
	warp "ac_cl_area",40,133;
	end;
}

// プロン
ac_cl_room,30,46,6	script	プロン#ac_room	750,{
...
//アルディ
ac_cl_room,57,46,2	script	アルディ#ac_room	751,{
...
//フェイ
ac_cl_room,44,65,4	script	フェイ#ac_room	828,6,6,{
	if(AC_PASSPORT<2){
		mes "[フェイ]";
		mes "ん？";
		mes "入学希望者みたいだな。";
	...
	set AC_JOBCHANGE,1;
	switch(.@sel){
	case 1: warp "izlude_in",74,167; break;
	case 2: warp "geffen_in",164,122; break;
	case 3: warp "prt_church",183,37; break;
	case 4: warp "moc_prydb1",45,124; break;
	case 5: warp "payon_in02",63,67; break;
	case 6: warp "alberta_in",57,43; break;
	case 7: warp "payon",157,145; break;
	case 8: warp "que_ng",150,167; break;
	case 9: warp "que_ng",30,62; break;
	case 10:warp "aldebaran",112,64; break;
	}
	end;
...
OnTouch:
	set AC_JOBCHANGE,0;
	if(AC_NOVICE_QUE==30 && Job!=Job_Novice && !checkquest2(100128)){
		mes "[フェイ]";
		mes "無事転職できたようだな。";
		mes "おめでとう！";
		next;
...
ac_library,110,108,0	duplicate(操作ノート#func)	操作ノート#_1	111
ac_library,107,108,0	duplicate(操作ノート#func)	操作ノート#_2	111
ac_cl_room,45,62,4	duplicate(操作ノート#func)	操作ノート#3	111
ac_cl_room,33,47,4	duplicate(操作ノート#func)	操作ノート#4	111
ac_cl_room,55,44,4	duplicate(操作ノート#func)	操作ノート#4_1	111

ac_cl_room,37,32,4	script	マスター・スヌス	51,{
	...
	if(checkquest2(117480)) {
		if(checkquest2(117480)&2) {
			mes "‐インフォメーション‐";
			mes "　初心者用ポーション提供開始から";
			mes "　2週間経過したので、";
			mes "　初心者用ポーションの配布は";
			...
			if(!checkquest2(117470) || checkquest2(117470)&2) {
