...
prontera,73,140,0	script	牛乳商人	86,{
	mes "[牛乳商人]";
	mes "空きビンを持ってきたら、";
...
prt_in,49,172,3	script	マリエヌ	53,{
	switch(JUICE_EVE) {
	case 0:
		mes "[主婦マリエヌ]";
		mes "モリスン!!";
...
prt_in,47,173,3	script	モリスン	97,{
	switch(JUICE_EVE) {
	default:	//0～9のとき
		mes "[ちびモリスン]";
		mes "あ……アアァッ!!!";
...
payon_in03,188,146,4	script	マルクハンセン	86,{
	if(JUICE_EVE < 13) {
		mes "[商人マルクハンセン]";
		mes "いらっしゃい！";
		mes "なんのご用ですか？";
...
alberta_in,16,28,4	script	薬師おじいさん	61,{
	mes "[製薬師おじいさん]";
	mes "おぉ…お客さんか…？";
	mes "何の用かね？";
	next;
