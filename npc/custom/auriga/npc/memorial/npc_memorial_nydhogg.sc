...
// ダンジョン生成NPC
//------------------------------------------------------------
nyd_dun02,100,201,3	script	守護者の門	111,8,8,{
	switch(NYD_1QUE) {
	case 0:
		mes "‐あなたを見下ろすように";
		mes "　龍の彫刻があり、";
...
1@nyd,213,277,5	script	イグドラシルリアド	437,5,5,{
	switch(NYD_2QUE) {
	case 0:
...
OnKilled2:
	areamonster getmdmapname("1@nyd"),0,0,0,0,"リンコ",2020,1,getmdnpcname("nyd_call_mon_1")+ "::OnKilled2";
	end;
OnKilled3:
	areamonster getmdmapname("1@nyd"),0,0,0,0,"フィラ",2021,1,getmdnpcname("nyd_call_mon_1")+ "::OnKilled3";
	end;
OnKilled4:
	areamonster getmdmapname("1@nyd"),0,0,0,0,"アクアエレメンタル",2016,1,getmdnpcname("nyd_call_mon_1")+ "::OnKilled4";
	end;
OnKilled5:
	areamonster getmdmapname("1@nyd"),0,0,0,0,"ダークピンギキュラ",2015,1,getmdnpcname("nyd_call_mon_1")+ "::OnKilled5";
	end;
}
...
OnStart2:
	monster getmdmapname("2@nyd"),199,327,"ニーズヘッグの影",2022,1,getmdnpcname("nyd_boss_enter_call")+ "::OnKilled";
...
OnKilled1:
	areamonster getmdmapname("2@nyd"),20,12,380,172,"リンコ",2020,1,getmdnpcname("nyd_call_mon_1")+ "::OnKilled1";
	end;
OnKilled2:
	areamonster getmdmapname("2@nyd"),20,12,380,172,"フィラ",2021,1,getmdnpcname("nyd_call_mon_1")+ "::OnKilled2";
	end;
OnKilled3:
	areamonster getmdmapname("2@nyd"),20,12,380,172,"ダークシャドウ",2023,1,getmdnpcname("nyd_call_mon_1")+ "::OnKilled3";
	end;
OnKilled4:
	areamonster getmdmapname("2@nyd"),20,12,380,172,"ダークピンギキュラ",2015,1,getmdnpcname("nyd_call_mon_1")+ "::OnKilled4";
	end;
}

2@nyd,202,324,5	script	イグドラシルリアド#	437,{
	if(NYD_1QUE == 200 || NYD_1QUE == 201) {
		mes "[イグドラシルリアド]";
		mes "ありがとう。";
		mes "あなたはイグドラシルを、";
