...
ac_cl_room,152,41,4	script	ユタ#ac_cl_room	84,{
	if(Job != Job_Novice){
		mes "[ユタ]";
		mes "おめでとう！";
		mes "1次職への転職試験を";
...
ac_cl_room,145,48,4	script	フィー#ac_cl_room	123,{
	mes "[フィー]";
	mes "こんにちは。";
	mes "私はフィー。";
	mes "私は新入生に、";
...
ac_cl_room,158,48,4	script	ルティー	92,{
	mes "[ルティー]";
	mes "新入生の人だね。";
	mes "こんにちは。";
	mes "私は、ルティ。";
	...
	case Job_Mage:      set .@jobname$,"マジシャン";        break;
