...
// 治療師
//============================================================
lasagna,305,242,4	script	治療師ハル	10164,{
	set .@price,5000;
...
// 転送NPC
//============================================================
izlude,181,187,3	script	ドラム船員#izlude	544,{
	mes "[ドラム船員]";
	mes "ミッドガルド大陸から";
	mes "パースタ大陸へ！";
	mes "港町ラザーニャまで";
...
malangdo,218,81,0	script	ドラム船員#malangdo	544,{
	mes "[ドラム船員]";
	mes "マラン島から";
	mes "パースタ大陸へ！";
	mes "港町ラザーニャまで";
...
lasagna,203,324,5	script	エッグリン#do_tu02	10157,{
	mes "[エッグリン]";
	if(Job == Job_Summoner) {
		mes "料理長から罰として";
		mes "大量の雑用を押し付けられたんだ。";
...
// Shop
//============================================================
lasagna,312,259,5	shop	道具商人#lasagna	553,11602:-1,515:-1,567:-1,601:-1,602:-1,610:-1,656:-1,525:-1,611:-1
lasagna,339,248,3	shop	婚礼品商人#lasagna	10163,744:-1,745:-1,2338:-1,2206:-1,7170:-1,2613:-1

lasagna,293,289,5	script	武具商人#do_su03	10162,{
	mes "[武具商人]";
	mes "いらっしゃい。";
	mes "うちの品物は一級品ばかりだよ。";
	mes "何を見ていくんだい？";
...
lasagna,298,289,5	script	加工職人#do_su03	555,{
	mes "[加工職人]";
	mes "いらっしゃい。";
	mes "今日はどうしたんだい？";
	next;
...
lasagna,289,287,5	script	鍛冶職人#lasagna	561,{
...
lasagna,321,242,4	script	看板#1lasagna	835,7,7,{
	npctalk  "北西側：道具商人　／　東側：髪型変更・スペシャルアイテム販売員",bc_self;
	end;
}

lasagna,312,251,4	script	看板#2lasagna	835,7,7,{
	npctalk  "北西側：精錬・修理・ドラム武具販売・アップグレード",bc_self;
	end;
}

lasagna,297,229,4	script	チュートリアル掲示板#01	857,{
	mes "‐チュートリアルで学んだことが";
	mes "　確認できる掲示板だ。";
	mes "　どれを読みますか‐";
	while(1) {
...
// 住民
//============================================================
lasa_fild01,35,288,3	script	自警団員アジェニャー#la	10162,{
	mes "[自警団員アジェニャー]";
	if(Job == Job_Summoner) {
		mes "お、無事に入団出来たか。";
		mes "これからよろしくな！";
...
lasa_fild01,60,322,3	script	自警団員アリオ#lasa_fil	10154,{
	mes "[自警団員アリオ]";
	if(Job == Job_Summoner) {
		mes "ミッドガルドには行けたか？";
		mes "大丈夫、君なら何が来ても";
...
lasa_dun01,29,146,5	script	自警団員#lasa_dun01	10162,{
	mes "[自警団員]";
	if(Job == Job_Summoner) {
		mes "おや、冒険者さん。";
		mes "タルトゥーフィに";
...
lasa_dun03,162,158,3	script	タルトゥーフィ	10161,{
	mes "[タルトゥーフィ]";
	if(Job == Job_Summoner) {
		mes "やあ、この前は世話になったね。";
		mes "もうミッドガルドには";
...
lasagna,235,198,5	script	ペロン団長	10152,{
	mes "[ペロン団長]";
	if(Job == Job_Summoner) {
		mes "ミッドガルド大陸は";
		mes "とても厳しい所だ。";
...
conch_in,26,64,5	script	ガムベリー船長	10153,{
	mes "[ガムベリー船長]";
	if(Job == Job_Summoner) {
		mes "そろそろ出航だ。";
		mes "準備はいいか？";
...
conch_in,24,62,5	script	ステルロー	10156,{
	mes "[ステルロー]";
	if(Job == Job_Summoner) {
		mes "なんだ？";
		mes "航海士の仕事に興味があるのか？";
...
conch_in,181,61,5	script	甲板長	421,{
	mes "[甲板長]";
	if(Job == Job_Summoner) {
		mes "もう積み荷は全部片付いたぜ。";
		mes "悪くなっちまう前に、";
...
conch_in,181,58,3	script	操舵手	561,{
	mes "[操舵手]";
	if(Job == Job_Summoner) {
		mes "いよいよ出航か。";
		mes "ようやく俺の腕の見せ所が";
...
conch_in,186,57,3	script	料理長	548,{
	mes "[料理長]";
	if(Job == Job_Summoner) {
		mes "もう腹が減ったのか？";
		mes "飯にはまだ早いぞ。";
...
conch_in,122,61,5	script	船員	559,{
	mes "[船員]";
	mes "新大陸には初めてですか？";
	mes "一度も行って見たことない場所に";
	mes "行く気分はどうですか？";
...
conch_in,169,70,3	script	船員	545,{
	mes "[船員]";
	mes "ステルロー一等航海士なら";
	mes "地図にもない新大陸への航路を";
	mes "また見つけ出しそうな気がする。";
...
conch_in,166,68,6	script	船員	544,{
	mes "[船員]";
	mes "ミッドガルドも発見されたけど、";
	mes "他にもあるかな？";
	mes "地図にもない場所。";
...
lasagna,226,181,3	script	カルルー	548,{
	mes "[カルルー]";
	mes "カルーニャミルクの";
	mes "主な材料を知っているか？";
	mes "カルーニャという特別な貝を";
...
lasagna,225,290,5	script	作業班長	421,{
	mes "[作業班長]";
	mes "この仕事をやったことある？";
	mes "すぐに覚えられる簡単な事だ。";
	mes "コンキリナ号のガムベリー船長は";
...
lasagna,139,299,3	script	イワシ漁船船長	561,{
	mes "[イワシ漁船船長]";
	mes "イワシ産業が";
	mes "以前より落ち込んでいても";
	mes "人手は常に不足している。";
...
lasagna,263,156,5	script	おばあちゃん	554,{
	mes "[おばあちゃん]";
	mes "昔のラザーニャは凄かった。";
	mes "道も住民もボロボロ。";
	mes "当時は暗黒期と呼ばれているよ。";
...
lasagna,244,231,3	script	イワシ漁船員	544,{
	mes "[イワシ漁船員]";
	mes "この黄色いチーズ道に沿って";
	mes "歩いて行けば、";
	mes "私たちの故郷が現れる。";
...
lasagna,260,134,3	script	ラスムス	546,{
	mes "[ラスムス]";
	mes "この黄色いチーズ道は";
	mes "自警団と猫の手サービスが";
	mes "作ったものなんだ。";
...
lasagna,141,166,5	script	クルメ	555,{
	mes "[クルメ]";
	mes "道を歩いていると悟ることがある。";
	mes "この世界のどこからでも";
	mes "ミートソースの匂いが";
...
lasagna,233,174,5	script	酔っ払い	561,{
	mes "[飲み手]";
	mes "カルーニャミルクは";
	mes "ゆっくり混ぜてから飲まなきゃ。";
	mes "最近ここに来た流れ者たちは";
...
lasagna,236,173,3	script	酔っ払い	561,{
	mes "[飲み手]";
	mes "カルーニャミルクは";
	mes "よく振ってから飲むのが一番だ。";
	mes "発酵されたカルーニャが";
...
lasagna,200,278,5	script	心配そうなドラム	559,{
...
lasagna,202,276,5	script	浮かれたドラム	560,{
...
lasagna,209,301,3	script	ムスタチ	10167,{
	mes "[ムスタチ]";
	mes "新大陸に旅立つ前に";
	mes "身だしなみを整えてみては？";
	close;
...
lasagna,236,179,5	script	ニャンクン	10163,{
	mes "[ニャンクン]";
	mes "困った事があるなら";
	mes "自警団に頼んでみたら？";
	close;
...
lasagna,229,197,5	script	トス	10164,{
	emotion 22;
	mes "[トス]";
...
lasagna,228,193,5	script	ポルト	10163,{
	emotion 32;
	mes "[ポルト]";
	mes "ここに来たなら";
	mes "カルーニャミルクは";
...
lasagna,226,196,5	script	アラム	10166,{
	emotion 7;
	mes "[アラム]";
	mes "きょろきょろしないの！";
	mes "田舎者丸出しじゃない！";
...
lasagna,227,187,1	script	ヴォンゴロ	544,{
	mes "[ヴォンゴロ]";
	mes "こんにちは。";
	mes "パブ「オーブン」へようこそ。";
	mes "注文は決まりましたか？";
...
lasagna,232,187,6	script	フェットゥチーニャ	545,{
	mes "[フェットゥチーニャ]";
	mes "ここで働いてそれなりに経つけど、";
	mes "未だに下っ端なので皿洗いは";
	mes "すべて私の担当です。";
...
lasagna,232,181,5	script	リンギュイーネ	559,{
	mes "[リンギュイーネ]";
	mes "ここは自警団本部ですが、";
	mes "冒険者が立ち寄っていく";
	mes "パブでもあります。";
...
lasagna,211,186,5	script	乗船案内員	559,{
	mes "[乗船案内員]";
	mes "こんにちは！";
	mes "新大陸に旅立つ船はここから北の";
	mes "船着き場に停泊していますよ。";
...
lasagna,222,187,3	script	ボス	548,{
	mes "[ボス]";
	mes "なんだ？";
	mes "あんたもカルーニャミルクかい？";
	close;
...
lasagna,202,291,3	script	自警団案内員	10162,{
	mes "[自警団案内員]";
	mes "港町ラザーニャへようこそ！";
	mes "助けが必要な時は";
	mes "いつでもファルファーレ自警団を";
...
lasagna,174,160,3	script	自警団案内員	10162,{
	mes "[自警団案内員]";
	mes "こんにちは。";
	mes "良い天気ですにゃ。";
	close;
...
lasagna,233,197,5	script	自警団員オリオ	10155,{
	mes "[自警団員オリオ]";
	mes "この方はファルファーレ自警団の";
	mes "団長であるペロン様だ！";
	close;
...
lasagna,77,263,5	script	タルリー	10166,{
	mes "[タルリー]";
	mes "早く仕事を仕上げないと……";
	mes "待ち合わせに間に合わないわ。";
	close;
...
lasagna,191,174,3	script	ゴルリ	547,{
...
lasagna,165,125,5	script	道具商人	10163,{
	mes "[道具商人]";
	mes "うちの息子はいったいどこまで";
	mes "配達に行ったっていうんだ？";
	close;
...
lasagna,175,209,3	script	小物売り	547,{
	mes "[小物売り]";
	mes "みんなバーで飲んでて誰も来ない。";
	mes "暇だ……。";
	close;
...
lasagna,73,237,5	script	落ち着きたいドラム	544,{
	mes "[落ち着きたいドラム]";
	mes "この辺りは静かでいい……。";
	mes "中心部は旅行者や酔っ払いが";
	mes "うるさくてたまらん。";
...
lasagna,71,200,3	script	困っているドラム	546,{
	mes "[困っているドラム]";
	mes "あれ？";
	mes "今日は休みか。";
	mes "どうしよう……。";
...
lasagna,61,115,3	script	快活なドラム	560,{
	mes "[快活なドラム]";
	mes "俺は気になる物は";
	mes "片っ端から調べる性格なんだ。";
	mes "他人の家の物だって";
...
lasagna,88,91,3	script	旅に出るドラム	555,{
	mes "[旅に出るドラム]";
	mes "早く新大陸に行かないと！";
	mes "野菜作ってる場合じゃねえ！";
	close;
...
lasagna,186,193,3	script	外から来たドラム	553,{
	mes "[外から来たドラム]";
	mes "ここがラザーニャかぁ！";
	mes "よーし、やってやるぞー！";
	close;
...
lasagna,103,119,5	script	賢いドラム	545,{
	mes "[賢いドラム]";
	mes "この世のすべての生命体は";
	mes "属性を持っている。";
	mes "各々の属性の相性を理解すれば";
...
lasagna,140,269,3	script	繊細な長女	10166,{
	mes "[ゴマー]";
	mes "ねえ、ヨター！";
	mes "ちゃんと片づけなさい！";
	mes "そこに呪符の破片が落ちてるわよ！";
...
lasagna,131,269,5	script	誠実な次男	555,{
	mes "[ヨター]";
	mes "お父さん、お母さん、";
	mes "無事に戻って来て下さい。";
	next;
...
lasagna,131,274,5	script	勇敢な三男	10164,{
	mes "[ジョギー]";
	mes "ウィィィィン！";
	mes "イヌハッカ爆撃のジョギーだぞ！";
	mes "武器を捨てて投降しろ！";
...
lasagna,140,274,3	script	弱気な四男	546,{
	mes "[タンディ]";
	mes "お姉ちゃんはよく怒るけど、";
	mes "いつも綺麗にいられるように";
	mes "新しい洋服を作ってくれるんです。";
...
// 婚礼NPC
//============================================================
lasagna,200,300,3	script	結婚式場の案内#wedd01	10162,{
	mes "[結婚式場の案内]";
	mes "こんにちは！　いい天気ですよね？";
	mes "気持ちのいい日差しです。";
	...
	mes "では幸せに！";
	close2;
	warp "lasagna",335,246;
	end;
}
lasagna,163,84,3	duplicate(結婚式場の案内#wedd01)	結婚式場の案内#wedd02	10162

lasagna,344,275,3	script	フローリン#do_wedd	10163,{
	mes "[フローリン]";
	mes "お花の香りがいいでしょう？";
	mes "新しい門出を迎える";
	mes "幸せな新婚さんのために、";
...
lasagna,320,268,7	script	シト#do_wedd	10166,{
	mes "[シト]";
	mes "新しい門出を迎える二人は、";
	mes "いつ見ても美しいですね。";
	next;
...
lasagna,319,290,1	script	女性#do_wedd01	882,{
	mes "[女性]";
	mes "もし人生で一番の出来事が";
	mes "何かと聞かれたら、";
...
lasagna,320,291,3	script	男性#do_wedd01	881,{
	mes "[女性]";
...
lasagna,316,206,5	script	女性#do_wedd02	958,{
	mes "[女性]";
	mes "ダーリンはどうして";
	mes "見ても見てもまた見たくなるの？";
...
lasagna,317,205,1	script	男性#do_wedd02	962,{
	mes "[男性]";
	mes "ここが結婚式場らしい。";
	mes "見て！　本当に綺麗だ。";
	emotion 3,"男性#do_wedd02";
...
lasagna,346,237,5	script	父さん#do_wedd01	10164,{
	mes "[父さん]";
	mes "ジャジャーン!!";
...
lasagna,347,235,7	script	母さん#do_wedd01	10148,{
	end;
OnInit:
...
lasagna,349,237,1	script	子ども#do_wedd01	10167,{
	end;
OnInit:
	cloakonnpc strnpcinfo(0);
	end;
...
lasagna,302,323,3	script	ジャワイブ	10159,{
	mes "[ジャワイブ]";
	mes "新婚さんも、結婚された2人も、";
	mes "いつでも行ける幻のリゾート地。";
	mes "「ジャワイ」にみなさまを";
