...
lhz_dun04,151,276,3	script	研究員#memo	865,{
	switch(LHZ_6QUE) {
	case 7:
		mes "‐研究室の扉の前で";
		mes "　ボルセブは混乱している‐";
	...
	case 11:
		for(set .@i,5113;.@i<5126;set .@i,.@i+1) {
			set .@total,.@total + ((checkquest2(.@i) & 0x4) == 0);
		}
		if(.@total == 0) {
			mes "[ボルセブ]";
			mes "キヒヒヒヒ……";
...
lhz_dun04,147,279,0	script	研究室出入口#memo	844,{
	if(LHZ_6QUE < 8) {
		mes "‐^0000FF****様の研究室";
...
1@lhz,45,148,0	script	1研究室#1_1	139,1,1,{
OnStart:
	if(.flag)
		end;
	set .flag,1;
...
1@lhz,1,1,0	script	MobCtrl1#mob01	139,{
OnStart:
	announce "警備システム : 保安システム稼働!!　実験動物が開放されます。関係者は退避してください。",0x9,0xff9977;
	areamonster getmdmapname("1@lhz"),36,156,53,169,"飢えた実験動物",2242,11,getmdnpcname("MobCtrl1#mob01")+ "::OnKilled";
	end;
OnKilled:
	initnpctimer;
	end;
OnTimer1000:
	set .@count,getmapmobs(getmdmapname("1@lhz"),getmdnpcname("MobCtrl1#mob01")+ "::OnKilled");
	if(.@count == 0) {
...
1@lhz,39,168,0	script	書類#1_1	844,{
	mes "‐書類がばらまかれている。";
	mes "　保安システムが停止した際の";
	mes "　出入口の操作マニュアルのようだ‐";
	next;
...
1@lhz,41,172,0	script	バルブ#1_2	844,{
	mes "‐「非常出入用（左バルブ）」と";
	mes "　書かれたバルブがある。";
	mes "　手動で出入口を開閉する際に";
	mes "　使用されるバルブのようだ‐";
...
1@lhz,52,172,0	script	バルブ#1_3	844,{
	mes "‐「非常出入用（右バルブ）」と";
	mes "　書かれたバルブがある。";
	mes "　手動で出入口を開閉する際に";
	mes "　使用されるバルブのようだ‐";
...
1@lhz,45,173,0	warp	#potal_01	2,2,1@lhz,151,29

1@lhz,151,29,0	script	#2_0	139,1,1,{
	donpcevent getmdnpcname("2研究室#2_1")+"::OnStart";
	hideonnpc getmdnpcname("#2_0");
	end;
}

1@lhz,1,2,0	script	2研究室#2_1	139,{
OnStart:
	initnpctimer;
	end;
OnStart2:
...
1@lhz,1,3,0	script	2研究室#2_2	139,{
OnStart:
	switch(rand(1,6)) {
	case 1:
...
1@lhz,1,4,0	script	MobCtrl2#mob02	139,{
OnStart:
	set .lv,1;
	setarray .mob[1],10,20,16,19,20;
	areamonster getmdmapname("1@lhz"),139,37,164,58,"飢えた実験動物",2242,.mob[.lv],getmdnpcname("MobCtrl2#mob02")+"::OnKilled";
	end;
OnKilled:
	set .@count,getmapmobs(getmdmapname("1@lhz"),getmdnpcname("MobCtrl2#mob02")+ "::OnKilled");
	if(.@count > 0)
		end;
	set .lv,.lv + 1;
	if(.lv == 6) {
...
OnSpawn_01:
	areamonster getmdmapname("1@lhz"),155,43,161,49,"飢えた実験動物",2243,5,getmdnpcname("MobCtrl2#mob02")+"::OnKilled";
	end;
OnSpawn_02:
	areamonster getmdmapname("1@lhz"),137,40,143,46,"飢えた実験動物",2243,5,getmdnpcname("MobCtrl2#mob02")+"::OnKilled";
	end;
OnSpawn_03:
	areamonster getmdmapname("1@lhz"),137,51,143,57,"飢えた実験動物",2243,5,getmdnpcname("MobCtrl2#mob02")+"::OnKilled";
	end;
OnSpawn_04:
	areamonster getmdmapname("1@lhz"),143,56,149,62,"飢えた実験動物",2243,5,getmdnpcname("MobCtrl2#mob02")+"::OnKilled";
	end;
OnSpawn_05:
	areamonster getmdmapname("1@lhz"),160,48,166,54,"飢えた実験動物",2243,5,getmdnpcname("MobCtrl2#mob02")+"::OnKilled";
	end;
OnSpawn_06:
	areamonster getmdmapname("1@lhz"),135,44,141,50,"飢えた実験動物",2243,5,getmdnpcname("MobCtrl2#mob02")+"::OnKilled";
	end;
}

1@lhz,151,53,0	script	#2_3	139,{
OnStart:
	initnpctimer;
	end;
OnTimer1000:
...
1@lhz,46,158,0	script	#escape1	139,20,20,{
	warp "lhz_dun04",147,273;
	end;
}

1@lhz,151,38,0	script	#escape2	139,20,20,{
	warp "lhz_dun04",147,273;
	end;
}

1@lhz,158,46,0	script	第1バルブ#2_1	844,{
...
1@lhz,138,43,0	duplicate(第1バルブ#2_1)	第2バルブ#2_2	844
1@lhz,139,54,0	duplicate(第1バルブ#2_1)	第3バルブ#2_3	844
1@lhz,145,60,0	duplicate(第1バルブ#2_1)	第4バルブ#2_4	844
1@lhz,165,51,0	duplicate(第1バルブ#2_1)	第5バルブ#2_5	844
1@lhz,137,47,0	duplicate(第1バルブ#2_1)	第6バルブ#2_6	844

1@lhz,151,64,0	warp	#potal_02	2,2,1@lhz,84,28

1@lhz,84,28,0	script	#3_0	139,1,1,{
	donpcevent getmdnpcname("3研究室#3_1")+"::OnStart";
	hideonnpc getmdnpcname("#3_0");
	end;
}

1@lhz,1,5,0	script	3研究室#3_1	139,{
OnStart:
	initnpctimer;
	end;
OnStart2:
...
1@lhz,1,6,0	script	MobCtrl3#mob03	139,{
OnStart:
	set .lv,1;
	set .@map$,getmdmapname("1@lhz");
...
OnKilled:
	set .@count,getmapmobs(getmdmapname("1@lhz"),getmdnpcname("MobCtrl3#mob03")+ "::OnKilled");
	if(.@count > 0)
		end;
	set .lv,.lv + 1;
	if(.lv == 6) {
...
1@lhz,83,62,0	warp	#potal_03	2,2,1@lhz,137,100

1@lhz,137,100,0	script	#4_0	139,1,1,{
	donpcevent getmdnpcname("4研究室#4_1")+"::OnStart";
	hideonnpc getmdnpcname("#4_0");
	end;
}

1@lhz,1,7,0	script	4研究室#4_1	139,{
OnStart:
	initnpctimer;
	end;
OnTimer1000:
...
1@lhz,1,8,0	script	MobCtrl4#mob04	139,{
OnStart:
	set .mvp,rand(1,13);
	if(.mvp > 9) {
...
1@lhz,127,156,5	script	セイレン=ウィンザー::Worsef_boss01	1646,{}
1@lhz,123,152,5	script	セシル=ディモン::Worsef_boss02	1650,{}
1@lhz,119,148,5	script	ガーティー=ウー::Worsef_boss03	2239,{}
1@lhz,115,144,5	script	エレメス=ガイル::Worsef_boss04	1647,{}
1@lhz,115,123,7	script	トレンティーニ::Worsef_boss05	2241,{}
1@lhz,119,119,7	script	チェン=リウ::Worsef_boss06	2238,{}
1@lhz,123,115,7	script	アルフォシオ=バジル::Worsef_boss07	2240,{}
1@lhz,127,111,7	script	エミュール=プラメール::Worsef_boss08	2236,{}
1@lhz,148,111,1	script	ランデル=ロレンス::Worsef_boss09	2235,{}
1@lhz,152,115,1	script	セリア=アルデ::Worsef_boss10	2237,{}
1@lhz,156,119,1	script	カトリーヌ=ケイロン::Worsef_boss11	1651,{}
1@lhz,160,123,1	script	マーガレッタ=ソリン::Worsef_boss12	1649,{}
1@lhz,160,144,3	script	ハワード=アルトアイゼン::Worsef_boss13	1648,{}

1@lhz,137,156,7	script	ボルセブ#last	865,{
	mes "[ボルセブ]";
	mes "今すぐ研究室の外に出るのか？";
	next;
	if(select("出ない","出る") == 1) {
