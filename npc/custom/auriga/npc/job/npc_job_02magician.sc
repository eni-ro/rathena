...
geffen_in,164,124,4	script	ギルド関係者#MG	123,{
...
//==============================================================
geffen_in,164,109,2	script	魔導師	64,{
	mes "[魔導師]";
	mes "魔法の強力な力は因果律によって";
	mes "調節されているのじゃ。";
	next;
...
geffen_in,177,112,0	script	本棚	111,{
	mes "-本棚に注意書きの";
	mes " 張り紙が貼ってある-";
	next;
	mes "[注意]";
...
pay_arche,120,100,0	duplicate(水溶液アルバイト)	水溶液アルバイト#Pay	88
moc_ruins,91,150,0	duplicate(水溶液アルバイト)	水溶液アルバイト#Moc	93
