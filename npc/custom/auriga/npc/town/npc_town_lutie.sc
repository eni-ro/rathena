...
// Shop
//------------------------------------------------------------
xmas_in,40,38,5	shop	道具商人	83,501:-1,502:-1,503:-1,504:-1,506:-1,645:-1,656:-1,601:-1,602:-1,611:-1,610:-1
xmas_in,174,98,2	shop	武器商人	49,1201:-1,1204:-1,1207:-1,1210:-1,1213:-1,1216:-1,1219:-1,1222:-1
xmas_in,168,104,4	shop	防具商人	101,2228:-1,2103:-1,2105:-1,2307:-1,2309:-1,2312:-1,2314:-1,2316:-1,2505:-1,2405:-1
xmas_in,169,34,2	shop	プレゼント商人	702,2612:-1,744:-1,748:-1,736:-1,746:-1,740:-1,2613:-1

//============================================================
// アルデバラン⇔ルティエ転送NPC
//------------------------------------------------------------
aldebaran,168,168,4	script	リンクサンタ	718,{
	mes "[シュウタウン]";
	mes "ホーホーホー";
	mes "メリークリスマス!!";
	mes "若者達よ！君たちに祝福を!!";
...
// LUTIE_1QUE -> 0～11
//------------------------------------------------------------
xmas_in,100,96,4	script	サンタジジ	718,{
...
xmas_in,165,174,4	script	クリスマス少女	711,{
	if(LUTIE_1QUE == 1) {
		mes "[ダップル]";
		mes "メリークリスマス!!";
		mes "クリスマスの街、";
...
xmas,134,112,4	script	雪だるま	710,{
...
xmas,117,304,4	script	クリスマス青年	713,{
	if(LUTIE_1QUE == 3) {
		mes "[ポーズ]";
...
xmas,176,236,4	script	毛深いおじさん	712,{
	if(LUTIE_1QUE == 4) {
...
xmas_in,27,103,4	script	太っちょおばさん#normal	701,{
	switch(LUTIE_1QUE) {
	default:
		mes "[タシンチェ]";
		mes "メリークリスマスー";
...
xmas,146,136,4	script	クリスマス芸人	715,{
	mes "[ハソキ]";
	mes "メリークリスマスーピィィ～";
	mes "ピリリ、ピリピリ、ピリリリー";
	mes "ラララーラララー";
...
xmas,206,168,4	script	ちびっこ少年	706,{
	if(LUTIE_1QUE == 9) {
		mes "[チャルチャル]";
		mes "ううん？スノウノウ？";
...
xmas,208,168,4	script	ちびっこ少女	703,{
	if(LUTIE_1QUE == 9) {
		mes "[マーセル]";
		mes "スノウノウ？";
		mes "もちろん知ってるよ～";
...
// 交換NPC
//------------------------------------------------------------
xmas,240,291,3	script	黄金の手のビリーナ	711,{
	if(BaseLevel < 110) {
		mes "[黄金の手のビリーナ]";
		mes "なんだ、あんた。";
		mes "こんな辺鄙な場所に来ても";
...
xmas,240,297,3	script	カーイン	713,{
	if(BaseLevel < 110) {
		mes "[カーイン]";
		mes "ここに来たってことは……";
		mes "何か刺激を求めてきたんだろ？";
