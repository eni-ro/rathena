...
alde_alche,27,185,5	script	錬金術師ギルド員	744,{
	if(Upper == UPPER_HIGH) {
		mes "[パルミジァニーノ]";
		mes "いらっしゃいませ。";
		mes "こちらは錬金術師ギルドです。";
...
alde_alche,175,107,2	script	気むずかしい錬金術師	749,{
	if(Job == Job_Alchemist) {
		mes "[グレゴリー]";
		mes "キキキ　ケケケケ";
		mes "ん、なんじゃ貴様は?!";
...
alde_alche,13,15,7	script	研究者	750,{
	if(Job == Job_Alchemist) {
		mes "[ダルシア]";
		mes "あ……君か。来たのか……そうだね。";
...
alde_alche,79,19,5	script	実験専門家	748,{
	if(Job == Job_Alchemist) {
		mes "[ヴァン=ヘルモント]";
		mes "なんだっ、私は今忙しいんだ!!";
		mes "とっとと用件を言ったらどうだ。";
...
alde_alche,145,19,1	script	首席研究員	57,{
	switch(CHANGE_AM) {
	default:
		mes "[ニコラス=プラメール]";
		mes "ここがこうなるとこうなって……";
...
alde_alche,101,184,4	script	マスターアルケミスト	122,{
...
alde_alche,24,188,2	script	ギルド商人	740,{
	mes "[アルシャープ]";
	mes "いらっしゃいませ！";
	next;
