...
pay_fild08,218,283,4	script	陰気な男	89,{
	mes "…";
	if(DOOM_SWORD & 3 != 3)
		close;
	next;
...
izlude_in,173,88,2	script	ナイン	102,{
	if(DOOM_SWORD & 12) {
		mes "[ナイン]";
...
prontera,197,188,4	script	 ビヨップ	50,{
	if(DOOM_SWORD & 192) {
		mes "[ビヨップ]";
		mes "バルドゥルと言ったら我々が";
