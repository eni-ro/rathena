...
// 転職
//------------------------------------------------------------
yuno_in02,38,61,5	script	魔法アカデミー学長	743,{
...
// 試験申請
//------------------------------------------------------------
yuno_in03,154,35,4	script	アカデミー関係者	742,{
	if(Job == Job_Sage) {
		mes "[メテウス=シルプ]";
		mes "いらっしゃいませ。";
		mes "ひさしぶりですね。";
...
// 一次試験（筆記）
//------------------------------------------
yuno_in03,105,177,5	script	筆記試験教授	754,{
	if(Job == Job_Sage) {
		mes "[クレイトス=ベルモ]";
		mes "うん？卒業した者が何の用かな？";
		mes "またまた入学をご希望かね？";
...
// 二次試験（実技）
//------------------------------------------
yuno_in03,169,180,3	script	実技試験教授	755,{
	if(Job == Job_Sage) {
		mes "[ヘルメス=トリス]";
		mes "やぁ、元気かい？";
		mes "顔を見たところ、それなりに";
...
job_sage,50,165,4	script	実技試験担当#sage	700,{
	mes "[実技試験担当]";
	mes "セージ実技試験へようこそ。";
	mes "試験を受けたければ";
	mes "試験待機室へ入室してください。";
...
OnStart1:
	set .count,16;
	set .flag,1;	//1回目フラグ
	monster "job_sage",111,102,"単位",1183,1,"SageTest::OnKilled";
	monster "job_sage",120,102,"単位",1183,1,"SageTest::OnKilled";
	monster "job_sage",111,93,"単位",1183,1,"SageTest::OnKilled";
	monster "job_sage",120,93,"単位",1183,1,"SageTest::OnKilled";
	monster "job_sage",107,98,"単位",1183,1,"SageTest::OnKilled";
	monster "job_sage",124,98,"単位",1183,1,"SageTest::OnKilled";
	monster "job_sage",115,106,"単位",1183,1,"SageTest::OnKilled";
	monster "job_sage",115,90,"単位",1183,1,"SageTest::OnKilled";
	monster "job_sage",103,110,"単位",1184,1,"SageTest::OnKilled";
	monster "job_sage",128,110,"単位",1184,1,"SageTest::OnKilled";
	monster "job_sage",103,85,"単位",1184,1,"SageTest::OnKilled";
	monster "job_sage",128,85,"単位",1184,1,"SageTest::OnKilled";
	monster "job_sage",107,106,"単位",1184,1,"SageTest::OnKilled";
	monster "job_sage",124,106,"単位",1184,1,"SageTest::OnKilled";
	monster "job_sage",107,89,"単位",1184,1,"SageTest::OnKilled";
	monster "job_sage",124,89,"単位",1184,1,"SageTest::OnKilled";
	initnpctimer;
	end;
OnStart2:
	set .count,24;
	set .flag,2;	//2回目フラグ
	monster "job_sage",111,102,"数学",1063,1,"SageTest::OnKilled";
	monster "job_sage",111,102,"物理学",1063,1,"SageTest::OnKilled";
	monster "job_sage",111,102,"史学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,102,"地理学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,102,"天文学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,102,"気象学",1063,1,"SageTest::OnKilled";
	monster "job_sage",111,93,"建築学",1063,1,"SageTest::OnKilled";
	monster "job_sage",111,93,"制御学",1063,1,"SageTest::OnKilled";
	monster "job_sage",111,93,"計測学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,102,"統計学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,102,"都市学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,102,"言語学",1063,1,"SageTest::OnKilled";
	monster "job_sage",111,93,"食品学",1063,1,"SageTest::OnKilled";
	monster "job_sage",111,93,"栄養学",1063,1,"SageTest::OnKilled";
	monster "job_sage",111,93,"造形学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,93,"人類学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,93,"生物学",1063,1,"SageTest::OnKilled";
	monster "job_sage",120,93,"倫理学",1063,1,"SageTest::OnKilled";
	monster "job_sage",107,98,"経済学",1063,1,"SageTest::OnKilled";
	monster "job_sage",107,98,"政治学",1063,1,"SageTest::OnKilled";
	monster "job_sage",107,98,"魔法学",1063,1,"SageTest::OnKilled";
	monster "job_sage",124,98,"山林学",1063,1,"SageTest::OnKilled";
	monster "job_sage",124,98,"保健学",1063,1,"SageTest::OnKilled";
	monster "job_sage",124,98,"心理学",1063,1,"SageTest::OnKilled";
	setnpctimer 1001;
	end;
OnStart3:
	set .flag,3;	//3回目フラグ
	monster "job_sage",116,97,"学士称号",1179,1,"SageTest::OnPass";
	monster "job_sage",107,106,"欠席",1185,1;
	monster "job_sage",124,106,"遅刻",1185,1;
	monster "job_sage",107,89,"カンニング",1185,1;
	monster "job_sage",124,89,"貸し出し",1185,1;
	setnpctimer 123001;
	end;
OnKilled:
	set .count,.count-1;
...
// 三次試験（イグドラシル研究）
//------------------------------------------
yuno_in03,62,176,2	script	史学教授	109,{
	if(Job == Job_Sage) {
		mes "[シピエン=ライルリース]";
		mes "誰かな……？";
		mes "ああ、私が教えた学生ですね。";
...
// 三次試験（モンスター研究）
//------------------------------------------
yuno_in03,32,102,1	script	生物学教授	755,{
	if(Job == Job_Sage) {
		mes "[ルシウス=ケルソス]";
		mes "何か、不明な点でもあるのかね？";
		mes "質問があったら一週間前に";
...
// 三次試験（魔法研究）
//------------------------------------------
yuno_in03,244,31,3	script	物理学教授	120,{
	if(Job == Job_Sage) {
		mes "[エベシ=ジョルダ]";
		mes "ヒョホホ、こんにちは。";
		mes "何の用かな？";
