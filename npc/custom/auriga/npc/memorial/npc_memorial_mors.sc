...
// ダンジョン生成NPC
//------------------------------------------------------------
moro_cav,61,69,3	script	先任追跡隊員#a1	730,{
	if(checkquest2(9319) || checkquest2(118930)) {
		if(checkquest2(9319)&0x2 == 0 || checkquest2(118930)&0x2 == 0) {
			mes "[先任追跡隊員]";
	...
	if(checkquest2(201725)) {	// モルスクリア済み
		mes "[先任追跡隊員]";
		mes "もう一度戻って来ると思いました。";
		next;
		mes "[先任追跡隊員]";
	...
	mes "私はモロクの足跡を追っています。";
	next;
	if(checkquest2(201720) == 0) {	// ビオスの島未攻略
		mes "[先任追跡隊員]";
		mes "現在、この赤い花を調査中です。";
		mes "どうもその隣にある、";
		mes "黄色い種と深い関係が";
...
moro_cav,57,69,3	script	赤い花#a1	844,{
	if(checkquest2(9319) || checkquest2(118930)) {
		if(checkquest2(9319)&0x2 == 0 || checkquest2(118930)&0x2 == 0) {
			mes "‐赤い花が閉ざされている。";
			mes "　入る事ができなさそうだ‐";
...
// モルスの洞窟
//------------------------------------------------------------
1@rev,1,1,0	script	MorsControl	139,{
OnStart:
	if(.flag)
		end;
	set .flag,1;
...
1@rev,27,181,0	script	#RZメモリアルスタート	139,1,1,{
OnTouch:
	if(getpartyleader(getcharid(1)) != strcharinfo(0))
		end;
...
1@rev,34,120,0	script	#RZ_EFFECT01	139,{
OnStart:
	initnpctimer;
	misceffect 89;
	end;
...
1@rev,34,48,0	script	#RZ_EFFECT02	139,{
OnStart:
	initnpctimer;
	misceffect 89;
	misceffect 196;
...
1@rev,31,181,0	script	#RZイベント_1	139,5,5,{
OnTouch:
	if(getpartyleader(getcharid(1)) != strcharinfo(0))
		end;
	pcblockmove 1;
...
1@rev,31,181,0	script	#RZイベント_1-2	139,5,5,{
OnTouch:
	if(getpartyleader(getcharid(1)) != strcharinfo(0))
		end;
	mes "‐後方から声が聞こえる？";
...
1@rev,20,181,0	script	#モルス入口スタート	139,{
OnStart:
	set .@map$,getmdmapname("1@rev");
...
OnTimer2000:
	set .@count,getmapmobs(getmdmapname("1@rev"),getmdnpcname("#モルス入口スタート")+ "::OnKilled");
	if(.@count <= 0) {
		stopnpctimer;
...
1@rev,25,183,5	script	教官長イグリド#RZ1	751,{
	mes "[イグリド]";
	mes "気を付けろ！";
	mes "敵が来ているぞ！";
	close;
...
1@rev,25,183,5	script	キド#RZ1	884,{
	mes "[キド]";
	mes "敵が来るぞ！";
	close;
OnStart:
...
1@rev,25,183,5	script	ヒシエ#RZ1	623,{
	mes "[ヒシエ]";
	mes "敵が来ているぞ！";
	mes "注意しろ！";
	close;
...
1@rev,60,184,5	script	教官長イグリド#RZ2	751,{
	mes "[イグリド]";
	mes "死神みてえな顔しやがって！";
	close;
}

1@rev,60,184,5	script	キド#RZ2	884,{
	mes "[キド]";
	mes "目の前の敵に集中しろ。";
	close;
}

1@rev,60,184,5	script	ヒシエ#RZ2	623,{
	mes "[ヒシエ]";
	mes "得体のしれない奴だ。気を付けよう。";
	close;
}

1@rev,64,181,4	script	死神アンク#RZイベント_2	3029,{
	end;
OnStart:
	set .menu,getvariableofnpc(.menu, getmdnpcname("#RZイベント_1-2"));
...
1@rev,34,126,4	script	死神アンク#RZイベント_3	3029,{
	end;
OnStart:
...
1@rev,34,55,4	script	死神アンク#RZイベント_5	3029,{
	end;
OnStart:
...
1@rev,112,48,4	script	死神アンク#RZイベント_6	3029,{}

1@rev,63,181,0	warp	#RZ移動_30	10,8,1@rev,103,177
1@rev,47,181,0	warp	#RZ移動_31	10,8,1@rev,103,177
1@rev,31,181,0	warp	#RZ移動_32	10,8,1@rev,103,177
1@rev,104,176,0	script	#RZイベント_3	139,1,1,{
OnTouch:
	pcblockmove 1;
	set .menu,getvariableofnpc(.menu, getmdnpcname("#RZイベント_1-2"));
...
1@rev,102,180,5	script	教官長イグリド#RZ3	751,{
	mes "[イグリド]";
	mes "気を付けろ！";
	mes "あのモロクがこんなにあっさり";
	mes "見つかるとは思えない。";
...
1@rev,102,180,5	script	キド#RZ3	884,{
	mes "[キド]";
	mes "気を付けろ！";
	mes "あのモロクがこんなにあっさり";
	mes "見つかるとは思えない。";
...
1@rev,102,180,5	script	ヒシエ#RZ3	623,{
	mes "[ヒシエ]";
	mes "気を付けろ！";
	mes "あのモロクがこんなにあっさり";
	mes "見つかるとは思えない。";
...
1@rev,111,178,4	script	モロク??#RZ1	1916,{
	end;
OnStart:
	sleep 500;
	...
	monster getmdmapname("1@rev"),111,178,"モロク??",2998,1,getmdnpcname("モロク??#RZ1")+ "::OnKilled";
	end;
OnTimer2000:
	set .@count,getmapmobs(getmdmapname("1@rev"),getmdnpcname("モロク??#RZ1")+ "::OnKilled");
	if(.@count <= 0) {
		stopnpctimer;
...
1@rev,33,120,4	script	教官長イグリド#RZ4	751,{
	mes "[イグリド]";
	mes "くそっ。動けそうにないな……。";
	close;
}

1@rev,33,120,4	script	キド#RZ4	884,{
	mes "[キド]";
	mes "くっ。なんだこれは。";
	mes "全く動けん。";
	close;
...
1@rev,33,120,4	script	ヒシエ#RZ4	623,{
	mes "[ヒシエ]";
	mes "くぅっ。力が入らない……。";
	close;
}

1@rev,33,120,0	script	#停止エフェクトRZ1	139,{
OnStart:
OnTimer10000:
	initnpctimer;
	misceffect 74;
...
/*
1@rev,33,108,0	script	#2部屋目デバフ_1	139,{}
1@rev,33,112,0	script	#2部屋目デバフ_2	139,{}
1@rev,33,116,0	script	#2部屋目デバフ_3	139,{}
1@rev,33,120,0	script	#2部屋目デバフ_4	139,{}
1@rev,33,124,0	script	#2部屋目デバフ_5	139,{}
1@rev,33,128,0	script	#2部屋目デバフ_6	139,{}
1@rev,33,131,0	script	#2部屋目デバフ_7	139,{}
*/

1@rev,34,120,0	script	#魂エフェクト用	139,{}

1@rev,35,119,0	script	#戦闘_1RZ1	139,2,2,{
	set .menu,getvariableofnpc(.menu, getmdnpcname("#RZイベント_1-2"));
	set .cnt,0;
	...
	hideoffnpc .name$;
	monster getmdmapname("1@rev"),34,120,.@mobname$,3007,1,getmdnpcname("#戦闘_1RZ1")+ "::OnKilled1";
...
OnTimer1000:
	initnpctimer;
	set .@count,getmapmobs(getmdmapname("1@rev"),getmdnpcname("#戦闘_1RZ1")+ "::OnKilled2");
	if(.@count == 0) {
		switch(.cnt) {
...
1@rev,35,119,0	script	#戦闘_1RZ1_timer	139,{
OnStart:
...
1@rev,34,47,0	script	#戦闘_2RZ1	139,10,10,{
	set .cnt,0;
...
OnTimer1000:
	initnpctimer;
	set .@count,getmapmobs(getmdmapname("1@rev"),getmdnpcname("#戦闘_2RZ1")+ "::OnKilled");
	if(.@count == 0) {
		switch(.cnt) {
...
1@rev,34,47,0	script	#戦闘_2RZ1_timer	139,{
OnStart:
...
1@rev,112,48,4	script	モルス・魔導士#RZ1	10029,{
	end;
OnStart:
	sleep 3000;
...
1@rev,104,47,0	script	#戦闘_3RZ1	139,5,5,{
	set .menu,getvariableofnpc(.menu, getmdnpcname("#RZイベント_1-2"));
	...
	if(.menu==0)
		...
		set .@mobname$,"ヒシエの魂";
	hideoffnpc .name$;
	monster getmdmapname("1@rev"),112,48,.@mobname$,3007,1,getmdnpcname("#戦闘_3RZ1")+ "::OnKilled1";
	...
	killmonster getmdmapname("1@rev"),getmdnpcname("#戦闘_3RZ1")+ "::OnKilled1";
	sleep 3000;
	...
	sleep 3000;
	hideonnpc getmdnpcname("モルス・魔導士#RZ1");
	monster getmdmapname("1@rev"),112,48,"モルス・魔導士",2999,1,getmdnpcname("#戦闘_3RZ1")+ "::OnKilled2";
	initnpctimer;
	end;
OnKilled1:
OnKilled2:
...
OnTimer2000:
	set .@count,getmapmobs(getmdmapname("1@rev"),getmdnpcname("#戦闘_3RZ1")+ "::OnKilled2");
	if(.@count <= 0) {
		stopnpctimer;
...
1@rev,108,51,5	script	教官長イグリド#RZ5	751,{
	mes "[イグリド]";
	mes "はぁ……はぁ……";
	mes "モロクを……モロクはどこだ……。";
	close;
...
1@rev,108,51,5	script	キド#RZ5	884,{
	mes "[キド]";
	mes "モロクを……";
	mes "くそっ……";
	mes "傷が深い。";
...
1@rev,108,51,5	script	ヒシエ#RZ5	623,{
	mes "[ヒシエ]";
	mes "ふぅ……少し……";
	mes "傷が深いな……。";
	close;
...
1@rev,106,60,0	script	#戦闘_3RZ2	139,{
OnStart:
	hideoffnpc getmdnpcname("モルス・魔導士#RZ1");
	sleep 3000;
	...
	hideonnpc getmdnpcname("モルス・魔導士#RZ1");
	set .mob_id,callmonster(getmdmapname("1@rev"),112,48,"モルス・ネクロマンサー",3000,getmdnpcname("#戦闘_3RZ2")+ "::OnKilled");
	if(.menu >= 1) {
...
OnTimer1000:
	set .cnt,.cnt+1;
	set .@count,getmapmobs(getmdmapname("1@rev"),getmdnpcname("#戦闘_3RZ2")+ "::OnKilled");
	if(.@count <= 0) {
		stopnpctimer;
		set getvariableofnpc(.users,getmdnpcname("#RZ移動_17a")),getmapusers(getmdmapname("1@rev"));
...
1@rev,120,60,0	script	#戦闘_3RZ3	139,{
OnStart:
	set .flag,0;
	initnpctimer;
	end;
...
OnStop:
	stopnpctimer;
	killmonster getmdmapname("1@rev"),getmdnpcname("#戦闘_3RZ3")+ "::OnKilled";
	end;
}

1@rev,120,61,0	script	#戦闘_3RZ4	139,{
OnStart:
	set .mob,callmonster(getmdmapname("1@rev"),112,57,"モルス・オシリス#1",3002,getmdnpcname("#戦闘_3RZ4")+ "::OnKilled");
	initnpctimer;
	end;
OnTimer4500:
	if(getunitdata(.mob,UMOB_HP) > 0) {
		set .@dummy,getmapxy(.@map$,.@x,.@y,BL_NPC,.mob);
		monster getmdmapname("1@rev"),.@x,.@y,"モルス・プランクトン#1",3008,1,getmdnpcname("#戦闘_3RZ4")+ "::OnKilled";
	}
	initnpctimer;
	end;
OnKilled:
...
OnStop:
	stopnpctimer;
	killmonster getmdmapname("1@rev"),getmdnpcname("#戦闘_3RZ4")+ "::OnKilled";
	end;
}

1@rev,120,62,0	script	#戦闘_3RZ5	139,{
OnStart:
	set .mob,callmonster(getmdmapname("1@rev"),121,47,"モルス・オシリス#2",3002,getmdnpcname("#戦闘_3RZ5")+ "::OnKilled");
	initnpctimer;
	end;
OnTimer4500:
	if(getunitdata(.mob,UMOB_HP) > 0) {
		set .@dummy,getmapxy(.@map$,.@x,.@y,BL_NPC,.mob);
		monster getmdmapname("1@rev"),.@x,.@y,"モルス・プランクトン#2",3008,1,getmdnpcname("#戦闘_3RZ5")+ "::OnKilled";
	}
	initnpctimer;
	end;
OnKilled:
...
OnStop:
	stopnpctimer;
	killmonster getmdmapname("1@rev"),getmdnpcname("#戦闘_3RZ5")+ "::OnKilled";
	end;
}

1@rev,120,63,0	script	#戦闘_3RZ6	139,{
OnStart:
	set .mob,callmonster(getmdmapname("1@rev"),112,38,"モルス・オシリス#3",3002,getmdnpcname("#戦闘_3RZ6")+ "::OnKilled");
	initnpctimer;
	end;
OnTimer4500:
	if(getunitdata(.mob,UMOB_HP) > 0) {
		set .@dummy,getmapxy(.@map$,.@x,.@y,BL_NPC,.mob);
		monster getmdmapname("1@rev"),.@x,.@y,"モルス・プランクトン#3",3008,1,getmdnpcname("#戦闘_3RZ6")+ "::OnKilled";
	}
	initnpctimer;
	end;
OnKilled:
...
OnStop:
	stopnpctimer;
	killmonster getmdmapname("1@rev"),getmdnpcname("#戦闘_3RZ6")+ "::OnKilled";
	end;
}

1@rev,120,58,0	script	#戦闘_3RZ7	139,{
OnStart:
	set .mob,callmonster(getmdmapname("1@rev"),102,48,"モルス・オシリス#4",3002,getmdnpcname("#戦闘_3RZ7")+ "::OnKilled");
	initnpctimer;
	end;
OnTimer4500:
	if(getunitdata(.mob,UMOB_HP) > 0) {
		set .@dummy,getmapxy(.@map$,.@x,.@y,BL_NPC,.mob);
		monster getmdmapname("1@rev"),.@x,.@y,"モルス・プランクトン#4",3008,1,getmdnpcname("#戦闘_3RZ7")+ "::OnKilled";
	}
	initnpctimer;
	end;
OnKilled:
...
OnStop:
	stopnpctimer;
	killmonster getmdmapname("1@rev"),getmdnpcname("#戦闘_3RZ7")+ "::OnKilled";
	end;
}

1@rev,106,183,0	warp	#RZ移動_1	10,10,1@rev,33,117
1@rev,106,172,0	warp	#RZ移動_2	10,10,1@rev,33,117
1@rev,117,172,0	warp	#RZ移動_3	10,10,1@rev,33,117
1@rev,117,183,0	warp	#RZ移動_4	10,10,1@rev,33,117
1@rev,28,125,0	warp	#RZ移動_5	10,10,1@rev,31,50
1@rev,28,114,0	warp	#RZ移動_6	10,10,1@rev,31,50
1@rev,39,114,0	warp	#RZ移動_7	10,10,1@rev,31,50
1@rev,39,125,0	warp	#RZ移動_8	10,10,1@rev,31,50
1@rev,28,125,0	warp	#RZ移動_5a	10,10,moro_cav,59,63
1@rev,28,114,0	warp	#RZ移動_6a	10,10,moro_cav,59,63
1@rev,39,114,0	warp	#RZ移動_7a	10,10,moro_cav,59,63
1@rev,39,125,0	warp	#RZ移動_8a	10,10,moro_cav,59,63

1@rev,28,53,0	warp	#RZ移動_13a	10,10,moro_cav,59,63
1@rev,28,42,0	warp	#RZ移動_14a	10,10,moro_cav,59,63
1@rev,39,42,0	warp	#RZ移動_15a	10,10,moro_cav,59,63
1@rev,39,53,0	warp	#RZ移動_16a	10,10,moro_cav,59,63
1@rev,28,53,0	warp	#RZ移動_13	10,10,1@rev,104,48
1@rev,28,42,0	warp	#RZ移動_14	10,10,1@rev,104,48
1@rev,39,42,0	warp	#RZ移動_15	10,10,1@rev,104,48
1@rev,39,53,0	warp	#RZ移動_16	10,10,1@rev,104,48

1@rev,112,56,3	script	#RZ移動_17a	723,{
	...
	if(checkquest2(116514)==0) {
		setquest 116514;
		compquest 116514;
	}
	if(checkquest2(9318) & 0x8)
		getitem 6684,1;
	if(checkquest2(201725)==0)
		setquest 201725;
	if(MORS_1QUE==0)
		set MORS_1QUE,.users;
	warp "moro_cav",59,63;
