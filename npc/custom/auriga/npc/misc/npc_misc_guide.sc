...
//[案内要員 - プロンテラ]
prontera,154,196,4	script	案内要員#prontera	105,{
	cutin "prt_soldier",2;
	mes "[プロンテラ 案内要員]";
...
prontera,282,208,2	duplicate(案内要員#prontera)	東門-案内要員	105
prontera,29,200,6	duplicate(案内要員#prontera)	西門-案内要員	105
prontera,160,29,0	duplicate(案内要員#prontera)	南門-案内要員	105
prontera,151,330,4	duplicate(案内要員#prontera)	北門-案内要員	105


//----------------------------------------------------------------------
//[案内要員 - イズルード]

izlude,123,87,6	script	案内要員	105,{
	cutin "prt_soldier",2;
	mes "[イズルード案内要員]";
	mes "衛星都市イズルードにようこそ！";
	mes "私はこのイズルードの道案内を";
...
geffen,203,116,0	script	案内要員#geffen	705,{
	cutin "gef_soldier",2;
	mes "[ゲフェン案内要員]";
...
geffen,118,62,0	duplicate(案内要員#geffen)	案内要員	705


//----------------------------------------------------------------------
//[案内要員 - フェイヨン]

payon,162,67,4	script	案内要員	708,{
	cutin "pay_soldier",2;
	mes "[フェイヨン案内要員]";
	mes "山岳都市フェイヨンにようこそ。";
	mes "私達はここフェイヨンにいらした";
...
pay_arche,85,30,2	script	案内要員	708,{
	cutin "pay_soldier",2;
	mes "[フェイヨン案内要員]";
	mes "山岳都市フェイヨンにようこそ。";
	mes "私はここフェイヨンにいらした";
...
alberta,23,238,4	script	案内要員#alberta	105,{
	cutin "prt_soldier",2;
	mes "[アルベルタ案内要員]";
	mes "港の都市アルベルタにようこそ。";
	mes "私達はここアルベルタに訪れた";
...
alberta,120,60,3	duplicate(案内要員#alberta)	案内要員	105


//----------------------------------------------------------------------
//[案内要員 - モロク]

morocc,153,286,6	script	案内要員#morocc	707,{
	cutin "moc_soldier",2;
	mes "[モロク案内要員]";
	mes "……ようこそ、辺境の地モロクへ。";
...
morocc,54,97,6	duplicate(案内要員#morocc)	案内要員	707


//----------------------------------------------------------------------
//[案内要員 - アルデバラン]

aldebaran,139,63,4	script	兵士	105,{
	cutin "prt_soldier",2;
	mes "[アルデバラン守備兵]";
	mes "私は、どこにでもいる平凡な";
	mes "守備兵ではありません。";
...
aldebaran,241,136,2	script	兵士	105,{
	cutin "prt_soldier",2;
	mes "[アルデバラン守備兵]";
	mes "私は、どこにでもいる平凡な";
	mes "守備兵ではありません。";
...
//----------------------------------------------------------------------
//[案内要員 - コモド]
comodo,322,178,4	script	コモドガイド#ココモ	700,{
...
comodo,176,350,4	duplicate(コモドガイド#ココモ)	コモドガイド#ノッココ	700
comodo,37,219,4	duplicate(コモドガイド#ココモ)	コモドガイド#パパヤ	700


//----------------------------------------------------------------------
//[案内要員 - ジュノー]

yuno,153,47,4	script	"ジュノーガイド"	700,{
	mes "[ジュノーガイド]";
	mes "過去を知り……";
	mes "現在を見つめ……";
	mes "未来を予知する……";
...
amatsu,207,91,4	script	ミス・アマツ::蛍ちゃん	758,{
...
amatsu,251,283,4	duplicate(蛍ちゃん)	案内人	767


//----------------------------------------------------------------------
//[案内要員 - コンロン]

gonryun,163,60,4	script	コンロンガイド	780,{
	mes "[ハ ウォンチ]";
...
umbala,128,94,4	script	探険家	702,{
	mes "[探険家]";
	mes "ここはとても変な所です。";
	mes "未開拓のためなのか、";
	mes "道もとても複雑です。";
...
niflheim,186,190,6	script	迷い人	798,{
	mes "[リカエル]";
	mes "こんなに恐ろしい街へ";
	mes "いらっしゃるなんて……";
	mes "あなたも道に迷われたのですね。";
...
//----------------------------------------------------------------------
//[案内要員 - 龍之城]
louyang,224,104,4	script	広報大使#Lou	818,{
	mes "["+strnpcinfo(0)+"]";
	mes "龍之城へようこそ。";
...
louyang,160,175,4	duplicate(広報大使#Lou)	兵士	825
louyang,213,213,4	duplicate(広報大使#Lou)	兵士	825


//----------------------------------------------------------------------
//[案内要員 - アユタヤ]

ayothaya,203,169,4	script	ノイ	839,{
	mes "[ノイ]";
	mes "こんにちは。";
	mes "アユタヤへようこそ。";
	mes "ここアユタヤは、深き森に囲まれ";
...
einbroch,72,202,4	script	案内要員#einbroch	852,{
	cutin "ein_soldier",2;
	mes "[アインブロック案内要員]";
...
//大気汚染イベントでハイドされる
einbroch,155,43,4	duplicate(案内要員#einbroch)	案内要員#einbrochdummy1	852
einbroch,162,317,4	duplicate(案内要員#einbroch)	案内要員#einbrochdummy2	852

//----------------------------------------------------------------------
//[案内要員 - アインベフ]

einbech,67,37,4	script	案内要員#einbech	852,{
	cutin "ein_soldier",2;
	mes "[アインベフ案内要員]";
	mes "採鉱の村アインベフへようこそ。";
...
einbech,48,214,4	duplicate(案内要員#einbech)	案内要員#einbechdummy	852

//----------------------------------------------------------------------
//[案内要員 - リヒタルゼン]

lighthalzen,207,310,5	script	案内要員#West_Lhz1	852,{
	cutin "ein_soldier",2;
	mes "[リヒタルゼン案内要員]";
	mes "企業都市リヒタルゼンへようこそ！";
	mes "私はここリヒタルゼンに訪れた";
...
lighthalzen,154,100,5	duplicate(案内要員#West_Lhz1)	案内要員#West_Lhz2	852
lighthalzen,220,311,3	duplicate(案内要員#West_Lhz1)	案内要員#East_Lhz1	852
lighthalzen,307,224,3	duplicate(案内要員#West_Lhz1)	案内要員#East_Lhz2	852

//----------------------------------------------------------------------
//[案内要員 - フィゲル]

hugel,98,56,3	script	案内要員	863,{
	mes "[フィゲル案内要員]";
	mes "おや、若い人ね。こんにちわ。";
	mes "ここはシュバルツバルドの";
	mes "フィゲルという村よ。";
...
rachel,138,146,5	script	ラヘル案内要員	934,{
	mes "[ラヘル案内要員]";
	mes "女神フレイヤ様の愛に包まれた";
	mes "アルナベルツの首都、ラヘルに";
	mes "ようこそいらっしゃいました。";
...
veins,210,345,5	script	ベインス案内兵士#ve	934,{
	mes "[ベインス案内兵士]";
	mes "砂嵐を通り抜けて来た皆様、";
	mes "ようこそ！";
	mes "ここは";
...
veins,189,101,5	duplicate(ベインス案内兵士#ve)	ベインス案内兵士	934

//----------------------------------------------------------------------
//[案内要員 - モスコビア]

moscovia,161,76,4	script	モスコビアガイド	959,{
	mes "[モスコビアガイド]";
	mes "ようこそ。";
	mes "広い海の上に浮き上がる楽園。";
	mes "美しい海の音色と暖かい日差しが";
...
brasilis,240,81,3	script	ブラジリスガイド	478,{
	mes "[ブラジリスガイド]";
	mes "真っ赤に輝く太陽に";
	mes "情熱的な国、ブラジリスに";
	mes "ようこそいらっしゃいました。";
...
dewata,226,82,4	script	デワタ案内要員#dew1	537,{
	mes "[デワタ案内要員]";
	mes "美しい波が心を穏やかにさせる、";
...
dewata,197,184,4	duplicate(デワタ案内要員#dew1)	デワタ案内要員#dew2	537
