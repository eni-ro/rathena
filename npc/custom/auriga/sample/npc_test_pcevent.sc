...
gl_cas02,0,0,0	script	DieControl	-1,{
OnPCDie:
	clearitem;
	end;
}
...
pvp_y_1-1,155,192,4	script	記録者	711,{
	mes "[記録者]";
	mes "あなたが倒した人数は";
...
prontera,146,92,6	script	観光地案内#pro	114,{
...
izlude,134,91,4	script	観光地案内#izl	114,{
...
alberta,113,57,6	script	観光地案内#alb	114,{
