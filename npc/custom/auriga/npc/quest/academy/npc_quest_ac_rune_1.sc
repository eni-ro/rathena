...
// 赤色 0xFF0000
alberta,39,46,5		script	ルイーゼ	726,{
...
alberta,234,98,3	script	職人	847,{
...
payon,216,120,4		script	ロイス	928,{
...
amatsu,212,141,4	script	アーチボルド	120,{
...
gonryun,140,65,4	script	ゲイソン	777,{
...
louyang,229,109,4	script	老人	866,{
...
louyang,233,109,4	script	女性#AC_QUE01	66,{
	if(AC_QUEST_LV_1==4 && AC_QUEST_ST_1==3){
		mes "[女性]";
		mes "ここまで、はっきり言う人も";
		mes "珍しいわね……";
...
ayothaya,212,176,4		script	デューイ	109,{
...
comodo,113,219,4	script	老婆#ac_comodo	918,{
...
comodo,116,219,4	duplicate(老婆#ac_comodo)	老人#ac_comodo	55
//初期の頃は自動会話ではなく、クリック方式だった
alberta,107,59,0	script		埋める場所#AC_QUE01		139,2,2,{
