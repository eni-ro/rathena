...
function	script	KafraMain	{
	...
	function KafraTrans {
		...
		switch ( getelementofarray(getarg(10),.@j) ) {
			...
			//追加
			case 20: warp "malangdo",135,134;	break;
		}
		end;
	}
...
prontera,146,89,6	script	カプラ職員	117,{
	...
	callfunc "KafraMain",1,0x1ff,"prontera",116,72,"NULL",0,0,40,800,.@code,.@price;
	close2;
...
prontera,282,200,2	script	カプラ職員	114,{
	...
	setarray .@code,2,3,4,5,6,8,7;
	setarray .@price,600,1200,1200,1200,1800,2000,1700;
	callfunc "KafraMain",1,0x1ff,"prt_fild06",33,192,"prontera",279,200,40,800,.@code,.@price;
	close2;
	viewpoint 1,146,89,1,0x0000FF;
	viewpoint 1,282,200,2,0x0000FF;
	viewpoint 1,151,29,3,0x0000FF;
...
prontera,151,29,0	script	カプラ職員	115,{
	...
	setarray .@code,2,3,4,5,6,8,7;
	setarray .@price,600,1200,1200,1200,1800,2000,1700;
	callfunc "KafraMain",1,0x1ff,"prt_fild08",170,368,"prontera",116,72,40,800,.@code,.@price;
	close2;
	viewpoint 1,146,89,1,0x0000FF;
	viewpoint 1,282,200,2,0x0000FF;
	viewpoint 1,151,29,3,0x0000FF;
...
prontera,29,207,6	script	カプラ職員	113,{
	...
	setarray .@code,2,3,4,5,6,8,7;
	setarray .@price,600,1200,1200,1200,1800,2000,1700;
	callfunc "KafraMain",1,0x1ff,"prt_fild05",368,205,"prontera",33,207,40,800,.@code,.@price;
	close2;
	viewpoint 1,146,89,1,0x0000FF;
	viewpoint 1,282,200,2,0x0000FF;
	viewpoint 1,151,29,3,0x0000FF;
...
prt_fild01,198,47,0	script	カプラ職員	112,{
	...
	setarray .@code,2,3,4,5,6,8,7;
	setarray .@price,600,1200,1200,1200,1800,2000,1700;
	callfunc "KafraMain",1,0x1df,"prt_fild01",198,51,"NULL",0,0,40,800,.@code,.@price;
	end;
}
...
prt_fild05,290,224,4	script	カプラ職員	114,{
	cutin "kafra_04",2;
	callfunc "KafraMain",0,0x1db,"prt_fild05",274,244,"NULL",0,0,30,800;
	end;
}
...
izlude,134,88,4	script	カプラ職員	115,{
	...
	callfunc "KafraMain",1,0x1ff,"prt_fild08",350,202,"izlude",94,103,30,800,.@code,.@price;
	close2;
...
geffen,120,62,0	script	カプラ職員	115,{
	...
	callfunc "KafraMain",0,0x1ff,"geffen",120,38,"NULL",0,0,30,800,.@code,.@price;
	close2;
...
geffen,203,123,4	script	カプラ職員	114,{
	...
	setarray .@code,1,8,7,9;
	setarray .@price,1200,1200,1700,1700;
	callfunc "KafraMain",0,0x1ff,"gef_fild00",55,222,"geffen",120,38,30,800,.@code,.@price;
	close2;
	viewpoint 1,120,62,1,0x0000FF;
	viewpoint 1,203,123,2,0x0000FF;
	cutin "kafra_04",255;
...
morocc,156,97,4	script	カプラ職員	113,{
	...
	callfunc "KafraMain",1,0x1ff,"morocc",156,46,"NULL",0,0,40,800,.@code,.@price;
	close2;
...
morocc,160,258,4	script	カプラ職員	114,{
	...
	setarray .@code,1,4,6,10,11;
	setarray .@price,1200,1200,1800,1800,1200;
	callfunc "KafraMain",1,0x1ff,"moc_fild07",211,29,"morocc",160,283,40,800,.@code,.@price;
	close2;
	viewpoint 1,160,258,1,0x0000FF;
	viewpoint 1,159,97,2,0x0000FF;
	cutin "kafra_04",255;
...
alberta,28,229,0	script	カプラ職員	116,{
	...
	callfunc "KafraMain",1,0x1ff,"pay_fild03",387,76,"alberta",31,231,50,800,.@code,.@price;
	close2;
...
alberta,113,60,6	script	カプラ職員#alberta2	112,{
	...
	setarray .@code,4,1,5;
	setarray .@price,1200,1800,1800;
	callfunc "KafraMain",1,0x1ff,"alberta",117,56,"NULL",0,0,50,800,.@code,.@price;
	close2;
	viewpoint 1,28,229,1,0x0000FF;
	viewpoint 1,113,60,2,0x0000FF;
	cutin "kafra_06",255;
...
payon,175,226,4	script	カプラ職員	116,{
	...
	callfunc "KafraMain",1,0x1df,"payon",207,113,"NULL",0,0,40,800,.@code,.@price;
	end;
}
...
payon,181,104,4	script	カプラ職員	113,{
	...
	setarray .@code,6,1,5;
	setarray .@price,1200,1200,1200;
	callfunc "KafraMain",1,0x1df,"payon",160,58,"NULL",0,0,40,800,.@code,.@price;
	end;
}
...
pay_arche,55,123,4	script	カプラ職員	114,{
	cutin "kafra_04",2;
	callfunc "KafraMain",1,0x1db,"pay_arche",50,145,"NULL",0,0,40,800;
	end;
}
...
aldebaran,143,119,4	script	カプラ職員	113,{
	...
	callfunc "KafraMain",0,0x1df,"aldebaran",167,112,"NULL",0,0,40,800,.@code,.@price;
	end;
}
...
cmd_in02,146,180,4	script	カプラ職員	721,{
	...
	callfunc "KafraMain",2,0x1df,"comodo",209,143,"NULL",0,0,40,800,.@code,.@price;
	end;
}
...
cmd_fild07,136,134,4	script	カプラ職員	721,{
	...
	callfunc "KafraMain",2,0x1df,"cmd_fild07",127,134,"NULL",0,0,80,1000,.@code,.@price;
	end;
}
...
comodo,195,150,4	script	カプラ職員	721,{
	...
	callfunc "KafraMain",2,0x1df,"comodo",180,151,"NULL",0,0,80,1000,.@code,.@price;
	end;
}
...
yuno,152,187,4	script	カプラ職員	113,{
	...
	set .@code,8;
	set .@price,1200;
	callfunc "KafraMain",0,0x1ff,"yuno",158,124,"NULL",0,0,40,800,.@code,.@price;
	close2;
...
yuno,327,109,4	script	カプラ職員	113,{
	...
	set .@code,8;
	set .@price,1200;
	callfunc "KafraMain",0,0x1ff,"yuno",327,100,"NULL",0,0,40,800,.@code,.@price;
	close2;
...
yuno,277,221,4	script	カプラ職員	113,{
	...
	set .@code,8;
	set .@price,1200;
	callfunc "KafraMain",0,0x1ff,"yuno",275,229,"NULL",0,0,40,800,.@code,.@price;
	close2;
	viewpoint 1,152,187,1,0x0000FF;
	viewpoint 1,327,109,2,0x0000FF;
	cutin "kafra_05",255;
...
amatsu,102,149,5	script	カプラ職員#amatsunomal	116,{
	...
	mes "何をお手伝いいたしましょう？";
	next;
	callfunc "KafraMain",3,0x1db,"amatsu",116,94,"NULL",0,0,80,700;
	end;
}
...
gonryun,159,122,4	script	カプラ職員	116,{
	cutin "kafra_02",2;
	callfunc "KafraMain",1,0x1db,"gonryun",160,62,"NULL",0,0,80,700;
	end;
}
...
umbala,87,160,5	script	カプラ職員	721,{
	...
	set .@code,10;
	set .@price,1800;
	callfunc "KafraMain",0,0x1d7,"umbala",100,154,"NULL",0,0,80,0,.@code,.@price;
	end;
}
...
louyang,210,104,4	script	カプラ職員	116,{
	cutin "kafra_02",2;
	callfunc "KafraMain",1,0x1db,"louyang",218,97,"NULL",0,0,80,700;
	end;
}
...
ayothaya,212,169,6	script	カプラ職員	116,{
	cutin "kafra_02",2;
	callfunc "KafraMain",1,0x1db,"ayothaya",217,187,"NULL",0,0,80,700;
	end;
}
...
einbroch,242,205,5	script	カプラ職員#einbroch1	116,{
	cutin "kafra_02",2;
	callfunc "KafraMain",4,0x1ff,"einbroch",239,197,"NULL",0,0,40,800;
	close2;
...
einbech,181,132,5	script	カプラ職員	115,{
	cutin "kafra_03",2;
	callfunc "KafraMain",4,0x1ff,"einbech",181,123,"NULL",0,0,40,850;
	close2;
...
lighthalzen,191,320,4	script	カプラ職員	861,{
	cutin "kafra_09",2;
	callfunc "KafraMain",4,0x1df,"lighthalzen",194,313,"NULL",0,0,40,800;
	end;
}
...
lighthalzen,164,100,4	script	カプラ職員	860,{
	cutin "kafra_08",2;
	callfunc "KafraMain",4,0x1df,"lighthalzen",158,96,"NULL",0,0,40,800;
	end;
}
...
lhz_in02,237,284,4	script	カプラ職員	861,{
	cutin "kafra_09",2;
	callfunc "KafraMain",4,0x1df,"lhz_in02",278,214,"NULL",0,0,40,800;
	end;
}
...
moscovia,223,191,3	script	カプラ職員	114,{
	cutin "kafra_04",2;
	callfunc "KafraMain",1,0x1db,"moscovia",220,193,"NULL",0,0,80,700;
	end;
}
...
brasilis,197,221,3	script	カプラ職員	112,{
	cutin "kafra_06",2;
	callfunc "KafraMain",1,0x1db,"brasilis",195,259,"NULL",0,0,40,700;
	end;
}
...
dewata,202,184,6	script	カプラ職員	117,{
	cutin "kafra_01",2;
	callfunc "KafraMain",1,0x1db,"dewata",199,177,"NULL",0,0,40,800;
	end;
}
...
malaya,71,79,4	script	カプラ職員	581,{
	callfunc "KafraMain",1,0x1db,"malaya",44,54,"NULL",0,0,500,800;
	end;
}

malaya,234,204,4	script	カプラ職員	581,{
	callfunc "KafraMain",1,0x1db,"malaya",281,211,"NULL",0,0,500,800;
	end;
}
...
lasagna,300,242,4	script	カプラ職員#lasagna	117,5,5,{
	cutin "kafra_01",2;
	setarray .@code,1,2,20;
	setarray .@price,0,0,0;
	callfunc "KafraMain",1,0x1df,"lasagna",298,239,"NULL",0,0,0,800,.@code,.@price;
	close2;
	cutin "kafra_01",255;
	end;
OnTouch:
...
harboro1,291,207,5	script	カプラ職員#rockridge	117,{
	cutin "kafra_01",2;
	set .@code,1;
	set .@price,2000;
	callfunc "KafraMain",1,0x1db,"harboro1",298,203,"NULL",0,0,40,800,.@code,.@price;
	end;
}
