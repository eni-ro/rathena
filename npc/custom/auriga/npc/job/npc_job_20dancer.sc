...
comodo,193,151,4	script	ボルロブ	86,{
	mes "[ボルロブ]";
	mes "ああ……多くの人の注目を集める";
	mes "プリマドンナ！";
	mes "彼女達がダンサーになる瞬間を";
...
//==============================================================
job_duncer,43,93,4	script	エイル	724,{
...
job_duncer,95,93,4	script	ボルワージュ	101,{
	if(Job == Job_Dancer) {
		mes "[ボルワージュ]";
		mes "あら、こんにちは～";
		next;
...
job_duncer,32,152,6	script	案内要員::DC_Test	69,{
	//ダンスのステップ判定
	function Judgement {
...
OnStart:
	...
	awake "DC_Test";
	HideTile;
	killmonster "job_duncer","DC_Test::OnKilled";	//本鯖はここではkillされないけど面倒なのでkillする
	warpwaitingpc "job_duncer",70,111,1;
...
OnTimer72000:
	if(getareausers("job_duncer",65,109,73,111) + getareausers("job_duncer",68,106,70,114) > 0) {
		if(attachrid(.accid))
	...
	monster "job_duncer",69,106,"ダンスポリン",1002,1,"DC_Test::OnKilled";
	end;
OnKilled:
	stopnpctimer;
...
OnTimer78000:
	stopnpctimer;
	killmonster "job_duncer","DC_Test::OnKilled";
	areawarp "job_duncer",65,109,73,111,"comodo",188,162;	//タイル5,1,3の範囲
	areawarp "job_duncer",68,106,70,114,"comodo",188,162;	//タイル2,1,4の範囲
	enablewaitingroomevent;
	end;
}

//==============================================================
job_duncer,69,110,4	script	#DC_Step1	139,1,1,{
	end;
OnTouch:
	announce "dance: " +strcharinfo(0)+ "さん～ タイミングが遅れました！",9;
	areawarp "job_duncer",65,109,73,111,"comodo",188,162;
	areawarp "job_duncer",68,106,70,114,"comodo",188,162;
...
job_duncer,69,107,4	duplicate(#DC_Step1)	#DC_Step2	139,1,1
job_duncer,72,110,4	duplicate(#DC_Step1)	#DC_Step3	139,1,1
job_duncer,69,113,4	duplicate(#DC_Step1)	#DC_Step4	139,1,1
job_duncer,66,110,4	duplicate(#DC_Step1)	#DC_Step5	139,1,1

//==============================================================
job_duncer,69,110,4	script	#DC_Dummy1	101,{	//セルに乗れないようにするためだけのダミーNPC
	end;
OnInit:
	hideonnpc;
	end;
...
job_duncer,69,107,4	duplicate(#DC_Dummy1)	#DC_Dummy2	101
job_duncer,72,110,4	duplicate(#DC_Dummy1)	#DC_Dummy3	101
job_duncer,69,113,4	duplicate(#DC_Dummy1)	#DC_Dummy4	101
job_duncer,66,110,4	duplicate(#DC_Dummy1)	#DC_Dummy5	101

//==============================================================
job_duncer,63,110,4	script	バックダンサー::DC_Dancer1	724,{}
job_duncer,66,113,4	script	バックダンサー::DC_Dancer2	724,{}
job_duncer,72,113,4	script	バックダンサー::DC_Dancer3	724,{}
job_duncer,75,110,4	script	バックダンサー::DC_Dancer4	724,{}
