...
// Shop
//------------------------------------------------------------
um_in,104,124,3	shop	道具商人	788,512:-1,515:-1,535:-1,516:-1,513:-1,517:-1,528:-1,537:-1,601:-1,602:-1,645:-1,656:-1,610:-1
um_in,160,125,3	shop	武器商人	789,1501:-1,1504:-1,1507:-1,1510:-1,1513:-1,1519:-1,1807:-1,1811:-1,1809:-1

//============================================================
// コモドNPC
//------------------------------------------------------------
comodo,170,137,7	script	ラエド	84,{}

comodo,171,137,1	script	ヘイス	92,{
	mes "[ラエド]";
	mes "ものすごい宝が、隠されているに";
	mes "違いない！";
	next;
...
cmd_in01,175,120,3	script	イリヤ	69,{
	mes "[イリヤ]";
...
cmd_in01,164,115,1	script	ニルス	731,{
	mes "[ニルス]";
	mes "……うん？何？";
...
// ウンバラNPC
//------------------------------------------------------------
umbala,177,153,3	script	パスト	97,{
	emotion 0;
	mes "[パスト]";
	mes "うわっ！人間じゃないですか！";
	mes "こんな人里離れた所で人間に";
...
umbala,92,159,4	script	ベルタン	785,{
	if(UM_1QUE < 3) {
		mes "[？？？？]";
		mes "ウムバウムバウムバウムバ";
		mes "ウムバウムバウムバウムバ";
...
umbala,140,157,6	script	ウータン族の青年	785,{
	if(UM_1QUE < 3) {
		mes "[？？？？？]";
		mes "ウムバウムバフムバ。";
		mes "ウウムバウムバウムババウフムバ";
...
umbala,146,157,4	script	ウータン族の青年	786,{
	if(UM_1QUE < 3) {
		mes "[？？？？]";
		mes "ウムバウムバウムババウムババ。";
...
umbala,149,165,4	script	ウータン族の子供	781,{
	if(UM_1QUE<3) {
		mes "[？？？？？？]";
		mes "ウムバウムバウムバババ。";
...
umbala,194,104,4	script	ウータン族の子供	787,{
	if(UM_1QUE<3) {
		mes "[？？？]";
		mes "ウムバウムバババウムフムバ。";
		mes "ウムババウムウムバウムバウムバ。";
...
umbala,193,208,6	script	ウータン族の青年	789,{
	if(UM_1QUE < 3) {
		mes "[？？？？]";
		mes "ウムバウムバウムババ。";
...
umbala,139,205,4	script	ウータン族の青年	785,{
	if(UM_1QUE < 3) {
		mes "[？？？？]";
		mes "ウムバウムバ！";
		mes "ウムバウムババババウムウムバ。";
...
umbala,80,146,4	script	ユーキ	753,{
	mes "[ユーキ]";
	mes "ウムバウムバウガウ……ではなく";
	mes "あなたもやっぱり外の人？";
...
// ウンバラ室内NPC
//------------------------------------------------------------
um_in,158,71,3	script	ウータン族の住民	787,{
	if(UM_1QUE < 3) {
		mes "[？？？？]";
		mes "ウムバウムバウムババウムハ！";
		mes "ウムバウムバウムバババウムバ";
...
// 物々交換NPC
//------------------------------------------------------------
umbala,70,106,3	script	ウータン族の子供#1	781,{
	if(UM_1QUE < 3) {
		mes "[？？？]";
		mes "ウムバ。";
		mes "ウムバルウムウムババウムバ。";
...
umbala,59,243,5	script	ウータン族の子供#4	787,{
	if(UM_1QUE < 3) {
		mes "[？？？]";
		mes "…………";
		mes "……ウムバ。";
...
// バンジージャンプNPC
//------------------------------------------------------------
umbala,140,197,0	script	#バンジージャンプ	139,0,1,{
	switch(rand(10)) {
	case 0:
	case 1:
	case 2:
...
umbala,136,195,0	script	#ワープポイント	139,1,1,{
	warp "umbala",145,166;
	end;
}
...
// UM_1QUE -> 0～7
//------------------------------------------------------------
um_in,39,122,5	script	ウータン族酋長	784,{
	switch(UM_1QUE) {
	case 0:
		mes "[カルカタン]";
		mes "ホッホッ、人間族じゃな。";
	...
	case 1:
		...
		case 1:
			if(getequipid2(9) != 2278 && getequipid2(9) != 2297 && getequipid2(9) != 2288 &&
				getequipid2(9) != 2292 &&  getequipid2(9) != 5005 &&  getequipid2(9) != 2281 &&  getequipid2(9) != 5043) {
				mes "[カルカタン]";
...
umbala,221,193,1	script	 #骸骨門	111,{
	if(UM_1QUE== 7) {
		warp "um_in",32,71;
		end;
	}
...
umbala,220,189,0	script	#umbalawarp1013	45,1,1,{
	if(UM_1QUE == 7)
		warp "um_in",32,71;
	end;
}

um_in,29,71,0	warp	umbalawarp1014	1,1,umbala,217,186

um_in,44,71,2	script	ウータン族シャーマン	782,{
	switch(UM_1QUE) {
	default:
		mes "[？？？？？]";
...
// UM_2QUE -> 0～6
//------------------------------------------------------------
um_in,139,48,5	script	プレネタン	783,{
	if(UM_1QUE >= 3) {
		mes "[プレネタン]";
		mes "全く、この人はすぐ浮気する";
		mes "んだから……ああ！今度やったら、";
...
um_in,144,45,5	script	ウムポコリオタン	789,{
	if(UM_1QUE >= 3) {
		mes "[ウムポコリオタン]";
		mes "うう……うちの家内は乱暴";
		mes "過ぎるよ……痛い痛い。";
...
um_in,101,73,3	script	ウェナタン	783,{
	if(UM_1QUE >= 3) {
		mes "[ウェナタン]";
		mes "はぁ……夜になると現われて";
...
um_in,94,123,5	script	ベルツタン	783,{
	if(UM_1QUE >= 3) {
		mes "[ベルツタン]";
		mes "もう……ウムポコリオタンは変態";
		mes "みたいな奴よ！いくら大嫌いだと";
...
umbala,145,217,3	script	チャビバタン	783,{
	if(UM_1QUE >= 3) {
		mes "[チャビバタン]";
...
um_in,141,46,0	script	夫婦喧嘩#um1	139,8,8,{
	if(UM_2QUE != 4)
		end;
	mes "- 家に入ろうとしたら -";
	mes "- プレネタンが男を乱暴に -";
...
umbala,94,181,0	script	夫婦喧嘩#um2	139,1,1,{
	if(UM_2QUE != 5)
		end;
	mes "- 強引に外へ追い出された。-";
	mes "- ……我に返ってふと見ると -";
