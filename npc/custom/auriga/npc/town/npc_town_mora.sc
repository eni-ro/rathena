...
// Shop
//------------------------------------------------------------
-	shop	mora_callshop1	-1,11519:-1
mora,138,110,3	script	シェフ#mora	518,{
...
-	shop	mora_callshop2	-1,11522:-1,11523:-1,11524:-1,602:-1,601:-1,611:-1,1773:-1,1774:-1
mora,100,118,3	script	モーラ道具屋#mora	517,{
...
//------------------------------------------------------------
bif_fild01,38,374,0	script	不思議な花	844,{
	mes "‐巨大な花がある‐";
	next;
...
//------------------------------------------------------------
bif_fild02,285,332,0	script	不思議なトンネル#mora1	844,7,7,{
	mes "‐大きな花に囲まれるように";
	mes "　小さなトンネルがある。";
	mes "　この小さなトンネルの奥から";
	mes "　賑やかな声が聞こえる……‐";
...
bif_fild02,95,310,0		duplicate(不思議なトンネル#mora1)	不思議なトンネル#mora2	844,7,7
bif_fild02,173,162,0	duplicate(不思議なトンネル#mora1)	不思議なトンネル#mora3	844,7,7

mora,182,74,0	script	出口#mora1	45,1,1,{
	...
	if(strnpcinfo(2) == "mora1")
		warp "bif_fild02",286,327;
	else if(strnpcinfo(2) == "mora2")
		warp "bif_fild02",99,308;
	else if(strnpcinfo(2) == "mora3")
		warp "bif_fild02",176,162;
	end;
}

mora,20,159,0	duplicate(出口#mora1)	出口#mora2	45,1,1
mora,56,25,0	duplicate(出口#mora1)	出口#mora3	45,1,1

//============================================================
// スプレンディッド転送NPC
//------------------------------------------------------------
mora,135,81,4	script	猫の手職員#mora	421,{
	if(ASH_1QUE < 100) {	//異世界クエスト未クリア
		mes "[猫の手職員]";
		mes "うにゃにゃー。";
		mes "モーラは居心地がいいから";
...
// 案内員
//------------------------------------------------------------
mora,167,76,3	script	レシア案内員#mora	522,5,5,{
	mes "[案内員ラプオ]";
	mes "ラオ～！";
	mes "レシア族の街モーラへようこそ！";
	mes "歓迎するお！";
...
// 旅館
//------------------------------------------------------------
mora,43,127,3	script	旅館の主#mora	522,{
	if(ASH_1QUE < 100) {	//異世界クエスト未クリア
		mes "[旅館の主]";
		mes "おや、あなたは";
		mes "人間の集団の連合軍なんたらに";
...
// 矢筒作成
//------------------------------------------------------------
mora,106,117,3	script	矢筒職人#mora	516,{
	if(checkitemblank() == 0) {
		mes "[矢筒職人]";
		mes "あれ？";
		mes "荷物の種類が多いみたいだね。";
...
mora,160,123,3	script	ネムネム	517,{
	mes "[ネムネム]";
	mes "ビフロストに亀裂ができてから";
	mes "多くの旅人が訪れて";
...
mora,105,100,1	script	グルグル	516,{
	mes "[グルグル]";
	mes "泣き疲れて、寝て起きて";
	mes "それでもまだ終わらない！";
	mes "どうしてどうして!?";
...
mora,99,100,7	script	ラプレドル	515,{
	mes "[ラプレドル]";
	mes "コインならいくらでも払うよ！";
	mes "早く続きを！";
	mes "続きを話してくれ！";
...
mora,98,104,5	script	悲しんでいるレシア族	516,{
	mes "[悲しんでいるレシア族]";
	mes "悲しい、とても悲しい！";
	mes "男に幸せは訪れないの？";
	mes "どうして！";
...
mora,102,107,5	script	話を聞いているレシア族	517,{
	mes "[話を聞いているレシア族]";
	mes "ああ……興味がつきない。";
	mes "私がそんな目にあったら";
	mes "……どうすれば終わるの!?";
...
mora,101,107,5	script	効果音を出すレシア族	518,{
	mes "[効果音を出すレシア族]";
	mes "ここで出すのは";
	mes "この音！";
	mes "おお～！";
...
mora,103,100,5	script	感激しているレシア族	518,{
	mes "[感激しているレシア族]";
	mes "おおお……";
	mes "まさかこんな素晴らしい物語を";
	mes "ここで聞けるなんて！";
...
mora,179,155,1	script	若輩者の働き手	516,{
	mes "[若輩者の働き手]";
	mes "オレはいつか";
	mes "霧の森を制覇して";
	mes "英雄になるんだ！";
...
mora,177,157,5	script	口の悪い働き手	518,{
	mes "[若輩者の働き手]";
	mes "オレはいつか";
	mes "霧の森を制覇して";
	mes "英雄になるんだ！";
...
mora,122,97,6	script	休んでいるレシア族	517,{
	mes "[休んでいるレシア族]";
	mes "街の中央にある温泉は";
	mes "モーラの街の象徴なんだ。";
	next;
...
mora,174,171,0	script	倉庫職員ショップレ	518,{
	mes "[ショップレ]";
	mes "ちょっとお、誰だよ";
	mes "このハシゴ持ってきたの。";
	mes "これだと僕の足じゃ";
...
mora,113,185,4	script	読書中のレシア族	516,{
	mes "‐読書に没頭しているようだ‐";
	next;
...
mora,99,65,6	script	バナナ好きなレシア族	516,{
	mes "[バナナ好きなレシア族]";
	mes "ね、君";
	mes "バナナ好き？";
	next;
...
mora,30,128,4	script	休憩中の旅人	514,{
	mes "[旅人]";
	mes "モーラの街の旅館は、";
	mes "ここでも独特な内装で";
	mes "有名なんだ。";
...
mora,130,96,4	script	休憩中の旅人	513,{
	mes "[旅人]";
	mes "ここモーラの街のレシア族は";
	mes "みんな似た姿をしていて";
	mes "見分けるのが大変だ。";
...
mora,43,113,4	script	負傷したレシア族	517,{
	mes "[負傷したレシア族]";
	mes "うううう……";
	mes "温泉にいたあれは";
	mes "一体なんだったんだろう……";
...
mora,168,161,4	script	倉庫職員ライブリ	513,{
	mes "[ライブリ]";
	mes "あっちにある旅館～";
	mes "あの旅館が私の物だったら～";
	next;
...
mora,175,161,6	script	倉庫職員クオリタ	518,{
	mes "[クオリタ]";
	mes "ながーくのびた赤いクチバシ♪";
	mes "すーぐはずかし、赤いほお～";
	mes "まっすぐ飛んでく黒いはね～♪";
...
mora,140,186,3	script	レシア族の哲学者	517,{
	mes "[レシア族の哲学者]";
	mes "人によって、一つの言葉の解釈も";
	mes "まったく異なってしまう。";
	mes "それが異文化にあるもの同士なら";
...
mora,140,72,4	script	ちょっかいをかける旅人	513,{
	mes "[ちょっかいをかける旅人]";
	mes "やあ、そこの君。";
	mes "見ない姿かたちをしてるけど";
	mes "どこから来たんだい？";
...
mora,138,72,6	script	問いかける旅人	513,{
	mes "[問いかける旅人]";
	mes "なあ、ちょっとちょっと";
...
mora,139,73,4	script	悩んでる旅人	513,{
	mes "[悩んでる旅人]";
	mes "うーん……";
	next;
	mes "[悩んでる旅人]";
...
mora,139,179,5	script	モーラの街の住民	518,{
	mes "[モーラの街の住民]";
	mes "ぷう……ぷう……";
	mes "　";
	mes "‐かわいらしい寝息を立てている‐";
...
mora,137,181,5	script	モーラの街の住民	524,{
	mes "[モーラの街の住民]";
	mes "グガー、グガー・・・・・・";
	mes "　";
	mes "‐大口を開けて寝ている‐";
...
mora,136,183,3	script	モーラの街の住民	525,{
	mes "[モーラの街の住民]";
	mes "ウェイ……";
	mes "　";
	mes "君にたなびたいことがある……";
...
mora,134,180,5	script	モーラの街の住民	522,{
	mes "[モーラの街の住民]";
	mes "お菓子……";
	mes "オイラもだーい好きでゲス……";
	mes "むにゃむにゃ……";
...
mora,134,184,1	script	モーラの街の住民	516,{
	mes "[モーラの街の住民]";
	mes "パーティー……";
	mes "盛大にやろうぜ！……";
	mes "ムニャムニャ";
...
mora,133,178,7	script	モーラの街の住民	524,{
	mes "[モーラの街の住民]";
	mes "……すすす";
	mes "　";
	mes "‐鼻が何かを求めて";
...
mora,133,183,7	script	モーラの街の住民	518,{
	mes "[モーラの街の住民]";
	mes "むにゃむにゃ";
	mes "……お、応援、ありがとー!!";
	mes "むにゃ……";
...
mora,131,181,1	script	モーラの街の住民	522,{
	mes "[モーラの街の住民]";
	mes "いやあ、哲学とは";
	mes "よく眠れる学問ですなあ。";
	mes "哲学者の話を聞いていると";
...
//------------------------------------------------------------
mid_camp,148,222,4	script	テオレ#mora	865,3,3,{
	if(BaseLevel < 100) {
		mes "[テオレ]";
		mes "うあああああ!!!!";
		mes "終わりだ！";
...
spl_fild02,0,0,0	script	茂み#mora	844,{
	switch(BIF_1QUE) {
	case 3:
		if(rand(6)) {
			mes "‐ガサゴソッ……";
...
spl_fild02,0,0,0	script	妖精#mora	844,{
	end;
OnStart:
	initnpctimer;
...
spl_fild02,79,104,0		duplicate(茂み#mora)	茂み#mora1		111
spl_fild02,79,104,6		duplicate(妖精#mora)	妖精#mora1-1	440
spl_fild02,79,104,6		duplicate(妖精#mora)	妖精#mora1-2	445
spl_fild02,79,104,6		duplicate(妖精#mora)	妖精#mora1-3	439

spl_fild02,103,344,0	duplicate(茂み#mora)	茂み#mora2		111
spl_fild02,103,344,6	duplicate(妖精#mora)	妖精#mora2-1	440
spl_fild02,103,344,6	duplicate(妖精#mora)	妖精#mora2-2	445
spl_fild02,103,344,6	duplicate(妖精#mora)	妖精#mora2-3	439

spl_fild02,261,323,0	duplicate(茂み#mora)	茂み#mora3		111
spl_fild02,261,323,6	duplicate(妖精#mora)	妖精#mora3-1	440
spl_fild02,261,323,6	duplicate(妖精#mora)	妖精#mora3-2	445
spl_fild02,261,323,6	duplicate(妖精#mora)	妖精#mora3-3	439

spl_fild02,137,305,0	duplicate(茂み#mora)	茂み#mora4		111
spl_fild02,137,305,6	duplicate(妖精#mora)	妖精#mora4-1	440
spl_fild02,137,305,6	duplicate(妖精#mora)	妖精#mora4-2	445
spl_fild02,137,305,6	duplicate(妖精#mora)	妖精#mora4-3	439

spl_fild02,23,196,0		duplicate(茂み#mora)	茂み#mora5		111
spl_fild02,23,196,6		duplicate(妖精#mora)	妖精#mora5-1	440
spl_fild02,23,196,6		duplicate(妖精#mora)	妖精#mora5-2	445
spl_fild02,23,196,6		duplicate(妖精#mora)	妖精#mora5-3	439

spl_fild02,186,260,0	duplicate(茂み#mora)	茂み#mora6		111
spl_fild02,186,260,6	duplicate(妖精#mora)	妖精#mora6-1	440
spl_fild02,186,260,6	duplicate(妖精#mora)	妖精#mora6-2	445
spl_fild02,186,260,6	duplicate(妖精#mora)	妖精#mora6-3	439

splendide,183,117,4	script	疲れ気味の妖精	438,{
...
splendide,119,138,4	script	クスミ	440,{
	if(!equippeditem(2782)) {
		mes "[クスミ]";
...
splendide,304,295,4	script	テオド	445,{
	if(!equippeditem(2782)) {
		mes "[テオド]";
		mes "DimFusTal Mu Lars";
		mes "ModAnduLo";
...
splendide,168,301,4	script	ポション	439,{
	if(!equippeditem(2782)) {
		mes "[ポション]";
		mes "DimFusTal Mu Lars";
		mes "ModAnduLo";
...
splendide,262,376,4	script	ラフィネ族の兵士	447,{
	if(!equippeditem(2782)) {
		mes "[ラフィネ族の兵士]";
...
splendide,118,261,4	script	ダプレル	435,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,185,163,2	script	物流倉庫の管理人	516,{
	switch(BIF_1QUE) {
	case 131:
	case 132:
	case 133:
...
// BIF_2QUE -> 0～
//------------------------------------------------------------
1@mist,1,1,0	script	#mistwood_mon	844,{
OnStart:
	switch(rand(1,6)) {
	...
	monster getmdmapname("1@mist"),.@x,.@y,"彷徨う紫色の竜",2131,1,getmdnpcname("#mistwood_mon")+"::OnKilled";
	end;
OnKilled:
...
1@mist,97,30,3	script	謎の青年#mist	512,{
	if(BaseLevel < 98) {
		mes "[謎の青年]";
		mes "ここを通るつもりなのか？";
		mes "……";
	...
	case 1:
		...
		break;
	case 2:
		if(getmapmobs(getmdmapname("1@mist"),getmdnpcname("#mistwood_mon")+ "::OnKilled")) {
			mes "[ロキ]";
			mes "この森のどこかで";
			mes "竜が目を覚ましたようだ。";
			mes "戦ってくるがいい。";
		...
		if(.flag) {
			...
			mes "では行こう。";
			close2;
			warp getmdmapname("1@mist"),334,178;
			end;
		}
		mes "[ロキ]";
		mes "この森に迷い込んだ竜は";
...
1@mist,334,182,3	script	ロキ#mist	512,{
	switch(BIF_2QUE) {
	case 2:
...
1@mist,333,179,3	script	倒れている女性#mist	511,{
...
mora,46,152,5	script	紫色の髪の女性#ep14_1	510,{
	switch(BIF_2QUE) {
	case 3:
		mes "[紫色の髪の女性]";
		mes "あなたをお待ちしていました。";
...
mora,48,152,3	script	鋭い目つきの青年#ep14_1	512,{
	switch(BIF_2QUE) {
	case 3:
		mes "[ロキ]";
		mes "待っていた。";
...
splendide,272,338,4	script	何かの気配#14_1	437,{
	switch(BIF_2QUE_SUB) {
	case 0:
...
1@mist,94,24,0	script	mora_ensyutu_1	139,{}
1@mist,84,33,0	script	mora_ensyutu_2	139,{}
1@mist,94,27,0	script	mora_ensyutu_3	139,{}
1@mist,76,41,0	script	mora_ensyutu_4	139,{}
1@mist,76,32,0	script	mora_ensyutu_5	139,{}
1@mist,81,23,0	script	mora_ensyutu_6	139,{}
...
// BIF_3QUE -> 0～
//------------------------------------------------------------
mora,117,66,3	script	ユリディ#mora	521,{
...
mora,115,68,3	script	ユリディの友達#mora	520,{
	switch(BIF_3QUE) {
	case 2:
		mes "[ユリディの友達]";
		mes "ロペにガイドを頼んだっていう";
...
bif_fild01,132,338,3	script	ロペ#mora	461,2,2,{
	if(BIF_3QUE != 8) {
		mes "‐うつろな目をした";
		mes "　怪しい男がいる‐";
		close;
...
//------------------------------------------------------------
mora,31,138,6	script	レシア研究員#mora	522,{
	if(ASH_1QUE < 100) {	//異世界クエスト未クリア
		mes "[レシア研究員]";
		mes "ああ、どうしよう……";
		mes "大事な大事な、私の実験道具が";
...
mora,114,79,0	script	黒い影#mora	844,{
	if(BaseLevel < 100) {
		mes "‐見たことのない形の影が";
		mes "　あなたをあざ笑い、";
		mes "　水中に姿を消した‐";
...
mora,108,86,0	script	源泉#mora1	844,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,107,82,0	duplicate(源泉#mora1)	源泉#mora2	844
mora,113,84,0	duplicate(源泉#mora1)	源泉#mora3	844
mora,116,81,0	duplicate(源泉#mora1)	源泉#mora4	844
mora,118,86,0	duplicate(源泉#mora1)	源泉#mora5	844

bif_fild02,315,285,0	script	水溜り#mora1	844,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
bif_fild02,65,109,0	script	水溜り#mora2	844,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
bif_fild02,223,71,0	script	水溜り#mora3	844,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
bif_fild02,113,340,0	script	水溜り#mora4	844,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,105,91,4	script	温泉の管理人#mora	522,{
	if(BIF_4QUE == 22) {
		mes "[温泉の管理人]";
		mes "コギ君から話は聞きましたよ。";
...
// BIF_5QUE -> 0～4
//------------------------------------------------------------
dic_in01,262,191,0	script	#ep14_1_xq02	139,3,3,{
...
dic_in01,260,194,4	script	チェシャー#ep14_1	498,{
	end;
OnStart:
	initnpctimer;
...
dic_dun01,274,114,0	script	積み上げられた箱	844,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　新しくアイテムを受け取ることが";
		mes "　できません。";
...
bif_fild01,335,168,3	script	チェシャー	497,{
...
dicastes02,125,192,0	script	#call_cheshir_ep14	139,3,3,{
...
dicastes02,120,192,3	script	チェシャー#cheshir_ep14	497,{
	if(DIC_2QUE < 23) {
		mes "‐男がいる‐";
		close;
	}
...
// モーラ住人の依頼クエスト
//------------------------------------------------------------
mora,108,98,4	script	ルルララ#mora	517,{
	mes "[ルルララ]";
	mes "人間の冒険者殿。";
	mes "あなたもよろしければ";
	mes "力を貸してください。";
...
mora,112,100,8	script	ゾウリン	509,{
	if(BaseLevel < 110) {
		mes "[ゾウリン]";
		mes "ここには、モーラの街の住民が";
		mes "日々のこまごまとした用件への";
	...
	if(checkquest2(12225)) {
		set .@quest,12225;
	} else if(checkquest2(12226)) {
		set .@quest,12226;
	} else if(checkquest2(12227)) {
		set .@quest,12227;
	} else if(checkquest2(12228)) {
		set .@quest,12228;
	} else if(checkquest2(12229)) {
		set .@quest,12229;
	}
	if(checkquest2(.@quest)) {
		if(checkquest2(.@quest) & 0x2) {
			mes "[ゾウリン]";
			mes "どうやら時間内に討伐を";
			mes "完了できなかったようですね。";
			mes "残念です。";
	...
	if(checkquest2(12230)) {
		if(checkquest2(12230) & 0x2) {
			mes "[ゾウリン]";
			mes "またあなたに";
			mes "依頼をお願いしたいです。";
			mes "依頼を受けてくれるならば、";
...
mora,119,103,4	script	ワンワォーン	513,{
	if(BIF_2QUE < 99) {
		mes "[ワンワォーン]";
		mes "仕事を依頼したいのですが、";
		mes "霧の森周辺で紫の竜が現れた";
	...
	if(checkquest2(12231)) {
		set .@quest,12231;
	} else if(checkquest2(12232)) {
		set .@quest,12232;
	} else if(checkquest2(12233)) {
		set .@quest,12233;
	} else if(checkquest2(12234)) {
		set .@quest,12234;
	} else if(checkquest2(12235)) {
		set .@quest,12235;
	}
	if(checkquest2(.@quest)) {
		if(checkquest2(.@quest) & 0x2) {
	...
	if(checkquest2(12241)) {
		if(checkquest2(12241) & 0x2) {
			mes "[ワンワォーン]";
			mes "またあなたに";
			mes "依頼をお願いしたいです。";
			mes "依頼を受けてくれるならば、";
...
mora,116,105,4	script	雑貨業者	516,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,109,93,4	script	キャングルル	514,{
	if(BIF_2QUE < 99) {
		mes "[キャングルル]";
		mes "霧の森あたりで危険な竜が";
		mes "出現したそうです。";
	...
	if(checkquest2(12236)) {
		set .@quest,12236;
	} else if(checkquest2(12237)) {
		set .@quest,12237;
	} else if(checkquest2(12238)) {
		set .@quest,12238;
	} else if(checkquest2(12239)) {
		set .@quest,12239;
	} else if(checkquest2(12240)) {
		set .@quest,12240;
	}
	if(checkquest2(.@quest)) {
		if(checkquest2(.@quest) & 0x2) {
	...
	if(checkquest2(12242)) {
		if(checkquest2(12242) & 0x2) {
			mes "[キャングルル]";
			mes "またあなたに";
			mes "依頼をお願いしたいです。";
			mes "依頼を受けてくれるならば、";
...
mora,114,92,4	script	生活用品業者	518,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,170,101,4	script	魂の引導者#mora	517,{
	if(BIF_2QUE < 99) {
		mes "[魂の引導者ニューリ]";
		mes "あなたはまだ霧の森で迷える竜を";
		mes "導いていないようだ。";
	...
	if(checkquest2(12253)) {
		if(checkquest2(12243))
			set .@quest,12243;
		if(checkquest2(12244))
			set .@quest,12244;
		if(checkquest2(12245))
			set .@quest,12245;
		if(checkquest2(12246))
			set .@quest,12246;
		if(checkquest2(12247))
			set .@quest,12247;
		if(checkquest2(12248))
			set .@quest,12248;
		if(checkquest2(12249))
			set .@quest,12249;
		if(checkquest2(12250))
			set .@quest,12250;
		if(checkquest2(12251))
			set .@quest,12251;
		if(checkquest2(12252))
			set .@quest,12252;
		if(.@quest) {
			if(checkquest2(12253) & 0x2) {
				mes "[魂の引導者ニューリ]";
				mes "・・・・・・時間が経過しすぎた。";
				mes "どうした、もう諦めるか？";
				next;
...
1@mist,132,100,0	script	タザルの痕跡		844,{ callfunc "Mora_Remain",12243,"タザルの花",6,526,1,3; }
1@mist,102,242,0	script	ナイザの痕跡		844,{ callfunc "Mora_Remain",12244,"ナイザのペンダント",5,942,2,17; }
1@mist,145,245,0	script	メシルの痕跡		844,{ callfunc "Mora_Remain",12245,"メシルの指輪",5,943,2,4; }
1@mist,196,276,0	script	ヌワルイの痕跡		844,{ callfunc "Mora_Remain",12246,"ヌワルイの剣",6,549,1,3; }
1@mist,304,327,0	script	パザマの痕跡		844,{ callfunc "Mora_Remain",12247,"パザマの剣",5,945,8,18; }
1@mist,334,287,0	script	メンデルの痕跡		844,{ callfunc "Mora_Remain",12248,"メンデルの薬草",7,946,2,31; }
1@mist,330,177,0	script	マイルビットの痕跡	844,{ callfunc "Mora_Remain",12249,"マイルビットの嘘",5,7008,6,17; }
1@mist,284,84,0		script	クーンムンの痕跡	844,{ callfunc "Mora_Remain",12250,"クーンムンの親の遺産",4,0,0,0; }
1@mist,170,54,0		script	チャイホキンの痕跡	844,{ callfunc "Mora_Remain",12251,"チャイホキンの想い人の遺品",2,929,1,5; }
1@mist,118,43,0		script	トゥーアルの痕跡	844,{ callfunc "Mora_Remain",12252,"トゥーアルの友の見舞い品",3,0,0,0; }

mora,131,165,7	script	モーラの街住民	520,{
	mes "[モーラの街住民]";
	mes "ここでは、冒険者が";
	mes "モーラの街でできる仕事を";
	mes "請けおうことができます。";
...
mora,125,174,2	script	モーラの街住民	520,{
	mes "[モーラの街住民]";
	mes "ああ……";
	mes "私の出した依頼、";
	mes "無事に優秀な人の手に";
...
mora,104,172,7	script	モーラの街住民	520,{
	mes "[モーラの街住民]";
	mes "モーラの街の住民は、";
	mes "困ったことがあったら";
	mes "すぐにここに依頼しに来るんだ。";
...
// 地元騎士団クエスト
//------------------------------------------------------------
mora,118,166,5	script	地元騎士団のボス	525,{
	mes "[地元騎士団のボス]";
	mes "我々は5分前に結成された";
	mes "伝説の地元騎士団である！";
	next;
...
mora,116,165,5	script	地元騎士団の親分#mora	524,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,114,163,5	script	地元騎士団の団長	522,{
	if(BIF_3QUE < 11) {
		mes "[地元騎士団の団長]";
		mes "霧の森でロペというラフィネ族が";
		mes "失踪したそうだよ！";
...
mora,112,161,5	script	地元騎士団の隊長	523,{
	mes "[地元騎士団の隊長]";
	mes "私は地元騎士団の隊長だ！";
	mes "どうした、事件か!?";
	mes "隊長の私に話してみなさい。";
...
mora,105,176,4	script	モーラの服縫製家	509,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,123,177,6	script	ペンダント細工師	509,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,134,166,4	script	バルバリウェストフード	509,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　報酬を受け取ることができません。";
		mes "　アイテムを整理してから、";
...
mora,152,97,5	script	アーティファクト管理人	515,{
	mes "[管理人]";
	mes "こんにちは、人間の冒険者。";
	mes "私はこのモーラの村の周辺で";
	mes "発見された古の装備、";
...
mora,147,98,3	script	アーティファクト研究者	521,{
	mes "[アーティファクトの研究者]";
	mes "私はアーティファクトを";
	mes "研究しています。";
	mes "研究の結果、アーティファクトに";
	...
	case 3:
		...
		set .@menu,select(
				"装備しなおします",
				(getequipid2(4)!=0? "^nItemID^" +getequipid2(4): "(右手)‐[装着していない]"),
				(getequipid2(6)!=0? "^nItemID^" +getequipid2(6): "靴‐[装着していない]"),
				(getequipid2(5)!=0? "^nItemID^" +getequipid2(5): "肩にかける物-[装着していない]"),
				(getequipid2(2)!=0? "^nItemID^" +getequipid2(2): "鎧‐[装着していない]"),
				(getequipid2(7)!=0? "^nItemID^" +getequipid2(7): "アクセサリー1‐[装着していない]"),
				(getequipid2(8)!=0? "^nItemID^" +getequipid2(8): "アクセサリー2‐[装着していない]"),
				(getequipid2(3)!=0? "^nItemID^" +getequipid2(3): "(左手)‐[装着していない]"));
		switch(.@menu) {
		case 1:
			mes "[アーティファクトの研究者]";
			mes "わかりました。";
			...
			mes "また話しかけてください。";
			close;
		case 2: set .@itemid,getequipid2(4); set .@menu,4; break;
		case 3: set .@itemid,getequipid2(6); set .@menu,6; break;
		case 4: set .@itemid,getequipid2(5); set .@menu,5; break;
		case 5: set .@itemid,getequipid2(2); set .@menu,2; break;
		case 6: set .@itemid,getequipid2(7); set .@menu,7; break;
		case 7: set .@itemid,getequipid2(8); set .@menu,8; break;
		case 8: set .@itemid,getequipid2(3); set .@menu,3; break;
		}
		if(.@itemid == 0) {
			mes "[アーティファクトの研究者]";
			mes "おや、";
