...
dali02,58,122,3	script	好奇心旺盛な騎士#cr	418,{
	mes "[好奇心旺盛な騎士]";
	mes "近くにいる近衛兵から";
	mes "助けを求められたよ。";
	mes "次元移動機が壊れたとかで、";
...
dali02,46,135,5	script	老婆#dk	846,{
	...
	next;
	set .@menu,select(
			(getequipid2(2)!=0? "^nItemID^" +getequipid2(2): "体-[装備していない]"),
			(getequipid2(3)!=0? "^nItemID^" +getequipid2(3): "左手-[装備していない]"),
			(getequipid2(4)!=0? "^nItemID^" +getequipid2(4): "右手-[装備していない]"),
			(getequipid2(5)!=0? "^nItemID^" +getequipid2(5): "肩にかける物-[装備していない]"),
			(getequipid2(6)!=0? "^nItemID^" +getequipid2(6): "靴-[装備していない]"));
	set .@menu,.@menu+1;
	set .@refine,getequiprefinerycnt2(.@menu);
	switch(getequipid2(.@menu)) {
	case 0:
		mes "[老婆]";
		mes "ぼけているのか？";
		mes "何も装備していないようじゃぞ。";
...
dali02,43,129,5	script	近衛兵#dk	686,{
	if(BaseLevel < 100) {
		mes "[近衛兵]";
		mes "……君は……";
		mes "旅人か……？";
...
dali02,40,134,5	script	次元移動機	10007,{
	if(BaseLevel < 100) {
		mes "[近衛兵]";
		mes "……君は……。";
		mes "どうやらまだまだ、";
...
1@spa,0,0,0	script	#DK_Control1	-1,{
OnStart:
	if(.flag > 0)
		end;
	set .flag,1;
...
1@spa,42,201,1	script	近衛兵#dk	686,{
	mes "‐何も反応がない……。";
	mes "　まるで時が止まっているように";
	mes "　微動だにしない……‐";
	close;
OnTalk1:
	unittalk getcharid(3), "近衛兵 : ありがたき幸せ。……この命に代えましても必ずや姫をお守りすることを陛下と、この剣に誓いましょう。";
	end;
OnTalk2:
	unittalk getcharid(3), "近衛兵 : ……御意にございます、陛下。おや？　なにか外が騒がしいようですね。……!?　この匂いは血の匂い……。";
	end;
OnTalk3:
	unittalk getcharid(3), "近衛兵 : 陛下!!　何かが起きていることは事実の模様……ここに居ては危険です!!　ひとまず、お部屋へお戻りください!!";
	end;
OnTalk4:
	unittalk getcharid(3), "近衛兵 : 御意。……。姫の私室は2階、急がねば……。　彼女にもしものことがあれば私は……。";
	end;
}

1@spa,41,207,4	script	黒づくめの男#dkf1	685,{
	mes "‐全身黒づくめの";
	mes "　長い髪の男が";
	mes "　大きな剣を持ち";
	mes "　目の前の二人を";
	...
	close;
OnTalk1:
	unittalk getcharid(3), "謎の声 : ほう……これは珍しい。アレを見ろ、アイツは生きた人間のようだぞ。";
	end;
OnTalk2:
	unittalk getcharid(3), "黒づくめの男 : 人間だと……？　どうしてここに人間がいる。";
	end;
OnTalk3:
	unittalk getcharid(3), "謎の声 : まあ待て。この人間の始末はいつでも可能なんだ。そう焦る必要もない。それに……観客は多いほうがいい。";
	end;
OnTalk4:
	unittalk getcharid(3), "黒づくめの男 : ……そういうことらしい。ならば、お前に教えてやろう。この世界はある男の記憶だ。ゆえにお前がこいつらに干渉することは出来ない。";
	end;
OnTalk5:
	unittalk getcharid(3), "黒づくめの男 : そこでこのバカな男の顛末を見届けるといい。ただし、干渉できないのはこのバカな男にだけだ。";
	end;
OnTalk6:
	unittalk getcharid(3), "黒づくめの男 : モンスターどもはお前に干渉することが出来る。せいぜい殺されないようにするんだな。クックックック……。";
	end;
OnTalk7:
	unittalk getcharid(3), "謎の声 : 人間は他人の不幸が好きらしいからな……。蜜をたっぷり吸い込んだ頃にまた会おうじゃないか。";
	end;
}

1@spa,41,204,5	script	国王#dk	965,{
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "‐先ほどの近衛兵が";
		mes "　国王らしき人物と会話をしている‐";
		close;
	...
	mes "姫をよろしく頼む。";
	unittalk getcharid(3), "国王 : そなたを我が娘、ティアラ姫の直属の近衛兵として任命する。そなたの卓越した剣術と忠誠心を信じよう。姫をよろしく頼む。";
	next;
	mes "[近衛兵]";
	mes "ありがたき幸せ。";
	mes "……この命に代えましても";
	...
	mes "この縁談がまとまれば、わが国は";
	mes "今後も末永く安泰であろう。";
	unittalk getcharid(3), "国王 : 幸多くも今、この城を訪れている隣国の王子と我が娘との縁談もまとまりつつある。この縁談がまとまれば、わが国は今後も末永く安泰であろう。";
	next;
	mes "[国王]";
	mes "娘も今はこの縁談に";
	mes "あまり乗り気ではないようだが";
	...
	mes "一国の王女としてなすべき";
	mes "ことは何かということを……。";
	unittalk getcharid(3), "国王 : 娘も今はこの縁談にあまり乗り気ではないようだがきっと必ずや、わかってくれる日がくるであろう。一国の王女としてなすべきことは何かということを……。";
	next;
	mes "[近衛兵]";
	mes "……御意にございます、陛下。";
	mes "おや？";
	...
	mes "誰か報告をするのだ！";
	unittalk getcharid(3), "国王 : この音は、剣戟の音なのか!?　どうした！　なにが起こっているのだ!?　誰か報告をするのだ！";
	next;
	mes "[近衛兵]";
	mes "陛下!!";
	mes "何かが起きていることは";
	...
	mes "それよりもそなたは、娘を……";
	mes "ティアラ姫を守ってやってくれ!!";
	unittalk getcharid(3), "国王 : 私のことは心配ない。それよりもそなたは、娘を……ティアラ姫を守ってやってくれ!!";
	next;
	mes "[近衛兵]";
	mes "御意。";
	mes "……。";
...
1@spa,1,1,0	script	#DK_NPCTimer1	139,{
OnStart:
	initnpctimer;
	end;
OnTimer3000:
...
1@spa,41,217,0	warp	亡霊の王宮2階	2,2,1@spa,114,120

1@spa,135,125,3	script	ティアラ姫#dk	640,{
	mes "‐美しい女性が佇んでいる。";
	mes "　どこか儚げに見えるのは";
	mes "　気のせいだろうか？‐";
	close;
OnTalk1:
	unittalk getcharid(3), "ティアラ姫 : この城にモンスターが入り込んだと、侍女から聞きました……。それで、お父様はご無事なのですね？";
	end;
OnTalk2:
	unittalk getcharid(3), "ティアラ姫 : ……私にとって安全で安心な場所は一つしかありません。それは昔から、ずっと変わってはおりません……。";
	end;
OnTalk3:
	unittalk getcharid(3), "ティアラ姫 : ……ごめんなさい。モンスターが城を襲うなど、今までなかったことが起きたせいでいやな予感がぬぐえないのです……。なにか悪いことがおきそうで……。";
	end;
OnTalk4:
	unittalk getcharid(3), "ティアラ姫 : モンスターがこの城を襲った理由は定かではありません。そしてこのような時に、貴方にこのようなことを聞くのは不謹慎かもしれないのですが……。";
	end;
OnTalk5:
	unittalk getcharid(3), "ティアラ姫 : ……お聞かせください。あなたにとっても私は、顔も知らない隣国の殿方と結婚の契りを交わすことが望みなのでしょうか……。私は……。私の望みはあなたと……。";
	end;
}

1@spa,132,122,7	script	近衛兵#dk1	686,{
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "[近衛兵]";
		mes "……姫様、ご無事でなによりです。";
		close;
	...
	mes "[近衛兵]";
	mes "……姫様、ご無事でなによりです。";
	unittalk getcharid(3), "近衛兵 : ……姫様、ご無事でなによりです。";
	next;
	if(checkquest2(114755)&0x8) {
	...
	mes "このままでは";
	mes "いつ危険な目にあうか……。";
	unittalk getcharid(3), "近衛兵 : ご安心ください。陛下は無事です。姫様もここではなくもう少し安全な場所に参りましょう。このままではいつ危険な目にあうか……。";
	next;
	mes "[ティアラ姫]";
	mes "……私にとって安全で安心な場所は";
	mes "一つしかありません。";
	...
	mes "[近衛兵]";
	mes "ティアラ姫……。";
	unittalk getcharid(3), "近衛兵 : ティアラ姫……。";
	next;
	mes "‐ティアラ姫と近衛兵の間に";
	mes "　主従関係を超えた";
	mes "　空気と距離感を感じる‐";
	...
	unittalk getcharid(3), "近衛兵 : 姫様、不安を感じるのはよくわかります。ですが姫様は、今後この国を背負って立つお方です。どうか気をしっかりもち、隣国のあの方の、よき伴侶になってください……。";
	next;
	mes "[ティアラ姫]";
	mes "モンスターがこの城を襲った";
	mes "理由は定かではありません。";
	...
	mes "……姫様。";
	mes "わ、私は……。";
	unittalk getcharid(3), "近衛兵 : ……姫様。わ、私は……。";
	next;
	mes "[近衛兵]";
	mes "!?";
	mes "騒音が……近い!!";
	unittalk getcharid(3), "近衛兵 : !?　騒音が……近い!!";
	next;
	mes "‐剣戟と人々の叫び声が";
	mes "　すぐ側に迫っているのが";
	mes "　聞こえた！‐";
	...
	mes "安全な場所までお送りします!!";
	mes "……参りましょう！";
	unittalk getcharid(3), "近衛兵 : 姫様！　安全な場所までお送りします!!……参りましょう！";
	close2;
	hideonnpc getmdnpcname("近衛兵#dk1");
	hideonnpc getmdnpcname("ティアラ姫#dk");
	misceffect 904,"";
...
1@spa,1,1,0	script	#DK_NPCTimer2	139,{
OnStart:
	initnpctimer;
	end;
OnTimer3000:
...
1@spa,111,133,5	script	隣国の王子#dk3	470,7,7,{
	mes "‐仕立てられた上品そうな";
	mes "　服を着た男が、不気味な笑顔を";
	mes "　浮かべながら笑っている‐";
	close;
OnTouch:
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		...
		mes "担っていただこう……。";
		mes "ククククク。";
		unittalk getcharid(3), "隣国の王子 : あの近衛兵は使えそうだ。とりあえず彼には今回のモンスターの襲撃事件の首謀者という役でも担っていただこう。ククククク。";
		close2;
		hideonnpc getmdnpcname("隣国の王子#dk3");
		announce "‐時間が速く流れるような感覚の後、北で何かが開くような音がした‐",0x9,0xffff00,0x190,20,0,0;
...
1@spa,117,137,0	warp	亡霊の王宮3階	2,2,1@spa,60,43

1@spa,28,52,7	script	騎士団長#dk	418,{
	mes "‐男は苦渋の色を浮かべた表情で、";
	mes "　近衛兵を見つめている……‐";
	close;
}

1@spa,25,53,7	script	兵士#dk1	413,{
	mes "‐男は苦渋の色を浮かべた表情で、";
	mes "　近衛兵を見つめている……‐";
	close;
}

1@spa,34,53,1	script	兵士#dk2	413,{
	mes "‐男は戸惑いの表情で、";
	mes "　近衛兵を見つめている……‐";
	close;
}

1@spa,30,52,7	script	兵士#dk3	417,{
	mes "‐男は戸惑いの表情で、";
	mes "　近衛兵を見つめている……‐";
	close;
}

1@spa,30,58,5	script	近衛兵#dk2	10018,{
	mes "‐鎖にしっかりと繋がれ、";
	mes "　身動きがとれないようだ‐";
	close;
OnTalk1:
	unittalk getcharid(3), "近衛兵 : 誤解です！　陛下！　私は……私は断じて陛下を、この国を裏切るような行為はおこなっておりません！";
	end;
OnTalk2:
	unittalk getcharid(3), "近衛兵 : そ、それは……。";
	end;
OnTalk3:
	unittalk getcharid(3), "近衛兵 : ティアラ姫……。私の者のようなもののために……。";
	end;
}

1@spa,32,54,1	script	国王#dk1	965,{
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "[国王]";
	...
	mes "一番信頼していたそなたに";
	mes "まさか裏切られるとは……な。";
	unittalk getcharid(3), "国王 : ここにモンスターを呼び寄せたのがまさかそなただったとは……。一番信頼していたそなたにまさか裏切られるとは……な。";
	next;
	if(checkquest2(114755)&0x8) {
		if(select("急ぐ","二人の会話を聞く") == 1) {
			mes "‐時間が瞬時に流れたのを感じた‐";
	...
	unittalk getcharid(3), "国王 : 私もそなたを信じたい気持ちはある。しかし、あの方が嘘をつく理由がない。今一度、問おう。そなたに、その理由を説明できるのか？";
	next;
	mes "[近衛兵]";
	mes "そ、それは……。";
	...
	mes "そなたの命を奪ったと知れば";
	mes "命を落としかねないほどに……な。";
	unittalk getcharid(3), "国王 : そなたのこれまでの働きに免じ命までは、奪わん。我が娘もこのことを聞いてから床に伏した状態が続いている。そなたの命を奪ったと知れば命を落としかねないほどに……な。";
	next;
	mes "[近衛兵]";
	mes "ティアラ姫……。";
	mes "私のようなもののために……。";
...
1@spa,1,1,0	script	#DK_NPCTimer3	139,{
OnStart:
	initnpctimer;
	end;
OnTimer3000:
...
1@spa,31,57,5	script	近衛兵#dk3	10018,{
	end;
OnTalk1:
	unittalk getcharid(3), "近衛兵 : 誰だ……。誰が私に語りかけている……。私のことは放っておいてくれ……。";
	end;
OnTalk2:
	unittalk getcharid(3), "近衛兵 : 契約？　どうして、私が契約を……！　それよりも何故だ!!　何故、姫に危険が迫っている!!";
	end;
OnTalk3:
	unittalk getcharid(3), "近衛兵 : ……隣国の王子……!?　やはりあの時見た人影は……！　……クッ……！　この鎖さえなければ……!!";
	end;
}

1@spa,35,56,5	script	魔剣タルタノス#dkt	844,{}

1@spa,54,28,0	warp	亡霊の王宮4階	2,2,1@spa,218,186

1@spa,201,214,1	script	魔剣タルタノス#dkt1	1205,{
	end;
OnTalk1:
	unittalk getcharid(3), "魔剣タルタノス : ……その言葉に嘘はないな？　貴様と我はいまこの時から魂をともにし、我は貴様に力を与えよう！　貴様は我に血を捧げるのだ！";
	end;
OnTalk2:
	unittalk getcharid(3), "魔剣タルタノス : 愛しの姫君はどうやら牢獄に幽閉されているようだぞ。";
	end;
}

1@spa,197,218,5	script	隣国の王子#dk	470,{
	mes "‐不適な笑みを浮かべ";
	mes "　近衛兵を見つめている‐";
	close;
OnTalk1:
	unittalk getcharid(3), "隣国の王子 : 随分と遅かったね。君があまりにも遅いからうっかり問い詰めてきた僕の義理の父と家来を殺める結果になってしまったじゃないか。";
	end;
OnTalk2:
	unittalk getcharid(3), "隣国の王子 : しかし、人の命なんて安いものさ。そう、君がその手に握っているその剣。呪われし魔剣タルタノスに比べたらね。……この国にそれがあると知ってから僕がどれだけその魔剣を探し求めたことか……。";
	end;
OnTalk3:
	unittalk getcharid(3), "隣国の王子 : 誰に聞いたのか知らないけれど君のいっていることは概ね正解かな。ただ、僕だってできれば命を奪うなんて野蛮なことは避けたかったんだよ？";
	end;
OnTalk4:
	unittalk getcharid(3), "隣国の王子 : 許婚だとかいうあの姫も近衛兵の君はそんな人じゃないって泣きながら訴えてくるしさ。あんまりにもうるさいからある場所に一人で留守番してもらっているよ。";
	end;
OnTalk5:
	unittalk getcharid(3), "隣国の王子 : なぜだ!?　呪われし魔剣タルタノスよ！　お前が仕えるべき主人はそいつじゃなくこの僕のほうが相応しいはず!!　なぜそれがわからない!?";
	end;
OnTalk6:
	unittalk getcharid(3), "隣国の王子 : 待てっ!!　どうして僕を無視する!!　お前達も母上や父上のように僕を無能だと思ってるんだな!?　……いいだろう。僕の本当の姿を見せてやる!!";
	end;
OnTalk7:
	unittalk getcharid(3), "呪いの根源 : グオオオオ……ッ！　見るがいい、これが僕の本当の力!!　魔剣を……世界を……統べる新しい世界の王となる者!";
	end;
OnTalk8:
	unittalk getcharid(3), "呪いの根源 : では、魔剣を置いていけっ!! 貴様には不要なもののはず!!　何よりその魔剣を使って、あの女を助けようなど今更手遅れだ!!";
	end;
OnTalk9:
	unittalk getcharid(3), "呪いの根源 : あの女が悪いんだよッ!!　僕が魔物を呼び込んでるとこを見た上に、誰にも殴られたことがないこの僕を殴ったんだ……この僕を……。卑怯者っていいながらさぁ……？　許せない……許せないよ……。";
	end;
}

1@spa,197,218,5	script	呪いの根源#dk	2959,{}

1@spa,194,214,5	script	倒れた国王#dk	956,{
	mes "‐返事がない……。";
	mes "　殺されて間もないようだ‐";
	close;
}
1@spa,211,194,3	script	倒れた騎士団長#dk	887,{
	mes "‐返事がない……。";
	mes "　殺されて間もないようだ‐";
	close;
}

1@spa,201,198,1	script	倒れた兵士#dk	849,{
	mes "‐返事がない……。";
	mes "　殺されて間もないようだ‐";
	close;
}

1@spa,197,190,1	script	倒れた兵士#dk1	849,{
	mes "‐返事がない……。";
	mes "　殺されて間もないようだ‐";
	close;
}

1@spa,191,207,7	script	倒れた兵士#dk2	849,{
	mes "‐返事がない……。";
	mes "　殺されて間もないようだ‐";
	close;
}

1@spa,206,209,7	script	倒れた兵士#dk3	849,{
	mes "‐返事がない……。";
	mes "　殺されて間もないようだ‐";
	close;
}

1@spa,189,195,1	script	倒れた兵士#dk4	849,{
	mes "‐返事がない……。";
	mes "　殺されて間もないようだ‐";
	close;
}

1@spa,199,214,1	script	近衛兵#dk4	686,{
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "‐隣国の王子と近衛兵が";
		mes "　話しているのが見える‐";
		close;
	...
	unittalk getcharid(3), "近衛兵 : ……あなたが我が主に嘘を伝え私を今回の事件の首謀者として仕立て上げたというのは本当ですか。";
	next;
	mes "[隣国の王子]";
	mes "随分と遅かったね。";
	mes "君があまりにも遅いから";
	...
	mes "ティアラ姫まで、危険な目に";
	mes "あわせようとしたのか!?";
	unittalk getcharid(3), "近衛兵 : この剣を手に入れるためだけにあなたは国王を騙し、私を陥れこの城にモンスターを呼び込み我らが同胞の命を奪い、ティアラ姫まで、危険な目にあわせようとしたのか!?";
	next;
	mes "[隣国の王子]";
	mes "誰に聞いたのか知らないけれど";
	...
	mes "改めて……契約成立だ。";
	unittalk getcharid(3), "近衛兵 : ……そうか。これで納得がいった。お前が私にいったことは正しかったようだな、魔剣タルタノス。改めて……契約成立だ。";
	next;
	cutin "tartanos.bmp",3;
	mes "[魔剣タルタノス]";
	mes "……その言葉に嘘はないな？";
	...
	mes "……私はティアラ姫を探す。";
	unittalk getcharid(3), "近衛兵 : お前に時間をかけるほど、暇ではない。……私はティアラ姫を探す。";
	next;
	mes "[魔剣タルタノス]";
	mes "愛しの姫君はどうやら";
	mes "牢獄に幽閉されて";
	...
	mes "私はそんなもの、興味はない。";
	mes "安心しろ。";
	unittalk getcharid(3), "近衛兵 : 新しい世界の王だと……？　……くだらない……。私はそんなもの、興味はない。安心しろ。";
	next;
	mes "[呪いの根源]";
	mes "では、魔剣を置いていけっ!!";
	mes "貴様には不要なもののはず!!";
	...
	mes "姫に……彼女に……";
	mes "何をした……ッ!!";
	unittalk getcharid(3), "近衛兵 : 姫に……彼女に……何をした……ッ!!";
	next;
	mes "[呪いの根源]";
	mes "あの女が悪いんだよッ!!";
	mes "僕が魔物を呼び込んでるとこを";
	...
	mes "……こんな奴に……こんな奴に……";
	mes "姫が……国王が……ッ!!";
	unittalk getcharid(3), "近衛兵 : ……こんな奴に……こんな奴に……姫が……国王が……ッ!!";
	next;
	mes "[近衛兵]";
	mes "その小汚い姿を私の前に";
	mes "晒すな、失せろ……！";
	unittalk getcharid(3), "近衛兵 : その小汚い姿を私の前に晒すな、失せろ……！";
	next;
	mes "‐近衛兵が隣国の王子に";
	mes "　一太刀浴びせると";
	mes "　隣国の王子は跡形もなく";
...
1@spa,1,1,0	script	#DK_NPCTimer4	139,{
OnStart:
	initnpctimer;
	end;
OnTimer3000:
...
1@spa,178,186,0	warp	亡霊の王宮5階	2,2,1@spa,186,57

1@spa,213,42,7	script	近衛兵#dk5	686,{
	mes "‐ティアラ姫を抱きかかえており、";
	mes "　その表情は見えない……‐";
	close;
OnTalk1:
	unittalk getcharid(3), "近衛兵 : ティアラ姫……!!　すぐに、腕の良い治療術師が来るはずです……!!　気をしっかりもってください……。";
	end;
OnTalk2:
	unittalk getcharid(3), "近衛兵 : 姫……喋らない方が……。お体に障ります……。";
	end;
OnTalk3:
	unittalk getcharid(3), "近衛兵 : そんな……身にあまるお言葉です……。それに私は、国王に対し感謝はすれど、恨むことなどこれからもございません。ですからご安心ください。";
	end;
OnTalk4:
	unittalk getcharid(3), "近衛兵 : 姫……血が……血が……ッ！　誰か!!　誰か居ないのか!?　早く……早く姫を……姫の治療を……ッ！　お願い……だ……。";
	end;
OnTalk5:
	unittalk getcharid(3), "近衛兵 : 失格など!!　聡明で美しく姫様ほど王女に相応しい女性はおりません……。私が……私が身分をわきまえず心惹かれたのは、そんな姫様だからこそなのです……。";
	end;
OnTalk6:
	unittalk getcharid(3), "近衛兵 : ……姫？　ティアラ姫……？　……私の……私の……私のせい……だ……。私が守れなかった……。私が……守っていれば……!";
	end;
OnTalk7:
	unittalk getcharid(3), "近衛兵 : ……。いや、きっとこれは悪い夢だ……。夢なんだ……現実なわけがない……。さあ、姫様。起きてください。こんなところで寝てはお体に差し障ります。";
	end;
OnTalk8:
	unittalk getcharid(3), "近衛兵 : 姫様？　ティアラ姫……？　どうして……どうして目を開けてくれないのですかッ!?　何故、笑ってくれないのですか……!?どうして……どうして……どうし……て……。";
	end;
}

1@spa,216,43,3	script	ティアラ姫#dk1	640,{
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "‐ティアラ姫と近衛兵が";
		mes "　話しているのが見える‐";
		close;
	...
	mes "夢ではないのですね。";
	mes "ゴホ、ゴホッ……。";
	unittalk getcharid(3), "ティアラ姫 : 貴方の腕に抱かれる日がくるなんて……夢ではないのですね。ゴホ、ゴホッ……。";
	next;
	mes "[近衛兵]";
	mes "ティアラ姫……!!";
	mes "すぐに、腕の良い治療術師が";
	...
	mes "……聞いて……くれ……";
	mes "ますか……？";
	unittalk getcharid(3), "ティアラ姫 : ……どうしても貴方に、伝えたいことがあったのです……。ゴホ、ゴホッ……。……聞いて……くれ……ますか……？";
	next;
	mes "[近衛兵]";
	mes "姫……喋らない方が……。";
	mes "お体に障ります……。";
	...
	mes "父も本心では、貴方のことを";
	mes "信じていたはずです。";
	unittalk getcharid(3), "ティアラ姫 : 大丈夫です……。だから聞いて……ください……。どうか、過ちを犯した私の父を許してください。父も本心では、貴方のことを信じていたはずです。";
	next;
	mes "[近衛兵]";
	mes "そんな……身にあまるお言葉です……。";
	mes "それに私は、国王に対し";
	...
	mes "暮らしていたかったのに……ゴホッ。";
	unittalk getcharid(3), "ティアラ姫 : 貴方は本当に優しいのですね……。私が落ち込んだときや辛いときいつも貴方は傍にいて慰めてくれた。ずっと、そんな貴方と父とこの国で暮らしていたかったのに……ゴホッ。";
	next;
	mes "[近衛兵]";
	mes "姫……血が……血が……ッ！";
	mes "誰か!!　誰か居ないのか!?";
	...
	mes "叶わぬ気持ちと分かっていたのに……。";
	mes "私は王女失格です……ね……。";
	unittalk getcharid(3), "ティアラ姫 : 泣いて……いるのです……か？　……貴方に特別な気持ちを抱いてしまった私をどうか、ゴホゴホ……許してください……。叶わぬ気持ちと分かっていたのに……。私は王女失格です……ね……。";
	next;
	mes "[近衛兵]";
	mes "失格など!!　聡明で美しく";
	mes "姫様ほど王女に相応しい女性は";
	...
	mes "その言葉を貴方から聞け……";
	mes "私は今、誰よりも……。";
	unittalk getcharid(3), "ティアラ姫 : ……。……ありがとう。その言葉を貴方から聞け……私は今、誰よりも……。";
	next;
	mes "[ティアラ姫]";
	mes "…………。";
	unittalk getcharid(3), "ティアラ姫 : …………。";
	next;
	cutin "b-tiara.BMP",3;
	mes "[近衛兵]";
	mes "……姫？　ティアラ姫……？";
...
1@spa,1,1,0	script	#DK_BattleAnnounce	139,{
OnStart:
	...
	set .@map$,getmdmapname("1@spa");
	set .@label$,getmdnpcname("#DK_BattleAnnounce")+ "::OnKilled1";
	areamonster .@map$,196,42,198,45,"物欲の化身",2955,4,.@label$;
	end;
OnKilled1:
	set .@count,getmapmobs(getmdmapname("1@spa"),getmdnpcname("#DK_BattleAnnounce")+ "::OnKilled1");
	if(.@count > 0) end;
...
OnKilled2:
	set .@count,getmapmobs(getmdmapname("1@spa"),getmdnpcname("#DK_BattleAnnounce")+ "::OnKilled2");
	if(.@count > 0) end;
...
OnKilled3:
	set .@count,getmapmobs(getmdmapname("1@spa"),getmdnpcname("#DK_BattleAnnounce")+ "::OnKilled3");
	if(.@count > 0) end;
...
OnKilled4:
	set .@count,getmapmobs(getmdmapname("1@spa"),getmdnpcname("#DK_BattleAnnounce")+ "::OnKilled4");
	if(.@count > 0) end;
...
OnKilled5:
	set .@count,getmapmobs(getmdmapname("1@spa"),getmdnpcname("#DK_BattleAnnounce")+ "::OnKilled5");
	if(.@count > 0) end;
...
OnKilled6:
	set .@count,getmapmobs(getmdmapname("1@spa"),getmdnpcname("#DK_BattleAnnounce")+ "::OnKilled6");
	if(.@count > 0) end;
	...
	monster getmdmapname("1@spa"),197,41,"呪いの根源",2959,1,getmdnpcname("#DK_BattleAnnounce")+ "::OnKilled7";
	end;
OnKilled7:
...
1@spa,196,44,5	script	黒づくめの男#dk	685,{
	if(getpartyleader(getcharid(1)) != strcharinfo(0)) {
		mes "‐黒づくめの男が凶々しい";
		mes "　剣を片手に立っている‐";
		close;
	...
	mes "あのままおとなしく";
	mes "彷徨っていればよいものを。";
	unittalk getcharid(3), "黒づくめの男 : まさか捨てたはずのものが再度またこの世界へとノコノコ舞い戻ってくるとはな。あのままおとなしく彷徨っていればよいものを。";
	next;
	cutin "cry-b.bmp",2;
	mes "[黒づくめの男]";
	mes "これで全てというわけでは";
	...
	mes "絶望と恐怖にまみれモンスターへ";
	mes "変貌した者たちの血は。";
	unittalk getcharid(3), "黒づくめの男 : これで全てというわけではなさそうだが……まあいい。どうだ？　魔剣タルタノス。絶望と恐怖にまみれモンスターへ変貌した者たちの血は。";
	next;
	cutin "cry-b.bmp",255;
	mes "[魔剣タルタノス]";
	mes "愚問だな、サクライ。";
	...
	mes "光と闇、生と死を経験した";
	mes "深紅なる甘美な血だ……。";
	unittalk getcharid(3), "魔剣タルタノス : 愚問だな、サクライ。我が求める血はもっともっと光と闇、生と死を経験した深紅なる甘美な血だ……。";
	next;
	mes "[魔剣タルタノス]";
	mes "……ククククク。";
	mes "そしてまた会ったな、人間。";
	...
	mes "ここまで見逃してきたが……";
	mes "そろそろ我慢の限界だ。";
	unittalk getcharid(3), "魔剣タルタノス : ……ククククク。そしてまた会ったな、人間。他人の不幸の味はどうだ？　しかし、よい余興になるとここまで見逃してきたが……そろそろ我慢の限界だ。";
	next;
	mes "[魔剣タルタノス]";
	mes "あの人間の血を……";
	mes "我に捧げるのだ！　サクライ。";
	...
	mes "血の匂いを漂わせた人間は";
	mes "かなり珍しい……！";
	unittalk getcharid(3), "魔剣タルタノス : あの人間の血を……我に捧げるのだ！　サクライ。ここまで極上の香りがする血の匂いを漂わせた人間はかなり珍しい……！";
	next;
	mes "[サクライ]";
	mes "タルタノスが興味をもつ人間……。";
	mes "物珍しさから泳がしてみたが、";
	...
	mes "……";
	mes "お前は……。";
	unittalk getcharid(3), "サクライ : タルタノスが興味をもつ人間……。物珍しさから泳がしてみたが、ここまでのようだな。……お前は……。";
	next;
	mes "[サクライ]";
	mes "……その顔。";
	mes "そうか、お前がアレを";
	mes "この世界へと導いた";
	mes "お人よしの冒険者だったのか。";
	unittalk getcharid(3), "サクライ : ……その顔。そうか、お前がアレをこの世界へと導いたお人よしの冒険者だったのか。";
	next;
	menu "まさか……",-;
	mes "[サクライ]";
	mes "そう、あの時の近衛兵が私だ。";
	...
	mes "それがお前の時代に";
	mes "どういうわけか、現れたらしい。";
	unittalk getcharid(3), "サクライ : そう、あの時の近衛兵が私だ。正確には、私の中から追い出した感情という名のくだらない存在。この記憶の残滓のようなもの。それがお前の時代にどういうわけか、現れたらしい。";
	next;
	mes "[サクライ]";
	mes "そして僅かに残ったくだらない";
	mes "正義感からお前に助けを求め、";
	...
	mes "結局お前のやったことは、";
	mes "無駄に終わったということだ。";
	unittalk getcharid(3), "サクライ : そして僅かに残ったくだらない正義感からお前に助けを求め、ここに戻ってきたようだがそれは今、私が取り込み消滅した。結局お前のやったことは、無駄に終わったということだ。";
	next;
	mes "[魔剣タルタノス]";
	mes "サクライ。";
	mes "無駄話をしている暇があるなら";
	mes "あの者の血を早く……";
	mes "早く我に捧げるのだ……！";
	unittalk getcharid(3), "魔剣タルタノス : サクライ。無駄話をしている暇があるならあの者の血を早く……早く我に捧げるのだ……！";
	next;
	mes "[サクライ]";
	mes "焦るな、タルタノスよ。";
	mes "……お前に問いたいことがある。";
	...
	mes "兵士などの元人間。";
	mes "それらを斬った感想はどうだ？";
	unittalk getcharid(3), "サクライ : 焦るな、タルタノスよ。……お前に問いたいことがある。先ほど、お前を襲ったモンスター。あれはこの国に住んでいた兵士などの元人間。それらを斬った感想はどうだ？";
	next;
	...
	case 1:
		...
		mes "命を奪ったという事実はな!!";
		mes "何にしろ……";
		unittalk getcharid(3), "サクライ : ほう？　答える気はないのか。だが、結果は変わらない。モンスターであれ、元人であれ、命を奪ったという事実はな!!　何にしろ……";
		break;
	case 2:
		mes "[サクライ]";
		mes "ほう、お前はそう感じたのか。";
		...
		mes "命を奪ったという事実はな。";
		mes "何にしろ……";
		unittalk getcharid(3), "サクライ : ほう、お前はそう感じたのか。これは面白い。だが、結果は変わらない。モンスターであれ、元人であれ、命を奪ったという事実はな。何にしろ……";
		break;
	}
	next;
	mes "[サクライ]";
	...
	mes "この時間のこの場所に";
	mes "招き入れたのだろう……。";
	unittalk getcharid(3), "サクライ : この運命は他の誰でもない。私が弱かったゆえの結果。そしてその弱さが、お前をこの時間のこの場所に招き入れたのだろう……。";
	next;
	menu "はじめから強い人間はいない",-;
	mes "[サクライ]";
	mes "その通りだ。";
	...
	mes "思いつくことができたのだから、";
	mes "お前にはひとまず、感謝しよう。";
	unittalk getcharid(3), "サクライ : その通りだ。だからこそ私は、過去の自分の弱さを断ち切るため、ここに来たのだ。しかし、今はそのお陰で私はよいことを思いつくことができたのだから、お前にはひとまず、感謝しよう。";
	next;
	mes "[魔剣タルタノス]";
	mes "サクライ、貴様なにを……。";
	unittalk getcharid(3), "魔剣タルタノス : サクライ、貴様なにを……。";
	next;
	mes "[サクライ]";
	mes "タルタノスよ。奴の血は";
	mes "極上の香りだといったな？";
	...
	mes "最高の状態で味わってみたいと";
	mes "思わないか……？";
	unittalk getcharid(3), "サクライ : タルタノスよ。奴の血は極上の香りだといったな？ならばもっとその香りの質が、最高の状態で味わってみたいと思わないか……？";
	next;
	mes "[魔剣タルタノス]";
	mes "ほう……？";
	mes "貴様にはそうなる目算が";
	...
	mes "良いだろう。";
	mes "貴様の企みに乗ってやろう。";
	unittalk getcharid(3), "ほう……？　貴様にはそうなる目算があるということなのだな？　良いだろう。貴様の企みに乗ってやろう。";
	next;
	mes "[サクライ]";
	mes "ここでお前を殺しては";
	mes "その意味が失われる。";
	...
	mes "ノコノコと時間移動までして";
	mes "助けようとしたほどだ。";
	unittalk getcharid(3), "サクライ : ここでお前を殺してはその意味が失われる。ゆえに今回は見逃すことにする。お前は見知らぬ者のために、ノコノコと時間移動までして助けようとしたほどだ。";
	next;
	mes "[サクライ]";
	mes "もっと世界を知り、この世の";
	mes "不条理な理に絶望するがいい。";
	...
	mes "なるだろう。";
	unittalk getcharid(3), "サクライ : もっと世界を知り、この世の不条理な理に絶望するがいい。そして人の力の無力さを感じ絶望した時……お前の血はさぞ、想像を絶するほど甘美な味となるだろう。";
	next;
	mes "‐それだけいうと";
	mes "　サクライは音もなく";
	mes "　闇の中に消えた。";
...
1@spa,196,46,1	script	#dk_tb	844,{
	end;
OnStart:
	initnpctimer;
	end;
OnTimer3000:
	unittalk getcharid(3), "優しい声 : 私は感謝しています。貴方に会えたことを……。";
	end;
OnTimer8000:
...
1@spa,198,43,1	script	#dk_sv	844,{
	end;
OnTalk1:
	unittalk getcharid(3), "若い男の声 : ご安心ください。これからはずっと、姫様の傍におります。もう一人にはしません……。";
	end;
OnTalk2:
	unittalk getcharid(3), "若い男の声 : 案ずるには及ばない。一度交わした契約を忘れるものか。";
	end;
OnTalk3:
	unittalk getcharid(3), "若い男の声 : 我が名はサクライ。我が名をゆめゆめ忘れるな。再び、相見える日までな……。";
	end;
}

1@spa,196,41,1	script	#dk_tv	844,{
	end;
OnTalk1:
	unittalk getcharid(3), "謎の声 : 忘れるな、サクライ。私と交わした血の契約を。";
	end;
OnTalk2:
	unittalk getcharid(3), "謎の声 : 私を満足させる血を見つけるまで、貴様の魂は私のモノだ。クククククク……。";
	end;
}

1@spa,204,29,1	script	国王#dk11	965,{
	if(checkquest2(114765)&0x8){
		mes "[国王]";
		mes "どうかサクライを";
		mes "救ってやってくれ……。";
...
1@spa,210,28,0	script	亡霊の王宮出口	45,2,2,{
	mes "‐……景色が揺らいでいる。";
	mes "　そろそろ記憶の中の世界から";
	mes "　離れる時間のようだ‐";
	close2;
