...
// Shop
//------------------------------------------------------------
yuno_in01,112,26,4	shop	防具商人	101,2628:-1,2101:-1,2107:-1,2401:-1,2501:-1,2230:-1,2301:-1,2303:-1,2305:-1,2321:-1,2332:-1
yuno_in01,103,35,2	shop	武器商人	49,1750:-1,1751:-1,1101:-1,1701:-1,1201:-1,1204:-1,1207:-1,1210:-1,1213:-1,1216:-1,1601:-1,1604:-1,1607:-1,1610:-1
yuno_in01,25,34,4	shop	道具商人	83,1750:-1,611:-1,501:-1,502:-1,503:-1,504:-1,506:-1,645:-1,656:-1,601:-1,602:-1
yuno,163,187,4	shop	魔法商人	90,717:-1,1601:-1,1604:-1,1607:-1,1610:-1,2232:-1,2321:-1,2332:-1
yuno,218,97,4	shop	道具商人	84,1750:-1,611:-1,501:-1,502:-1,503:-1,504:-1,506:-1,645:-1,656:-1,601:-1,602:-1
yuno,226,107,4	shop	道具商人	83,911:-1,910:-1,912:-1
yuno,205,103,4	shop	王窓商会	125,2340:-1,2341:-1,2411:-1,2222:-1,2230:-1,1721:-1
yuno,197,114,4	shop	テイミング商人	124,537:-1,643:-1,10013:-1,10014:-1,6095:-1,6096:-1,6097:-1,6098:-1,6099:-1,6100:-1,6104:-1,6105:-1,6106:-1,6107:-1,6108:-1,6109:-1,6110:-1,6111:-1,6112:-1

//============================================================
// ジュノーNPC
//------------------------------------------------------------
yuno,334,182,4	script	ジュノー兵士	852,{
	mes "[ジュノー兵士]";
	mes "ここは高度な知識が息づく";
	mes "賢者の都市ジュノーであります。";
	mes "ジュノーにいらした皆様を";
...
yuno,263,320,4	script	ジュノー兵士	852,{
	mes "[ジュノー兵士]";
	mes "ここは高度な知識が息づく";
	mes "賢者の都市ジュノーであります。";
	mes "ジュノーにいらした皆様を";
...
yuno,228,291,4	script	ジュノー兵士	852,{
	mes "[ジュノー兵士]";
	mes "ここは高度な知識が息づく";
	mes "賢者の都市ジュノーであります。";
	mes "ジュノーにいらした皆様を";
...
yuno,165,283,4	script	ジュノー兵士	852,{
	mes "[ジュノー兵士]";
	mes "ここは高度な知識が息づく";
	mes "賢者の都市ジュノーであります。";
	mes "ジュノーにいらした皆様を";
...
yuno,150,283,4	script	ジュノー兵士	852,{
	mes "[ジュノー兵士]";
	mes "ここは高度な知識が息づく";
	mes "賢者の都市ジュノーであります。";
	mes "ジュノーにいらした皆様を";
...
yuno,165,228,4	script	ジュノー兵士	852,{
	mes "[ジュノー兵士]";
	mes "ここは高度な知識が息づく";
	mes "賢者の都市ジュノーであります。";
	mes "ジュノーにいらした皆様を";
...
yuno,150,228,4	script	ジュノー兵士	852,{
	mes "[ジュノー兵士]";
	mes "ここは高度な知識が息づく";
	mes "賢者の都市ジュノーであります。";
	mes "ジュノーにいらした皆様を";
...
yuno,184,173,4	script	ジュノー民	729,{
	mes "[イフレット]";
...
yuno,157,205,4	script	物知りじいさん	54,{
	mes "[物知りじいさん]";
	mes "もぐもぐ　もきゅもきゅ";
	mes "お元気かね～？";
	mes "私はジュノーの";
...
// YUNO_1QUE -> 0～1
//------------------------------------------------------------
yuno_in01,103,157,3	script	バーン	98,{
	if(YUNO_1QUE == 0) {
		mes "[バーン]";
		mes "私はアルケミスト。";
		mes "弟と共にホムンクルスの";
...
yuno_in01,100,153,7	script	バジン	47,{
	if(YUNO_1QUE == 0) {
		mes "[バジン]";
		mes "私はアルケミストのバジンです。";
		mes "兄と一緒に研究しています。";
...
// YUNO_2QUE -> 0～9
//------------------------------------------------------------
yuno_in01,17,30,4	script	ウェイコン	85,{
	switch(YUNO_2QUE) {
	case 0:
		mes "[ウェイコン]";
		mes "ご存知の通り、";
...
yuno_in03,26,39,4	script	メト	709,{
	switch(YUNO_2QUE) {
	case 0:
		mes "[メト]";
		mes "今日も研究、明日も研究";
...
yuno_in01,17,95,4	script	ステンクル	99,{
	switch(YUNO_2QUE) {
	case 0:
	case 1:
		mes "[ステンクル]";
...
yuno_in01,19,183,4	script	カブト	55,{
	switch(YUNO_2QUE) {
	case 0:
	case 1:
	case 2:
...
yuno_in03,178,43,4	script	ジジ	121,{
	if(YUNO_2QUE >= 7) {
		mes "[ジジ]";
		mes "う～む……";
		mes "ライドエンジン理論を具現化";
...
// MJO_2QUE -> 0～10
//------------------------------------------------------------
yuno,157,87,4	script	ジュノー住民	102,{
	mes "[イコン=リクチチ]";
	mes "アルデバラン方面へ";
	mes "旅をしていると";
	mes "「エルメスプレート」と呼ばれる";
...
yuno,261,99,4	script	賢者イクルラ	735,{
	switch(MJO_2QUE) {
	default:
		mes "[イクルラ]";
...
yuno,305,207,4	script	賢者シクルラ	735,{
	switch(MJO_2QUE) {
	default:
		mes "[シクルラ]";
		mes "賢者の都市ジュノーのどこかに";
...
yuno,213,298,4	script	賢者エスクラ	735,{
	switch(MJO_2QUE) {
	default:
		mes "[エスクラ]";
		mes "いつか見たことがあるんだ。";
...
mjolnir_02,170,193,0	script	ミョルニールの別荘	111,{
	switch(MJO_2QUE) {
	default:
		mes "- 「ミョルニールの別荘」 -";
		mes "- 家の中と外に -";
