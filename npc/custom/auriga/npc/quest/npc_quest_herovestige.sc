...
dali,109,94,5	shop	猫の手サービス雑貨商人	496,611:-1,1750:-1,1065:-1,579:-1,602:-1
...
dali02,51,112,5	script	混乱に陥ったシーフ	939,{
	mes "[混乱に陥ったシーフ]";
	mes "酒に酔った奴らから金品を";
	mes "盗んでいたら、いつの間にか";
	mes "こんなところに出たんだ。";
...
dali02,68,117,5	script	案内人レシア族	516,{
	mes "[案内人レシア族]";
	mes "また、ここに出てしまった。";
	mes "出口も見えないなんて……";
	mes "まったく……";
...
dali02,65,119,5	script	観光客レシア族	516,{
	mes "[観光客レシア族]";
	mes "ここがあの有名なプロンテラか？";
	mes "やはり大都市！　薄暗いな！";
	close;
...
dali02,69,122,5	script	旅行中レシア族	516,{
	mes "[旅行中レシア族]";
	mes "時計の音が聞こえる暗い場所！";
	mes "ここは絶対コモドだよ！";
	close;
...
dali02,65,115,5	script	冒険好きレシア族	516,{
	mes "[冒険好きレシア族]";
	mes "みんな、武器を取れ！";
	mes "僕たちはタナトスタワーの";
	mes "真っ只中なんだ！";
...
dali02,45,96,6	script	コンチネンタルガード	707,{
	mes "[コンチネンタルガード]";
...
dali,100,82,5	script	案内人ガド#01	516,{
	mes "[案内人ガド]";
	mes "ここって風景がどこも似ていて";
	mes "意外に迷いやすいよね。";
	mes "行きたいところがあったら";
...
dali02,100,82,5		duplicate(案内人ガド#01)	案内人ガド#02	516
