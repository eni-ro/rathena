...
// 大型マジェスティックゴート製作NPC
//------------------------------------------------------------
prt_monk,261,91,3	script	ブラックハンド	826,{
	mes "[ブラックハンド]";
	mes "なんだお前は？";
	mes "オレに用でもあるのか？";
	next;
...
// ダンジョン生成NPC
//------------------------------------------------------------
monk_test,309,146,3	script	修道士パトリック	412,{
	if(checkitemblank() < 5) {
		mes "‐所持アイテムの種類数が多い為";
		mes "　危険です。";
		mes "　5種類以上の所持アイテムを";
...
// 転送NPC
//------------------------------------------------------------
monk_test,306,151,3	script	封印石	111,{
	if(countitem(6001) > 0)
...
OnStart:
	...
	areamonster getmdmapname("1@cata"),0,0,0,0,"デッドリーレイス",1291,40,getmdnpcname("BaphometControl1-1")+"::OnKilled1";
	areamonster getmdmapname("1@cata"),0,0,0,0,"カーリッツバーグ",1132,20,getmdnpcname("BaphometControl1-1")+"::OnKilled2";
	areamonster getmdmapname("1@cata"),0,0,0,0,"フレームスカル",1869,40,getmdnpcname("BaphometControl1-1")+"::OnKilled3";
	areamonster getmdmapname("1@cata"),0,0,0,0,"エンシェントミミック",1699,30,getmdnpcname("BaphometControl1-1")+"::OnKilled4";
	areamonster getmdmapname("1@cata"),0,0,0,0,"ゾンビマスター",1298,40,getmdnpcname("BaphometControl1-1")+"::OnKilled5";
	areamonster getmdmapname("1@cata"),0,0,0,0,"ジェネラルスケルトン",1290,40,getmdnpcname("BaphometControl1-1")+"::OnKilled6";
	areamonster getmdmapname("1@cata"),0,0,0,0,"ウィンドゴースト",1263,30,getmdnpcname("BaphometControl1-1")+"::OnKilled7";
	areamonster getmdmapname("1@cata"),0,0,0,0,"ルード",1509,20,getmdnpcname("BaphometControl1-1")+"::OnKilled8";
	areamonster getmdmapname("1@cata"),0,0,0,0,"イビルドルイド",1117,30,getmdnpcname("BaphometControl1-1")+"::OnKilled9";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バンシー",1867,10,getmdnpcname("BaphometControl1-1")+"::OnKilled10";
	areamonster getmdmapname("1@cata"),0,0,0,0,"ダークイリュージョン",1302,1,getmdnpcname("BaphometControl1-1")+"::OnKilled11";
	end;
OnKilled:
...
OnKilled1:
	areamonster getmdmapname("1@cata"),0,0,0,0,"デッドリーレイス",1291,1,getmdnpcname("BaphometControl1-1")+"::OnKilled1";
	end;
OnKilled2:
	areamonster getmdmapname("1@cata"),0,0,0,0,"カーリッツバーグ",1132,1,getmdnpcname("BaphometControl1-1")+"::OnKilled2";
	end;
OnKilled3:
	areamonster getmdmapname("1@cata"),0,0,0,0,"フレームスカル",1869,1,getmdnpcname("BaphometControl1-1")+"::OnKilled3";
	end;
OnKilled4:
	areamonster getmdmapname("1@cata"),0,0,0,0,"エンシェントミミック",1699,1,getmdnpcname("BaphometControl1-1")+"::OnKilled4";
	end;
OnKilled5:
	areamonster getmdmapname("1@cata"),0,0,0,0,"ゾンビマスター",1298,1,getmdnpcname("BaphometControl1-1")+"::OnKilled5";
	end;
OnKilled6:
	areamonster getmdmapname("1@cata"),0,0,0,0,"ジェネラルスケルトン",1290,1,getmdnpcname("BaphometControl1-1")+"::OnKilled6";
	end;
OnKilled7:
	areamonster getmdmapname("1@cata"),0,0,0,0,"ウィンドゴースト",1263,1,getmdnpcname("BaphometControl1-1")+"::OnKilled7";
	end;
OnKilled8:
	areamonster getmdmapname("1@cata"),0,0,0,0,"ルード",1509,1,getmdnpcname("BaphometControl1-1")+"::OnKilled8";
	end;
OnKilled9:
	areamonster getmdmapname("1@cata"),0,0,0,0,"イビルドルイド",1117,1,getmdnpcname("BaphometControl1-1")+"::OnKilled9";
	end;
OnKilled10:
	areamonster getmdmapname("1@cata"),0,0,0,0,"バンシー",1867,1,getmdnpcname("BaphometControl1-1")+"::OnKilled10";
	end;
OnKilled11:
	areamonster getmdmapname("1@cata"),0,0,0,0,"ダークイリュージョン",1302,1,getmdnpcname("BaphometControl1-1")+"::OnKilled11";
	end;
...
OnStart:
	...
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1869,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1291,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1869,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1291,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1869,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1291,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1869,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1132,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1117,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1132,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1117,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1132,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
	areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1291,1,getmdnpcname("BaphometControl1-2")+"::OnKilled";
...
OnKilled:
	switch(rand(5)) {
	case 0: areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1869,1,getmdnpcname("BaphometControl1-2")+"::OnKilled"; break;
	case 1: areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1291,1,getmdnpcname("BaphometControl1-2")+"::OnKilled"; break;
	case 2: areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1132,1,getmdnpcname("BaphometControl1-2")+"::OnKilled"; break;
	case 3: areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1117,1,getmdnpcname("BaphometControl1-2")+"::OnKilled"; break;
	case 4: areamonster getmdmapname("1@cata"),0,0,0,0,"バフォメットの使徒",1869,1,getmdnpcname("BaphometControl1-2")+"::OnKilled"; break;
	}
	getitem 6002,1;
	end;
}
...
1@cata,86,214,0	script	崩れかけの墓#1F_1F	844,{
	mes "‐倒れかけた墓石の下には";
	mes "　何もなかった‐";
	close;
}

1@cata,200,209,0	duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_2T	844
1@cata,200,209,0	duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_2F	844
1@cata,230,195,0	duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_3T	844
1@cata,230,195,0	duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_3F	844
1@cata,118,182,0	duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_4T	844
1@cata,118,182,0	duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_4F	844
1@cata,193,182,0	duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_5T	844
1@cata,193,182,0	duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_5F	844
1@cata,253,156,0	duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_6T	844
1@cata,253,156,0	duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_6F	844
1@cata,88,154,0		duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_7T	844
1@cata,88,154,0		duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_7F	844
1@cata,127,116,0	duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_8T	844
1@cata,127,116,0	duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_8F	844
1@cata,90,98,0		duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_9T	844
1@cata,90,98,0		duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_9F	844
1@cata,188,84,0		duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_10T	844
1@cata,188,84,0		duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_10F	844
1@cata,244,42,0		duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_11T	844
1@cata,244,42,0		duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_11F	844
1@cata,127,32,0		duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_12T	844
1@cata,127,32,0		duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_12F	844
1@cata,267,30,0		duplicate(崩れかけの墓#1F_1T)	崩れかけの墓#1F_13T	844
1@cata,267,30,0		duplicate(崩れかけの墓#1F_1F)	崩れかけの墓#1F_13F	844
...
1@cata,85,182,0		duplicate(揺らめく松明#1)	揺らめく松明#2	844
1@cata,267,154,0	duplicate(揺らめく松明#1)	揺らめく松明#3	844
1@cata,157,139,0	duplicate(揺らめく松明#1)	揺らめく松明#4	844
1@cata,193,138,0	duplicate(揺らめく松明#1)	揺らめく松明#5	844
1@cata,193,102,0	duplicate(揺らめく松明#1)	揺らめく松明#6	844
1@cata,157,102,0	duplicate(揺らめく松明#1)	揺らめく松明#7	844
1@cata,113,112,0	duplicate(揺らめく松明#1)	揺らめく松明#8	844
1@cata,253,56,0		duplicate(揺らめく松明#1)	揺らめく松明#9	844
1@cata,239,56,0		duplicate(揺らめく松明#1)	揺らめく松明#10	844
1@cata,71,42,0		duplicate(揺らめく松明#1)	揺らめく松明#11	844
1@cata,155,14,0		duplicate(揺らめく松明#1)	揺らめく松明#12	844
...
2@cata,50,67,0	script	BaphometLeftSlave	139,5,5,{
	...
	monster getmdmapname("2@cata"),55,67,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),51,67,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),58,67,"バフォメットの使徒",1292,1;
	monster getmdmapname("2@cata"),53,67,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),54,67,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),55,67,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),56,67,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),58,66,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),56,66,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),60,66,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),59,66,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),54,66,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),55,66,"バフォメットの使徒",1292,1;
	monster getmdmapname("2@cata"),56,66,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),50,65,"バフォメットの使徒",1867,1;
	monster getmdmapname("2@cata"),61,65,"バフォメットの使徒",1292,1;
...
2@cata,109,67,0	script	BaphometRightSlave	139,5,5,{
	announce "バフォメットの使徒 : 人間ドモヲ殺セ！　ゴ主人様ノ復活ニ邪魔ナ存在ハ全テ消セ！",0x9,0xFFFF00;
	monster getmdmapname("2@cata"),105,67,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),104,67,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),107,67,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),106,67,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),102,67,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),103,67,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),103,67,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),109,66,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),108,66,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),101,66,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),106,66,"バフォメットの使徒",1292,1;
	monster getmdmapname("2@cata"),102,66,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),104,66,"バフォメットの使徒",1292,1;
	monster getmdmapname("2@cata"),103,66,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),109,65,"バフォメットの使徒",1867,1;
	monster getmdmapname("2@cata"),108,65,"バフォメットの使徒",1292,1;
...
2@cata,79,39,0	script	BaphometDownSlave	139,5,5,{
	announce "バフォメットの使徒 : 人間ドモヲ殺セ！　ゴ主人様ノ復活ニ邪魔ナ存在ハ全テ消セ！",0x9,0xFFFF00;
	monster getmdmapname("2@cata"),78,41,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),79,42,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),78,46,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),81,41,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),81,42,"バフォメットの使徒",1869,1;
	monster getmdmapname("2@cata"),79,43,"バフォメットの使徒",1291,1;
	monster getmdmapname("2@cata"),77,40,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),79,41,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),79,42,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),79,43,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),79,48,"バフォメットの使徒",1117,1;
	monster getmdmapname("2@cata"),78,49,"バフォメットの使徒",1132,1;
	monster getmdmapname("2@cata"),78,41,"バフォメットの使徒",1292,1;
	monster getmdmapname("2@cata"),74,42,"バフォメットの使徒",1292,1;
	monster getmdmapname("2@cata"),72,48,"バフォメットの使徒",1867,1;
	monster getmdmapname("2@cata"),72,38,"バフォメットの使徒",1292,1;
	hideonnpc getmdnpcname("BaphometDownSlave");
	end;
}

2@cata,79,81,0	script	封印魔法陣#0	844,{
...
2@cata,123,109,0	script	封印魔法陣#2	844,{
	if(!checkquest2(3041) || checkquest2(3041) & 0x2) {
		if(checkquest2(3041) & 0x2)
			delquest 3041;
		misceffect 87;
...
2@cata,123,22,0	script	封印魔法陣#4	844,{
	if(!checkquest2(3041) || checkquest2(3041) & 0x2) {
		if(checkquest2(3041) & 0x2)
			delquest 3041;
		misceffect 87;
...
2@cata,35,21,0	script	封印魔法陣#8	844,{
	if(!checkquest2(3041) || checkquest2(3041) & 0x2) {
		if(checkquest2(3041) & 0x2)
			delquest 3041;
		misceffect 87;
...
2@cata,35,109,0	script	封印魔法陣#10	844,{
	if(!checkquest2(3041) || checkquest2(3041) & 0x2) {
		if(checkquest2(3041) & 0x2)
			delquest 3041;
		misceffect 87;
...
2@cata,80,63,4	script	先代英雄の魂#2F	411,{
...
OnStart:
	...
	monster getmdmapname("2@cata"),79,64,"魔王バフォメット",1929,1,getmdnpcname("BaphometControl2-2")+"::OnMyMobDead";
	end;
