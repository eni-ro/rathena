...
また、ステータスが上限に達した後に該当するステータスの成長が抽選された場合、ステータスポイントを50取得します。  

スキルポイントの取得確率は固定で0.75%です。  

成長システムに関しては、バランスが悪ければ今後確率を変更する可能性があります。
...
武器改造装置と大罪武器改造装置による、ランダムオプションに対応しています。  
武器改造装置と大罪武器改造装置は、ベネット室内のNPCでバルミールチケットと交換可能です。  
交換材料のバルミールチケットは、MVP部屋の報酬で取得可能です。  
