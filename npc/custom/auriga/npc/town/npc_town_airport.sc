...
//アインブロック
einbroch,94,267,3	duplicate(飛行船職員#guide)	飛行船職員	91

//ジュノー
yuno,88,263,3	duplicate(飛行船職員#guide)	飛行船職員	91
yuno,14,262,5	duplicate(飛行船職員#guide)	飛行船職員	91
...
-	script	空港職員#AirportIn	90,{
	...
	mes "何をお手伝いいたしましょう？";
	next;
	set .@dummy,getmapxy(.@map$,.@dummy,.@dummy,BL_NPC);		//map以外はダミー
	if(.@map$ == "izlude")
...
//アインブロック
airport,126,43,5		duplicate(空港職員#AirportIn)	空港職員	90
airport,143,43,5		duplicate(空港職員#AirportIn)	空港職員	90
airport,158,43,5		duplicate(空港職員#AirportIn)	空港職員	90

//ジュノー
y_airport,126,43,5		duplicate(空港職員#AirportIn)	空港職員	90
y_airport,143,43,5		duplicate(空港職員#AirportIn)	空港職員	90
y_airport,158,43,5		duplicate(空港職員#AirportIn)	空港職員	90

//リヒタルゼン
lhz_airport,126,43,5	duplicate(空港職員#AirportIn)	空港職員	90
lhz_airport,143,43,5	duplicate(空港職員#AirportIn)	空港職員	90
lhz_airport,158,43,5	duplicate(空港職員#AirportIn)	空港職員	90

//イズルード
izlude,206,55,2		duplicate(空港職員#AirportIn)	空港職員	90
...
//アインブロック
airport,126,51,3		duplicate(空港職員#AirportOut)	空港職員	90
airport,143,49,3		duplicate(空港職員#AirportOut)	空港職員	90
airport,158,50,3		duplicate(空港職員#AirportOut)	空港職員	90

//ジュノー
y_airport,126,51,3		duplicate(空港職員#AirportOut)	空港職員	90
y_airport,143,49,3		duplicate(空港職員#AirportOut)	空港職員	90
y_airport,158,50,3		duplicate(空港職員#AirportOut)	空港職員	90

//リヒタルゼン
lhz_airport,126,51,3	duplicate(空港職員#AirportOut)	空港職員	90
lhz_airport,143,49,3	duplicate(空港職員#AirportOut)	空港職員	90
lhz_airport,158,50,3	duplicate(空港職員#AirportOut)	空港職員	90

//============================================================
// アインブロック空港NPC
//------------------------------------------------------------
airport,174,41,6	script	青年	99,{
	mes "[ルンアン]";
	mes "私は世界中から珍しい物を";
	mes "集めているんですが……";
	mes "最近の金持ちは、いわゆる";
...
airport,176,41,4	script	おじさん	88,{
	mes "[チンアン]";
	mes "ここら辺にいるモンスターから、";
...
// ジュノー空港路線変更職員
//------------------------------------------------------------
y_airport,145,63,4	script	空港職員	91,{
	mes "[空港職員]";
	mes "シュバルツバルド共和国内の";
	mes "各地域を行き来する";
	mes "飛行船をご利用なさいますか？";
...
y_airport,140,63,4	script	空港職員	91,{
	mes "[空港職員]";
	mes "ジュノー・イズルード・ラヘル";
	mes "を運行する飛行船を";
	mes "ご利用なさいますか？";
...
// シュバルツバルド国内線 飛行船NPC
//------------------------------------------------------------
airplane,100,69,3	script	乗務員	852,{
	mes "[乗務員]";
	mes "飛行船をご利用の方は、";
	mes "そこの階段を上ってください。";
	mes "いつも飛行船を利用してくださり";
...
airplane,250,58,2	script	飛行船案内員	67,{
	mes "[飛行船案内員]";
	mes "こんにちは。";
	mes "当船では、いつも";
	mes "お客様の快適な旅行のために";
...
airplane,221,158,2	script	操縦士	852,{
	if(HU_7QUE == 3) {
		mes "[操縦士]";
		mes "どこへ行っても、";
		mes "酒さえ飲めればいいです。";
...
airplane,65,63,4	script	少女	714,{
	mes "[少女]";
	mes "この飛行船は、";
	mes "いつルティエに着くのかしら？";
	mes "いくら待っても、";
...
airplane,80,71,2	script	ゼルタ	834,{
	mes "[ゼルタ]";
	mes "私は、ある教えを広めるために";
	mes "巡業している者です。";
	mes "この教えにより、";
...
airplane,72,34,6	script	アノース	702,{
	mes "[アノース]";
	mes "空から眺める景色は、";
	mes "本当に良いですね。";
	mes "鳥になって、自由に飛び回れたら";
...
airplane,71,91,6	script	ウンバラの男性	789,{
	if(UM_1QUE < 3) {
		mes "[お父さん]";
		mes "ウムババ、フムババ。";
		next;
...
airplane,66,93,2	script	ウンバラの女性	783,{
	if(UM_1QUE < 3) {
		emotion 9;
		mes "[お母さん]";
		mes "ウムバウムバ……";
...
airplane,64,94,0	script	ウンバラの子供	787,{
	if(UM_1QUE < 3) {
		emotion 19;
		mes "[子供]";
		mes "ウムバウムバ!!";
...
airplane,240,64,5	script	出口	857,{}
airplane,247,64,5	script	出口	857,{}
airplane,240,40,0	script	出口	857,{}
airplane,247,40,0	script	出口	857,{}

//============================================================
// 国外線 飛行船NPC
//------------------------------------------------------------
airplane_01,250,58,3	script	飛行船案内員#AirEvent	67,{
	mes "[飛行船案内員]";
	mes "こんにちは。";
	mes "当船では、いつも";
	mes "お客様の快適な旅行のために";
...
airplane_01,221,158,2	script	操縦士	852,{
	switch(rand(4)) {
	case 0:
		mes "[操縦士]";
		mes "今日は雲が多いですね。";
...
airplane_01,83,61,2	script	少女	72,2,2,{
	mes "[少女]";
	mes "うわ～ん!!";
	mes "お外ではしゃいでたら、";
	mes "鹿さん怒られた～。";
...
airplane_01,69,63,2	script	貴族の男性	55,{
	mes "[貴族の男性]";
...
airplane_01,71,31,2	script	剣士	106,{
	mes "[剣士]";
	mes "……5年前の復讐……。";
	mes "……覚えてろ……。";
	mes "今度は絶対に逃がさんぞ!!";
...
airplane_01,240,64,5	script	出口	857,{}
airplane_01,247,64,5	script	出口	857,{}
airplane_01,240,40,0	script	出口	857,{}
airplane_01,247,40,0	script	出口	857,{}

airplane_01,247,54,3	script	飛行船船長#AirEvent	873,{
	mes "[ペルロック]";
...
airplane,50,66,5	duplicate(AirApple)	リンゴ商人#フルツ	86
airplane_01,50,66,5	duplicate(AirApple)	リンゴ商人#メルツ	86
...
airplane,33,69,4	duplicate(AirDice)	ケージ#Air	73
airplane_01,33,69,4	duplicate(AirDice)	クラリス#Air	74
...
airplane,32,61,4	duplicate(AirTyping)	ジョン#Air	51
airplane_01,32,61,4	duplicate(AirTyping)	ニルス#Air	49
...
// AIR_1QUE -> 0～7
//------------------------------------------------------------
airplane_01,238,154,2	script	飛行船船長#Air	873,{
	cutin "fly_felrock",2;
	mes "[ペルロック]";
	mes "私が、この飛行船の船長ペルロックだ。";
	mes "私に何か用事でもあるのかね？";
...
airplane,236,163,2	script	飛行船船長	873,{
	cutin "fly_trock",2;
	switch(HU_7QUE) {
	case 3:
	case 4:
...
// AIR_2QUE -> 0～13
//------------------------------------------------------------
airplane,236,63,4	script	ヘイルレン	706,{
	if(HU_7QUE == 3) {
		mes "[ヘイルレン]";
		mes "サッサッサ～";
		mes "お掃除サッサ～";
...
ein_in01,279,25,0	script	#研究所入口	139,1,1,{
	if(AIR_2QUE == 9) {
		mes "（研究所の中を探せば、";
		mes "何か出るかも知れない）";
		close;
...
ein_in01,264,17,0	script	#暗号チェック機	139,1,1,{
	if(AIR_2QUE == 9) {
		mes "（ん!?　これは……？";
		mes "暗号チェック機？";
		mes "……どうやら、";
...
ein_in01,261,35,0	script	#暗号入力機	139,1,1,{
...
ein_in01,263,35,2	script	トロック#Air	873,{
	end;
OnTimer120000:
	stopnpctimer;
OnInit:
