...
//==============================================================================
alberta,218,87,3	script	アマツ貿易商	762,{
	mes "[貿易商]";
	mes "こんにちは！";
	mes "最近どうですか？";
	next;
...
//==============================================================================
alberta,218,82,3	script	アマツ貿易商	757,{
	mes "[貿易商]";
	mes "こんにちは～";
	mes "風が気持ちいいですね～。";
	next;
...
//==============================================================================
alberta,226,84,1	script	アマツ貿易商	762,{
	mes "[貿易商]";
	mes "こんにちは。";
	mes "最近どうです？";
	next;
...
//==============================================================================
alberta,226,78,1	script	アマツ貿易商	762,{
	mes "[貿易商]";
	mes "こんにちはー！";
	mes "最近どう？";
	next;
...
//==============================================================================
amatsu,102,149,4	script	カプラ職員#amatsuevent	112,{
	cutin "kafra_06",2;
	mes "[カプラ職員]";
	mes "やっぱりひなあられは";
	mes "おいひいれすね～(モグモグ)";
	...
	next;
	callfunc "KafraMain",3,0x11b,"amatsu",116,94,"NULL",0,0,80,700;
	end;
OnInit:
	//デフォルトのカプラ・ガイドを無効にする
...
amatsu,207,91,4	script	ミス・アマツ	758,{
	//メニュー名を返す
	function Place {
		switch(getarg(0)) {
			case 0: return "城";
	...
	if(.@flag&2)
		delitem 543,1;
	switch(.@i) {
		case 4: warp "ama_dun03",120,204; 	break;
		case 5: warp "mag_dun02",151,194; 	break;
		case 6: warp "gonryun",36,90; 	break;
		case 7: warp "pay_fild05",92,153; 	break;
		case 8: warp "gef_fild12",247,180; 	break;
		case 9: warp "gef_fild02",87,49; 	break;
		case 10: warp "cmd_fild07",155,357; break;
		case 11: warp "yuno_in02",93,205; 	break;
		case 12: warp "moc_fild11",198,215; break;
		case 13: warp "yuno_fild02",92,211; break;
		case 14: warp "cmd_fild04",129,261; break;
		case 15: warp "prt_maze02",105,80; 	break;
		case 16: warp "alde_dun04",164,143; break;
		case 17: warp "glast_01",44,363; 	break;
		case 18: warp "tur_dun03",56,36; 	break;
		case 19: warp "c_tower4",42,38; 	break;
	}
	end;
}
