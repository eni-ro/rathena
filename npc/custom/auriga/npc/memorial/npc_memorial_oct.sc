...
// ダンジョン生成NPC
//------------------------------------------------------------
mal_dun01,151,235,5	script	ヒトデ	551,{
...
// ダンジョン入場NPC
//------------------------------------------------------------
mal_dun01,153,237,5	script	不思議な通路	844,{
	mes "‐木の板でふさがれた";
	mes "　洞窟につながる道がある。";
	mes "　板の隙間をくぐれば";
	mes "　先に進めそうだ‐";
...
1@cash,78,99,0	script	oct_backattack2	139,3,3,{
	initnpctimer;
	monster getmdmapname("1@cash"),71,105,"子分タコ",2192,1;
...
OnTimer6000:
	monster getmdmapname("1@cash"),71,105,"子分タコ",2192,3;
...
OnStart:
	...
	monster getmdmapname("1@cash"),196,188,"頭領タコ",2194,1,getmdnpcname("oct_boss_con")+ "::OnKilled";
	initnpctimer;
	end;
OnTimer7000:
	switch(rand(3)) {
...
OnTimer10000:
	...
	areamonster getmdmapname("1@cash"),184,173,214,203,"子分タコ",2192,5;
	stopnpctimer;
	end;
}
