...
pay_fild03,388,63,0	script	AC_TSTVP1_02	139,1,1,{ //ŠX‚©‚ç‚Ìƒ[ƒvæ‚Åƒ^ƒbƒ`
	if(AC_RANK==0 && AC_RANKTEST==2){ //‘æ‚P‰Û’ö
		viewpoint 1,209,143,20,0xFFFF00;
	}
}
prt_fild08,170,375,0	script	AC_TSTVP2_02	139,1,1,{ //ƒvƒ“ì‚Åƒ^ƒbƒ`
...
moc_fild01,238,378,0	script	AC_TSTVP2_03	139,1,1,{ //ŽqƒfƒUƒ}ƒbƒv‚Åƒ^ƒbƒ`
	if(AC_RANK==1 && AC_RANKTEST==2){ //‘æ‚Q‰Û’ö
...
pay_fild04,20,165,0		script	AC_TSTVP2_04	139,1,1,{ //ƒ|ƒŠƒ““‡‚Åƒ^ƒbƒ`
	if(AC_RANK==1 && AC_RANKTEST==2){ //‘æ‚Q‰Û’ö
...
pay_fild01,333,356,0				script	AC_TSTVP3_02	139,1,1,{ //ƒtƒFƒC“ì‚Åƒ^ƒbƒ`
...
pay_fild02,160,381,0				script	AC_TSTVP2_03	139,1,1,{ //ƒEƒ‹ƒtƒ}ƒbƒv‰EãWP‚Åƒ^ƒbƒ`
	if(AC_QUEST_LV_3==6 && AC_QUEST_ST_3==3){//	ŽÀŒ±‚Ì‚¨Žè“`‚¢‚S
...
pay_fild02,83,382,0					script	AC_TSTVP2_04	139,1,1,{ //ƒEƒ‹ƒtƒ}ƒbƒvã’†‰›WP‚Åƒ^ƒbƒ`(‚¢‚ç‚È‚¢H)
	if(AC_RANK==2 && AC_RANKTEST==2){ //‘æ‚R‰Û’ö
		viewpoint 1,105,242,20,0xFFFF00;
	}
}
mjolnir_09,106,34,0					script	AC_TSTVP4_03	139,1,1,{ //ƒvƒ©ªƒ[ƒvæ‚Åƒ^ƒbƒ`
...
gef_fild00,376,140,0				script	AC_TSTVP4_05	139,1,1,{ //ƒQƒtƒF“Œ
	if(AC_RANK==3 && AC_RANKTEST>=7 && AC_RANKTEST!=99){ //‘æ‚S‰Û’ö
		viewpoint 1,40,199,20,0xFFFF00;
	}
}
prt_fild00,380,249,0				script	AC_TSTVP4_05	139,1,1,{ //ƒvƒ©ª©ƒ[ƒvæ‚Åƒ^ƒbƒ`
	if(AC_RANK==3 && AC_RANKTEST>=2 && AC_RANKTEST!=99){ //‘æ‚S‰Û’ö
		viewpoint 1,152,250,20,0xFFFF00;
	}
}
prt_fild05,367,205,0				script	AC_TSTVP5_02	139,1,1,{ //ƒvƒ¼
...
prt_fild05,357,205,0				script	AC_TSTVP5_02	139,7,7,{ //ƒvƒ¼iƒ[ƒv‘Oj
...
pay_fild08,20,74,0					script	AC_TSTVP6_02	139,1,1,{ //ƒtƒFƒC“Œ
	if(AC_RANK==5 && AC_RANKTEST>=2 && AC_RANKTEST!=99){ //‘æ‚U‰Û’ö
		viewpoint 1,167,332,20,0xFFFF00;
	}
}
gef_fild00,46,199,0					script	AC_TSTVP6_04	139,1,1,{ //ƒQƒtƒFƒ““Œ
	if(AC_RANK==5 && AC_RANKTEST>=3 && AC_RANKTEST!=99){ //‘æ‚U‰Û’ö
		viewpoint 1,267,382,20,0xFFFF00;
	}
}
mjolnir_06,265,32,0					script	AC_TSTVP6_05	139,1,1,{ //ƒ~ƒ‡ƒ‹ƒj[ƒ‹ŽR–¬06
	if(AC_RANK==5 && AC_RANKTEST>=3 && AC_RANKTEST!=99){ //‘æ‚U‰Û’ö
		viewpoint 1,226,183,20,0xFFFF00;
	}
}
moc_fild12,159,378,0				script	AC_TSTVP6_07	139,1,1,{ //ƒ‚ƒƒN“ì
...
moc_fild18,158,379,0				script	AC_TSTVP6_07	139,1,1,{ //ƒ\ƒOƒ‰ƒg»”™18
	if(AC_RANK==5 && AC_RANKTEST>=4 && AC_RANKTEST!=99){ //‘æ‚U‰Û’ö
...
comodo,172,165,0		script	AC_QUEVP00_05	139,7,7,{ //ƒRƒ‚ƒh ƒAƒJƒfƒ~[ŠÖŒWŽÒƒ^ƒCƒv‚Q
...
prt_fild06,27,193,0		script	AC_QUEVP00_06	139,1,1,{
...
prt_fild02,305,22,0		script	AC_QUEVP00_07	139,1,1,{
	if(AC_QUEST_ST_0==2 && AC_QUEST_LV_0==6){		//‹C‚É‚È‚é‚ ‚ÌŽq‚U
...
moc_fild17,33,300,0		script	AC_QUEVP04_15	139,1,1,{
	if(AC_QUEST_LV_4==4 && AC_QUEST_ST_4==2) { //–`Œ¯ŽÒ‚É‚È‚è‚½‚¢‚T
		viewpoint 1,146,145,14,0x00FFFF;//ŽB‰eƒ|ƒCƒ“ƒg‚T
	}
}
moc_fild02,77,338,0		script	AC_QUEVP04_19	139,1,1,{
	if(AC_QUEST_LV_4==5 && AC_QUEST_ST_4==2) { //–`Œ¯ŽÒ‚É‚È‚è‚½‚¢‚U
		viewpoint 1,332,19,14,0x00FFFF;
	}
}
gef_fild09,368,92,0		script	AC_QUEVP04_20	139,1,1,{
	if(AC_QUEST_LV_4==6 && AC_QUEST_ST_4==2) { //–`Œ¯ŽÒ‚É‚È‚è‚½‚¢‚V
		viewpoint 1,225,25,14,0x00FFFF;
	}
}
aldebaran,134,114,0		script	AC_QUEVP04_21	139,7,7,{ 	//ƒAƒJƒfƒ~[ŠÖŒWŽÒƒ^ƒCƒv‚Q
...
aldebaran,231,107,0				script	AC_QUEVP02_02	139,1,1,{ //ƒ~ƒUƒŠ[‚ÌŒš•¨‚©‚ço‚½
	if(AC_QUEST_LV_2==0 && AC_QUEST_ST_2==2) {
		viewpoint 1,168,166,12,0xFF9900; //ƒŠƒ“ƒNƒTƒ“ƒ^
	}
}
xmas_fild01,100,100,0	script	AC_QUEVP04_22	139,1,1,{
...
xmas,149,44,0			script	AC_QUEVP04_23	139,1,1,{
	if(AC_QUEST_LV_2==0 && AC_QUEST_ST_2==2) { //‚¨¢˜b‚É‚È‚Á‚½‚ ‚Ìl‚É‚P
...
xmas_dun01,205,16,0		script	AC_QUEVP04_24	139,1,1,{
	if(AC_QUEST_LV_4==7 && AC_QUEST_ST_4==2) { //–`Œ¯ŽÒ‚É‚È‚è‚½‚¢‚W
		viewpoint 1,129,130,14,0x00FFFF;
	}
}
prt_sewb1,131,247,0		script	AC_QUEVP04_25	139,1,1,{	//ƒvƒ’n‰º…˜H‚P
	if(AC_QUEST_LV_3==1 && AC_QUEST_ST_3==2){ //	ƒ_ƒ“ƒWƒ‡ƒ“‹~o‚P
...
prt_sewb2,19,19,0		script	AC_QUEVP04_26	139,1,1,{	//ƒvƒ’n‰º…˜H‚Q
	if(AC_QUEST_LV_3==5 && AC_QUEST_ST_3==2){ //	ƒ_ƒ“ƒWƒ‡ƒ“‹~o‚R
...
prt_sewb3,180,169,0		script	AC_QUEVP04_27	139,1,1,{	//ƒvƒ’n‰º…˜H‚R
	if(AC_QUEST_LV_3==8 && AC_QUEST_ST_3==3){ //	ŽÀŒ±‚Ì‚¨Žè“`‚¢‚T
...
yuno,142,176,0					script	AC_QUEVP02_05	139,7,7,{ //ƒ}ƒbƒYƒC‚Ì‰Æ
...
lighthalzen,219,161,0			script	AC_QUEVP02_06	139,7,7,{ //ƒŠƒq ƒAƒJƒfƒ~[ŠÖŒWŽÒƒ^ƒCƒv‚Q
	if(AC_QUEST_ST_2==2 && AC_QUEST_LV_2==2){ //‚¨‰ÙŽq‚ÌÞ—¿W‚ß‚P
		viewpoint 1,51,161,12,0xFF9900;  //–Ø
	}
}
einbroch,223,182,0			script	AC_QUEVP02_07	139,7,7,{ //ƒAƒCƒ“ƒuƒƒbƒN ƒAƒJƒfƒ~[ŠÖŒWŽÒƒ^ƒCƒv‚Q
	if(AC_QUEST_ST_2==2 && AC_QUEST_LV_2==3){ //‚¨‰ÙŽq‚ÌÞ—¿W‚ß‚Q
		viewpoint 1,111,261,12,0xFF9900; //ƒhƒu
	}
}
einbech,171,137,0			script	AC_QUEVP02_08	139,7,7,{ //ƒAƒCƒ“ƒxƒt ƒAƒJƒfƒ~[ŠÖŒWŽÒƒ^ƒCƒv‚Q
	if(AC_QUEST_ST_2==2 && AC_QUEST_LV_2==4){ //‚¨‰ÙŽq‚ÌÞ—¿W‚ß‚R
		viewpoint 1,130,247,12,0xFF9900; //ƒhƒ‹ƒhƒC
	}
}
izlu2dun,107,50,0			script	AC_QUEVP02_09	139,1,1,{ //ƒoƒCƒ‰ƒ““‡
...
alb2trea,43,53,0	script	AC_QUEVP02_10	139,1,1,{ //’¾–v‘D
	if(AC_QUEST_ST_2==2 && AC_QUEST_LV_2==6){ //‚¨‰ÙŽq‚ÌÞ—¿W‚ß‚T
		viewpoint 1,105,95,12,0xFF9900; //ƒAƒCƒŠƒ“
	}
}
hugel,93,155,0	script	AC_QUEVP02_11	139,8,9,{ //ƒtƒBƒQƒ‹ ƒAƒJƒfƒ~[ŠÖŒWŽÒƒ^ƒCƒv‚Q
...
gef_fild07,336,187,0	script	AC_QUEVP03_01	139,1,1,{ //ƒQƒtƒFƒ“¼
	if(AC_QUEST_LV_3==0 && AC_QUEST_ST_3==3){ //	ŽÀŒ±‚Ì‚¨Žè“`‚¢‚P
		viewpoint 1,185,249,13,0x00FF00;
	}
}
moc_pryd01,192,9,0	script	AC_QUEVP03_03	139,1,1,{ //ƒsƒ‰ƒ~ƒbƒh’nã1F
	if(AC_QUEST_LV_3==2 && AC_QUEST_ST_3==3){ //ŽÀŒ±‚Ì‚¨Žè“`‚¢‚Q
		viewpoint 1,193,193,13,0x00FF00; //ƒ‰ƒCƒ‰ƒC‘
	}
}
iz_dun00,168,168,0	script	AC_QUEVP03_05	139,1,1,{ //ŠC’ê“´ŒA1‘w
	if(AC_QUEST_LV_3==3 && AC_QUEST_ST_3==2){//	ƒ_ƒ“ƒWƒ‡ƒ“‹~o‚Q
...
iz_dun01,253,252,0	script	AC_QUEVP03_06	139,1,1,{ //ŠC’ê“´ŒA2‘w
	if(AC_QUEST_LV_3==7 && AC_QUEST_ST_3==2){//	ƒ_ƒ“ƒWƒ‡ƒ“‹~o‚S
		viewpoint 1,129,79,13,0x00FF00;	//ƒU[ƒpƒt
	}
}
pay_arche,81,22,0	script	AC_QUEVP03_07	139,1,1,{ //‹|Žè‘º“ü‚èŒû
	if(AC_QUEST_LV_3==4 && AC_QUEST_ST_3==3){//	ŽÀŒ±‚Ì‚¨Žè“`‚¢‚R
		viewpoint 1,36,131,13,0x00FF00;	// ƒtƒFƒCƒˆƒ“ƒ_ƒ“ƒWƒ‡ƒ“
	}
}
pay_dun00,21,183,0	script	AC_QUEVP03_08	139,1,1,{ //ƒtƒFƒCƒˆƒ“ƒ_ƒ“ƒWƒ‡ƒ“
	if(AC_QUEST_LV_3==4 && AC_QUEST_ST_3==3){//	ŽÀŒ±‚Ì‚¨Žè“`‚¢‚R
