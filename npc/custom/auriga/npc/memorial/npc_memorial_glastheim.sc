	...
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		...
		if(OLDGLAST_QUE >= 1) {
			...
			if(select("急ぐ","会話をする") == 1) {
				...
				mes "ヒメルメズの事を知らせろ。";
				mes "私もすぐに向かう！";
				npctalk  "バルムント : 急げ！　ハインリヒ卿の所に行って ヒメルメズの事を知らせろ。私もすぐに向かう！";
				close2;
		...
		mes "協力者というのは君なのか？";
		npctalk  "バルムント : ヘリコがよこした協力者というのは君なのか？";
		next;
		mes "‐ヘリコという人物がよこした";
		mes "　協力者を待っているようだ。";
		mes "　ヘリコという人物は知らないが";
		...
		mes "賢者バルムント様に会ってみろと";
		mes "言っていました。";
		npctalk strcharinfo(0)+" : あ、ははは、ヘリコさんが賢者バルムント様に会ってみろと言っていました。";
		next;
		cutin "GL_BARMUND2",2;
		mes "[バルムント]";
		mes "そうか。早速で悪いが時間がない。";
		...
		mes "ついて話さなければならないのだ。";
		npctalk  "バルムント : そうか。早速で悪いが時間がない。ハインリヒ卿にヒメルメズの侵略について話さなければならないのだ。";
		next;
		menu "ヒメルメズ？",-;
		mes "["+strcharinfo(0)+"]";
		mes "ヒメルメズとは誰ですか？";
		npctalk strcharinfo(0)+" : ヒメルメズとは誰ですか？";
		next;
		cutin "GL_BARMUND3",2;
		mes "[バルムント]";
		mes "ヘリコはそんなことも";
		mes "教えてくれなかったのか？";
		npctalk  "バルムント : ヘリコはそんなことも教えてくれなかったのか？";
		next;
		cutin "GL_BARMUND2",2;
		mes "[バルムント]";
		...
		npctalk  "バルムント : 死人を治める者、亡者のヴァルキリー。彼女は今ここに隠してあるユミルの心臓を手に入れるつもりだ。";
		next;
		mes "[バルムント]";
		mes "おそらく、目的の為ならこの城ごと";
		mes "破壊してしまうだろう。";
		npctalk  "バルムント : おそらく、目的の為ならこの城ごと破壊してしまうだろう。";
		next;
		mes "[バルムント]";
		mes "急げ！　ハインリヒ卿の所に行って";
		mes "ヒメルメズの事を知らせろ。";
...
OnTalk1:
	npctalk  "バルムント : 冗談ではありません、ハインリヒ卿。私の考えが正しければ、もうすぐ彼女がここに来るはずです。";
	end;
OnTalk2:
	npctalk  "バルムント : 私と一緒に来たこの者は信用できる人物です。ヒメルメズがここにあるユミルの心臓の欠片を手に入れる前に、安全な場所に隠さなければなりません。";
	end;
OnTalk3:
	npctalk  "バルムント : 貴様、いつの間に！";
	end;
OnTalk4:
	npctalk  "バルムント : ハインリヒ卿、お気をたしかに。彼らはすでに魔物化しています。彼らに安息を与えてやるのが司令官の務めです。";
	end;
OnTalk5:
	npctalk  "バルムント : 彼らはもう、人間には戻れないのです。";
	end;
OnTalk6:
	npctalk  "バルムント : 今は君の力が必要だ。よろしく頼む。";
	end;
OnTalk7:
	npctalk  "バルムント : ではハインリヒ卿、急いでヒメルメズの後を追いましょう。";
	end;
}
...
1@gl_k,149,100,5	script	ハインリヒ#1	652,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		...
		mes "この城の事でバルムント様より";
		mes "言伝があります。";
		npctalk strcharinfo(0)+" : あなたがハインリヒ様ですね。この城の事でバルムント様より言伝があります。";
		next;
		cutin "GL_HEINRICH2",2;
		mes "[ハインリヒ]";
		mes "あなたは確か、バルムント様と";
		mes "一緒に来た冒険者の方ですね。";
		mes "この城の中で何か問題でも？";
		npctalk  "ハインリヒ : あなたは確か、バルムント様と一緒に来た冒険者の方ですね。この城の中で何か問題でも？";
		next;
		menu "ユミルの心臓が狙われています",-;
		mes "["+strcharinfo(0)+"]";
		mes "ヒメルメズというヴァルキリーが、";
		...
		npctalk strcharinfo(0)+" : ヒメルメズというヴァルキリーが、この城の中に隠してあるユミルの心臓の欠片を狙っています。";
		next;
		...
		mes "そんなモノがここにあるわけ";
		mes "ないじゃないですか。";
		npctalk  "ハインリヒ : ははは、冗談はやめてください。そのようなモノがここにあるわけないじゃないですか。";
		next;
		...
		mes "いくら貴方の頼みといえど……";
		mes "いや、しかし……。";
		npctalk  "ハインリヒ : これはバルムント様……。いくら貴方の頼みといえど……いや、しかし……。";
		next;
		cutin "GL_BARMUND2",2;
		mes "[バルムント]";
		mes "私と一緒に来たこの者は";
		...
		mes "信じられないかも知れませんが";
		mes "時間がありません！";
		npctalk strcharinfo(0)+" : 信じられないかも知れませんが 時間がありません！";
		next;
		cutin "GL_HEINRICH1",2;
		mes "[ハインリヒ]";
		mes "……確かに、";
		mes "この城にはユミルの心臓の欠片が";
		mes "隠されています。";
		npctalk  "ハインリヒ : ……確かに、この城にはユミルの心臓の欠片が隠されています。";
		next;
		mes "[ハインリヒ]";
		mes "ですが、国王様が不在の今、";
		mes "そのような推測だけで";
		mes "ユミルの心臓を動かすわけには";
		mes "いきません。";
		npctalk  "ハインリヒ : ですが、国王様が不在の今、そのような推測だけでユミルの心臓を動かすわけにはいきません。";
		close2;
		cutin "gl_heinrich1",255;
...
OnTalk1:
	npctalk  "女性 : あら、お邪魔だったかしら？　お客様が訪ねて来たのに、誰も気づいてくれなかったから寂しくて。";
	end;
OnTalk2:
	npctalk  "ヒメルメズ : 私の名前はリサ・カン・ヒメルメズ。死人を治める者、亡者のヴァルキリー、そう呼ばれてるみたいね。";
	end;
OnTalk3:
	npctalk  "ヒメルメズ : あなたがハインリヒ？　へぇ～、本当に今でも若い姿のままなのね。";
	end;
OnTalk4:
	npctalk  "ヒメルメズ : それに、とっても紳士的なのね。でも、あなたの主君の行方を聞いても涼しい顔をしていられるかしら？";
	end;
OnTalk5:
	npctalk  "ヒメルメズ : 気になるの？　空席の玉座を欲しがりもしないで、永々と王の帰還を待っているのね……本当に不思議な男。";
	end;
OnTalk6:
	npctalk  "ヒメルメズ : その純粋さ、嫌いじゃないわ。もっと違う場所で出逢えたら良かったのに。残念ね。";
	end;
OnTalk7:
	npctalk  "ヒメルメズ : そうね。そう……あなたのご主人は、ルーンミッドガッツ王家に招待されているのよね。";
	end;
OnTalk8:
	npctalk  "ヒメルメズ : でも変じゃない？　王が出発してからどれだけの時間が経ったかしら？";
	end;
OnTalk9:
	npctalk  "ヒメルメズ : さあね～？　ゆっくり説明してあげたいけど、私の用を終わらせないと。";
	end;
OnTalk10:
	npctalk  "ヒメルメズ : 私は紅茶をいただいてくるわ。この城に隠された最高の紅茶を……ね。";
	end;
}
...
OnTalk2:
	npctalk  "ハインリヒ : ほう、物騒な二つ名と違って美しいレディだ。ですが、ここには貴女のお気に召すような紅茶はありませんよ。";
	end;
OnTalk3:
	npctalk  "ハインリヒ : ……何だと？";
	end;
OnTalk4:
	npctalk  "ハインリヒ : 戯言を……私の主はルーンミッドガッツ王家の招待に応じただけだ。";
	end;
OnTalk5:
	npctalk  "ハインリヒ : ……貴様……王の身に何が起きた！";
	end;
OnTalk6:
	npctalk  "ハインリヒ : ……しまった！　奴はユミルの心臓の欠片がある場所を把握している！";
	end;
OnTalk7:
	npctalk  "ハインリヒ : カーリッツバーグ騎士団と白衣の騎士団は今すぐ奴を追え！";
	end;
OnTalk8:
	npctalk  "ハインリヒ : ……おい、どうした！　なぜ追わない！";
	end;
OnTalk9:
	npctalk  "ハインリヒ : ま、まさかこんなことが……私の部下たちが……あ、ありえない！";
	end;
OnTalk10:
	npctalk  "ハインリヒ : ……。";
	end;
OnTalk11:
	npctalk  "ハインリヒ : ……そうですね。すみません……。";
	end;
OnTalk12:
	npctalk  "ハインリヒ : すまない、すべて私の責任だ……。せめて安らかに眠ってくれ……。";
	end;
}
...
OnTalk1:
	npctalk  "ハインリヒ : ……バルムント様のおっしゃる通りです。悲しんでいる場合ではありません。";
	end;
OnTalk2:
	npctalk  "ハインリヒ : 冒険者の方にお願いがあります。";
	end;
OnTalk3:
	npctalk  "ハインリヒ : まだこの周辺に生存者がいるかもしれません。生存者を探して助けてあげて下さい。";
	end;
OnTalk4:
	npctalk  "ハインリヒ : それから……ヒメルメズは生きている人間を魔物に変える能力を持っているようです。";
	end;
OnTalk5:
	npctalk  "ハインリヒ : 魔物と化した者は、どうか……あなたの手で……";
	end;
OnTalk6:
	npctalk  "ハインリヒ : ……私は、バルムント様と共にヒメルメズの後を追います。";
	end;
}
...
1@gl_k,17,51,3	script	アコライト志望生ドムン#	706,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		mes "[アコライト志望生ドムン]";
		mes "助けて下さい！　助けて下さい！";
		npctalk  "アコライト志望生ドムン : 助けて下さい！　助けて下さい！";
		next;
		menu "大丈夫？",-;
		mes "["+strcharinfo(0)+"]";
		mes "大丈夫？";
		npctalk strcharinfo(0)+" : 大丈夫？";
		next;
		mes "[アコライト志望生ドムン]";
		mes "家令様が……修道士様が……";
		mes "みんな怪物になってしまいました。";
		mes "僕は何もできなくて……。";
		npctalk  "アコライト志望生ドムン : 家令様が……修道士様が……みんな怪物になってしまいました。僕は何もできなくて……。";
		next;
		mes "[アコライト志望生ドムン]";
		mes "ただ、ここに隠れているしか……";
		mes "何も、何もできませんでした……。";
		npctalk  "アコライト志望生ドムン : ただ、ここに隠れているしか……何も、何もできませんでした……。";
		next;
		menu "しっかりして！",-;
		mes "["+strcharinfo(0)+"]";
		mes "しっかりして！";
		...
		mes "外に出れる！";
		mes "その経路は安全だから！";
		npctalk strcharinfo(0)+" : しっかりして！　中央ホールから南に向かえば外に出れる！　その経路は安全だから！";
		next;
		mes "[アコライト志望生ドムン]";
		mes "中央ホールですか？";
		mes "ひとりで？　どうやって？";
		npctalk  "アコライト志望生ドムン : 中央ホールですか？　ひとりで？　どうやって？";
		next;
		mes "‐ふと足元を見ると";
		mes "　犠牲となった人の持ち物らしき";
		mes "　1本のメイスが転がっていた‐";
		npctalk strcharinfo(0)+" : ‐ふと足元を見ると犠牲となった人の持ち物らしき1本のメイスが転がっていた‐";
		next;
		menu "このメイスを使って",-;
		mes "["+strcharinfo(0)+"]";
		mes "このメイスを使って。";
		...
		mes "どうしてもダメなら目を閉じて";
		mes "振り回すんだ。";
		npctalk strcharinfo(0)+" : このメイスを使って。身を守るくらいには使えるはず。どうしてもダメなら目を閉じて振り回すんだ。";
		next;
		mes "[アコライト志望生ドムン]";
		mes "わかりました。";
		mes "や、やってみます。";
		npctalk  "アコライト志望生ドムン : わかりました。や、やってみます。";
		close2;
		hideonnpc;
...
1@gl_k,291,145,3	script	鍛冶屋デストロイヤー#1	726,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		...
		mes "おひとりですか？";
		mes "他の生存者はいませんか？";
		npctalk strcharinfo(0)+" : 安心して下さい！　人間です。おひとりですか？　他の生存者はいませんか？";
		next;
		mes "[鍛冶屋デストロイヤー]";
		mes "生き残ったのは私だけです……。";
		npctalk  "鍛冶屋デストロイヤー : 生き残ったのは私だけです……。";
		next;
		menu "ここは危険です",-;
		mes "["+strcharinfo(0)+"]";
		mes "ここは危険です。";
		...
		mes "身重な体のようですが……。";
		mes "動けそうですか？";
		npctalk strcharinfo(0)+" : ここは危険です。中央ホールに行く道は解りますか？　身重な体のようですが……動けそうですか？";
		next;
		mes "[鍛冶屋デストロイヤー]";
		mes "はい、動けます。";
		mes "この子の為にも私が動かなくちゃ。";
		npctalk  "鍛冶屋デストロイヤー : はい、動けます。この子の為にも私が動かなくちゃ。";
		next;
		menu "どうかご無事で",-;
		mes "["+strcharinfo(0)+"]";
		mes "無事にその子とここから";
		mes "抜け出せることを祈っています。";
		mes "共に行けなくて申し訳ありません。";
		npctalk strcharinfo(0)+" : 無事にその子とここから抜け出せることを祈っています。共に行けなくて申し訳ありません。";
		next;
		mes "[鍛冶屋デストロイヤー]";
		mes "いいえ、本当に助かりました。";
		mes "ありがとうございます。";
		npctalk  "鍛冶屋デストロイヤー : いいえ、本当に助かりました。ありがとうございます。";
		close2;
		hideonnpc;
...
OnTalk1:
	npctalk  "ヒメルメズ : ここまで辿りつくなんて、運がいいわね。それとも、それだけの力を持っていたのかしら。";
	end;
OnTalk2:
	npctalk  "ヒメルメズ : あ～ら、追いつかれちゃったわ。でも、ここまで来るのに随分苦労したみたいね～、おほほ。";
	end;
OnTalk3:
	npctalk  "ヒメルメズ : うふふ、あなたの苦しむ姿……本当に、よかったわ。ん～、でもね、楽しみはまだ始まったばかりなのよ。";
	end;
OnTalk4:
	npctalk  "ヒメルメズ : 私が一人で来たと思っているの？　おほほ、それじゃあ、あなたたちは私のオモチャと遊んでいなさい。";
	end;
OnTalk5:
	npctalk  "ヒメルメズ : では私はこれで。ハインリヒ……あなたとはもう一度会いたいわ。また機会があれば、ね。";
	end;
}
...
OnTalk1:
	npctalk  "ハインリヒ : ヒメルメズ！　貴様、ここにいたか！";
	end;
OnTalk2:
	npctalk  "ハインリヒ : よくも部下たちを……その罪、命をもって償ってもらう！";
	end;
OnTalk3:
	npctalk  "ハインリヒ : こ……これは！";
	end;
OnTalk4:
	npctalk  "ハインリヒ : 待て！　ヒメルメズ!!";
	end;
OnTalk5:
	npctalk  "ハインリヒ : 冒険者の方も力を貸して下さい。私とバルムント卿はヒメルメズを追います！";
	end;
}
...
OnTalk1:
	npctalk  "バルムント : ハインリヒ卿！　何か、強大な力がこちらに向かって来ています！";
	end;
OnTalk2:
	npctalk  "バルムント : 大丈夫か？　こちらもちょっと問題があってな……まずは私に話しかけてくれ。";
	end;
}
...
OnTalk1:
	npctalk  "ハインリヒ : ……くっ、この結界は、私の剣ではどうやっても破壊できないのか……。";
	end;
OnTalk2:
	npctalk  "ハインリヒ : むう……おお、冒険者の方。よくぞご無事で。";
	end;
OnTalk3:
	npctalk  "ハインリヒ : 結界に邪魔され、先に進むことができないのです。";
	end;
OnTalk4:
	npctalk  "ハインリヒ : そんなこと、許されるはずがないだろう！";
	end;
OnTalk5:
	npctalk  "ハインリヒ : 私はすでに多くの部下をこの手にかけた。また、罪もない者を斬れというのか！";
	end;
OnTalk6:
	npctalk  "ハインリヒ : ……。";
	end;
...
OnTalk1:
	npctalk  "バルムント : ヒメルメズの結界は、物理的なダメージを受け付けないようですね。";
	end;
OnTalk2:
	npctalk  "バルムント : ヒメルメズによって今通った階段の時空が歪められ、ここに出たのだが……。";
	end;
OnTalk3:
	npctalk  "バルムント : 私の魔法をもう1度試してみます。ハインリヒ卿、下がってください。";
	end;
OnTalk4:
	npctalk  "バルムント : 結界の一部は壊れましたが、やはりこれ以上は無理なようですね。";
	end;
OnTalk5:
	npctalk  "バルムント : 実は、以前にもこのような結界を見たことがあるのですが……";
	end;
OnTalk6:
	npctalk  "バルムント : その時、ヒメルメズはアンデッド化した人の中に埋め込んだ結界石で結界を維持していました。";
	end;
OnTalk7:
	npctalk  "バルムント : おそらく、この結界もそうやって維持されているのでしょう。";
	end;
OnTalk8:
	npctalk  "バルムント : 他の結界を壊すには彼らの中から結界石を持った者を倒すしかありません。";
	end;
OnTalk9:
	npctalk  "バルムント : しかし、私たちにはそれを見分けることはできない。つまり見かけたものすべてを浄化していくしかありません……。";
	end;
OnTalk10:
	npctalk  "バルムント : ハインリヒ卿……。";
	end;
OnTalk11:
	npctalk  "バルムント : あなたは優し過ぎます。";
	end;
OnTalk12:
	npctalk  "バルムント : 私たちが相手にする存在は、すでに人間ではありません。";
	end;
OnTalk13:
	npctalk  "バルムント : 彼らが魔物である事を否定したからといって、彼らが再び人間に戻ることはありません。";
	end;
OnTalk14:
	npctalk  "バルムント : 君も戦力を整えたら、私たちについてきてくれ。";
	end;
OnTalk15:
	npctalk  "バルムント : 東西のエリアを探索して結界石を持った魔物を倒すぞ。";
	end;
OnTalk16:
	npctalk  "バルムント : 辛い戦いになるだろうが……頼んだぞ。";
	end;
}
...
OnTalk2:
	npctalk  "ハインリヒ : ゲルハルトに何をした！　ヒメルメズ！";
	end;
OnTalk3:
	npctalk  "ハインリヒ : ヒメルメズ！　ユミルの心臓の欠片を見つけたならば、もうここに用は無いはずだ！";
	end;
OnTalk4:
	npctalk  "ハインリヒ : ゲルハルトを離せ！　これ以上の犠牲は必要ないだろう！";
	end;
OnTalk5:
	npctalk  "ハインリヒ : ヒメルメズ！　貴様、絶対に許さんぞ！";
	end;
OnTalk6:
	npctalk  "ハインリヒ : このまま逃がすとでも思っているのか！　ヒメルメズ!!";
	end;
}
...
OnTalk1:
	npctalk  "バルムント : ハインリヒ卿！　……仕方ない、残った私たちだけでアムダライスを止めなければ！";
	end;
}
...
2@gl_k,158,255,1	script	ゲルハルト#23	651,{
	...
	close;
OnTalk1:
	npctalk  "ゲルハルト : くっ！　逃げて下さい！　これ以上は耐えられません！";
	end;
OnTalk2:
	npctalk  "ゲルハルト : 司令官……急いでここから逃げ……。";
	end;
OnTalk3:
	npctalk  "ゲルハルト : どれほど私の体を汚そうとも、私の魂まで汚せると思うなよ！　ヒメルメズ！";
	end;
}
...
OnTalk1:
	npctalk  "ヒメルメズ : 素晴らしい！　ここまで来れるとは思っていなかったわ。";
	end;
OnTalk2:
	npctalk  "ヒメルメズ : ふふふ、ユミルの心臓の欠片はすでに見つけたわよ。ハインリヒ。";
	end;
OnTalk3:
	npctalk  "ヒメルメズ : 彼の邪魔さえなければもっと早かったのだけれど。";
	end;
OnTalk4:
	npctalk  "ヒメルメズ : 本当にそう思っているの？　口が達者なのは王も兵士も変わらないのね……。";
	end;
OnTalk5:
	npctalk  "ヒメルメズ : 嫌よ。";
	end;
OnTalk6:
	npctalk  "ヒメルメズ : 彼が最後の部下なんでしょう？";
	end;
OnTalk7:
	npctalk  "ヒメルメズ : 彼、かなりの腕前だったわ。";
	end;
OnTalk8:
	npctalk  "ヒメルメズ : 私の新しいアムダライスの素体にぴったりな程にね。";
	end;
OnTalk9:
	npctalk  "ヒメルメズ : あ～ら怖い。";
	end;
OnTalk10:
	npctalk  "ヒメルメズ : まあ、あなたとはもう少し話したいこともあるし、次の機会にまた会いましょう。";
	end;
OnTalk11:
	npctalk  "ヒメルメズ : けど、今は生まれ変わった部下とお喋りでもしていなさい。";
	end;
}
...
OnStart:
	hideoffnpc;
	initnpctimer;
	npctalk  "バルムントの幻影 : アムダライスが強力な魔法を使用するぞ！　私の近くまで下がれ！";
	end;
OnTimer12000:
	stopnpctimer;
	hideonnpc;
...
OnStart:
	hideoffnpc;
	initnpctimer;
	npctalk  "バルムントの幻影 : 今は攻撃のチャンスだ！　私の近くに来て強化を受けるんだ！";
	end;
OnTimer12000:
	stopnpctimer;
	hideonnpc;
...
OnStart:
	hideoffnpc;
	initnpctimer;
	npctalk  "バルムントの幻影 : アムダライスの召喚した魔物にやられる前に、私の近くに来て態勢を立て直すんだ！";
	end;
OnTimer12000:
	stopnpctimer;
	hideonnpc;
...
OnStart:
	hideoffnpc;
	initnpctimer;
	npctalk  "バルムントの幻影 : アムダライスの力にやられたくなければ、私の近くで補助を受けるんだ！";
	end;
OnTimer12000:
	stopnpctimer;
	hideonnpc;
