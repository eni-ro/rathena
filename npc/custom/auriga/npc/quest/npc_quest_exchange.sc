...
prontera,123,102,5	duplicate(NoviceExchange)	商人::NoviceExchange#0	85
geffen,173,88,5	duplicate(NoviceExchange)	商人::NoviceExchange#1	85
morocc,180,259,3	duplicate(NoviceExchange)	商人::NoviceExchange#2	85
aldebaran,152,63,5	duplicate(NoviceExchange)	商人::NoviceExchange#3	85
payon,200,134,5	duplicate(NoviceExchange)	商人::NoviceExchange#4	85


//ペリックス
//  ■ @change_jellopy

alberta,190,173,3	script	ペリックス	85,{
	if(@change_jellopy == 0) {
		mes "[ペリックス]";
		mes "なんだ、俺に何か用か？";
		mes "いくら物欲しそうな顔したって";
...
// アイテムエクスチェンジNPC
prontera,80,66,5	script	イセナ	440,{
	mes "[イセナ]";
	mes "こんにちは。";
	mes "　";
	mes "言葉…通じてますか？";
