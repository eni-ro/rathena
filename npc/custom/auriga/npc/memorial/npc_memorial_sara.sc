...
// ダンジョン生成NPC
//------------------------------------------------------------
dali,130,107,5	script	探検家レーン#sara	945,{
	...
	case 0:
		...
		mes "何か発見があるかもしれない。";
		mes "帰ったら私に話を聞かせてくれ！";
		if(!(checkquest2(15002) & 0x2) || !(checkquest2(118900) & 0x2)) {
			next;
			mes "[探検家レーン]";
			mes "次元の狭間の探検に失敗したのか？";
			mes "歪んだ次元が元に戻るまでは";
...
// ダンジョン入場NPC
//------------------------------------------------------------
dali,139,118,3	script	次元移動機#sara	10007,{
	if((Job <= Job_Dancer && Upper != UPPER_HIGH) ||
		Job == Job_Taekwon || Job == Job_StarGladiator || Job == Job_SoulLinker || BaseLevel < 85
	) {
		mes "‐このダンジョンは、";
...
// サラの記憶
//------------------------------------------------------------
1@sara,246,159,3	script	#hugin_sara1	111,5,5,{
	end;
OnTouch:
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
...
1@sara,240,145,0	warp	warp01#sara0	2,2,1@sara,94,320
1@sara,208,250,0	warp	warp12#sara1	2,2,1@sara,230,316
1@sara,226,190,0	warp	warp23#sara2	2,2,1@sara,263,94
1@sara,166,67,0		warp	warp34#sara3	2,2,1@sara,164,81
1@sara,155,180,0	script	warp45#sara4	45,2,2,{
	hideonnpc getmdnpcname("warp01#sara0");
	hideonnpc getmdnpcname("warp12#sara1");
	warp getmdmapname("1@sara"),155,196;
	end;
}

1@sara,250,155,0	script	bgmchg#sara0	139,1,1,{
	playBGM "14";
	end;
}

1@sara,107,326,0	script	bgmchg#sara1	139,10,10,{
	playBGM "37";
	end;
OnStart:
	initnpctimer;
...
1@sara,261,156,5	script	少女#sara0	668,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		mes "‐花を抱えた少女がいる。";
		mes "　褐色がかった肌の色をした少女は、";
		mes "　少しすねたような表情をしている‐";
...
1@sara,257,146,0	script	navi#sara0	139,10,10,{
OnTouch:
	viewpoint 1,240,145,1,0x00FF00;
	end;
}

1@sara,268,158,3	script	大長老アイリン#sara	684,{
	cutin "sara_elder_irine1",2;
	mes "‐大長老アイリンは";
	mes "　優しい顔でサラをみつめており";
	mes "　こちらなど眼中に";
...
1@sara,107,325,5	script	サラ・アイリン#sa1	668,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		cutin "sara_9sara1",2;
		mes "[サラ]";
		mes "あっ！";
...
1@sara,112,296,0	script	callmon_a#sara1	139,11,4,{
...
1@sara,117,225,0	script	callmon_b#sara1	139,12,2,{
...
1@sara,155,233,0	script	callmon_c#sara1	139,10,8,{
...
1@sara,177,221,0	script	callmon_d#sara1	139,2,6,{
...
1@sara,199,250,0	script	callmon_e#sara1	139,5,5,{
...
1@sara,230,316,0	script	callmon_a#sara2	139,1,1,{
	set .@mdmap$,getmdmapname("1@sara");
...
1@sara,263,94,0	script	callmon_a#sara3	139,1,1,{
	set .@mdmap$,getmdmapname("1@sara");
...
1@sara,194,63,0	script	callmon_b#sara3	139,2,5,{
...
1@sara,164,81,0	script	callmon_a#sara4	139,1,1,{
...
1@sara,155,196,0	script	callmon_a#sara300	139,{
OnStart:
	initnpctimer;
	end;
OnTimer1000:
...
OnSpawn2:
	set .@boss,callmonster(getmdmapname("1@sara"),156,228,"大長老アイリン",2542,getmdnpcname("callmon_a#sara300")+"::OnKilled");
	unittalk .@boss,"大長老アイリン : 妻の仇をとってやる！";
	end;
OnKilled:
	set .count,getmapmobs(getmdmapname("1@sara"),getmdnpcname("callmon_a#sara300")+ "::OnKilled");
	if(.count <= 0) {
		initnpctimer;
	}
	end;
...
1@sara,152,233,5	script	サラ・アイリン#sa5	668,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		cutin "sara_9sara2",2;
		mes "[サラ]";
		mes "……わからない……サラは……";
...
1@sara,156,236,3	script	大長老アイリン#sa5a	684,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		cutin "sara_elder_irine3",2;
		mes "[大長老アイリン]";
		mes "貴様は……";
...
1@sara,156,236,3	script	大長老アイリン#sa5b	684,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
		if(.flag == 1) {
			cutin "sara_elder_irine4",2;
			mes "[大長老アイリン]";
...
1@sara,88,188,0	warp	warp56#sara5	2,2,1@sara,89,175

1@sara,39,142,3	script	サラ・アイリン#sa6	668,{
	if(getpartyleader(getcharid(1)) == strcharinfo(0)) {
...
1@sara,36,144,0	script	#warp_end_sara6	139,30,5,{
OnTouch:
	compquest 15003;
	warp "dali",134,111;
	end;
...
1@sara,16,143,0	script	warp67#sara6	45,2,2,{
OnTouch:
	compquest 15003;
	warp "dali",134,111;
	end;
...
1@sara,107,252,0	script	sara_exmob1	139,3,3,{
OnTouch:
	if(.flag > 0)
		end;
	set .flag,1;
	monster getmdmapname("1@sara"),106,255,"フェイヨン警備兵#ex1sar",2543,1;
	monster getmdmapname("1@sara"),108,255,"フェイヨン警備兵#ex2sar",2543,1;
	monster getmdmapname("1@sara"),106,246,"フェイヨン警備兵#ex3sar",2543,1;
	monster getmdmapname("1@sara"),108,246,"フェイヨン警備兵#ex4sar",2543,1;
	end;
}

1@sara,82,259,0	script	sara_exmob2	139,3,3,{
OnTouch:
	if(.flag > 0)
		end;
	set .flag,1;
	monster getmdmapname("1@sara"),81,265,"フェイヨン警備兵#ex1sar",2543,1;
	monster getmdmapname("1@sara"),82,265,"フェイヨン警備兵#ex2sar",2543,1;
	monster getmdmapname("1@sara"),81,252,"フェイヨン警備兵#ex3sar",2543,1;
	monster getmdmapname("1@sara"),82,252,"フェイヨン警備兵#ex4sar",2543,1;
	end;
}
