...
//------------------------------------------------------------
//メッツの家
prontera,263,279,0	warp	signwarp1001	1,1,prt_in,227,18
prt_in,227,15,0	warp	signwarp1002	1,1,prontera,263,275
//ダンス試験場
cmd_in01,17,34,0	warp	signwarp1003	1,1,comodo,187,164
//ハワードの家
geffen,140,99,0	warp	signwarp1004	1,1,geffen_in,166,50
geffen_in,166,54,0	warp	signwarp1005	1,1,geffen,137,102
//サイオンの家
um_dun01,132,91,0	warp	signwarp1006	1,1,um_in,15,20
um_in,11,18,0	warp	signwarp1007	1,1,um_dun01,129,90
um_in,33,18,0	warp	signwarp1008	1,1,um_in,89,11
um_in,89,9,0	warp	signwarp1009	1,1,um_in,33,16
//ヴァルキリー神殿（ヒミン）
himinn,49,67,0	warp	signwarp1010	1,1,himinn,49,75
himinn,49,72,0	warp	signwarp1011	1,1,himinn,49,63
himinn,49,6,0	warp	signwarp1012	1,1,gef_fild07,179,241
//ヘルの館
que_sign01,113,132,0	warp	signwarp1013	1,1,nif_in,117,173
que_sign01,179,169,0	warp	signwarp1014	1,1,niflheim,30,156
que_sign01,179,19,0	warp	signwarp1014	1,1,niflheim,30,156
que_sign01,45,15,0	warp	signwarp1014	1,1,niflheim,146,245
//ヘルの庭
que_sign02,22,313,0	warp	signwarp1014	1,1,niflheim,30,156

//============================================================
// Monster
//------------------------------------------------------------
que_sign02,0,0,0,0	monster	エンシェントマミー	1522,8,0,0,0
que_sign02,0,0,0,0	monster	イビルドルイド		1435,8,0,0,0
que_sign02,0,0,0,0	monster	グール			1423,20,0,0,0
que_sign02,0,0,0,0	monster	インキュバス		1580,8,0,0,0
que_sign02,0,0,0,0	monster	インジャスティス	1446,8,0,0,0
que_sign02,0,0,0,0	monster	スケルプリズナー	1479,15,0,0,0
que_sign02,0,0,0,0	monster	ゾンビプリズナー	1480,15,0,0,0
que_sign02,0,0,0,0	monster	レイス			1475,15,0,0,0
que_sign02,0,0,0,0	monster	デッドリーレイス	1566,8,0,0,0
...
prontera,147,305,0	duplicate(張り紙#sign)	張り紙	111
geffen,168,175,0	duplicate(張り紙#sign)	張り紙	111
morocc,168,265,0	duplicate(張り紙#sign)	張り紙	111
payon,160,183,0	duplicate(張り紙#sign)	張り紙	111
aldebaran,54,223,0	duplicate(張り紙#sign)	張り紙	111
alberta,35,241,0	duplicate(張り紙#sign)	張り紙	111

prt_in,227,45,0	script	考古学者	804,{
	cutin "mets_alpha",2;
	switch(SIGN_QUE) {
	case 0:
		mes "[メッツ]";
...
prt_in,248,23,2	script	メイド	1275,{}
prt_in,248,23,0	script	メイド	111,{
	if(SIGN_QUE < 3) {
		mes "[イルシ]";
		mes "……";
		mes "何かご用ですか？";
...
// 第1部 - アーリアの試練
//------------------------------------------------------------
morocc_in,115,154,5	script	ローグ	810,{
	if(SIGN_QUE < 3) {
		emotion 9;
		end;
	}
...
morocc_in,114,162,4	script	青年	118,{
	if(SIGN_QUE < 11) {
		emotion 19;
		mes "[ガーナ]";
		mes "最近、暑いよなー！";
...
// 第1部 - ダイウの試練
//------------------------------------------------------------
payon_in03,11,31,4	script	ダイウ	808,{
	mes "[ダイウ]";
	mes "わっはっはっはーっ!!";
	mes "肉を持ってこい！";
	mes "楽を奏でろ!!";
...
payon_in03,13,31,4	script	下女	1416,{}
payon_in03,13,31,0	script	下女	111,{
	mes "[下女]";
...
payon_in03,8,31,4	script	下女	1416,{}
payon_in03,8,31,0	script	下女	111,{
	mes "[下女]";
	mes "この離宮の下女達が、どこかで";
	mes "見たことがある姿でも、弓や刀で";
	mes "傷つけようとしてはなりません。";
...
payon_in03,81,22,4	script	下女	1170,{}
payon_in03,81,22,0	script	下女#sign	111,{
	mes "[下女]";
	mes "いらっしゃいませ、";
	mes "ここはダイウ様がお暮らしの";
	mes "フェイヨン離宮です。";
...
payon_in03,81,15,0	script	下女	1170,{}
payon_in03,81,15,0	duplicate(下女#sign)	下女	111
payon_in03,79,22,4	script	下女	1404,{}
payon_in03,79,22,0	duplicate(下女#sign)	下女	111
payon_in03,79,15,0	script	下女	1404,{}
payon_in03,79,15,0	duplicate(下女#sign)	下女	111

//============================================================
// 第1部 - ヨルニムの試練
//------------------------------------------------------------
aldeba_in,155,101,3	script	ヨルニム	805,7,7,{
...
aldeba_in,156,118,4	script	ピルピル	102,{
...
aldeba_in,139,103,0	script	ノート	111,{
	mes "[ヨルニム]";
	mes "アアッ、触らないでください！";
	mes "私の研究日誌を、もとの場所に";
	mes "戻してください！";
...
prt_maze02,58,150,0	script	prtmazemove	139,5,5,{
OnTouch:
	...
	close2;
	switch(rand(10)) {
		default: warp "prt_maze02",11,146; break;
		case 4: 
		case 5: 
		case 6: warp "prt_maze03",55,8; break;
		case 7: 
		case 8: 
		case 9: warp "prt_maze01",62,129; break;
	}
	end;
}
prt_maze02,57,151,1	duplicate(prtmazemove)	プルレ	91

prt_maze02,18,126,0	script	prtmazewarp	139,3,3,{
	warp "prt_maze02",90,170;
	end;
}

prt_maze02,25,161,0	script	prtmazemusic	139,7,7,{
	soundeffect "assassin_of_sunset.wav",0;
	end;
}

prt_maze02,14,183,4	script	タッタ	51,{
	if(SIGN_QUE > 18) {
		mes "[タッタ]";
		mes "星明かりはささやく～";
		mes "どんなに偉い学者でも～♪";
	...
	if(SIGN_QUE < 18) {
		...
		if(select("うわー!!!!","失礼します")==1) {
			set SIGN_QUE,18;
			monster "prt_maze02",14,177,"フローラ",1118,1;
			monster "prt_maze02",17,171,"フローラ",1118,1;
			monster "prt_maze02",24,173,"フローラ",1118,1;
			monster "prt_maze02",17,175,"マリンスフィアー",1142,1;
			monster "prt_maze02",17,168,"マリンスフィアー",1142,1;
			emotion 23,"プルレ#sign";
			emotion 23;
			mes "[プルレ]";
			mes "ヤーッ!!";
...
prt_maze02,16,183,3	script	プルレ#sign	91,{
	if(SIGN_QUE < 19) {
		mes "[プルレ]";
		mes "ララル～";
		mes "ララリ～";
...
// 第1部 - ジスクリエの試練
//------------------------------------------------------------
geffen_in,59,74,4	script	ジスクリエ#sign	803,{
	if(SIGN_QUE < 20) {
		mes "[ジスクリエ]";
		mes "マスタ～～";
		mes "もう一杯～";
...
geffen_in,61,72,7	script	アロン	754,{
	switch(SIGN_QUE) {
	case 21:
		emotion 9;
		mes "[アロン]";
...
// 第1部 - ディアリースの試練
//==============================================================
cmd_in02,88,51,4	script	変な男	806,{
	if(SIGN_QUE < 25) {
		mes "[ディアリース]";
		mes "あたー、また外したか……";
		mes "ちぇっ……";
...
cmd_in01,33,25,5	script	試験官	724,{
	switch(SIGN_QUE) {
	case 30:
	case 31:
		mes "[ラマディン]";
...
cmd_in01,33,33,1	script	控室#sign	66,{
	end;
OnInit:
...
cmd_in01,0,0,0	script	SignDance	-1,{
	function StepReset {
...
OnTimer46000:
	...
	areawarp "cmd_in01",12,12,20,20,"cmd_in01",29,33;
	set .charid,0;
	set .count,0;
...
cmd_in01,16,16,0	script	SignDanceStep#1	139,1,1,{
	end;
OnTouch:
...
cmd_in01,16,11,0	duplicate(SignDanceStep#1)	SignDanceStep#2	139,1,3
cmd_in01,21,16,0	duplicate(SignDanceStep#1)	SignDanceStep#3	139,3,1
cmd_in01,16,21,0	duplicate(SignDanceStep#1)	SignDanceStep#4	139,1,3
cmd_in01,11,16,0	duplicate(SignDanceStep#1)	SignDanceStep#5	139,3,1

//==============================================================
// 第1部 - ベーカーの試練
//==============================================================
alberta_in,125,101,5	script	太っちょな商人	807,{
	if(SIGN_QUE < 35) {
		mes "[ベーカー]";
...
alberta_in,114,178,5	script	変わっている執事	109,{
	if(SIGN_QUE < 37) {
		mes "[マハト]";
		mes "ワッハッハ、";
		mes "ようこそいらっしゃいました。";
...
alberta_in,154,171,5	script	メイド	758,{
	if(SIGN_QUE < 38) {
		mes "[サイリン]";
...
alde_alche,169,162,7	script	アルケミスト	749,{
	if(SIGN_QUE < 46) {
		mes "[メルカ]";
		mes "錬金術の究極の形は";
...
prt_castle,107,58,5	script	兵士	105,{
...
alberta,98,202,5	script	警備兵	105,{
	if(SIGN_QUE > 51) {
		mes "[フルブ]";
		mes "いらっしゃいませ！";
		mes "この間から、ベーカー様のお顔が";
...
alberta,43,49,5	script	貧しそうな商人	89,{
	if(SIGN_QUE < 35) {
		mes "[マチェン]";
		mes "あぁ、どうしよう……";
		mes "私の家はどうなっちゃうんだろう……";
...
// 第2部
//------------------------------------------------------------
geffen_in,159,48,4	script	寂しそうな女性	711,{
	if(SIGN_QUE < 54) {
		mes "[ブレンダ]";
		mes "今日の夕飯は何がいいかしら？";
...
geffen_in,171,42,3	script	かわいい子供	703,{
	if(SIGN_QUE < 54) {
		emotion 28;
		mes "[リア]";
		mes "ぐすん、パパに会いたいなぁ。";
...
mjo_dun02,88,295,4	script	魂を燃やす男	85,{
...
gef_tower,118,36,4	script	怒っているウィザード	64,{
	if(SIGN_QUE != 72) {
		emotion 32;
		mes "[ドータ]";
		mes "ぶつぶつ、ぶつぶつぶつ……";
...
umbala,163,256,3	script	原住民	781,{
	if(UM_1QUE < 3) {
		mes "[？？？？]";
		mes "ウムバウムバ？";
		mes "ウムバ、ウムバ～!!";
...
um_in,152,125,5	script	気難しそうな男	121,{
	if(SIGN_QUE < 74) {
		emotion 29;
		mes "[サイオン]";
		mes "ククク、これをこのようにして……";
...
alberta,165,83,4	script	気難しそうなお爺さん	755,{
	if(SIGN_QUE < 77) {
		mes "[フランク]";
		mes "雨が降るかいな……";
...
gef_fild07,182,241,0	script	#himinnwarp	111,1,1,{
...
himinn,48,86,5	script	ヴァルキリー	811,{
	if(SIGN_QUE < 81) {
...
// 第3部
//------------------------------------------------------------
niflheim,313,70,4	script	物静かな女性	90,{
	if(SIGN_QUE < 82) {
		mes "[セリン]";
		mes "あなたは、私が探している";
		mes "人じゃない……";
...
niflheim,350,258,1	script	#呪われた魂	844,3,3,{
OnTouch:
	if((SIGN_QUE != 83 && SIGN_QUE != 90) || SIGN_SUBQUE != 0)
		end;
	killmonster "niflheim","nif_soul";
	mes "[アッシュブルース]";
	mes "お主には強い呪いを感じる!!!!";
	mes "わしはお主の存在を拒否する!!!!";
	mes "もし退かぬのなら、死を与えよう!!";
	...
	case 1:
		monster "niflheim",349,259,"ライドワード",1478,1,"nif_soul";
		mes "[アッシュブルース]";
		mes "ぐはははは!!";
		mes "むやみにわしの本を触れるからだ!!";
		mes "噛み切られ、引き裂かれるがよい!!";
	...
	case 3:
		...
		if(select("ネクタイ","ネックレス","ネロ","^FFFFFFニックト^000000")==4)
			set .@nif_soul,.@nif_soul+1;
		if(.@nif_soul < 3) {
			monster "niflheim",345,259,"オークスケルトン",1462,1,"nif_soul";
			monster "niflheim",347,261,"オークスケルトン",1462,1,"nif_soul";
			monster "niflheim",344,253,"オークスケルトン",1462,1,"nif_soul";
			monster "niflheim",346,251,"オークスケルトン",1462,1,"nif_soul";
			monster "niflheim",349,249,"オークスケルトン",1462,1,"nif_soul";
			monster "niflheim",350,260,"オークスケルトン",1462,1,"nif_soul";
			monster "niflheim",353,256,"オークスケルトン",1462,1,"nif_soul";
			mes "[アッシュブルース]";
			mes "ぐはははは!!!!";
			mes "お主、呪文が間違っているぞ!!";
			mes "お主に必要なのは死のようだな。";
...
nif_in,156,93,0	script	#少女	844,2,2,{
OnTouch:
	if(SIGN_QUE != 83) {
		emotion 28;
		mes "[アラキナ]";
...
nif_in,188,168,0	script	#魔女	844,2,2,{
OnTouch:
	switch(SIGN_QUE) {
	default:
		if(SIGN_QUE < 88) {
...
nif_in,105,81,0	script	#クレユ	844,2,2,{
OnTouch:
	switch(SIGN_QUE) {
	default:
		end;
...
niflheim,146,241,0	script	陰気な男	735,{
	if(SIGN_QUE < 80) {
		mes "[？？]";
		mes "邪魔するな!!";
		close;
...
nif_in,140,177,0	script	#スイッチ	111,{
	if(countitem(7313) == 1) {
...
que_sign01,122,141,4	script	魔女	792,{
	if(countitem(7313) == 1 && (SIGN_QUE < 124 || SIGN_QUE > 126)) {
		...
		mes "頼みます……";
		close2;
		if(@menu == 1) warp "que_sign01",195,189;
		else warp "que_sign02",35,313;
		end;
	}
	switch(SIGN_QUE) {
	case 90:
...
niflheim,102,54,4	script	威圧感のある男	739,{
	if(SIGN_QUE < 82) {
		mes "[レイキン]";
		mes "なに？　どこかで見たことあるって？";
...
gl_dun02,262,265,0	script	神秘的な気配#1	111,{
	set .@num,strnpcinfo(2);
	switch(.@num) {
...
gl_dun02,271,100,0	duplicate(神秘的な気配#1)	神秘的な気配#2	111
gl_dun02,268,32,0	duplicate(神秘的な気配#1)	神秘的な気配#3	111
gl_dun02,16,26,0	duplicate(神秘的な気配#1)	神秘的な気配#4	111
gl_dun02,42,251,0	duplicate(神秘的な気配#1)	神秘的な気配#5	111
gl_dun02,123,234,0	duplicate(神秘的な気配#1)	神秘的な気配#6	111
gl_dun02,140,72,0	duplicate(神秘的な気配#1)	神秘的な気配#7	111
gl_dun02,119,182,0	duplicate(神秘的な気配#1)	神秘的な気配#8	111

que_sign01,45,227,4	script	死者の主	856,{
	if(SIGN_QUE < 117) {
		mes "[ヘル]";
		mes "ぬしは招待されていない身で";
		mes "この我と会いに来たと申すのか？";
...
que_sign01,46,56,0	script	噴水台	111,{
	if(SIGN_QUE < 118) {
		mes "噴水だ。";
		mes "あふれ出している水は";
		mes "とてもきれいに見える。";
...
que_sign02,378,235,0	script	signwarp	45,1,1,{
	if(countitem(7313) == 1 && (SIGN_QUE < 124 || SIGN_QUE > 126)) {
...
que_sign01,0,0,0	script	SignTimer#witch	-1,{
OnTimer600000:
	areawarp "que_sign01",166,162,229,227,"niflheim",30,156;
	end;
OnTimer620000:
	killmonster "que_sign01","SignTimer#witch::OnKilled";
...
que_sign01,197,195,4	script	セリン#witch	90,{
	if(SIGN_QUE < 124) {
		emotion 9;
		mes "[セリン]";
		mes "…………";
	...
	case 125:
		...
		monster "que_sign01",196,195,"ダークロードの分身",1605,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",180,180,"エンシェントマミー",1522,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",210,210,"エンシェントマミー",1522,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",200,200,"エンシェントレイス",1475,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",200,180,"エンシェントレイス",1475,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",180,200,"腐った死体",1423,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",205,205,"腐った死体",1423,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",190,190,"腐った死体",1423,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",205,190,"腐った死体",1423,1,"SignTimer#witch::OnKilled";
		monster "que_sign01",190,205,"腐った死体",1423,1,"SignTimer#witch::OnKilled";
		hideonnpc;
		end;
	case 126:
		mes "[セリン]";
...
que_sign01,0,0,0	script	SignTimer#serin	-1,{
OnTimer600000:
	areawarp "que_sign01",166,12,229,77,"niflheim",30,156;
	end;
OnTimer620000:
	killmonster "que_sign01","SignTimer#serin::OnKilled";
...
que_sign01,196,39,4	script	セリン#serin	90,{
	if(SIGN_QUE < 132) {
		mes "[セリン]";
		mes "……？";
		close;
	...
	case 133:
		...
		hideonnpc;
		hideonnpc "ダークロード#serin";
		monster "que_sign01",196,44,"ダークロードの分身",1605,1,"SignTimer#serin::OnKilled";
		end;
	case 134:
		mes "[セリン]";
		mes "……これが、私のしようと";
...
que_sign01,196,39,4	script	セリン#dummy	90,{
	end;
OnInit:
	hideonnpc;
	end;
...
que_sign01,196,44,4	script	ダークロード#serin	737,{
	end;
OnInit:
	hideonnpc;
	end;
...
geffen,119,48,0	script	噴水台	111,{
	if(countitem(7025) < 1) {
		mes "噴水台がある。";
		close;
	}
...
geffen,119,55,0	script	GefeniaWarp	45,1,1,{
OnTouch:
	//switch(rand(4)) { //旧仕様
	switch(.rand) {
		case 0: warp "gefenia01",58,169; break;
		case 1: warp "gefenia02",116,115; break;
		case 2: warp "gefenia03",130,206; break;
		case 3: warp "gefenia04",133,88; break;
	}
	end;
OnInit:
	hideonnpc;
