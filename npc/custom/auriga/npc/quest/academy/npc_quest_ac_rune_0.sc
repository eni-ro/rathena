...
//                                                 by Pneuma
//気になるあの子   -------------------------------------------
prontera,146,232,4	script	ハルバード#AC_QUE00H01	48,{
...
izlude_in,108,55,4		script	店員#AC_QUE02	951,{
	mes "[マリアン]";
	mes "いらっしゃいませ！";
...
moc_ruins,114,100,4		script	スザンヌ#AC_QUE00SZ01	90,{
...
moc_ruins,116,100,4		script	宝石商#AC_QUE00	47,{
	if(AC_QUEST_LV_0==2 && (AC_QUEST_ST_0==2 || AC_QUEST_ST_0==3)) callfunc "宝石商FUNC#AC_QUE00";
	mes "[リューク]";
	mes "私、宝石商を営んでいる";
	mes "リュークと申します。";
...
geffen_in,113,104,4		script	スザンヌ#AC_QUE00SZ02	90,{
	if(AC_QUEST_LV_0==3){
		switch(AC_QUEST_ST_0){
		case 2:
			mes "‐スザンヌが医者らしき";
...
geffen_in,113,101,4		script	医者#AC_QUE00	121,{
	if(AC_QUEST_LV_0==3){
		switch(AC_QUEST_ST_0){
		case 2:
			mes "‐スザンヌが医者に話しかけている‐";
...
payon_in01,6,55,4		script	指輪職人#AC_QUE00	901,{
	if(AC_QUEST_LV_0==4){
		switch(AC_QUEST_ST_0){
		case 1:
			mes "[ジェラルド]";
...
comodo,165,163,4		script	スザンヌ#AC_QUE00SZ03	90,{
...
comodo,168,163,4		script	ノエリア#AC_QUE00	724,{
	if(AC_QUEST_LV_0==9) goto L_CLEAR;
	if(AC_QUEST_LV_0==5 && AC_QUEST_ST_0==2) callfunc "ノエリアFUNC#AC_QUE00";
	if(AC_QUEST_LV_0==5 && AC_QUEST_ST_0==3) {
		mes "[ノエリア]";
...
prt_monk,138,168,4		script	ハルバード#AC_QUE00H02	48,{
	set .@novice, callfunc("AC_GetNovice");
...
prt_monk,232,86,4		script	スザンヌ#AC_QUE00SZ03	90,{
	if(AC_QUEST_LV_0!=6) goto L_OTHER;
	switch(AC_QUEST_ST_0){
	case 3:
		emotion 28;
...
izlude,137,156,4		script	スザンヌ#AC_QUE00SZ04	90,{
	switch(AC_QUEST_LV_0){
	case 7:
		goto L_QUEST08;
	case 8:
...
rachel,148,190,4		script	スザンヌ#AC_QUE00SZ05	90,{
	if(AC_QUEST_LV_0==9) goto L_CLEAR;
...
veins,151,330,4			script	スザンヌ#AC_QUE00SZ06	90,{
	set .@novice, callfunc("AC_GetNovice");
	if(AC_QUEST_LV_0!=8) goto L_OTHER;
	switch(AC_QUEST_ST_0) {
	case 3:
...
veins,148,329,4		duplicate(スザンヌ#AC_QUE00SZ06)	ハルバード#AC_QUE00H03	48
