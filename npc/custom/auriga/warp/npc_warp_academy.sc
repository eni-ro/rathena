...
ac_cl_area,71,74,0	script	#教室棟2F_warp1	45,1,1,{/* 52554 */
...
ac_cl_area,71,14,0	script	#教室棟2F_warp2	45,1,1,{/* 52555 */
	if(!(AC_HINT_01 & 0x1) && Job!=Job_Summoner){
		mes "[インフォメーション]";
		mes "‐この先は^FF0000教室棟1F^000000です‐";
		mes "‐このまま進みますか？‐";
...
ac_cl_room,152,18,0	script	#自習室_warp1	45,1,1,{/* 52556 */
...
ac_cl_area,30,185,0	script	#教室棟1F_warp1	45,1,1,{/* 52557 */
...
ac_cl_area,35,176,0	script	#教室棟1F_warp2	45,1,1,{/* 52558 */
...
ac_cl_area,35,133,0	script	#教室棟1F_warp3	45,1,1,{/* 52559 */
	if(Job == Job_Summoner) {
		mes "[インフォメーション]";
		mes "‐ドラム族はこの先に";
		mes "　進むことができません‐";
...
ac_cl_area,30,125,0	script	#教室棟1F_warp4	45,1,1,{/* 52560 */
...
ac_cl_area,76,156,0	script	#教室棟1F_warp5	45,1,1,{/* 52561 */
...
ac_cl_hall,167,72,0	script	#教室ホール_warp1	45,1,1,{/* 52562 */
...
ac_cl_hall,167,19,0	script	#教室ホール_warp5	45,1,1,{/* 52563 */
...
ac_en_hall,54,13,0	script	#入り口_warp1	45,1,1,{/* 52564 */
...
ac_en_hall,97,7,0	script	#入り口_warp2	45,1,1,{/* 52565 */
	switch(AC_SAVE_MAP){
...
ac_en_hall,143,13,0	script	#入り口_warp3	45,1,1,{/* 52566 */
