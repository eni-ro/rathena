...
// Shop
//------------------------------------------------------------
moro_vol,95,96,6	shop	道具商人	553,717:-1,611:-1,504:-1,525:-1,610:-1,645:-1,656:-1,657:-1,601:-1,602:-1,1065:-1

//============================================================
// 案内要員
//------------------------------------------------------------
moro_vol,144,140,3	script	案内兵	469,{
	mes "[案内兵]";
	mes "魔王モロクを倒そうと、";
	mes "このフレイムヴァレーに";
	mes "人間、サファ族、ラフィネ族が";
...
moro_vol,91,105,1	script	次元移動機	10007,{
	mes "[ドフィ]";
	mes "それはエクラージュに";
	mes "繋がっている次元移動機です。";
	mes "この作戦が終われば破棄される";
...
moro_vol,88,107,5	script	魔学者ドフィ	440,{
	mes "[ドフィ]";
	mes "……ほう。";
	mes "人間ですか。";
...
moro_vol,104,86,3	script	リョースン	748,{
	mes "[リョースン]";
	mes "き、緊……緊張してます。";
	mes "……事務官殿は何故";
	mes "私なんかに騎士団の方を……。";
...
moro_vol,110,83,3	script	ヒュー	868,{
	mes "[ヒュー]";
	mes "ついにはここまで";
	mes "辿りついてしまいましたね。";
	mes "まあ、正直な話、";
...
moro_vol,118,86,5	script	ヘンジヌ	931,{
	mes "[ヘンジヌ]";
	mes "予想を裏切られるどころか";
	mes "予想以上に素晴らしい！";
	mes "この体に悪そうな空気とか!";
...
moro_vol,119,106,3	script	教官ジャケン#h_sol01	405,3,3,{
	mes "[教官ジャケン]";
	mes "アッシュバキューム遠征に";
	mes "申し込んだとき、";
	mes "いつかこのような日が";
...
moro_vol,105,97,3	script	遠征隊アサシン#ass01	884,{
	mes "[遠征隊アサシン]";
	mes "……間もなく";
	mes "新しい任務が下る予定だ……。";
	mes "我らの目的は魔王の";
...
moro_vol,103,96,5	script	遠征隊アサシン#ass02	885,{
	mes "[遠征隊アサシン]";
	mes "……ここは……そうだな……。";
	mes "私のルートの追加しよう……。";
	next;
...
moro_vol,105,95,1	script	遠征隊アサシン#ass03	10002,{
	mes "[遠征隊アサシン]";
	mes "………。";
	mes "………いや俺は新入りだから。";
	mes "先輩の話を聞いているだけだよ。";
...
moro_vol,87,104,5	script	魔学者コンパーナ#143vol	446,{
	mes "[コンパーナ]";
	mes "なんとか派遣員として";
	mes "ここまでは来ましたけど……";
	mes "想像以上ですね！";
...
moro_vol,88,102,6	script	魔学者マキア#143vol03	444,{
	mes "[マキア]";
	mes "始めて見る生態系ですね。";
	mes "すごく熱そうに見えて意外と";
	mes "熱くもないし……";
...
moro_vol,106,111,3	script	戦場指揮官#sol10	447,3,3,{
	mes "[ラフィネ指揮官]";
	mes "本格的な戦闘を前に";
	mes "部隊を整備中である。";
	mes "邪魔になるので立ち去るように。";
...
// 守護者
//------------------------------------------------------------
moro_vol,86,167,7	script	前線基地・守護者#1	415,3,3,{
	mes "[前線基地・守護者]";
...
moro_vol,93,166,7	duplicate(前線基地・守護者#1)	前線基地・守護者#2	414,3,3
moro_vol,100,165,7	duplicate(前線基地・守護者#1)	前線基地・守護者#3	413,3,3
moro_vol,107,164,7	duplicate(前線基地・守護者#1)	前線基地・守護者#4	419,3,3
moro_vol,114,162,7	duplicate(前線基地・守護者#1)	前線基地・守護者#5	420,3,3
moro_vol,121,160,7	duplicate(前線基地・守護者#1)	前線基地・守護者#6	418,3,3
moro_vol,128,158,7	duplicate(前線基地・守護者#1)	前線基地・守護者#7	415,3,3
moro_vol,135,155,7	duplicate(前線基地・守護者#1)	前線基地・守護者#8	414,3,3
moro_vol,142,152,7	duplicate(前線基地・守護者#1)	前線基地・守護者#9	413,3,3
moro_vol,149,148,7	duplicate(前線基地・守護者#1)	前線基地・守護者#10	419,3,3
moro_vol,156,144,7	duplicate(前線基地・守護者#1)	前線基地・守護者#11	420,3,3
moro_vol,162,137,6	duplicate(前線基地・守護者#1)	前線基地・守護者#12	418,3,3
moro_vol,168,130,6	duplicate(前線基地・守護者#1)	前線基地・守護者#13	415,3,3
moro_vol,174,123,6	duplicate(前線基地・守護者#1)	前線基地・守護者#14	414,3,3
moro_vol,178,116,6	duplicate(前線基地・守護者#1)	前線基地・守護者#15	413,3,3
moro_vol,182,109,6	duplicate(前線基地・守護者#1)	前線基地・守護者#16	419,3,3
moro_vol,185,102,6	duplicate(前線基地・守護者#1)	前線基地・守護者#17	420,3,3
moro_vol,187,95,6	duplicate(前線基地・守護者#1)	前線基地・守護者#18	418,3,3
moro_vol,189,88,6	duplicate(前線基地・守護者#1)	前線基地・守護者#19	415,3,3
moro_vol,191,81,6	duplicate(前線基地・守護者#1)	前線基地・守護者#20	414,3,3
...
moro_vol,100,183,1	script	駐屯地 番卒#bl0	417,3,3,{
	mes "[駐屯地 番卒]";
	mes "ここは危険地域です。";
	mes "勝手に歩き回っては";
	mes "困ります。";
...
moro_vol,102,188,1	script	駐屯地 番卒#bl1	417,3,3,{
	mes "[駐屯地 番卒]";
	mes "ここは危険地域です。";
	mes "勝手に歩き回っては";
	mes "困ります。";
...
moro_vol,104,193,1	script	駐屯地 番卒#bl2	417,3,3,{
	mes "[駐屯地 番卒]";
	mes "ここは危険地域です。";
	mes "勝手に歩き回っては";
	mes "困ります。";
...
moro_vol,95,182,1	script	駐屯地 番卒#bl3	417,3,3,{
	mes "[駐屯地 番卒]";
	mes "ここは危険地域です。";
	mes "勝手に歩き回っては";
	mes "困ります。";
...
moro_vol,90,181,7	script	駐屯地 番卒#bl4	417,3,3,{
	mes "[駐屯地 番卒]";
	mes "ここは危険地域です。";
	mes "勝手に歩き回っては";
	mes "困ります。";
...
// FVOL_1QUE -> 0～18、100
//------------------------------------------------------------
morocc,138,238,4	script	倒れている男性#ep14bs	849,{
	switch(FVOL_1QUE) {
	case 0:
...
moc_ruins,106,140,4	script	タマリン#ep14bs_ru	10027,{
	switch(FVOL_1QUE) {
	case 5:
		cutin "ep143_tasmi",2;
		mes "[タマリン]";
...
dali,112,69,4	script	タマリン#ep14bs_cha	10027,{
	switch(FVOL_1QUE) {
	case 7:
		cutin "ep143_tasmi",2;
		mes "[タマリン]";
...
dali,64,98,0	script	ひび#ep14bs	550,{
	switch(FVOL_1QUE) {
	case 8:
		mes "‐この場所には似合わない";
		mes "　ひびがある‐";
...
moro_vol,137,136,0	script	ひび	550,{
	mes "‐この場所には似合わない";
	mes "　ひびがある‐";
	next;
...
moro_vol,132,140,4	script	タマリン#ep14bs_ju	10027,{
	...
	case 9:
		...
		mes "いるかもしれません！";
		next;
		if(checkquest2(200875)) {	// 三ヶ国への報告書クエスト？
...
moro_vol,142,131,5	script	バゼット#ep14bs	883,{
	...
	case 10:
		...
		close;
	case 11:
		if(checkquest2(11355)&0x4 == 0 || countitem(6689) == 0) {
			mes "[バゼット]";
			mes "まずは虫の標本を集めてください。";
			mes "この地域では変形している生物が";
			mes "たくさん見つかっていますが、";
...
moro_vol,198,179,4	script	タマリン#ep14bs_st	10027,{
...
moro_cav,64,13,0	warp	#ep14_3洞窟出口	1,1,moro_vol,198,176

moro_vol,105,71,5	script	ルーゲン教官#ep14bs	405,{
...
moro_vol,104,70,4	script	中毒になった患者	887,{
	if(FVOL_1QUE > 16) {
		mes "[中毒になった患者]";
		mes "ふぅ……ふぅ……。";
		next;
...
moro_vol,101,72,4	script	患者	585,{
	mes "[患者]";
	mes "う……ううう……";
	close;
}

moro_vol,101,74,4	script	患者	441,{
	mes "[患者]";
	mes "くううう……";
	close;
}

moro_vol,103,71,6	script	患者	584,{
	mes "[患者]";
	mes "くう……うう……";
	close;
}

moro_vol,106,69,4	script	患者	585,{
	mes "[患者]";
	mes "ああ……う……";
	close;
}
...
// FVOL_2QUE -> 0～13
//------------------------------------------------------------
moro_vol,131,103,3	script	駐屯地調査官#bl	419,{
	...
	case 4:
		...
		close;
	case 5:
		if(!(checkquest2(1268) & 0x4) || !(checkquest2(1269) & 0x4)) {
			mes "[駐屯地調査官]";
			mes "急いでください。";
			mes "こうしている間にも";
			mes "モンスター達は増えています。";
...
moro_vol,234,301,3	script	偵察兵#bl	413,{
...
moro_vol,91,197,3	script	滅亡祝福教団教主#bl	10021,{
...
moro_vol,95,195,3	script	滅亡祝福教団副教主#bl	10022,{
	switch(FVOL_2QUE) {
	case 10:
		mes "[滅亡祝福教団副教主]";
		mes "滅亡祝福教団信者達よ！";
...
moro_vol,85,196,7	script	滅亡祝福教団信者#bl1	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "滅亡！　祝福！";
		mes "滅亡！　祝福！";
...
moro_vol,87,193,7	script	滅亡祝福教団信者#bl2	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "亡！　亡！　滅亡滅亡！";
		mes "福！　福！　私だけ祝福！";
...
moro_vol,90,191,7	script	滅亡祝福教団信者#bl3	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "滅亡！　祝福！";
		mes "滅亡！　祝福！";
...
moro_vol,93,189,7	script	滅亡祝福教団信者#bl4	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "亡！　亡！　滅亡滅亡！";
		mes "福！　福！　私だけ祝福！";
...
moro_vol,83,193,7	script	滅亡祝福教団信者#bl5	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "滅亡！　祝福！";
		mes "滅亡！　祝福！";
...
moro_vol,86,190,7	script	滅亡祝福教団信者#bl6	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "滅亡！　祝福！";
		mes "滅亡！　祝福！";
...
moro_vol,89,188,7	script	滅亡祝福教団信者#bl7	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "亡！　亡！　滅亡滅亡！";
		mes "福！　福！　私だけ祝福！";
...
moro_vol,93,185,7	script	滅亡祝福教団信者#bl8	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "滅亡！　祝福！";
		mes "滅亡！　祝福！";
...
moro_vol,81,197,7	script	滅亡祝福教団信者#bl9	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "亡！　亡！　滅亡滅亡！";
		mes "福！　福！　私だけ祝福！";
...
moro_vol,84,201,5	script	滅亡祝福教団信者#bl0	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "滅亡！　祝福！";
		mes "滅亡！　祝福！";
...
moro_vol,97,187,5	script	滅亡祝福教団信者#bl11	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "亡！　亡！　滅亡滅亡！";
		mes "福！　福！　私だけ祝福！";
...
moro_vol,82,189,7	script	滅亡祝福教団信者#bl12	10023,{
	if(FVOL_2QUE < 12) {
		mes "[滅亡祝福教団信者]";
		mes "おお、滅亡の神よ！";
		mes "早く、この私に滅亡を！";
...
// デイリークエストNPC
//------------------------------------------------------------
moro_vol,95,108,7	script	ヒシエ#143hisie01	623,{
	if(ECL_3QUE < 33) {	// エクラージュの王
		if(checkquest2(201730)) {	// 魔神殿攻略済み？
			cutin "hisie01",2;
			mes "[ヒシエ]";
			mes "果してここで";
			mes "魔王の実体を探し出すことが";
...
moro_vol,94,110,5	script	守護者ニーズヘッグ#143n	510,{
	if(checkquest2(201730)) {	// 魔神殿攻略済み？
		mes "[守護者ニーズヘッグ]";
		mes "不思議です……。";
		mes "私は確かに彼の者を";
...
moro_vol,97,110,3	script	ロキ#1432loki01	512,{
	cutin "ep14_roki01",2;
	mes "[ロキ]";
	mes "これはまだ前哨戦だ。";
	mes "あいつの真の姿が現れた時。";
...
moro_vol,98,107,3	script	魔学者#143avt01	618,{
	if(ECL_3QUE < 33) {	// エクラージュの王
		cutin "avant01",1;
		mes "[魔学者]";
		mes "……邪魔だ。";
	...
	case 1:
		if(checkquest2(7581) == 0) {	// 変異した現身退治受注
			cutin "avant01",1;
			mes "[エイヴァント]";
			mes "……ふん、極小の魔力でも";
			mes "あのような運用が可能とはな……。";
...
moro_vol,108,88,5	script	司令官アジフ#14301	459,{
	cutin "ep13_captin_edq",2;
	if(checkquest2(116545)) {
		mes "[司令官アジフ]";
		mes "どうした？";
		mes "魔王モロクはいたか？";
		mes "もし奴を倒すことができたのなら";
	...
	if(checkquest2(201720) && checkquest2(201725)) {	// ビオスの島、モルスの洞窟クリア済み
		mes "[司令官アジフ]";
		mes "ちょうど良いところに来たな。";
		mes "あの暗い洞窟に道が";
		mes "できたらしい。";
...
moro_vol,110,90,3	script	参謀アビダル#14302	755,{
	if(checkquest2(7599)) {
		if(checkquest2(7599)&0x2 == 0) {
			mes "[アビダル]";
			mes "ご苦労様でした。";
			mes "すこし休んでください。";
			next;
	...
	if(checkquest2(96435)&4 || checkquest2(96436)&4 || checkquest2(96437)&4 || checkquest2(96438)&4) {
		mes "[アビダル]";
		...
		mes "ゆっくり体を休めてください。";
		setquest 7599;
		if(checkquest2(96435)&4) {
			delquest 96435;
			set .@gain[0],1;
		}
		if(checkquest2(96436)&4) {
			delquest 96436;
			set .@gain[2],.@gain[2]+1;
		}
		if(checkquest2(96437)&4) {
			delquest 96437;
			set .@gain[1],.@gain[1]+1;
			set .@gain[2],.@gain[2]+1;
		}
		if(checkquest2(96438)&4) {
			delquest 96438;
			set .@gain[2],.@gain[2]+1;
		}
		if(.@gain[0]) {
...
moro_vol,111,87,1	script	教官長イグリド#14303	751,{
	if(checkquest2(7582)) {
		if(checkquest2(7582)&0x2 == 0) {
			mes "[イグリド]";
			mes strcharinfo(0)+ "か。";
			mes "あの強力な現身のことだが、";
			mes "おまえにだけ任せるわけには";
...
moro_vol,136,84,3	script	大臣ヘスランタ#ep143	451,{
	switch(FVOL_4QUE) {
	case 0:
		if(DIC_2QUE < 23) {
	...
	case 2:
		if(checkquest2(7578)&0x4 == 0 || countitem(6392) == 0) {
			cutin "ep13_heslanta",2;
			mes "[ヘスランタ]";
	...
	case 3:
		if(checkquest2(7579)&0x4 == 0 || countitem(6392) < 10) {
			cutin "ep13_heslanta",2;
			mes "[ヘスランタ]";
			mes "暴虐の箱はそんなに";
			mes "危険ではないですが……";
...
moro_vol,134,83,5	script	ビハヌス#ep143	451,{
	mes "[ビハヌス]";
	mes "あなたもここに来ましたか。";
	mes "……そういえばここでは";
	mes "指輪の力が無くても";
...
moro_vol,138,84,3	script	補佐官ティエラ#ep143	453,{
	mes "[ティエラ]";
	mes "ディエルにいた多くの";
	mes "ゼルートとニットは、";
	mes "ヘスランタ様の主張を";
...
moro_vol,134,87,1	script	先発隊長アバランチェ#ep	450,{
	mes "[アバランチェ]";
	mes "例え数は少なくとも";
...
moro_vol,131,86,1	script	ガルトン#gal01	492,{
	mes "[ガルトン]";
	mes "戦闘はいつだ！";
	mes "いつ始まるのか！";
	next;
...
moro_vol,138,87,7	script	ガルトン#gal02	492,{
	mes "[ガルトン]";
	mes "我が任務は";
	mes "ゼルート・ヘスランタ様の護衛。";
	mes "ここから立ち去るがいい。";
...
moro_vol,140,97,1	script	精鋭部隊#gal11	492,{}
moro_vol,143,97,1	script	精鋭部隊#gal12	492,{}
moro_vol,146,97,1	script	精鋭部隊#gal13	492,{}
moro_vol,140,94,1	script	精鋭部隊#gal14	450,{}
moro_vol,143,94,1	script	精鋭部隊#gal15	450,{}
moro_vol,146,94,1	script	精鋭部隊#gal16	450,{}

moro_vol,150,86,1	script	精鋭部隊#gal21	492,{}
moro_vol,153,86,1	script	精鋭部隊#gal22	492,{}
moro_vol,156,86,1	script	精鋭部隊#gal23	492,{}
moro_vol,150,83,1	script	精鋭部隊#gal24	450,{}
moro_vol,153,83,1	script	精鋭部隊#gal25	450,{}
moro_vol,156,83,1	script	精鋭部隊#gal26	450,{}

moro_cav,34,65,5	script	バンズ#morocav	49,{
	if(!(checkquest2(116510) & 0x8)) {
		mes "[バンズ]";
		mes "君、もしかして、";
		mes "ここにいるという事は……";
		mes "モロク討伐へ向かう冒険者だな！";
	...
	case 3:
		...
		next;
		switch(select(
				(getequipid2(7)!=0? "^nItemID^" +getequipid2(7): "アクセサリー[1]‐装備していない"),
				(getequipid2(8)!=0? "^nItemID^" +getequipid2(8): "アクセサリー[2]‐装備していない"))
		) {
		case 1: set .@itemid,getequipid2(7); set .@menu,7; break;
		case 2: set .@itemid,getequipid2(8); set .@menu,8; break;
		}
		if(.@itemid == 0) {
			mes "[バンズ]";
			mes "エンチャントをしたい場合は、";
	...
	case 4:
		...
		next;
		if(!checkquest2(116513) && !checkquest2(116514) && countitem(6684) < 3) {
			mes "[バンズ]";
			mes "残念だが君は勇者の証が";
			mes "足りないようだな。";
			close;
		...
		case 1: set .@itemid,getequipid2(7); set .@menu,7; set .@str$,"左"; break;
		case 2: set .@itemid,getequipid2(8); set .@menu,8; set .@str$,"右"; break;
		}
		if(.@itemid == 0) {
			mes "[バンズ]";
			mes "エンチャントをしたい場合は、";
		...
		if(checkquest2(116513) || checkquest2(116514)) {
			mes "[バンズ]";
			mes "おや、君は無料で初期化を";
			mes "することができるようだね。";
			while(1) {
				mes "どちらを使用して、";
				mes "初期化するんだい？";
				if(checkquest2(116513))
					set .@str1$,"黄色い種完了";
				else
					set .@str1$,"黄色い種完了(未達成)";
				if(checkquest2(116514))
					set .@str2$,"赤い花完了";
				else
					set .@str2$,"赤い花完了(未達成)";
				next;
...
moro_cav,32,73,5	script	チェイコ#1	482,{
	mes "[チェイコ]";
...
moro_cav,36,57,5	script	先遣隊兵士#moro	707,{
...
moro_vol,0,0,0	script	moro_vol_mon	-1,{
OnTimer10000:
	...
	set .@dummy,getmapxy(.@map$,.@x,.@y,BL_NPC,.mob2);
	if(.@x < 277-15 || .@x > 277+15 || .@y < 238-15 || .@y > 238+15) {
		set .mob2call,1;
		unittalk .mob2,"あの方の命令だ。持ち場へ戻らなければ……。";
	}
	set .@dummy,getmapxy(.@map$,.@x,.@y,BL_NPC,.mob3);
...
OnTimer15000:
	if(.mob1dead > 0) {
		...
		if(.mob1dead <= 0) {
			set .mob1,callmonster("moro_vol",rand(288,296),rand(197,205),"炎火のモロクの現身",3039,"moro_vol_mon::OnKilled1");
		}
	}
	else if(.mob1call > 0) {
		set .mob1call,0;
	...
	if(.mob2dead > 0) {
		...
		if(.mob2dead <= 0) {
			set .mob2,callmonster("moro_vol",rand(273,281),rand(234,242),"歪んだモロクの現身",3040,"moro_vol_mon::OnKilled2");
		}
	}
	else if(.mob2call > 0) {
		set .mob2call,0;
	...
	if(.mob3dead > 0) {
		...
		if(.mob3dead <= 0) {
			set .mob3,callmonster("moro_vol",rand(212,220),rand(241,249),"冷気のモロクの現身",3041,"moro_vol_mon::OnKilled3");
		}
	}
	else if(.mob3call > 0) {
		set .mob3call,0;
		set .@mob3hp,getunitdata(.mob3,UMOB_HP);
...
// エクラージュ追加NPC
//------------------------------------------------------------
ecl_in01,38,98,1	script	次元移動機#143_1	10007,{
	mes "[エクラージュガード]";
	mes "最近発見された魔王の隠れ家、";
...
ecl_in01,35,89,6	script	魔学者アマンディー#143_	620,{
	mes "[アマンディー]";
	mes "次元の狭間というものが";
	mes "この世界に大きな打撃を";
	mes "与えなければいいのですが。";
...
ecl_in01,37,90,3	script	魔学者レモニー#143_3	611,{
	mes "[レモニー]";
	mes "今回の月刊心理の扉は読んだか？";
	mes "エイヴァントが新しく作った";
...
ecl_in01,44,99,1	script	ラフィネ兵士#143_4	461,{
	mes "[ラフィネ兵士]";
	mes "……緊張してきましたね。";
	close;
OnTalk1:
...
ecl_in01,46,99,1	script	ラフィネ兵士#143_5	461,{
	mes "[ラフィネ兵士]";
	mes "無事に戻って来られるかな。";
	close;
OnTalk1:
...
ecl_in01,48,99,1	script	ラフィネ兵士#143_6	461,{
	mes "[ラフィネ兵士]";
	mes "ふむ……。";
	close;
OnTalk1:
...
ecl_in01,44,97,1	script	ラフィネ兵士#143_7	462,{
	mes "[ラフィネ兵士]";
	mes "静かに。";
	close;
OnTalk1:
...
ecl_in01,46,97,1	script	ラフィネ兵士#143_8	462,{
	mes "[ラフィネ兵士]";
	mes "やっと私が優れていることを";
	mes "お見せするチャンスが来たか。";
	close;
...
ecl_in01,48,97,1	script	ラフィネ兵士#143_9	462,{
	mes "[ラフィネ兵士]";
	mes "私がどうして兵士に志願したか";
	mes "わかりますか？";
...
ecl_in01,46,102,6	script	指揮官ラフィネ#143_10	447,5,5,{
	mes "[指揮官ラフィネ]";
	mes "闇の種は発見したら";
	mes "消してしまったほうがいいです。";
...
ecl_in01,40,96,3	script	エクラージュガード	447,{
	mes "[エクラージュガード]";
	mes "なんの用ですか？";
	next;
...
ecl_in01,47,106,6	script	カルデュイ#14301	624,{
	end;
...
ecl_in01,48,67,0	script	#ecl_orb_buff	139,10,10,{
OnTouch:
	misceffect 313,"";
...
ecl_in01,48,67,0	script	オーブ#orb	844,{
	if(ECL_3QUE < 33 || FVOL_1QUE < 100) {
		mes "‐オーブの魔力が感じられる‐";
		close;
	}
	if(checkquest2(116540) == 0) {
		mes "‐オーブに触れると頭の中に";
		mes "　カルデュイの声が響いてきた‐";
		next;
		mes "[カルデュイ]";
	...
	if(checkquest2(116541)) {
		if(checkquest2(116541)&2 == 0) {
			mes "‐オーブの魔力は^ff000018時間に1回^000000";
			mes "　受けることができます‐";
			close;
		}
...
ecl_in01,47,92,0	duplicate(#ecl_orb_buff)	#ecl_buff_N	139,10,10
ecl_in01,71,67,0	duplicate(#ecl_orb_buff)	#ecl_buff_E	139,10,10
ecl_in01,48,44,0	duplicate(#ecl_orb_buff)	#ecl_buff_S	139,10,10
ecl_in01,23,68,0	duplicate(#ecl_orb_buff)	#ecl_buff_W	139,10,10

ecl_in01,58,101,3	script	案内板	837,{
	mes "[カルデュイ様が";
	mes " お越しになられる時間]";
