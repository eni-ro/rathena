...
aldeba_in,216,169,5	script	セレイ#sp2	86,{
	if(Job == Job_Novice) {
		mes "[セレイ]";
		mes "あなたはまだ平凡な道を歩く";
		mes "楽しみを知らない人なんだね！";
...
comodo,200,75,4	script	釣り中のノービス#sp2	567,{
	if(Job == Job_Super_Novice_E) {
	...
	case 2:
		...
		close;
	case 3:
		set .@poring_hunt,checkquest2(5094);
		set .@lunatic_hunt,checkquest2(5095);
		set .@fabre_hunt,checkquest2(5096);
		set .@picky_hunt,checkquest2(5097);
		mes "["+strcharinfo(0)+"]";
		mes "お～いノードル。";
		next;
		emotion 23;
...
airplane,33,47,5	script	ヌードル#sp2	567,{
	if(Job == Job_Super_Novice_E) {
		mes "[ヌードル]";
		mes "う～わ～";
		if(!Sex) {
