...
//お正月クエスト
//==============================================================
ama_in01,180,132,4	script	少年#Newyear	764,{
	if(countitem(669)<1) {
...
ama_in01,177,132,4	duplicate(少年#Newyear)	少女#Newyear	759


ama_in01,183,131,4	script	雅人形	1404,{}

ama_in01,183,131,0	script	雅人形	111,{
	switch(NEWYEAR_EVE) {
	case 0:
		break;
	case 1:
...
alberta,247,115,4	script	お爺さん	120,{
	switch(NEWYEAR_EVE) {
	case 0:
		break;
	case 1:
...
amatsu,262,248,6	script	お婆さん	103,{
	switch(NEWYEAR_EVE) {
	case 0:
	case 1:
		break;
