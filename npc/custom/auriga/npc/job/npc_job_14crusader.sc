...
prt_castle,45,169,4	script	マスタークルセイダー	752,{
	if(Job == Job_Crusader) {
		mes "[ミケル=レカント=ニキータ]";
		mes "貴公は聖戦に拠り為す者か。";
		mes "ここに留まらず己を鍛えるがよい。";
...
prt_castle,164,32,0	script	苦しむ者	733,{
	if(Job == Job_Novice) {
		mes "[ムルナク=ミヨオ]";
		mes "ノービスですか……";
		mes "私は悪者ではありません。";
...
//==============================================================
job_cru,0,0,0	script	#CRU_1stTest	-1,{
	end;
OnTimer150000:
	if(getareausers("job_cru",90,34,105,105) == 0) {	//誰も居ないならmobを抹消
		for(set .@i,0; .@i<3 ; set .@i,.@i+1)
			awake "#CRU_1stTest";
		killmonster "job_cru","All";
		stopnpctimer;
		end;
	}
OnStart:
	initnpctimer;
	killmonster "job_cru","#CRU_1stTest::OnKilled1";
	monster "job_cru",98,50,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	monster "job_cru",98,55,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	monster "job_cru",98,60,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	monster "job_cru",98,65,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	monster "job_cru",98,70,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	monster "job_cru",98,75,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	monster "job_cru",98,80,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	monster "job_cru",98,85,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	monster "job_cru",98,90,"ファミリアー",1005,1,"#CRU_1stTest::OnKilled1";
	sleep 50000;
	killmonster "job_cru","#CRU_1stTest::OnKilled2";
	monster "job_cru",94,45,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",101,45,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",94,55,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",101,55,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",94,65,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",101,65,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",94,75,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",101,75,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",94,85,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",101,85,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",94,95,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	monster "job_cru",101,95,"マンドラゴラ",1020,1,"#CRU_1stTest::OnKilled2";
	sleep 50000;
	killmonster "job_cru","#CRU_1stTest::OnKilled3";
	monster "job_cru",98,50,"フローラ",1118,1,"#CRU_1stTest::OnKilled3";
	monster "job_cru",92,60,"フローラ",1118,1,"#CRU_1stTest::OnKilled3";
	monster "job_cru",104,60,"フローラ",1118,1,"#CRU_1stTest::OnKilled3";
	monster "job_cru",98,70,"フローラ",1118,1,"#CRU_1stTest::OnKilled3";
	monster "job_cru",92,80,"フローラ",1118,1,"#CRU_1stTest::OnKilled3";
	monster "job_cru",104,80,"フローラ",1118,1,"#CRU_1stTest::OnKilled3";
	monster "job_cru",98,90,"フローラ",1118,1,"#CRU_1stTest::OnKilled3";
	sleep 50000;
	killmonster "job_cru","#CRU_1stTest::OnKilled4";
	monster "job_cru",90,50,"天下大将軍",1277,1,"#CRU_1stTest::OnKilled4";
	monster "job_cru",105,50,"天下大将軍",1277,1,"#CRU_1stTest::OnKilled4";
	monster "job_cru",98,60,"天下大将軍",1277,1,"#CRU_1stTest::OnKilled4";
	monster "job_cru",90,70,"天下大将軍",1277,1,"#CRU_1stTest::OnKilled4";
	monster "job_cru",105,70,"天下大将軍",1277,1,"#CRU_1stTest::OnKilled4";
	monster "job_cru",98,80,"天下大将軍",1277,1,"#CRU_1stTest::OnKilled4";
	monster "job_cru",90,90,"天下大将軍",1277,1,"#CRU_1stTest::OnKilled4";
	monster "job_cru",105,90,"天下大将軍",1277,1,"#CRU_1stTest::OnKilled4";
	end;
OnKilled1:
OnKilled2:
OnKilled3:
...
job_cru,98,105,0	script	#CRU_1stWarp	45,1,1,{
	set CHANGE_CRU,6;
...
prt_church,95,127,4	script	聖堂騎士	745,{
	switch(CHANGE_CRU) {
	case 0:
		mes "[ケイナ=バレンタイン]";
		mes "いらっしゃいませ。";
...
prt_castle,35,151,4	script	守備兵	751,{
	switch(CHANGE_CRU) {
	case 0:
		mes "[ブリッテン=ヒルド]";
		mes "よく来ました。";
...
//==============================================================
job_cru,24,187,4	script	守備騎士::CRU_ChatRoom	751,{
	mes "[ブリッテン=ヒルド]";
	mes "ようこそ。";
	mes "ここでは最後の試練を受けて";
	mes "もらいます。";
...
OnTimer240000:
	stopnpctimer;
	areawarp "job_cru",160,14,175,179,"prt_fild05",353,251;
	areakillmonster "job_cru",160,14,175,179;
	enablewaitingroomevent;
	end;
}

//==============================================================
job_cru,168,17,0	script	#CRU_Messanger	139,2,2,{
	mes "[ブリッテン=ヒルド]";
	mes "進みながら、現れた敵を";
	mes "全て撃退してください。";
	mes "一つでも残せば不合格です。";
...
//==============================================================
job_cru,168,45,0	script	#CRU_3rdTest1	139,8,1,{
	monster "job_cru",168,45,"ゾンビ",1015,6;
	hideonnpc;
	end;
}

job_cru,168,80,0	script	#CRU_3rdTest2	139,8,1,{
	monster "job_cru",168,80,"ソルジャースケルトン",1028,3;
	hideonnpc;
	end;
}

job_cru,168,110,0	script	#CRU_3rdTest3	139,8,1,{
	monster "job_cru",168,105,"アーチャースケルトン",1016,1;
	monster "job_cru",168,110,"マミー",1041,1;
	hideonnpc;
	end;
}

job_cru,168,150,0	script	#CRU_3rdTest4	139,8,1,{
	monster "job_cru",168,150,strcharinfo(0),1036,1,"CRU_ChatRoom::OnKilled";
	hideonnpc;
	end;
}

job_cru,168,180,0	script	#CRU_3rdWarp	45,1,1,{
	if(getareamobs("job_cru",160,14,175,179) == 0)
		set CHANGE_CRU,10;
...
prontera,232,318,3	script	ペコペコ管理兵	105,{
	if(Job != Job_Crusader) {
		mes "[ペコペコ管理兵]";
