...
alberta_in,173,76,4	script	モンスターテイマー	125,{
	mes "[イワド]";
	mes "時はいまや";
	mes "モンスターテイミングの時代！";
	mes "君もかわいいモンスターとの";
...
izlude_in,129,64,4	script	モンスターテイマー	125,{
	mes "[ショウゴ]";
	mes "モンスターテイミングに必要な";
	mes "嗜好品を取りそろえるのに";
	mes "専念していますかッ？";
...
aldeba_in,168,175,4	script	モンスターテイマー	125,{
	mes "[ユウ]";
	mes "なにをお探しでしょうか！";
	mes "ミッドガルド大陸でモンスター";
	mes "嗜好品を作らせたら、並ぶものが";
...
// コモド ボンゴンテイムアイテム交換
//----------------------------------
comodo,112,182,0	script	お婆さん	103,{
	if(countitem(1558)<1) {
		mes "[お婆さん]";
		mes "うう……";
		mes "私の可哀想な孫娘……";
