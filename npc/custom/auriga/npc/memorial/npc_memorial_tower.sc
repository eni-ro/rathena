...
// 説明NPC
//------------------------------------------------------------
e_tower,80,108,3	script	書置き	857,{
	mes "[書置き]";
	mes "……この場所に挑む";
	mes "後続の冒険者たちのために";
	mes "これを記す。";
...
5@tower,106,109,0	script	水晶#Tower	111,{
	mes "-強い光を放つ水晶から";
	mes "　奇妙な感覚を感じる。";
	mes "　まるでこちらを歓迎しているかの";
	mes "　ようだ……-";
...
// エンドレスタワー101F～102F
//------------------------------------------------------------
6@tower,45,89,0	script	命の泉#Tower	111,{
	misceffect 14,"";
...
OnKilled:
	...
	areamonster getmdmapname("6@tower"),152,66,152,106,"骨の守護兵",1152,50,getmdnpcname("TowerControl6")+ "::OnKilled2";
	areamonster getmdmapname("6@tower"),159,66,159,106,"骨の守護兵",1152,50,getmdnpcname("TowerControl6")+ "::OnKilled2";
	end;
OnKilled2:
	...
	areamonster getmdmapname("6@tower"),152,66,152,106,"風の守護兵",1263,30,getmdnpcname("TowerControl6")+ "::OnKilled3";
	areamonster getmdmapname("6@tower"),159,66,159,106,"風の守護兵",1263,30,getmdnpcname("TowerControl6")+ "::OnKilled3";
	end;
OnKilled3:
	...
	areamonster getmdmapname("6@tower"),152,66,152,106,"刃の守護兵",1132,20,getmdnpcname("TowerControl6")+ "::OnKilled4";
	areamonster getmdmapname("6@tower"),159,66,159,106,"刃の守護兵",1132,20,getmdnpcname("TowerControl6")+ "::OnKilled4";
	end;
OnKilled4:
	...
	monster getmdmapname("6@tower"),156,147,"ナハトズィーガー",1956,1,getmdnpcname("TowerControl6")+ "::OnKilled5";
	end;
OnKilled5:
...
6@tower,169,127,2	script	彷徨う魂#Tower	796,{
