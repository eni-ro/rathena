...
//	■ SKILL_CHARGEATK   -> 0～8
//-----------------------------------------------
prt_in,85,99,2	script	騎士団員	734,{
	if(getskilllv(1001)) {
		mes "[エソペ]";
		mes "精一杯やりたまえ。";
		mes "世の中は甘いものではない。";
...
prontera,72,352,7	script	騎士団長	733,{
...
prontera,78,354,3	script	騎士団員	734,{
...
prontera,73,357,5	script	騎士団員	734,{
...
prontera,78,357,3	script	騎士団員	734,{
...
prontera,66,358,5	script	騎士団員	733,{
...
//	■ SKILL_SHRINK   -> 0～8
//-----------------------------------------------
geffen,110,117,3	script	フォード	752,{
	if(getskilllv(1002)) {
		mes "[フォード]";
		mes "スラッティに薬を渡したようだね。";
		mes "ご苦労様！";
...
gef_fild13,297,242,3	script	兵士	751,{
	if(getskilllv(1002)) {
		mes "[スラッティ]";
		mes "おう、旅は順調か？";
		mes "たまにはこっちに来て";
...
prt_church,87,127,3	script	司祭	755,{
	if(getskilllv(1002)) {
		mes "[アーサー]";
		mes "こんにちは。";
		mes "お久しぶりですね。";
...
//-----------------------------------------------
in_moc_16,23,27,5	script	アサシン	885,{
...
in_sphinx2,259,213,0	script	古い棺#1	139,7,8,{
...
in_sphinx2,212,267,0	duplicate(古い棺#1)	古い棺#2	139,5,6

in_sphinx2,13,163,0	script	石像#1	139,7,7,{
...
in_sphinx2,13,146,0	duplicate(石像#1)	石像#2	139,7,7


//-----------------------------------------------
//==== ベナムナイフ - AS_VENOMKNIFE
//-----------------------------------------------
in_moc_16,14,27,5	script	アサシン	884,{
	if(getbaseclass(Class,2) != CLASS_AS) {
		mes "[アサシン]";
		mes "……………………";
		close;
...
in_moc_16,22,20,7	shop	陰気な商人	880,1771:-1
...
//-----------------------------------------------
in_rogue,355,179,0	script	ハイジャラ・グレグ	46,{
	if(getskilllv(1005)) {
		mes "[ハイジャラ・グレグ]";
		mes "この前は本当にありがとう。";
...
in_rogue,152,29,0	script	ルイ・グレグ	84,{
	if(getskilllv(1005)) {
		mes "[ルイ・グレグ]";
		mes "あの有名なチェテクベ様の";
		mes "エピソードについて兄さん達が";
...
in_rogue,268,125,2	script	トール・グレグ	84,{
	if(getskilllv(1005)) {
		mes "[トール・グレグ]";
		mes "チェテクベ様にはこんな";
		mes "エピソードがある。";
...
in_rogue,181,114,3	script	ジェイ・グレグ	85,{
	if(getskilllv(1005)) {
		mes "[ジェイ・グレグ]";
		mes "チェテクベ様の性格は無鉄砲……。";
		mes "そう、無鉄砲なんだよ。";
...
in_rogue,88,119,3	script	待機室担当#rogue10	828,{
	end;
OnInit:
...
prt_are01,149,162,0	script	キエナ#1	700,1,1,{
	end;
OnInit:
	hideonnpc;
	end;
...
prt_are01,136,150,0	duplicate(キエナ#1)	キエナ#2	700,1,1
prt_are01,150,138,0	duplicate(キエナ#1)	キエナ#3	700,1,1
prt_are01,163,147,0	duplicate(キエナ#1)	キエナ#4	700,1,1
prt_are01,134,140,0	duplicate(キエナ#1)	キエナ#5	700,1,1
prt_are01,161,140,0	duplicate(キエナ#1)	キエナ#6	700,1,1
prt_are01,161,160,0	duplicate(キエナ#1)	キエナ#7	700,1,1
prt_are01,138,159,0	duplicate(キエナ#1)	キエナ#8	700,1,1
...
in_rogue,357,174,2	script	刺客#rogue	705,1,1,{
	end;
OnTouch:
	switch(SKILL_CLOSECONFINE) {
	case 10:
...
//-----------------------------------------------
gef_tower,115,36,4	script	ニャオ	876,{
	if(getskilllv(1006)) {
		mes "[ニャオ]";
		mes "Zzz……Zzz……";
		mes "ウーン……ムニャ……";
...
prt_in,82,98,3	script	セイモンメイヤス	46,{
...
//	■ SKILL_ELEMENT   -> 0～6
//-----------------------------------------------
yuno_in03,176,24,3	script	ミシュナ	755,{
...
yuno_in03,176,22,3	shop	Scroll商人	67,7433:-1
...
//-----------------------------------------------
pay_arche,109,169,3	script	アルペスト	712,{
	if(getskilllv(1009)) {
		mes "[アルペスト]";
		mes "ふぁふぁ！";
		mes "この前は恥ずかしい所を見せたな。";
...
//	■ SKILL_PANGVOICE   -> 0～
//-----------------------------------------------
prontera,169,72,7	script	青年#bard	89,3,3,{
...
morocc_in,169,72,7	script	陰気なバード#bard	741,3,3,{
	if(getskilllv(1010)) {
		mes "[ライオト]";
		mes "クックックックックックッ。";
		mes "私が教えてやった技術はどうだ？";
...
niflheim,239,70,1	script	イヒレ#1	800,3,3,{
	emotion 23;
	emotion 23,"";
	mes "[ニワトリ・イヒレ]";
	mes "コケッ？";
...
niflheim,185,205,3	duplicate(イヒレ#1)	イヒレ#2	800,3,3
niflheim,85,203,5	duplicate(イヒレ#1)	イヒレ#3	800,3,3
niflheim,149,81,7	duplicate(イヒレ#1)	イヒレ#4	800,3,3
niflheim,209,144,3	duplicate(イヒレ#1)	イヒレ#5	800,3,3

morocc_in,178,73,3	script	お客さん#bard	54,{
	mes "[少し酔った男]";
	mes "やはり酒は言葉だ。";
	mes "そこどこか。";
	mes "そこそこそれが一番なの！";
...
morocc_in,175,70,7	duplicate(お客さん#bard)	お客さん	50

morocc_in,166,76,7	script	バーテン	46,{
	mes "[バーテン]";
	mes "注文か？";
	next;
...
//	■ SKILL_WINKCHARM   -> 0～8
//-----------------------------------------------
comodo,204,172,5	script	サネル	724,{
	if(getskilllv(1011)) {
		emotion 32;
		mes "[サネル]";
		mes "うん？　何か用？";
...
prontera,183,333,3	script	アエル	79,{
	if(getskilllv(1011)) {
		emotion 7;
		mes "[頭が痛いアエル]";
		mes "……ウウウ……二日酔いが……";
...
//	■ SKILL_GREED   -> 0～1
//-----------------------------------------------
geffen,172,52,1	script	グッドデー	826,{
	if(getskilllv(1013)) {
		mes "[グッドデー]";
		mes "学んだスキルは良く";
		mes "使っているかな？";
...
//	■ SKILL_REDEMPTIO   -> 0～2
//-----------------------------------------------
prt_church,111,112,2	script	ライナース修道女	79,{
	if(getskilllv(1016)) {
		mes "[ライナース修道女]";
...
//	■ SKILL_BALKYOUNG   -> 0～5
//-----------------------------------------------
monk_test,316,69,5	script	修行僧	823,{
	if(getskilllv(1016)) {
		mes "[修行僧]";
		mes "それでは行きなさい。";
		mes "もし旅の最中にでもその馬鹿を";
...
prt_monk,270,198,3	script	修行中のモンク	753,{
	if(getskilllv(1015)) {
		mes "[修行僧]";
		mes "自分がすべき事や置かれている";
		mes "状況を良く考えてみなさい。";
...
//-----------------------------------------------
lhz_in01,224,140,2	script	ケルラソス	57,{
...
lhz_in01,225,122,4	script	スクラザド	754,{
...
lhz_in01,204,138,4	script	ケシビオン	750,{
...
lhz_in02,278,273,2	script	ブランチョ	709,{
...
lhz_in03,106,34,2	script	コーリン	706,{
...
lhz_in03,109,31,4	script	ベニーネ	90,{
	if(SKILL_BIOETHICS == 8 || SKILL_BIOETHICS == 9) {
		mes "[ベニーネ]";
		mes "私の主人に会いましたか？";
		mes "頑固で、自分の主張を曲げるのが";
...
//-----------------------------------------------
yuno_in04,33,108,4	script	ピースリーク	883,{
	if(getbaseclass(Class,2) != CLASS_AM) {
		mes "[ピースリーク]";
		mes "そこで何をしてる！";
		mes "外に出てくれないか？";
...
yuno_in04,22,107,5	script	イラヘ	740,{
	mes "[イラヘ]";
	mes "……";
	mes "…………";
	mes "よし、よし。";
...
yuno_in04,27,107,4	script	テガス	748,{
	mes "[テガス]";
	mes "横で足が震えている奴は";
	mes "いつも変な物を作っているし、";
	mes "ぐるぐるメガネを付けた奴は";
...
yuno_in04,33,106,0	script	チェック	111,{
	mes "-あらゆる書類や箱が-";
	mes "ごちゃまぜに散らばっている-";
	mes "-机の主人は全然問題なしに";
	mes "必要なものを探し出している-";
