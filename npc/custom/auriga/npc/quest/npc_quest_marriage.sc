...
//====================================================================
prt_church,94,100,4	script	結婚コンパニオン	71,{
...
//========================================================================================
prt_church,100,128,4	script	主教	60,{
...
//=======================Solo軍団==============================
prt_church,97,102,0	script	ソロ軍団#プロンテラ	105,{
	mes "[ソロ軍団]";
	mes "精錬は1人で出来ちゃうぞ！";
	close;
}

prt_church,98,102,0	script	ソロ軍団#ゲフェン	705,{
	mes "[ソロ軍団]";
	mes "ダンジョンでパーティーは贅沢だ！";
	close;
}

prt_church,99,102,0	script	ソロ軍団#モロク		707,{
	mes "[ソロ軍団]";
	mes "私には心に決めたNPCがいる！";
	close;
}

prt_church,100,102,0	script	ソロ軍団#フェイヨン	708,{
	mes "[ソロ軍団]";
	mes "生まれて転職まで独りでした！";
	close;
}

prt_church,101,102,0	script	ソロ軍団#アマツ	767,{
	mes "[ソロ軍団]";
	mes "クリスマスにはシングルベ～ル！";
	close;
}

prt_church,102,102,0	script	ソロ軍団#コンロン	780,{
	mes "[ソロ軍団]";
	mes "私たちは無敵のソロ軍団！";
	close;
}
