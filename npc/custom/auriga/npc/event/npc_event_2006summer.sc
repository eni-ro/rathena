...
// モンスター
//=====================================================================
amatsu,0,0,0,0	monster	ガジョマート	1309,1,1800000,900000,0
amatsu,0,0,0,0	monster	ホロン	1129,5,600000,300000,0

//=====================================================================
// 転送NPC
//=====================================================================
prontera,104,65,5	script	アマツ観光協会員#summer	757,{
	emotion 3;
	mes "[アマツ観光協会員]";
	mes "お元気ですか？";
	mes "今、泉水の国アマツでは";
...
morocc,163,56,4	duplicate(アマツ観光協会員#summer)	アマツ観光協会員	757
geffen,104,56,6	duplicate(アマツ観光協会員#summer)	アマツ観光協会員	757
payon,165,100,5	duplicate(アマツ観光協会員#summer)	アマツ観光協会員	757
alberta,235,95,4	duplicate(アマツ観光協会員#summer)	アマツ観光協会員	757
izlude,134,93,4	duplicate(アマツ観光協会員#summer)	アマツ観光協会員	757

amatsu,200,79,4	script	特殊客船案内人	109,{
	mes "[特殊客船案内人]";
	mes "いらっしゃいませ。";
	mes "アマツ納涼泉水祭、";
	mes "楽しんでおられますか？";
...
amatsu,272,230,4	script	巫女	769,{
	emotion 3;
	mes "[桜子]";
	mes "ようこそ、アマツへ！";
	mes "私はアマツ納涼泉水祭";
...
amatsu,195,238,4	script	カプラ職員？	791,{
	misceffect 33;
	mes "[カプラ職員？]";
	mes "うらめしや～～……";
	next;
...
// 行商
//=====================================================================
amatsu,171,118,6	shop	行商	53,516:-1,535:-1,515:-1,512:-1,513:-1,519:-1,517:-1,528:-1,501:-1,502:-1,503:-1,504:-1,506:-1,537:-1
amatsu,177,122,4	shop	行商	770,1750:-1,1770:-1,1752:-1,1751:-1,1065:-1,1247:-1,1248:-1,1249:-1,13000:-1
amatsu,182,121,4	shop	行商	77,611:-1,601:-1,602:-1,717:-1,645:-1,656:-1,657:-1,610:-1
amatsu,172,112,6	shop	行商	886,581:-1,580:-1,577:-1,7482:-1,579:-1,7457:-1,7453:-1,7455:-1,7454:-1,7456:-1,7452:-1

amatsu,208,123,3	script	輸入洋酒屋	766,{
	mes "[輸入洋酒屋のおじいさん]";
	mes "いらっしゃい。";
	mes "祭はいいもんじゃのう。";
	mes "やはり祭は酒じゃろう～！";
...
// 一般人
//=====================================================================
amatsu,189,90,6	script	腹ペコ少年	764,{
	mes "[寿司田部大洋]";
	mes "あー……";
	mes "お腹空いた……";
	mes "お寿司……お寿司が食べたいよう！";
...
amatsu,190,106,6	script	お婆さん	760,{
	mes "[お婆さん]";
	mes "ようこそいらっしゃいました。";
	mes "お祭りは楽しんでいますか？";
	mes "お祭りの時間は短いですが";
...
amatsu,212,106,3	script	怖そうなお姉さん	747,{
	mes "[怖そうなお姉さん]";
	mes "へぇー、なかなか";
	mes "賑わってるじゃない。";
	mes "アマツのお祭りには";
...
amatsu,204,176,4	script	暗がりの男	97,{
	mes "[暗がりの男]";
	mes "うう……うぷっ……";
	mes "寿司……お寿司が……";
	mes "お寿司1個が……100個くらいに";
...
amatsu,190,197,7	script	震える男	748,{
	emotion 23;
	mes "[震える男]";
	mes "うぁーっ!!";
	mes "ビックリした……!!";
...
amatsu,208,214,4	script	旅する女性	726,{
	mes "[旅する女性]";
	mes "やっほー！";
	mes "貴方も遊びに来てるの？";
...
amatsu,209,213,4	script	場違いお兄さん	715,{
	mes "[場違いお兄さん]";
	mes "オー……";
	mes "『海の向こうでカーニバルしてるよ！』";
	mes "って聞いたから、";
...
amatsu,238,208,4	script	疲れきった女性	101,{
	mes "[疲れきった女性]";
	mes "あー……";
	mes "ふー……";
	next;
...
amatsu,244,237,7	script	全然勝てない男	753,{
	mes "[全然勝てない男]";
	mes "ぬがーッッッ!!!!";
	mes "か、勝てない!!!!";
	next;
...
amatsu,259,221,7	script	怪しい爺さん	120,{
	mes "[怪しい爺さん]";
	mes "ほぉ……";
	mes "ふぅーむ……";
	mes "ふむ……ふむ……";
...
amatsu,188,153,5	script	わたあめ親父#summer	826,{
...
amatsu,190,155,3	duplicate(わたあめ親父#summer)	子供#summer1	706
amatsu,186,151,7	duplicate(わたあめ親父#summer)	子供#summer2	96
amatsu,187,153,4	script	わたあめ	1620,{}
amatsu,189,153,4	script	わたあめ	1621,{}

amatsu,241,106,6	script	子供	703,{
	emotion 28;
	mes "[子供]";
	mes "あう～";
	mes "お祭りでみんなで";
...
amatsu,243,106,4	script	かき氷機#summer	1319,{}
amatsu,243,105,0	script	かき氷機	111,{
...
// 丁半お爺さん
//=====================================================================
amatsu,158,127,3	script	丁半お爺さん#summer	765,{
	mes "[寿司田部太郎]";
	mes "ほっほっほ。";
	mes "ワシの名は寿司田部太郎。";
...
amatsu,165,121,1	script	怪しい男	64,{
	mes "[怪しい男]";
	mes "フフ……";
	mes "お寿司……残り1個……";
	mes "この状況……明らかに不利っ……";
...
// 鍵屋のお兄さん
//=====================================================================
amatsu,213,254,5	script	鍵屋のお兄さん	763,{
	if((MaxWeight - Weight) < 2000) {
		mes "[鍵屋錠兵衛]";
		mes "……なんだなんだ？";
...
// クジ引きお姉さん
//=====================================================================
amatsu,208,134,3	script	クジ引きお姉さん	758,{
	if((MaxWeight - Weight) < 2000) {
		mes "[美香]";
		mes "あら？";
...
// 札博打お兄さん
//=====================================================================
amatsu,187,131,5	script	札博打お兄さん	762,{
	mes "[九札銀次郎]";
	mes "いよう！";
	mes "おいらの名前は九札銀次郎。";
...
// 牌籠お姉さん
//=====================================================================
amatsu,260,246,4	script	牌籠お姉さん	757,{
	emotion 14;
	mes "[紘子]";
	mes "やっほー！";
	mes "お祭り楽しんでる？";
...
// 一本釣りおじさん
//=====================================================================
amatsu,252,87,3	script	一本釣りおじさん	709,{
	if((MaxWeight - Weight) < 2000) {
		mes "[一本釣りおじさん]";
		mes "ん？";
		mes "そんなにたくさんアイテムを持って";
	...
	case 14:	//モンスター
		...
		if(.@feed == 3 && rand(20) == 0) {
			...
			monster "amatsu",248,85,"天津三岐大蛇",1720,1,"Fishing#Summer";
		}
		else if(rand(2))
			monster "amatsu",248,86,"暴れヒトデ",1266,1,"Fishing#Summer";
		else
			monster "amatsu",248,85,"暴れフェン",1158,1,"Fishing#Summer";
		initnpctimer;
		next;
		emotion 23;
		mes "[一本釣りおじさん]";
...
OnTimer10000:
	...
	killmonster "amatsu","Fishing#Summer";
	stopnpctimer;
	end;
OnTimer20000:
	killmonster "amatsu","Fishing#Summer";
...
amatsu,0,0,0	script	Fishing#Summer	-1,{}	//ダミーイベント

amatsu,253,92,6	script	釣り人	767,{
	emotion 9;
	mes "[釣り人]";
	mes "……";
	mes "……なかなか釣れないなあ。";
...
// 3周年アイスクリーム商人
//=====================================================================
amatsu,168,100,5	script	3周年アイスクリーム商人	85,{
	mes "[3周年アイスクリーム商人]";
	mes "夏ですね！";
	mes "夏といえば夏祭り！";
	mes "そして冷たいアイスクリーム！";
...
// 大絡繰屋敷
//=====================================================================
amatsu,233,165,3	script	アトラクション係員	758,{
	mes "[係員 姫子]";
	mes "びっくりアトラクション";
	mes "「大絡繰屋敷」は、";
	mes "ただいま準備中となっております。";
