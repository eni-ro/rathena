...
// 守備担当
//------------------------------------------------------------
schg_cas04,123,306,3	script	エルゼプ#N4	868,{
	if(.guardian1_x[0] == 0) {
...
schg_cas04,27,36,0	script	第1守護石#N4	844,{
...
schg_cas04,208,75,0	script	第2守護石#N4	844,{
...
schg_cas04,124,52,0	script	制御装置01#N4	111,{
...
OnAgitStart:
	...
	callguardian "schg_cas04",115,50," ",1905,1,"制御装置01#N4::OnKilled";
	callguardian "schg_cas04",117,50," ",1905,1,"制御装置01#N4::OnKilled";
	callguardian "schg_cas04",119,50," ",1905,1,"制御装置01#N4::OnKilled";
	callguardian "schg_cas04",121,50," ",1905,1,"制御装置01#N4::OnKilled";
	callguardian "schg_cas04",123,50," ",1905,1,"制御装置01#N4::OnKilled";
	callguardian "schg_cas04",125,50," ",1905,1,"制御装置01#N4::OnKilled";
	set .count,6;
	end;
OnKilled:
	set .count,.count-1;
	...
	killmonster "schg_cas04","制御装置01#N4::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "schg_cas04",114,51,126,51,0;
...
schg_cas04,128,157,0	script	制御装置02#N4	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "schg_cas04",115,153," ",1905,1,"制御装置02#N4::OnKilled";
	callguardian "schg_cas04",117,153," ",1905,1,"制御装置02#N4::OnKilled";
	callguardian "schg_cas04",119,153," ",1905,1,"制御装置02#N4::OnKilled";
	callguardian "schg_cas04",121,153," ",1905,1,"制御装置02#N4::OnKilled";
	callguardian "schg_cas04",123,153," ",1905,1,"制御装置02#N4::OnKilled";
	callguardian "schg_cas04",125,153," ",1905,1,"制御装置02#N4::OnKilled";
	set .count,6;
	end;
OnKilled:
	set .count,.count-1;
	...
	killmonster "schg_cas04","制御装置02#N4::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "schg_cas04",114,154,126,154,0;
...
schg_cas04,109,247,0	script	制御装置03#N4	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "schg_cas04",116,240," ",1905,1,"制御装置03#N4::OnKilled";
	callguardian "schg_cas04",118,240," ",1905,1,"制御装置03#N4::OnKilled";
	callguardian "schg_cas04",120,240," ",1905,1,"制御装置03#N4::OnKilled";
	callguardian "schg_cas04",122,240," ",1905,1,"制御装置03#N4::OnKilled";
	set .count,4;
	end;
OnKilled:
	set .count,.count-1;
	...
	killmonster "schg_cas04","制御装置03#N4::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "schg_cas04",116,241,126,241,0;
...
schg_cas04,17,45,0		duplicate(#LinkFlag_N4)	フリョーズ#A01	111
schg_cas04,207,95,0		duplicate(#LinkFlag_N4)	フリョーズ#A02	111
schg_cas04,111,46,4		duplicate(#LinkFlag_N4)	フリョーズ#B03	722
schg_cas04,129,46,4		duplicate(#LinkFlag_N4)	フリョーズ#B04	722
schg_cas04,99,77,0		duplicate(#LinkFlag_N4)	フリョーズ#A05	111
schg_cas04,140,77,0		duplicate(#LinkFlag_N4)	フリョーズ#A06	111
schg_cas04,109,150,4	duplicate(#LinkFlag_N4)	フリョーズ#B07	722
schg_cas04,130,150,4	duplicate(#LinkFlag_N4)	フリョーズ#B08	722
schg_cas04,112,212,0	duplicate(#LinkFlag_N4)	フリョーズ#A09	111
schg_cas04,127,212,0	duplicate(#LinkFlag_N4)	フリョーズ#A10	111
schg_cas04,113,238,0	duplicate(#LinkFlag_N4)	フリョーズ#A11	111
schg_cas04,126,238,0	duplicate(#LinkFlag_N4)	フリョーズ#A12	111
schg_cas04,95,247,0		duplicate(#LinkFlag_N4)	フリョーズ#A13	111
schg_cas04,144,247,0	duplicate(#LinkFlag_N4)	フリョーズ#A14	111

//============================================================
// カプラ職員
//------------------------------------------------------------
schg_cas04,300,287,5	script	カプラ職員::AgitKafra_N4	117,{
...
// 執事
//------------------------------------------------------------
schg_cas04,247,305,3	script	執事	55,{
...
sch_gld,134,97,4	duplicate(#GldFlag_N4a)	フリョーズ#a01	722
sch_gld,141,97,4	duplicate(#GldFlag_N4a)	フリョーズ#a02	722
...
//yuno,112,179,5	duplicate(#GldFlag_N4b)	フリョーズ#b01	722

//============================================================
// 不思議なヒマワリ（アジトダンジョン）
//------------------------------------------------------------
schg_cas04,280,391,3	script	不思議なヒマワリ#N4	976,{
