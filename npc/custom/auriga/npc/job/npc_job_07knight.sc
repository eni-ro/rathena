...
// 試験申請および転職
//------------------------------------------------------------
prt_in,88,101,4	script	プロンテラ騎士団長	56,{
	if(Job == Job_Novice) {
		mes "[騎士団長ヘルマン]";
		mes "こちらはプロンテラ騎士団です。";
		mes "何の用事かな？";
...
// 一次試験（アイテム収集）
//------------------------------------------------------------
prt_in,75,107,4	script	騎士アンドリュー	65,{
	if(Job == Job_Novice) {
		mes "[騎士アンドリュー]";
		mes "ノービスですね。";
		mes "プロンテラ騎士団にようこそ。";
...
// 二次試験（口頭試問）
//------------------------------------------------------------
prt_in,71,91,0	script	騎士ジェームズ	65,{
	if(Job == Job_Novice) {
		mes "[騎士ジェームズ]";
		mes "おう、ノービスがこんな所に";
		mes "どんな用かな？";
...
// 三次試験（戦闘試験）
//------------------------------------------------------------
prt_in,79,94,4	script	騎士ウインザー	733,{
	mes "[騎士ウインザー]";
	mes "……";
	next;
	if(Job == Job_Novice) {
...
job_knt,89,106,4	script	騎士ウインザー#Test	733,{
	mes "[騎士ウインザー]";
	mes "……";
	next;
	mes "[騎士ウインザー]";
...
OnWarp:
	...
	monster "job_knt",39,150,"--ja--",1114,1,"KN_Test3::OnKilled1";
	monster "job_knt",39,142,"--ja--",1114,1,"KN_Test3::OnKilled1";
	monster "job_knt",35,146,"--ja--",1100,1,"KN_Test3::OnKilled1";
	monster "job_knt",47,150,"--ja--",1114,1,"KN_Test3::OnKilled1";
	monster "job_knt",47,142,"--ja--",1114,1,"KN_Test3::OnKilled1";
	monster "job_knt",43,137,"--ja--",1160,1,"KN_Test3::OnKilled1";
	monster "job_knt",43,137,"--ja--",1095,1,"KN_Test3::OnKilled1";
	monster "job_knt",43,137,"--ja--",1105,1,"KN_Test3::OnKilled1";
	monster "job_knt",43,155,"--ja--",1160,1,"KN_Test3::OnKilled1";
	monster "job_knt",43,155,"--ja--",1095,1,"KN_Test3::OnKilled1";
	monster "job_knt",43,155,"--ja--",1105,1,"KN_Test3::OnKilled1";
	monster "job_knt",52,146,"--ja--",1100,1,"KN_Test3::OnKilled1";
	warpwaitingpc "job_knt",43,147,1;
	end;
}

job_knt,0,0,0	script	KN_Test3	-1,{
	end;
OnKilled1:
	set .count,.count-1;
	if(.count)
	...
	set .count,12;
	monster "job_knt",34,52,"--ja--",1119,1,"KN_Test3::OnKilled2";
	monster "job_knt",29,52,"--ja--",1111,2,"KN_Test3::OnKilled2";
	monster "job_knt",53,52,"--ja--",1119,1,"KN_Test3::OnKilled2";
	monster "job_knt",58,52,"--ja--",1111,2,"KN_Test3::OnKilled2";
	monster "job_knt",43,42,"--ja--",1106,1,"KN_Test3::OnKilled2";
	monster "job_knt",43,62,"--ja--",1106,1,"KN_Test3::OnKilled2";
	monster "job_knt",57,64,"--ja--",1030,1,"KN_Test3::OnKilled2";
	monster "job_knt",57,39,"--ja--",1030,1,"KN_Test3::OnKilled2";
	monster "job_knt",31,64,"--ja--",1030,1,"KN_Test3::OnKilled2";
	monster "job_knt",31,39,"--ja--",1030,1,"KN_Test3::OnKilled2";
	warp "job_knt",43,52;
	end;
OnKilled2:
	set .count,.count-1;
	...
	initnpctimer "KN_Timer";
	set .count,7;
	monster "job_knt",136,152,"--ja--",1122,1,"KN_Test3::OnKilled3";
	monster "job_knt",150,152,"--ja--",1123,1,"KN_Test3::OnKilled3";
	monster "job_knt",143,145,"--ja--",1124,1,"KN_Test3::OnKilled3";
	monster "job_knt",136,158,"--ja--",1280,1,"KN_Test3::OnKilled3";
	monster "job_knt",130,165,"--ja--",1125,1,"KN_Test3::OnKilled3";
	monster "job_knt",156,165,"--ja--",1126,1,"KN_Test3::OnKilled3";
	monster "job_knt",143,167,"--ja--",1258,1,"KN_Test3::OnKilled3";
...
OnKilled3:
	...
	set CHANGE_KN,8;
	warp "prt_in",80,100;
	killmonster "job_knt","KN_Test3::OnKilled1";
	killmonster "job_knt","KN_Test3::OnKilled2";
	killmonster "job_knt","KN_Test3::OnKilled3";
	enablewaitingroomevent "騎士ウインザー#Test";
	end;
}

job_knt,0,0,0	script	KN_Timer	-1,{	//試験中および各段階クリア後のnext待ちタイマー
	end;
OnTimer180000:
	stopnpctimer;
	areawarp "job_knt",22,126,65,165,"prt_in",80,100;
	areawarp "job_knt",22,32,65,71,"prt_in",80,100;
	areawarp "job_knt",122,132,165,171,"prt_in",80,100;
	killmonster "job_knt","KN_Test3::OnKilled1";
	killmonster "job_knt","KN_Test3::OnKilled2";
	killmonster "job_knt","KN_Test3::OnKilled3";
	enablewaitingroomevent "騎士ウインザー#Test";
...
// 四次試験（性格試験）
//------------------------------------------------------------
prt_in,69,107,6	script	騎士エイミー	728,{
	if(Job == Job_Novice) {
		mes "[騎士エイミー]";
		mes "あら、かわいいノービスさん。";
		mes "とってもかわいいわ～。";
...
// 五次試験（忍耐力試験）
//------------------------------------------------------------
prt_in,70,99,6	script	騎士エドモンド	734,{
	if(Job == Job_Novice) {
		mes "[騎士エドモンド]";
		mes "根深い木は風に負けない…";
		next;
	...
	killmonster "job_knt","KN_Test5::OnKilled";
	monster "job_knt",167,57,"--ja--",1182,1,"KN_Test5::OnKilled";
	monster "job_knt",167,54,"--ja--",1182,1,"KN_Test5::OnKilled";
	monster "job_knt",120,57,"--ja--",1182,1,"KN_Test5::OnKilled";
	monster "job_knt",120,54,"--ja--",1182,1,"KN_Test5::OnKilled";
	monster "job_knt",141,57,"--ja--",1002,1,"KN_Test5::OnKilled";
	monster "job_knt",145,57,"--ja--",1002,1,"KN_Test5::OnKilled";
	monster "job_knt",143,55,"--ja--",1002,1,"KN_Test5::OnKilled";
	monster "job_knt",143,59,"--ja--",1002,1,"KN_Test5::OnKilled";
	monster "job_knt",141,55,"--ja--",1063,1,"KN_Test5::OnKilled";
	monster "job_knt",141,59,"--ja--",1063,1,"KN_Test5::OnKilled";
	monster "job_knt",145,55,"--ja--",1063,1,"KN_Test5::OnKilled";
	monster "job_knt",145,59,"--ja--",1063,1,"KN_Test5::OnKilled";
	//stackとみなされ別所に沸くみたいなのでコメントアウト
	//	monster "job_knt",139,57,"--ja--",1011,1,"KN_Test5::OnKilled";
	//	monster "job_knt",147,57,"--ja--",1011,1,"KN_Test5::OnKilled";
	//	monster "job_knt",143,53,"--ja--",1011,1,"KN_Test5::OnKilled";
	//	monster "job_knt",143,61,"--ja--",1011,1,"KN_Test5::OnKilled";
	warp "job_knt",143,57;
	end;
}

//同一MAPに居るNPCからイベントを発動する必要あり
job_knt,0,0,0	script	KN_Test5	-1,{
	end;
...
// 最終試験 及び クレイモア作成
//------------------------------------------------------------
prt_in,87,92,4	script	騎士グレー	119,{
	if(Job == Job_Novice) {
		mes "[騎士グレー]";
		mes "こう見えても、俺にだって";
		mes "ノービス時代があったんだ。";
...
// ペコペコレンタル
//------------------------------------------------------------
prontera,55,350,5	script	ペコペコ管理兵	105,{
	if(Job != Job_Knight) {
		mes "[ペコペコ管理兵]";
		mes "何の御用ですか？";
		mes "ペコペコは、ナイト様と";
