...
// Shop
//------------------------------------------------------------
ma_in01,73,22,3	shop	武器商人	536,1207:-1,1216:-1,1107:-1,1122:-1,1116:-1,1154:-1,1407:-1,1457:-1,1354:-1,1519:-1
ma_in01,67,13,5	shop	防具商人	536,2211:-1,2401:-1,2403:-1,2501:-1,2503:-1,2101:-1,2103:-1,2305:-1,2321:-1,2332:-1,2328:-1,2627:-1
ma_in01,22,23,3	shop	道具商人	536,611:-1,1750:-1,501:-1,502:-1,503:-1,504:-1,645:-1,656:-1,601:-1,602:-1,1065:-1,2239:-1
malaya,150,261,3	shop	果物商人	535,512:-1,513:-1,515:-1,516:-1,535:-1

//============================================================
// アルベルタ⇔ポートマラヤ転送NPC
//------------------------------------------------------------
alberta,196,202,3	script	オフタラマ号船員	100,{
	mes "[オフタラマ号船員]";
	mes "お～い、君。";
...
malaya,276,55,4	script	オフタラマ号船員	100,{
	if(MALAYA_1QUE < 2) {
		mes "[オフタラマ号船員]";
		mes "まだ町が騒がしいようだな。";
		mes "観光は終わったか？";
...
malaya,237,240,4	script	ジプニードライバー#01	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "うううううっ……";
		mes "怖い……怖いよ……";
...
malaya,67,44,4	script	ジプニードライバー#02	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "い……いったい……";
		mes "病院で何が起こっているんだ？";
...
malaya,282,129,4	script	ジプニードライバー#03	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "よそ者に話すことはありません……";
		mes "ムンバキ様なら";
...
malaya,134,250,6	script	ジプニードライバー#04	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "あ……あっちに……行ってくれ……";
		close;
...
malaya,341,153,4	script	ジプニードライバー#05	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "ま……町に悪霊が……";
		mes "何だ……君も悪霊にやられたのか？";
...
malaya,293,290,6	script	ジプニードライバー#06	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "け……警備隊……";
...
malaya,242,221,4	script	ジプニードライバー#07	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "ああ……町じゅうがおばけだらけだ。";
		mes "やはり、指導者ムンバキ様が";
...
malaya,62,245,6	script	ジプニードライバー#08	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "来るな～";
		mes "おばけなら来るな～";
...
malaya,257,58,6	script	ジプニードライバー#09	582,{
	if(MALAYA_1QUE < 2) {
		mes "[ジプニードライバー]";
		mes "……外国から来た方ですね。";
		mes "町の中は危険なので";
...
// ポートマラヤ室内NPC
//------------------------------------------------------------
ma_in01_jp,81,22,5	script	悩む老女	575,{
	mes "[悩む老女]";
...
ma_in01_jp,67,22,5	script	ティクバラン専門家	582,{
	...
	if(checkquest2(106176)) {
		if(!(checkquest2(106176) & 0x4)) {
			mes "[ティクバラン専門家]";
			mes "どうした？";
...
// 謎の生物NPC
//------------------------------------------------------------
ma_fild01,74,367,6	script	謎の生物#01	572,2,2,{
	end;
OnTouch:
	if(getcharid(1)) {
		mes "‐謎の生物はあなたを見て";
...
ma_fild01,109,116,4		script	謎の生物#02	572,2,2,{
	end;
OnTouch:
	if(!getcharid(1)) {
		mes "‐謎の生物はあなたを見て";
...
ma_fild01,280,150,6		duplicate(謎の生物#02)	謎の生物#03	572,2,2
ma_fild01,309,221,6		duplicate(謎の生物#02)	謎の生物#04	572,2,2
ma_fild02,282,41,4		duplicate(謎の生物#01)	謎の生物#05	572,2,2

ma_fild02,246,324,4		script	謎の生物#06	572,2,2,{
	end;
OnTouch:
	if(!getcharid(1)) {
		mes "‐謎の生物はあなたを見て";
...
ma_fild02,71,296,6		duplicate(謎の生物#06)	謎の生物#07	572,2,2
ma_fild02,32,263,4		duplicate(謎の生物#06)	謎の生物#08	572,2,2

ma_scene01,195,92,4		script	謎の生物#09	572,2,2,{
	end;
OnTouch:
	if(getcharid(1)) {
		mes "‐謎の生物はあなたを見て";
...
ma_scene01,158,139,4	script	謎の生物#10	572,2,2,{
	end;
OnTouch:
	if(!getcharid(1)) {
		mes "‐謎の生物はあなたを見て";
...
ma_scene01,167,112,6	duplicate(謎の生物#10)	謎の生物#11	572,2,2

//============================================================
// 噂話NPC
//------------------------------------------------------------
malaya,227,311,4	script	お婆ちゃん	575,{
	if(MALAYA_1QUE < 2) {
		mes "[お婆ちゃん]";
		mes "外から来たのかい？";
...
malaya,189,263,4	script	太鼓を持った青年	578,{
	if(MALAYA_1QUE < 2) {
		emotion 23;
		mes "[太鼓を持った青年]";
		mes "うわああ……。";
...
malaya,270,59,4	script	港の警備隊員	570,{
	if(MALAYA_1QUE < 2) {
		emotion 19;
		mes "[港の警備隊員]";
		mes "町の様子が慌ただしいというのに";
...
malaya,219,92,6	script	ちびっ子	577,{
	if(MALAYA_1QUE < 2) {
		mes "[ちびっ子]";
		mes "お母さんが、危険だから";
		mes "外で遊ぶなって言うの。";
...
malaya,363,283,4	script	住民	582,{
	if(MALAYA_1QUE < 2) {
		mes "[住民]";
		mes "うむ……魔女の呪いを";
		mes "気を付けなければならない時期が";
...
malaya,185,358,3	script	指導者ムンバキ・ポン	580,{
	...
	case 2:
		...
		mes "君の魂はとても強く純粋だ。";
		mes "暗闇を恐れるな。";
		if(checkquest2(7353)&8 == 0)
			viewpoint 1,181,353,0,0xFFFFFF;
		if(checkquest2(7357)&8 == 0)
			viewpoint 1,228,267,1,0xFFFF00;
		if(checkquest2(7355)&8 == 0)
			viewpoint 1,295,171,2,0x0000FF;
		if(checkquest2(7354)&8 == 0)
			viewpoint 1,119,217,3,0xCCCCCC;
		if(checkquest2(7352)&8 == 0)
			viewpoint 1,326,68,4,0x00FF00;
		if(checkquest2(7356)&8 == 0)
			viewpoint 1,223,267,5,0xFF0000;
		close;
	case 3:
		mes "[ムンバキ・ポン]";
	...
	case 4:
		...
		mes "彼らのいる場所を地図に記そう。";
		mes "すまないが頼んだよ。";
		if(checkquest2(7360)&8 == 0)
			viewpoint 1,181,353,0,0xFFFFFF;
		if(checkquest2(7364)&8 == 0)
			viewpoint 1,228,267,1,0xFFFF00;
		if(checkquest2(7362)&8 == 0)
			viewpoint 1,295,171,2,0x0000FF;
		if(checkquest2(7361)&8 == 0)
			viewpoint 1,119,217,3,0xCCCCCC;
		if(checkquest2(7359)&8 == 0)
			viewpoint 1,326,68,4,0x00FF00;
		if(checkquest2(7363)&8 == 0)
			viewpoint 1,223,267,5,0xFF0000;
		close;
	case 5:
		mes "[ムンバキ・ポン]";
...
// MALAYA_2QUE -> 0～5
//------------------------------------------------------------
malaya,169,350,5	script	イメルダー	475,{
	if(MALAYA_1QUE < 2) {
		mes "[イメルダー]";
		mes "ん……なにかしら。";
	...
	case 3:
		...
		mes "みんな不安だと思うから、";
		mes "できるだけ早く配ってきてね。";
		if(checkquest2(7383) == 0)
			viewpoint 1,181,353,0,0xFFFFFF;
		if(checkquest2(7387) == 0)
			viewpoint 1,228,267,1,0xFFFF00;
		if(checkquest2(7385) == 0)
			viewpoint 1,295,171,2,0x0000FF;
		if(checkquest2(7384) == 0)
			viewpoint 1,119,217,3,0xCCCCCC;
		if(checkquest2(7382) == 0)
			viewpoint 1,326,68,4,0x00FF00;
		if(checkquest2(7386) == 0)
			viewpoint 1,223,267,5,0xFF0000;
		close;
	case 4:
		mes "[イメルダー]";
...
malaya,181,353,5	script	老人ナルド	574,{
	...
	case 2:
		...
		next;
		if( (
			checkquest2(7352) + checkquest2(7353) +
			checkquest2(7354) + checkquest2(7355) +
			checkquest2(7356) + checkquest2(7357)
		) == 48) {
			mes "‐すでに複数の町人から";
			mes "　同じようなお願いをされている。";
			mes "　どうしたものだろうか。";
	...
	case 4:
		...
		viewpoint 2,1,1,0,0xFFFFFF;
		if( (
			checkquest2(7359) + checkquest2(7360) +
			checkquest2(7361) + checkquest2(7362) +
			checkquest2(7363) + checkquest2(7364)
		) == 48) {
			next;
			mes "‐老人を最後に";
			mes "　全て配り終えたようだ。";
	...
	case 5:
		...
		close;
	case 6:
		if(checkquest2(7369) || checkquest2(72174)) {
			mes "[老人ナルド]";
			mes "おお、お主か。";
			mes "何か用ですかな。";
			next;
			...
			viewpoint 2,1,1,0,0xFFFFFF;
			if( (
				(checkquest2(7382)&1) + (checkquest2(7383)&1) +
				(checkquest2(7384)&1) + (checkquest2(7385)&1) +
				(checkquest2(7386)&1) + (checkquest2(7387)&1)
			) == 6) {
				setquest 7379;
				delquest 7382;
				delquest 7383;
...
malaya,228,267,3	script	ローメル	573,{
	...
	case 5:
		...
		close;
	case 6:
		if(checkquest2(7373) || checkquest2(72182)) {
			mes "[ローメル]";
			mes "こんにちは。";
			mes "良い天気ですね。";
			next;
...
malaya,223,267,5	script	タルラー	941,{
	...
	case 5:
		...
		close;
	case 6:
		if(checkquest2(7372) || checkquest2(72180)) {
			mes "[タルラー]";
			mes "こ……こんにちは。";
			mes "新しいお守りですか？";
			next;
...
malaya,62,274,0	script	砂くぼみ#mal01	557,{
	if(!checkquest2(7366) && !checkquest2(7380)) {
		mes "‐海水を蒸発させる簡易装置が";
		mes "　砂に埋まっている‐";
		close;
	}
...
// ジェジェリンの落し物クエストNPC
//------------------------------------------------------------
malaya,295,171,3	script	収集品商人ウォアン	582,{
	switch(MALAYA_1QUE) {
	case 0:
	case 1:
		mes "[ウォアン]";
	...
	case 5:
		...
		close;
	case 6:
		if(checkquest2(7371) || checkquest2(72178)) {
			mes "[ウォアン]";
			mes "よう、どうした？　仕事の催促か？";
			next;
			mes "‐ウォアンにお守りを渡した‐";
...
malaya,119,217,3	script	研修鍛冶屋パンドイ	538,{
	...
	case 5:
		...
		close;
	case 6:
		if(checkquest2(7370) || checkquest2(72176)) {
			mes "[パンドイ]";
			mes "おお、先生！　それはもしかして";
			mes "イメルダーさんが作ったという";
			mes "新しいお守りですか！";
		...
		if((checkquest2(7393) & 0x4) && countitem(6508) >= 10) {
			mes "[パンドイ]";
			mes "先生……さすがです！";
			mes "あの恐ろしい奴らを倒して";
			mes "注文通り、銀のブレスレットを";
...
malaya,326,68,2	script	船員ペドロ	100,{
	...
	case 5:
		...
		close;
	case 6:
		if(checkquest2(7368) || checkquest2(72172)) {
			mes "[ペドロ]";
			mes "おや、こんにちは冒険者様。";
			mes "風が気持ちいいですね。";
			next;
...
ma_in01,125,107,3	script	霊魂ディワタ	1752,4,4,{
	end;
OnTouch:
	switch(MALAYA_3QUE) {
	case 1:
	...
	case 6:
		if(checkquest2(7401) || checkquest2(7403)) {
			if(checkquest2(7401) & 0x2) {
				cutin "malaya_diwata01",2;
				mes "[ディワタ]";
				mes "あっちに行って!!";
...
ma_in01_jp,45,154,3	script	ムンバキ・キコ	580,{
	...
	if(checkquest2(72060) && countitem(523) >= 10) {
		mes "[ムンバキ・キコ]";
		mes "うむ、この悪霊の骨には";
		mes "すべて悪い気が宿っている。";
		mes "ただその分この骨には";
	...
	mes "人と霊を見守っている霊道師";
	mes "ムンバキ・キコだ。";
	if(checkquest2(7377) || checkquest2(72060) || checkquest2(7407)) {
		mes "何かご用かね。";
		next;
...
ma_in01,122,158,0	script	警備隊員ドン	570,{
	...
	if(checkquest2(7406) || checkquest2(106176) || checkquest2(72060)) {
		mes "[警備隊員ドン]";
		mes "悪霊の骨は、北西の家にいる";
		mes "ティクバラン専門家が持っています。";
		mes "よろしくお願いします。";
...
malaya,210,200,5	script	ドクタープン	865,{
	if(MALAYA_1QUE < 6) {
		mes "[ドクタープン]";
		mes "……";
		next;
...
// MALAYA_5QUE -> 0～15
//------------------------------------------------------------
malaya,305,281,3	script	警備隊員	570,7,7,{
	if(MALAYA_1QUE < 2) {
		mes "‐警備隊員は警戒中のようだ。";
		mes "　相手をしてくれそうにない‐";
		close;
...
malaya,290,152,5	script	狩りの達人	578,{
	switch(MALAYA_5QUE) {
	case 5:
		mes "[狩りの達人]";
		mes "ひゅぅぅう！　ふぉぉぉぉ！";
...
malaya,290,340,3	script	警備隊長	571,{
	if(MALAYA_1QUE < 6) {
		mes "‐警備隊長は鋭い目で";
		mes "　あなたを睨みながら警戒している‐";
		close;
...
ma_fild02,312,259,3	script	犬#buwaya	81,{
	mes "[犬]";
	mes "ワンワン!!";
	if(MALAYA_5QUE == 11) {
		next;
...
ma_fild02,305,268,3	script	警備隊員#buwaya	570,{
	end;
OnInit:
	hideonnpc "警備隊員#buwaya";
	end;
...
// MALAYA_6QUE -> 0～7
//------------------------------------------------------------
malaya,280,331,4	script	歌う男	578,{
	if(MALAYA_6QUE < 6) {
		mes "[歌う男]";
		mes "湖に住んでいる龍のお話し～";
		mes "遠い昔龍になってしまった ";
...
malaya,275,333,5	script	歌う女	579,{
	if(MALAYA_6QUE < 6) {
		mes "[歌う女]";
		mes "湖に住んでいるバコナワ、";
		mes "龍になった老婆の話。";
...
malaya,290,329,4	script	恐怖に怯えている少年	577,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,264,338,4	script	恐怖に怯えている女性	576,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,285,332,4	script	伝説に詳しい老人	574,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,304,100,4	script	老人の孫娘	576,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
// MALAYA_7QUE -> 0～15
//------------------------------------------------------------
malaya,286,269,4	script	激憤している男	578,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,276,269,5	script	落ち着いている少女	579,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,276,262,4	script	激憤している少年	577,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,283,265,4	script	町長	580,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,269,267,5	script	失踪した青年の父親	582,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,265,274,5	script	失踪した少女の友達	577,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,270,278,4	script	失踪した男性の息子	578,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,265,284,4	script	失踪した少年の母親	579,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
malaya,289,364,4	script	若い占い師	583,{
	if(MALAYA_1QUE < 6) {
		mes "‐あなたを警戒している‐";
		close;
	}
...
// ピンタドスフェスティバルNPC
//------------------------------------------------------------
ma_in01_jp,45,148,1	script	イスコ#pin	577,{
...
ma_fild01,249,206,6	script	若いタトゥーイスト#pin	582,{
	mes "[若いタトゥーイスト]";
	mes "無計画な人がお客様だと";
	mes "本当に困ります。";
	next;
...
ma_fild01,164,228,6	script	太鼓を叩く青年#pin3	578,{
	mes "‐ドドドドーン‐";
	next;
	mes "[太鼓を叩く青年]";
	mes "よく覚えてないが、";
...
ma_fild01,170,228,4	script	拍子を合わせる少年#pin3	577,{
	mes "‐タタタタン‐";
	next;
	mes "[拍子を合わせる少年]";
	mes "今は棒を使って";
