...
lasagna,346,244,6	substore(SpecialItemShopper)	スペシャルアイテム販売	73
...
prontera,123,62,5	script	服装染色師	97,{
	...
	function ExcolorSample {
		...
		case Job_Mage:	return "excolor_magician.bmp";
		...
		case Job_Super_Novice_E:	return "excolor_supernovice.bmp";
...
prontera,125,62,4	script	騎乗協会広報員	832,{
	...
	case Job_Mage:	set .@name$,"riding_magician.bmp"; break;
	...
	case Job_Dancer:
		...
		break;
	case Job_SuperNovice:
	case Job_Super_Novice_E:	set .@name$,"riding_supernovice.bmp"; break;
...
// ジェレミーの美容クーポン
//------------------------------------------------------------
izlude,136,122,6	script	シニアスタイリスト	878,{
