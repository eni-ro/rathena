...
morocc_in,174,30,6	script	子供	716,{
	if(Job == Job_Linker) {
		mes "[子供]";
		mes "これから進む道において、";
		mes "君に、そして共に歩む魂たちに";
...
job_soul,37,30,5	script	マイア#SL_Test	716,7,1,{
OnTouch:
...
OnTimer180000:
	stopnpctimer;
	areawarp "job_soul",30,30,30,30,"morocc",157,47;
	end;
}

job_soul,23,30,6	script	アルケミストの魂	744,{
	mes "[アルケミストの魂]";
...
job_soul,30,23,7	script	セージの魂	754,{
	mes "[セージの魂]";
	mes "破壊！";
	mes "破壊だけが私の進む道！";
...
job_soul,30,37,5	script	モンクの魂	827,{
	mes "[モンクの魂]";
	mes "俺は生きていた頃、";
	mes "モンクとしてすべきことを";
	mes "全て終えたと思っていた。";
