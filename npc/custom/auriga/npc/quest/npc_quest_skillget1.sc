...
// 追加スキル Part 0 - ノービス
//	■ SKILL_AID   -> 応急手当用フラグ、0～2
//	　 SKILL_DEAD  -> 死んだふり用フラグ、0～2
//	　 @novice_tag -> 0or1

//-----------------------------------------------
//==== 応急処置 - NV_FIRSTAID
//-----------------------------------------------
prt_in,234,133,4	script	ナミ	66,{
	if(Upper == UPPER_HIGH) {
		mes "[ナミ]";
		mes "あ、ちょうどいい所へ！";
		mes "私は看護教師志望の実習生、";
...
//-----------------------------------------------
prt_in,73,87,4	script	プロンテラ騎士団員	65,{
...
//==== 看護将校
//-----------------------------------------------
prt_castle,175,146,4	script	看護将校	50,{
	mes "[ドレッド]";
	mes "…";
	mes "……";
	mes "気が散る！";
...
//-----------------------------------------------
izlude_in,175,130,2	script	騎士デトマソ	98,{
	if(getskilllv(144)) {
		mes "[デトマソ]";
		mes "よう、";
		mes "久しぶりだな！";
...
//-----------------------------------------------
prt_in,75,88,5	script	レオ=フォン=フリッシュ	85,{
	if(getskilllv(145)) {
		mes "[レオ]";
		mes "やぁ、";
		mes "誰かと思ったら";
...
//-----------------------------------------------
geffen_in,151,119,4	script	大魔道師	64,{
	mes "[ブリザードリス]";
	mes "……";
	mes "魔道に生きる者ならば……";
	mes "己の内に秘めし力……";
	...
	case 2:
		...
		if((getbaseclass(Class) != CLASS_MG) || (Job == Job_Mage && JobLevel<35) ||
...
//==== 矢作成 ===
//---------------------------
morocc,121,109,5	script	ギョルナリ	88,{
	if(getskilllv(147)) {
		mes "[ギョルナリ]";
		mes "あ、故郷の方ですね！";
		mes "嬉しい！";
...
//==== チャージアロー ===
//---------------------------
payon,103,63,4	script	カイゴ	88,3,3,{
...
// 追加スキル Part 4 - 聖職者
//-----------------------------------------------
//==== ホーリーライト - AL_HOLYLIGHT
//-----------------------------------------------
prt_church,173,23,4	script	主任アコライト	79,{
	mes "[アコライト・クリプト]";
	mes "おお、迷える子羊よ…";
	mes "力を欲しているのですか…？";
	next;
	switch (select("^3355FF「アコライトの隠された能力」^000000 について","^3355FF「ホーリーライト」^000000 を引き継ぐ","会話をやめる")) {
	case 1:
		mes "[アコライト・クリプト]";
		mes "私たち聖職者たちは";
		mes "自ら身につける能力とは別に";
		...
		mes "聖なる力で浄化することに";
		mes "より人間界から消滅させる…";
		mes "^3355FF「ホーリーライト」^000000がそれです。";
		mes "その能力をあなたが引き継ぐには";
		mes "特別な準備が必要となり、";
		next;
		mes "[アコライト・クリプト]";
		mes "これらの媒体が必要です。";
		mes "^FF3355オパール 1つ^000000";
		mes "^FF3355クリスタルブルー 1つ^000000";
		mes "^FF3355ロザリー 1つ^000000";
		mes "以上です。";
		next;
		mes "[アコライト・クリプト]";
		mes "また、その能力を引き継ぐためには";
		mes "ある程度の資質…つまり";
		mes "^3355FF職業レベル 30 以上^000000";
		mes "が必要ですね。";
		next;
		mes "[アコライト・クリプト]";
		mes "プリーストの場合は";
	...
	case 2:
		//クローンスキルのHLは除外
		if((getbaseclass(Class) != CLASS_AL) && getskilllv(156)) {
			mes "[アコライト・クリプト]";
			mes "兄弟よ…あなたは";
			mes "「ホーリーライト」を";
			mes "すでに引き継いだ身…";
		...
		if((getbaseclass(Class) != CLASS_AL) || (Job == Job_Acolyte && JobLevel<30) ||
						countitem(727)<1 || countitem(991)<1 || countitem(2608)<1) {
			mes "[アコライト・クリプト]";
			mes "ああ…迷える子羊よ…";
			mes "あなたは「ホーリーライト」を";
			mes "引き継ぐ資格を得ていません…";
...
//==== ラウドボイス MC_LOUD ===
//-----------------------------------------------
alberta,83,96,5	script	ネコ	98,7,7,{
	if(getskilllv(155)) {
		mes "[ネコ]";
		mes "申し訳ありません。ネコの店は…";
		mes "あ、誰かと思ったら～";
...
//==== チェンジカート Change Cart ===
//-----------------------------------------------
alberta,119,221,6	script	シャイロン	107,{
	if(getskilllv(154)) {
		mes "[シャイロン]";
		mes "うーん、誰がこんなに騒々しい";
		mes "カートを引いてるのかと思ったら";
...
//-----------------------------------------------
//alberta,232,106,6	script	コサンス	57,{
alberta,232,103,6	script	コサンス	57,{
	if(getbaseclass(Class) != CLASS_MC) {
		mes "[コサンス]";
		mes "なるようにしかならない。";
		mes "どうにもならないときは";
...
moc_prydb1,154,128,4	script	アルコスク	118,{
	...
	mes "さぁ、どれに興味がある？";
	next;
	set @menu,select("砂まき","バックステップ","石拾い","石投げ","もう少し考えてみます");
	if(@menu==5) {
		mes "[アルコスク]";
		mes "慎重派だね。";
		mes "決まったらまたおいで。";
	...
	if(getskilllv(149+@menu-1)) {
		mes "[アルコスク]";
		mes "君はすでにマスターしてるじゃないか";
		mes "もっと他の事にチャレンジしよう";
		close;
	}
	switch(@menu) {
	case 1:
		if(SKILL_SAND == 0) {
			if((Job == Job_Thief && JobLevel<25) || countitem(7041)<5) {
				mes "[アルコスク]";
				mes "シーフってのはさ、手段を問わず";
				mes "自分を守る技術を一つは";
				mes "持っていて良いと思う。";
				mes "周りの奴は卑怯だとかずるいとか";
				mes "言うけどさ、僕はそうは思わないね。";
				next;
				mes "[アルコスク]";
				mes "世の中勝ったものが生き残る。";
				mes "同じ商売仲間として僕が特別に";
				...
				mes "[アルコスク]";
				mes "僕たちも生きるためならそれも";
				mes "やるしかない。そして、そのためには";
				mes "まず砂を用意しなきゃ。";
				mes "砂はあらかじめ用意しておこう。";
				mes "ちょっと行ってきて";
				mes "^3355FF「きれいな小石」^000000を^3355FF5個^000000集めてきて。";
				next;
				mes "[アルコスク]";
				mes "早く教えて欲しいっていう気持ちも";
				mes "分かるけど、とりあえずそれを";
				mes "集めてくる前にスキルを";
				mes "教えるわけにはいかない。";
				mes "わかったら行ってきて。";
				...
				mes "アサシンなら問題がないが";
				mes "シーフの場合は";
				mes "^3355FF職業レベル25以上^000000にならないと";
				mes "教えられないってことだけ";
				mes "覚えておいてね。";
				close;
			}
		...
		if(SKILL_SAND == 1) {
			...
			mes "[アルコスク]";
			mes "ていっ！";
			mes "^5533FF- ザザッ -^000000";
			next;
			mes "^5533FF- ぶわっ -^000000";
			next;
			mes "[アルコスク]";
			mes "ふふ…なかなか良い感じ。";
			mes "よし、マスターしたね。";
	...
	case 2:
		if((Job == Job_Thief && JobLevel<35) || countitem(940)<20) {
			mes "[アルコスク]";
			mes "戦闘ではもちろん攻撃をするけど";
			mes "少ない被害で相手を倒すことも";
			mes "大事なことだと思うんだよね。";
			mes "正確な判断のもとに裏をかくことも";
			mes "攻撃と同じくらい重要だ。";
			mes "僕たちは他の人達より";
			next;
			mes "[アルコスク]";
			...
			mes "練習に必要な物を今から";
			mes "いっぱい用意して来な。";
			mes "^3355FF「バッタの足」^000000を^3355FF20個^000000";
			mes "集めて来たら教えてあげるよ。";
			next;
			mes "[アルコスク]";
			mes "あ、一言言っておくけど、";
			mes "それを使いこなすためには";
			mes "ある程度の基本ができてなくちゃね。";
			mes "シーフの場合は";
			mes "^3355FF職業レベルが35^000000になるまでは";
			mes "教えられないな。";
			close;
		}
		mes "[アルコスク]";
		...
		close;
	case 3:
		if((Job == Job_Thief && JobLevel<20) || countitem(912)<1 || countitem(948)<1 || countitem(908)<5) {
			mes "[アルコスク]";
			mes "私達ギルド員の優秀な";
			mes "メンバー達は、大抵手先が器用なの。";
			mes "道端に落ちている小さな石ころを";
			mes "一瞬で見極め拾い、投げるのに";
			mes "適した石を選ぶことができるんだ。";
			next;
			...
			mes "「石投げ」をしっかりしたスキル";
			mes "にまで昇華することができた。";
			mes "いわゆる^3355FF「石拾い」^000000は";
			mes "^3355FF「石投げ」^000000スキルのために";
			next;
			mes "[アルコスク]";
			mes "どこででも硬くて投げやすい石を";
			mes "素早く選び抜き拾うためのスキルだ。";
			mes "そして石投げは遠くの敵に";
			mes "正確に石をぶつけることによって";
			mes "お金を一銭も掛けずに";
			mes "いくらかの効果を得られるもの。";
			...
			next;
			mes "[アルコスク]";
			mes "^3355FF「石拾い」^000000スキルは";
			mes "どこででも手軽に硬くて投げやすい";
			mes "石を拾いあげる能力…";
			mes "意外と奥が深いと思うよ？";
			next;
			mes "[アルコスク]";
			...
			mes "…オッホン…";
			mes "一応石ころを拾う練習の時";
			mes "手にはめる^3355FF「くまの足の裏」1つ^000000。";
			next;
			mes "[アルコスク]";
			mes "そのくまの足の裏で石の代わりに";
			mes "拾う対象が^3355FF「ジャルゴン」^000000！";
			mes "ジャルゴンが拾えれば完璧。";
			mes "あと^3355FF「かえるの卵」5つ^000000!!";
			mes "そして君の情熱！";
			mes "分かったら行ってきて～";
			close;
		}
		...
		mes "じゃ、一度やってみようか。";
		next;
		mes "^3355FF- シュッ -^000000";
		next;
		mes "^3355FF- カチッ！ -^000000";
		next;
		mes "^3355FF- シュパッ！ -^000000";
		next;
		mes "[アルコスク]";
		mes "良いじゃん、その調子！";
		mes "これなら実戦でもしっかり";
		...
		close;
	case 4:
		if((Job == Job_Thief && JobLevel<15) || countitem(910)<2 || countitem(911)<2) {
			mes "[アルコスク]";
			mes "私達ギルド員の優秀な";
			mes "メンバー達は、大抵手先が器用なの。";
			mes "道端に落ちている小さな石ころを";
			...
			next;
			mes "[アルコスク]";
			mes "用意するのは^3355FF「ガレット」2つ^000000";
			mes "そして^3355FF「セルー」2つ^000000だ。";
			mes "石の代わりに投げるのには";
			mes "十分丈夫な鉱物でしょ？";
			mes "用意してきたらすぐにでも";
			mes "スキル教えてあげるよ。";
		...
		mes "セルーとガレットを持ってー";
		next;
		mes "^3355FF- シューッ …カツン！ -^000000";
		next;
		mes "^3355FF- シュン！…パン！ -^000000";
		next;
		mes "^3355FF- シュパッ!! …ズガン!! -^000000";
		next;
		mes "[アルコスク]";
		mes "ストラィーーーク！";
		mes "よっしゃぁぁぁ！";
...
//-----------------------------------------------
//==== ポケット販売商人(SKILL_SAND関連)
//-----------------------------------------------
payon,91,77,4	script	ポケット販売商人	99,{
	mes "[ルルムニ]";
	mes "私はこのフェイヨン地方で";
	mes "弓と矢で狩りする";
	mes "狩人達と皮の取引をして";
	...
	case 0:
		...
		mes "います。";
		mes "たまにそちらから発注される";
		mes "^3355FF「底なし皮袋」^000000の";
		mes "製作もしています。";
		close;
	case 1:
		if(countitem(952)<1 || countitem(1055)<1 || countitem(1025)<1) {
			mes "[ルルムニ]";
			mes "シーフギルド員アルコスク";
			mes "からの注文を受けました。";
			mes "しかしこの底なし皮袋を";
			...
			mes "用意してきてください。";
			mes "材料は三種類";
			mes "^3355FFミミズの皮^000000";
			mes "^3355FFくもの糸^000000";
			mes "^3355FFサボテンの針^000000";
			mes "それぞれ1つずつです。";
			close;
		}
		mes "[ルルムニ]";
		mes "おお～お持ちくださいましたか！";
		mes "結構です結構です。";
		mes "今すぐ底なし皮袋をお作りしましょう。";
		mes "よっこらせっと、ちょいちょいちょい";
		mes "せっせせっせ、ちくちくちく…";
		mes "―";
		next;
		mes "[ルルムニ]";
