...
// Shop
//------------------------------------------------------------
-	shop	ecl_callshop	-1,519:-1
ecl_in01,65,85,5	script	牛乳商人#ecl	559,{
...
ecl_in01,66,95,3	script	防具商人ナパラ	436,{
	mes "[防具商人]";
	mes "こんにちは。";
	mes "高級品を厳選して扱う防具屋です。";
	mes "何か必要ですか？";
...
ecl_in01,64,97,5	script	スロット専門家ナトゥロ	436,{
	mes "[スロット専門家]";
	mes "私はナトゥロ。";
	mes "スロットの専門家です。";
	mes "スプレンディッドコイン5個で";
...
ecl_in01,33,98,5	script	薬草商人フライフィーナ	443,{
	mes "[薬草商人]";
	mes "いらっしゃいませ～っす！";
	mes "新鮮な生薬草だけ扱っている";
	mes "フライフィーナの薬草商店～っす！";
...
ecl_in01,67,39,4	script	複製の専門家パルツ	445,{
	emotion 3;
	mes "[パルツ]";
	mes "いらっしゃいませ。お客様。";
	mes "ふふっ。";
...
-	script	猫の手職員#eclage	-1,{
	...
	case 5:	// マヌク
		...
		setarray .@map$,"mid_camp","dicastes01";
		setarray .@x,207,189;
		setarray .@y,227,67;
		setarray .@cost,3,20;
		break;
...
eclage,117,40,4		duplicate(猫の手職員#eclage)	猫の手職員#1	421
splendide,373,240,4	duplicate(猫の手職員#eclage)	猫の手職員#2	421
mora,136,76,4		duplicate(猫の手職員#eclage)	猫の手職員#3	421
mid_camp,207,234,4	duplicate(猫の手職員#eclage)	猫の手職員#4	421
manuk,108,350,4		duplicate(猫の手職員#eclage)	猫の手職員#5	421
dicastes01,189,68,4	duplicate(猫の手職員#eclage)	猫の手職員#6	421

eclage,98,26,0	script	出口#eclage	45,1,1,{
...
// 案内員
//------------------------------------------------------------
eclage,177,56,3	script	エクラージュ案内員#01	462,{
	mes "[エクラージュ案内員]";
	mes "こんにちは冒険者さん。";
...
eclage,302,256,3	duplicate(エクラージュ案内員#01)	エクラージュ案内員#02	462
eclage,267,155,3	duplicate(エクラージュ案内員#01)	エクラージュ案内員#03	462
eclage,184,191,3	duplicate(エクラージュ案内員#01)	エクラージュ案内員#04	462
eclage,288,288,3	duplicate(エクラージュ案内員#01)	エクラージュ案内員#05	462
eclage,184,123,3	duplicate(エクラージュ案内員#01)	エクラージュ案内員#06	462
eclage,96,70,3		duplicate(エクラージュ案内員#01)	エクラージュ案内員#07	462

ecl_in01,48,60,5	script	エクラージュガード	447,{
	mes "[エクラージュガード]";
	mes "冒険者よ、歓迎します。";
	mes "ここは偉大で神聖な木";
...
// クエスト案内員
//------------------------------------------------------------
eclage,279,293,3	script	不思議な上級ラフィネ	435,{
	mes "[不思議な上級ラフィネ]";
	mes "……不思議な風が吹いています。";
	mes "どうやらあなたが";
	...
	while(1) {
		...
		case 1:
			...
			close2;
			switch(.@menu) {
			case 0: warp "ecl_fild01",94,320; break;	// 冒険者達との出会い
			case 1: warp "eclage",102,30; break;		// 夢見る作家
			case 2: warp "ecl_in01",32,49; break;		// エクラージュの王
			case 3: warp "eclage",282,254; break;		// 美しさの代償
			case 4: warp "eclage",156,53; break;		// 妖精たちの事件簿
			case 5: warp "ecl_in02",133,114; break;		// 悠久なる絆
			case 6: warp "ecl_in01",26,87; break;		// エクラージュの悪戯キッズ
			case 7: warp "ecl_fild01",190,92; break;	// ラフィネ流ガーデニング
			case 8: warp "ecl_fild01",190,92; break;	// 塔に挑んだ冒険者達
			case 9: warp "ecl_fild01",190,92; break;	// 塔の中の冒険者
			case 10: warp "ecl_tdun04",26,38; break;	// プロフェッサーワームの記憶
			}
			end;
		case 2:
			mes "[不思議な上級ラフィネ]";
...
// 住民
//------------------------------------------------------------
ecl_fild01,92,316,5	script	旅行者	545,{
	mes "[旅行者]";
	mes "こんなにいっぱい待っているとは……。";
	mes "私はいつになったら入れるかな？";
	emotion 28;
...
ecl_fild01,106,312,5	script	旅行者	525,{
	mes "[旅行者]";
	mes "私はもう書類を提出したけど";
	mes "ここの花畑がとても気に入って";
	mes "ここに居続けています。";
...
ecl_fild01,108,320,7	script	旅行者	941,{
	mes "[旅行者]";
	mes "エクラージュはどれほど美しい";
	mes "都市なのでしょうか？";
	mes "考えるだけでドキドキします。";
...
ecl_fild01,105,320,2	script	旅行者	436,{
	mes "[旅行者]";
	mes "違う、私は旅行者ではなく";
	mes "エクラージュの住民なんだよ！";
	emotion 6;
...
ecl_fild01,103,319,5	script	旅行者	900,{
	mes "[旅行者]";
	mes "ここのドングリは甘くて美味しい。";
	next;
	mes "[旅行者]";
...
ecl_fild01,110,316,3	script	旅行者	896,{
	mes "[旅行者]";
	mes "旅行をする時は荷物を";
	mes "少なめにした方がいいです。";
	next;
...
ecl_fild01,92,318,5	script	旅行者	517,{
	mes "[旅行者]";
	mes "うう……。";
	close;
}

ecl_fild01,93,318,5	script	旅行者	107,{
	mes "[旅行者]";
	mes "うう……うう……。";
	next;
	mes "[旅行者]";
...
ecl_fild01,94,313,5	script	旅行者	715,{
	mes "[旅行者]";
	mes "ん！　君もミッドガルド出身なのか？";
	next;
	mes "[旅行者]";
...
ecl_fild01,101,320,5	script	旅行者	522,{
	mes "[旅行者]";
	mes "はあ……足が痛い。";
...
ecl_fild01,88,315,5	script	旅行者	98,{
	mes "[旅行者]";
	mes "ああ……";
	mes "どうしてこんなに人が多いんだ……。";
	next;
...
ecl_in01,54,91,3	script	ダンディ#ecl	443,{
	mes "[ダンディ]";
	mes "この素晴らしい私を見てみな！";
	mes "どうだ？ かっこいいだろう？";
	next;
...
ecl_in01,53,92,4	script	ラフィキ#ecl	444,{
	mes "[ラフィキ]";
	mes "今日も私のセンスは素晴らしい。";
	next;
	emotion 14;
...
eclage,101,130,5	script	ウタポア	435,{
	mes "[ウタポア]";
	mes "私は親と一緒に住んでいたけど、";
	mes "最近一人暮らしを始めたのです!!";
	mes "自分のヤイを持つようになって";
...
ecl_in01,55,25,3	script	ミザニ	520,{
	mes "[ミザニ]";
	mes "異界から来た方ですね？";
	mes "歓迎します。";
	next;
...
eclage,106,61,4	script	マコサ	444,{
	mes "[マコサ]";
	mes "私も異界に行って見たいです。";
	next;
	mes "[マコサ]";
...
ecl_in02,168,41,3	script	パムボ	438,{
	mes "[パムボ]";
	mes "光るものは好きですか？";
	next;
	emotion 14;
...
ecl_fild01,134,109,6	script	ワラオ	446,{
	mes "[ワラオ]";
	mes "あ～、お腹が空いたけど、";
	mes "今日は何を食べようかな？";
	next;
...
ecl_in01,38,37,4	script	ひざまずいた少年	441,{
	mes "[ひざまずいた少年]";
	mes "どうしてこんな風にして";
	mes "いるのか気になるんですか？";
	next;
...
ecl_fild01,183,190,4	script	ケイタリン	447,{
	emotion 18;
	mes "[ケイタリン]";
	mes "わははは！ こんにちわ！";
...
ecl_in01,41,103,1	script	バルグレ少女	439,{
	mes "[バルグレ少女]";
	mes "この上にあるバルコニーが";
	mes "見えますか？";
...
ecl_in01,52,102,4	script	合唱団団長	442,{
	mes "[合唱団団長]";
...
ecl_in01,51,103,4	script	合唱団団員#ecl01	442,{
	emotion 2;
	mes "[合唱団団員]";
...
ecl_in01,53,103,4	duplicate(合唱団団員#ecl01)	合唱団団員#ecl02	442
ecl_in01,50,104,4	duplicate(合唱団団員#ecl01)	合唱団団員#ecl03	442
ecl_in01,52,104,4	duplicate(合唱団団員#ecl01)	合唱団団員#ecl04	442
ecl_in01,54,104,4	duplicate(合唱団団員#ecl01)	合唱団団員#ecl05	442

ecl_tdun03,50,47,4	script	看板	837,{
	mes "‐4階への入口が壊れているため、";
	mes "　ここからは上がれません。";
	mes "　用がある方は塔の入口にいる";
	mes "　案内人に話しかけてください‐";
...
ecl_in02,96,22,3	script	立て札	835,{
	mes "[北] 監獄";
	mes "[西] 治療所";
	close;
}

ecl_in01,8,71,5	script	エクラージュガード	447,{
	mes "[エクラージュガード]";
	mes "こちらはホームツリーの下層へ";
	mes "降りる道に繋がっています。";
	mes "また、監獄と治療所があります。";
...
ecl_in01,76,89,4	script	倉庫番ラフィネ	437,{
	mes "[倉庫番ラフィネ]";
	mes "倉庫使いますか～？";
...
ecl_in02,164,56,3	script	治療所受付員	437,{
	mes "[治療所受付員]";
	mes "こんにちは。";
	mes "ここはエクラージュ治療所です。";
	next;
...
ecl_in02,135,45,5	script	傷ついたラフィネ	441,{
	mes "[傷ついたラフィネ]";
	mes "うう……。";
	mes "ここは……どこですか……?";
	next;
...
ecl_in02,137,44,3	script	治療所ラフィネ	442,{
	mes "[傷ついたラフィネ]";
	mes "うう……。";
	mes "ここは……どこですか……?";
	next;
...
// ECL_1QUE -> 0～3
//------------------------------------------------------------
ecl_fild01,97,322,0	script	#ep14_2入り口	45,3,3,{
	if(ECL_1QUE < 3) {
		mes "[警備兵]";
		mes "お待ちください。";
		mes "初めてエクラージュを訪れる方は";
...
ecl_fild01,94,322,5	script	警備兵#ep14_2	447,{
	switch(ECL_1QUE) {
	case 0:
		mes "[警備兵]";
		mes "初めてエクラージュを訪れる方は";
...
ecl_fild01,100,323,3	duplicate(警備兵#ep14_2)	警備兵#ep14_2_2	447

ecl_fild01,111,320,3	script	出入国管理者	445,{
	switch(ECL_1QUE) {
	case 0:
		mes "[出入国管理者]";
		mes "何の用ですか？";
...
// ECL_2QUE -> 0～28
//------------------------------------------------------------
eclage,101,29,0	script	#ep14_2橋	139,5,5,{
...
eclage,102,32,4	script	妖精大工#ep14_2	443,{
	switch(ECL_2QUE) {
	case 0:
	case 1:
		mes "[妖精大工]";
...
ecl_fild01,201,91,4	script	ゴルリ	442,{
	switch(ECL_2QUE) {
	case 3:
		mes "[ゴルリ]";
		mes "生命は自然が作り出した";
...
eclage,283,275,4	script	グラシス	438,{
	switch(ECL_2QUE) {
	case 6:
		mes "[グラシス]";
		mes "う～ん……。";
...
eclage,191,200,4	script	ユッブ	446,{
	switch(ECL_2QUE) {
	case 7:
		mes "‐コソコソ‐";
		next;
...
ecl_in01,73,51,4	script	ミュラー	442,{
	switch(ECL_2QUE) {
	case 9:
		mes "[ミュラー]";
		mes "モレンの歳ですか？";
...
eclage,265,166,4	script	シュル	443,{
	switch(ECL_2QUE) {
	case 10:
		mes "[シュル]";
		mes "モレンの歳？";
...
eclage,137,169,4	script	タト	439,{
	switch(ECL_2QUE) {
	case 11:
		mes "[タト]";
		mes "モレンさんの歳ですか？";
...
eclage,266,216,4	script	モレン	444,{
	switch(ECL_2QUE) {
	case 15:
		mes "[モレン]";
...
ecl_in01,60,71,4	script	思い出にふけるラフィネ	443,{
	switch(ECL_2QUE) {
	case 17:
		mes "[思い出にふけるラフィネ]";
		mes "ふふふ";
...
ecl_fild01,97,315,4	script	旅人	732,{
	switch(ECL_2QUE) {
	case 18:
		mes "[旅人]";
		mes "誰だ？";
...
ecl_in01,70,88,4	script	行商人	495,{
	switch(ECL_2QUE) {
	case 19:
		mes "[行商人]";
		mes "にゃん？";
...
eclage,292,266,4	script	#ユッブの家	844,{
	if(ECL_2QUE < 15) {
		mes "‐扉が閉まっているようだ‐";
		close;
	}
...
ecl_in04,181,222,4	script	ユッブの家出口	844,{
	mes "‐ユッブの家の玄関だ‐";
	next;
...
ecl_in04,222,232,4	script	ユッブの家出口	844,{
	mes "‐ユッブの家の玄関だ‐";
	next;
	if(select("ユッブの家から出ない","ユッブの家から出る") == 1) {
		mes "‐もう少しここにいることにした‐";
...
ecl_in04,182,224,4	script	ユッブ	446,{
	switch(ECL_2QUE) {
	case 22:
		mes "[ユッブ]";
		mes "巨大な鳥の伝説？";
...
ecl_in04,179,226,4	script	オリバー#ep14_2	626,{
	switch(ECL_2QUE) {
	case 26:
		if(countitem(6558) < 1) {
			mes "[オリバー]";
...
ecl_in01,44,53,4	script	配達員	513,{
	switch(ECL_2QUE) {
	case 24:
		mes "[配達員]";
		mes "これが荷物ですか？";
...
ecl_in04,226,231,4	script	テューリアン#ep14_2in2	628,{
	if(ECL_2QUE == 27) {
		mes "[テューリアン]";
		mes "ど、どこに消えたんだろ……。";
		mes "まさか幽霊!?";
...
ecl_in04,224,234,4	script	マークイシャ#ep14_2in2	616,{
	if(ECL_2QUE == 27) {
		mes "[テューリアン]";
		mes "ど、どこに消えたんだろ……。";
		mes "まさか幽霊!?";
...
ecl_in04,223,234,4	script	マギスティン#ep14_2in2	612,{
	if(ECL_2QUE == 27) {
		mes "[テューリアン]";
		mes "ど、どこに消えたんだろ……。";
		mes "まさか幽霊!?";
...
ecl_in04,223,230,4	script	アルプオカート#ep14_2in	615,{
	if(ECL_2QUE == 27) {
		mes "[テューリアン]";
		mes "ど、どこに消えたんだろ……。";
		mes "まさか幽霊!?";
...
// ECL_3QUE -> 0～
//------------------------------------------------------------
ecl_hub01,98,32,3	script	エクラージュガード	461,{
	if(ECL_3QUE < 5) {
		mes "[エクラージュガード]";
...
eclage,112,40,3	script	エクラージュガード	461,{
	switch(ECL_3QUE) {
	case 5:
		if(ECL_3QUE_sub & 0x1) {
			mes "[レオ]";
	...
	case 8:
		...
		next;
		setquest 7423;
		if(checkquest2(7423) && checkquest2(7424) && checkquest2(7425) && checkquest2(7426)) {
			// 未調査
			mes "‐理由については、";
			mes "　カルデュイに直接聞いて";
			mes "　みるのが早そうだ‐";
...
ecl_tdun04,32,35,3	script	ヒシエ#tlord	623,{
	switch(ECL_3QUE) {
	case 12:
		cutin "hisie01",0;
		mes "[ヒシエ]";
...
mora,103,74,5	script	遠征隊員#tl01	946,{
	mes "[遠征隊員]";
...
ecl_in01,32,52,5	script	旅人ポメ#tl01	515,3,3,{
	...
	if(checkquest2(7411) && checkquest2(7412) && checkquest2(7413)) {
...
ecl_in01,32,51,7	script	旅人リトリップ#tl02	513,{
	if(ECL_3QUE == 1) {
		mes "[リトリップ]";
		mes "見たところ、ラフィネたちは";
		mes "君に用があるようだな。";
...
ecl_in01,35,51,3	script	旅人チーバー#tl03	514,{
	if(ECL_3QUE == 1) {
		mes "[チーバー]";
		mes "今、エクラージュガードが";
		mes "君を探していただろ？";
...
ecl_in01,31,49,7	script	エクラージュガード#tl01	447,{
	mes "[エクラージュガード]";
	mes "あ、急いで元の場所に戻らないと";
	mes "失礼します。";
	close2;
...
ecl_in01,82,70,3	script	エクラージュガード#tl02	447,{
	switch(ECL_3QUE) {
	case 0:
		cutin "minuel01",2;
		mes "[エクラージュガード]";
...
ecl_in03,245,93,5	script	軍参謀	435,{
	switch(ECL_3QUE) {
	case 2:
		mes "[軍参謀]";
		mes "エクラージュにようこそ。";
...
ecl_in03,41,90,5	script	カルデュイ	624,{
	switch(ECL_3QUE) {
	case 4:
		cutin "kardui04",1;
		mes "[カルデュイ]";
...
ecl_fild01,205,86,3	script	エクラージュ伝令ロイ	461,{
	switch(ECL_3QUE) {
	case 5:
		if(ECL_3QUE_sub & 0x4) {
			mes "[ロイ]";
...
splendide,267,368,3	script	定期連絡官	446,{
	if(ECL_3QUE >= 6) {
		if(countitem(6552) > 0) {
			mes "[定期連絡官]";
...
eclage,274,294,5	script	話中のラフィネ#tl01	436,3,3,{
	if(ECL_3QUE >= 9) {
		mes "[ラフィネ女性]";
		mes "あああ、私は何も話していないよ！";
		mes "確かに私はお喋りだけど、";
	...
	close;
OnTouch:
	if(ECL_3QUE == 8 && !checkquest2(7426)) {
		mes "‐ラフィネの男女が話している。";
		mes "　声をひそめてはいるが、";
		mes "　感情が高ぶっているためか、";
		mes "　話している内容が聞こえてくる‐";
...
eclage,275,294,3	script	エクラージュ住民#tl02	445,{
	switch(ECL_3QUE) {
	case 8:
		if(checkquest2(7426)) {
			mes "[ラフィネ男性]";
...
ecl_in03,244,57,5	script	休憩中のラフィネ	440,3,3,{
	if(ECL_3QUE >= 9) {
		mes "[休憩中のラフィネ]";
		mes "異種族の内政に、";
		mes "あまりにも興味を持ち過ぎでは";
...
ecl_in03,245,54,2	script	公務中のラフィネ	439,{
	switch(ECL_3QUE) {
	case 8:
		if(!checkquest2(7426)) {
			mes "[休憩中のラフィネ]";
...
eclage,280,290,0	script	#ヒシエ01	139,3,3,{
	if(ECL_3QUE == 19) {
		cutin "hisie01",0;
		mes "[ヒシエ]";
		mes "目的地はこの近くだ。";
...
eclage,307,237,0	script	研究用のヤイ#tllb	844,{
	if(ECL_3QUE == 19) {
		if(countitem(6560) < 10 || countitem(6561) < 10) {
			cutin "hisie01",0;
			mes "[ヒシエ]";
...
que_avan01,26,26,0	script	#tltimer	139,1,1,{
	mes "‐確かに小さなヤイに入ったのに、";
	mes "　目まいの後に気が付くと";
	mes "　大きな空間が現れた‐";
	hideonnpc "#tltimer";
...
que_avan01,18,38,0	script	デスク#tl01	844,{
	if(ECL_3QUE == 22) {
		mes "‐エイヴァントの研究資料は";
		mes "　すでに手に入れた。";
		mes "　デスクにこれ以上の用はない‐";
...
que_avan01,1,1,0	script	#avt管理者	844,{
OnStart1:
	hideonnpc "エイヴァントの召喚物#01";
	hideonnpc "エイヴァントの召喚物#02";
	hideonnpc "エイヴァントの召喚物#03";
	hideonnpc "エイヴァントの召喚物#04";
	monster "que_avan01",22,40,"エイヴァントの召喚物",1198,1,"#avt管理者::OnKilled1";
	monster "que_avan01",29,40,"エイヴァントの召喚物",1198,1,"#avt管理者::OnKilled1";
	monster "que_avan01",16,40,"エイヴァントの召喚物",1198,1,"#avt管理者::OnKilled1";
	monster "que_avan01",29,36,"エイヴァントの召喚物",1198,1,"#avt管理者::OnKilled1";
	monster "que_avan01",29,32,"エイヴァントの召喚物",1198,1,"#avt管理者::OnKilled1";
	end;
OnStart2:
	initnpctimer;
	end;
...
OnTimer2000:
	monster "que_avan01",26,38," ",2337,1,"#avt管理者::OnKilled2";
	end;
OnTimer4000:
...
OnTimer8000:
	stopnpctimer;
	killmonster "que_avan01","#avt管理者::OnKilled2";
	end;
OnKilled1:
	set .@count,getmapmobs("que_avan01","#avt管理者::OnKilled1");
	if(.@count <= 0) {
...
que_avan01,26,41,3	script	魔学者エイヴァント#tlac	618,{
	cutin "avant02",1;
	mes "[エイヴァント]";
	mes "私のからだに手をつけるとは";
	mes "死にたくて頭がおかしく";
...
que_avan01,22,40,3	script	エイヴァントの召喚物#01	1198,{}
que_avan01,29,40,3	script	エイヴァントの召喚物#02	1198,{}
que_avan01,29,36,3	script	エイヴァントの召喚物#03	1198,{}
que_avan01,29,32,3	script	エイヴァントの召喚物#04	1198,{}

que_avan01,23,34,2	script	ヒシエ#tlspt	623,3,3,{
	if(ECL_3QUE == 22) {
		cutin "hisie01",0;
		mes "[ヒシエ]";
		mes "隠れてこんなものを";
...
que_avan01,25,41,5	script	ヒシエ#tlhunt	623,{}

bif_fild02,311,91,3	script	巨大な花のつぼみ	613,{
	if(ECL_3QUE == 31) {
		mes "‐ラフィネの死体だ。";
		mes "　姿をみると、死亡してから";
		mes "　あまり時間が経っていないようだ‐";
...
// ECL_4QUE -> 0～24
//------------------------------------------------------------
eclage,282,255,4	script	ウハリ	620,{
	switch(ECL_4QUE) {
	case 0:
		mes "[ウハリ]";
		mes "…………。";
...
ecl_in02,149,117,4	script	ウフル	619,{
	switch(ECL_4QUE) {
	case 0:
	case 1:
		mes "[謎の男]";
...
eclage,200,272,4	script	マシオネ	437,{
	if(ECL_4QUE == 9) {
		viewpoint 2,1,1,0,0xFFFFFF;
		emotion 23;
		mes "[マシオネ]";
...
eclage,163,228,4	script	ゴティ	438,{
	if(ECL_4QUE == 10) {
		viewpoint 2,1,1,0,0xFFFFFF;
		mes "[ゴティ]";
		mes "どうしました？";
...
eclage,170,195,4	script	スベリ	443,{
	if(ECL_4QUE == 11) {
		viewpoint 2,1,1,0,0xFFFFFF;
		mes "[スベリ]";
		mes "俺に何か用でもあるのか？";
...
eclage,126,151,4	script	ポンペ	444,{
	if(ECL_4QUE == 17) {
		viewpoint 2,1,1,0,0xFFFFFF;
		mes "[ポンペ]";
		mes "うおっ！ びっくりした！";
...
ecl_fild01,70,285,4	script	ジラニ	611,{
	switch(ECL_4QUE) {
	case 18:
		mes "[ジラニ]";
		mes "あの！　すみません！";
...
ecl_fild01,269,165,4	script	巨大な花のつぼみ	613,{
	if(ECL_4QUE == 19) {
		mes "‐ポンペが話していた";
		mes "　ラフィネの死体のようだ‐";
		next;
...
eclage,156,51,0	script	#hidden_eclage	139,{}
...
// ECL_5QUE -> 0～
//------------------------------------------------------------
ecl_in04,81,106,0	script	#hidden2_eclage	139,2,2,{
	if(ECL_5QUE == 1) {
		mes "[ルーエン]";
		mes "これはいったい";
		mes "何があったの……？";
...
ecl_in04,78,108,5	script	ルーエン	437,{
	switch(ECL_5QUE) {
	case 1:
		mes "[ルーエン]";
		mes "これはいったい";
...
ecl_in04,85,110,3	script	デイムス	447,{
	switch(ECL_5QUE) {
	case 2:
		mes "[デイムス]";
		mes "泥棒を捕まえるためなら";
...
ecl_in04,77,104,5	script	ロサ	520,{
	switch(ECL_5QUE) {
	case 2:
	case 3:
		mes "[ロサ]";
...
ecl_in04,80,103,3	script	クルイアン#event	442,{
	mes "[クルイアン]";
	mes "これはいったい……？";
	close;
OnInit:
...
eclage,164,102,3	script	クルイアン	442,{
	switch(ECL_5QUE) {
	case 0:
		mes "[クルイアン]";
		mes "ルーエン……。";
...
ecl_fild01,98,299,5	script	バルミン	461,{
	switch(ECL_5QUE) {
	case 14:
		if(!(checkquest2(9259) & 0x4)) {
			mes "[バルミン]";
			mes "何か用かね？";
			mes "すまないが、今はちょっと忙しい。";
			mes "モンスターを狩っているんだ。";
...
eclage,222,131,3	script	放浪商人	807,{
	switch(ECL_5QUE) {
	case 15:
		mes "‐人間の商人だ。";
		mes "　昼間から酒を飲んでいるのか";
...
ecl_in04,85,104,3	script	ポピ	81,{
	switch(ECL_5QUE) {
	case 6:
		mes "‐この犬は、事件発生時間に";
		mes "　家にいたはずだ‐";
...
ecl_in04,80,112,3	script	荒らされた本棚	111,{
	if(ECL_5QUE >= 18)
		end;
	switch(ECL_5QUE) {
	case 6:
...
ecl_in04,78,111,3	script	破られた本	111,{
	if(ECL_5QUE >= 18)
		end;
	mes "‐机の上の本が";
	mes "　ビリビリに引き裂かれている‐";
...
ecl_in04,83,111,3	script	ドリンク箱	111,{
	if(ECL_5QUE >= 18)
		end;
	switch(ECL_5QUE) {
	case 6:
...
ecl_in04,76,107,3	script	荒らされたテーブル	111,{
	if(ECL_5QUE >= 18)
		end;
	mes "‐テーブルの上も荒らされている‐";
	switch(ECL_5QUE) {
...
ecl_in04,80,105,3	script	犬の収集物	557,{
	if(ECL_5QUE >= 18)
		end;
	switch(ECL_5QUE) {
	case 6:
...
ecl_in04,209,200,3	script	放浪商人	807,{
	if(ECL_5QUE >= 18) {
		mes "[放浪商人]";
		mes "う～ん……。";
		mes "まさか、私の商品がアリバイに";
...
ecl_in04,203,199,5	script	バルミン	461,{
	if(ECL_5QUE >= 18) {
		mes "[バルミン]";
...
ecl_in04,205,198,5	script	クルイアン	442,{
	if(ECL_5QUE >= 18) {
		mes "[クルイアン]";
		mes "ルーエンは悪くありません。";
		mes "すべて私が悪いのです……。";
...
ecl_in04,210,197,3	script	ロサ	520,{
	if(ECL_5QUE >= 18) {
		mes "[ロサ]";
		mes "まさか……。";
		mes "こんなことって……。";
...
ecl_in04,203,196,5	script	デイムス	447,{
	if(ECL_5QUE >= 18) {
		mes "[デイムス]";
		mes "うーん、まさかそんなことで……。";
		mes "なんにせよ、解決していただき";
...
ecl_in04,208,194,3	script	ルーエン	437,{
	if(ECL_5QUE != 17) {
		mes "[ルーエン]";
		mes "色々とありがとうございました。";
		mes "後は私とクルイアンで";
...
eclage,156,56,3	script	民家入り口#eclage	844,3,3,{
	switch(ECL_5QUE) {
	case 0:
		mes "‐民家がある。";
		mes "　扉は閉まっているようだ‐";
...
ecl_in04,81,102,3	script	民家出口#eclage	844,{
	mes "‐民家の玄関だ‐";
	next;
...
// ECL_6QUE -> 0～
//------------------------------------------------------------
ecl_in02,133,115,0	script	#pa0829看守自動	139,3,3,{
	if(ECL_6QUE > 0)
		end;
	mes "[クレヴァー]";
	mes "おーい、看守～。おーい。";
...
ecl_in02,146,114,4	script	クレヴァー	622,{
	switch(ECL_6QUE) {
	case 0:
	case 1:
		mes "[クレヴァー]";
...
ecl_in04,109,215,3	script	ヒエール	621,{
	switch(ECL_6QUE) {
	case 7:
		mes "[ヒエール]";
		mes "ふーむ……。";
...
mid_camp,173,257,5	script	シエルビー	545,{
	switch(ECL_6QUE) {
	case 10:
		mes "[シエルビー]";
		mes "ふん。";
...
mid_camp,179,258,4	script	ポード	544,{
	switch(ECL_6QUE) {
	case 11:
		mes "[ポード]";
		mes "給料として支給されるはずの";
...
ecl_in02,133,115,7	script	看守#pa0829	461,3,3,{
	switch(ECL_6QUE) {
	case 0:
		mes "[看守]";
		mes "こんにちは。";
...
ecl_in01,82,80,4	script	月刊エクラージュ	111,{
	if(ECL_6QUE >= 20) {
...
ecl_tdun01,60,56,4	script	#pa0829エスラン室内	111,{
	if(ECL_6QUE == 29 || ECL_6QUE == 30 || ECL_6QUE == 36) {
		mes "‐何かの反応があった！‐";
		close2;
		warp "ecl_tdun01a",60,51;
		end;
	}
	if(ECL_6QUE == 31) {
...
ecl_tdun01,60,56,0	script	#pa0829エスラン室内タッ	139,5,5,{
	if(ECL_6QUE == 29) {
		mes "‐何かの反応があった！‐";
		close2;
		warp "ecl_tdun01a",60,51;
...
ecl_tdun01a,60,56,4	script	#pa0829エスラン室内copy	111,{
	if(ECL_6QUE == 30) {
...
ecl_tdun01a,60,56,0	script	#pa0829エスラン室内タッ	139,5,5,{
	if(ECL_6QUE == 29) {
		cutin "EP14_etran0",1;
		mes "[？？？？]";
		mes "大変だ。";
...
ecl_fild01,183,94,0	script	#pa0829エスラン室外タッ	139,3,3,{
	if(ECL_6QUE == 31) {
		cutin "EP14_etran1",1;
		mes "[エスラン]";
		mes "ああ……これが！";
...
eclage,291,301,0	script	#pa0829ロベル室外タッチ	139,3,3,{
	if(ECL_6QUE == 27) {
		cutin "EP14_robert1",1;
		mes "[ロベル]";
		mes "こ……これが。";
...
ecl_fild01,110,240,0	script	#pa0829反応機1	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？？]";
...
ecl_fild01,110,198,0	script	#pa0829反応機2	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？？]";
...
ecl_fild01,165,158,0	script	#pa0829反応機3	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？？]";
...
ecl_fild01,237,166,0	script	#pa0829反応機4	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？]";
...
ecl_fild01,230,206,0	script	#pa0829反応機5	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？]";
...
ecl_fild01,234,266,0	script	#pa0829反応機6	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？？]";
...
ecl_fild01,179,125,0	script	#pa0829反応機7	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？？]";
...
ecl_fild01,179,179,0	script	#pa0829反応機8	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？？]";
...
ecl_fild01,187,243,0	script	#pa0829反応機9	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？]";
...
ecl_fild01,159,278,0	script	#pa0829反応機10	139,3,3,{
	if(ECL_6QUE == 29) {
		switch(rand(3)) {
		case 0:
			mes "[？？？]";
...
eclage,155,91,4	script	#pa0829ヒエール扉10	836,{
	mes "[掲示板]";
	mes "ヒエールの研究室。";
	mes "許可の無い";
	mes "パパン、動物、サファ族の";
...
ecl_in04,109,212,0	warp	ecl_in04_exit	1,1,eclage,152,91

ecl_in04,105,216,4	script	ヒエールの作業台	111,{
	switch(ECL_6QUE) {
	case 14:
		// 未調査
		mes "[ヒエール]";
...
// ECL_7QUE -> 0～
//------------------------------------------------------------
ecl_in02,160,36,4	script	アイリン#nk	441,{
	switch(ECL_7QUE) {
	case 4:
		if(checkquest2(4258)) {
			mes "[アイリン]";
...
ecl_in03,175,69,4	script	バルボン#nk	444,{
	switch(ECL_7QUE) {
	case 4:
		if(checkquest2(4259)) {
			mes "[バルボン]";
...
ecl_in01,26,88,5	script	セシリア#nk	440,{
	switch(ECL_7QUE) {
	case 0:
		if(!checkquest2(72500))
			setquest 72500;
	...
	case 3:
		...
		close;
	case 4:
		if(checkquest2(4258) || checkquest2(4259)) {
			mes "[セシリア]";
			mes "アイリンとバルボンに会って";
			mes "最近、ミッドガルド関係の本を";
			mes "借りたり読んだりしていないか";
...
ecl_in01,80,77,5	script	ドミニク#nk	445,3,3,{
	switch(ECL_7QUE) {
	case 5:
		mes "[ドミニク]";
		mes "ん。何の用です？";
...
OnTouch:
	if(ECL_7QUE == 7 && ECL_7QUE2 == 2) {
		...
		chgquest 4264,72525;
		initnpctimer;
		monster "ecl_in01",80,77,"ねずみ",1175,1,"ドミニク#nk::OnKilled";
		getexp 300000,0;
		next;
		mes "[ドミニク]";
		mes "おや……おぉ、これはもしや";
...
OnTimer15000:
	stopnpctimer;
	killmonster "ecl_in01","ドミニク#nk::OnKilled";
	end;
}

ecl_in01,79,84,0	script	#ecl_kusa	139,3,3,{
	if(ECL_7QUE == 7 && ECL_7QUE1 == 2) {
		...
		delquest 4262;
		initnpctimer;
		monster "ecl_in01",79,84,"雑草",1080,1,"#ecl_kusa::OnKilled";
		getexp 300000,0;
		next;
		mes "[ドミニク]";
		mes "ちょっと！　あなた！";
...
OnTimer15000:
	stopnpctimer;
	killmonster "ecl_in01","#ecl_kusa::OnKilled";
	end;
}

ecl_in01,80,86,4	script	ミッドガルド探検史#book	111,{
	if(ECL_7QUE < 8) {
		mes "‐読めそうな本がある。";
...
ecl_in01,82,84,4	script	ミッドガルド探検史#book	111,{
	if(ECL_7QUE < 8) {
		mes "‐読めそうな本がある。";
		mes "　ミッドガルドに関する内容のようだ。";
		mes "　棚に手をのばしてみた‐";
...
ecl_in01,83,84,4	script	ミッドガルド探検史#book	111,{
	if(ECL_7QUE < 8) {
		mes "‐読めそうな本がある。";
		mes "　ミッドガルドに関する内容のようだ。";
		mes "　棚に手をのばしてみた‐";
...
ecl_in01,83,81,4	script	ミッドガルド探検史#book	111,{
	if(ECL_7QUE < 8) {
		mes "‐読めそうな本がある。";
		mes "　ミッドガルドに関する内容のようだ。";
		mes "　棚に手をのばしてみた‐";
...
ecl_in01,82,78,4	script	雑誌#01	111,{
	if(ECL_7QUE < 8) {
		mes "‐読めそうな本がある。";
		mes "　ミッドガルドに関する内容のようだ。";
		mes "　棚に手をのばしてみた‐";
...
// ECL_8QUE -> 0～
//------------------------------------------------------------
ecl_fild01,190,93,5	script	フィリー	617,{
	switch(ECL_8QUE) {
	case 0:
	...
	case 1:
		...
		close;
	case 2:
		if(checkquest2(13051) || checkquest2(13052) || checkquest2(13053) || checkquest2(13054)) {
			mes "[フィリー]";
			mes "作業を行うラフィネは4名いる。";
			mes "全員に作業を始めるよう";
			mes "伝えてくれ。";
	...
	case 10:
		...
		case 3:
			...
			if(checkquest2(13055)) {
				if(!checkquest2(72475)) {
					mes "[フィリー]";
					mes "3人の冒険者が";
					mes "まだビフロストタワーから";
					mes "出て来ないんだ。";
...
ecl_fild01,222,290,5	script	歌うラフィネ	436,{
	if(ECL_8QUE == 2) {
		if(checkquest2(13051)) {
			mes "[歌うラフィネ]";
			mes "フィリー様のお遣いですか？";
			mes "では、歌いますね！";
			next;
...
ecl_fild01,83,263,5	script	水を与えているラフィネ	444,{
	if(ECL_8QUE == 2) {
		if(checkquest2(13052)) {
			mes "[水を与えているラフィネ]";
			mes "作業が始まっているんですか？";
			mes "では、私は大地に水を与えます。";
			delquest 13052;
...
ecl_fild01,163,196,5	script	踊るラフィネ	438,{
	if(ECL_8QUE == 2) {
		if(checkquest2(13053)) {
			mes "[踊るラフィネ]";
			mes "フィリー様が作業を始めなさいと";
			mes "言ったんですか？";
...
ecl_fild01,237,181,5	script	カワイイラフィネ	446,{
	if(ECL_8QUE == 2) {
		if(checkquest2(13054)) {
			mes "[カワイイラフィネ]";
			mes "何か用ですか？";
			next;
			menu "フィリーの頼みで来た",-;
...
ecl_fild01,98,47,5	script	ロシ#0番	893,{
	mes "‐真面目そうな女性がいる‐";
	close2;
	warp "ecl_tdun01a",98,44;
	end;
}

ecl_tdun01a,98,47,5	script	ロシ#1番	893,{
	if(ECL_8QUE == 4) {
		if(checkquest2(13057)) {
			mes "[ロシ]";
			mes "あら、びっくりした！";
			mes "あなたは……？";
			next;
			...
			next;
			if(checkquest2(13056) || checkquest2(13058)) {
				mes "‐ロシは無事なようだ。";
				mes "　他の冒険者の安否も確認しよう‐";
				delquest 13057;
				close2;
				warp "ecl_tdun01",98,44;
				end;
			}
			mes "‐3人とも無事のようだ。";
			mes "　フィリーに報告しよう‐";
...
ecl_tdun01,11,62,5	script	ウンチョウ#0番	896,{
	mes "‐若い冒険者風の男性がいる‐";
	close2;
	warp "ecl_tdun01a",13,61;
	end;
}

ecl_tdun01a,11,62,5	script	ウンチョウ#1番	896,{
	if(ECL_8QUE == 4) {
		if(checkquest2(13056)) {
			mes "[ウンチョウ]";
			mes "あなたも冒険者ですか？";
			mes "ここは私が調べているので";
			mes "もし調べたいなら";
			...
			mes "伝えておいてください。";
			next;
			if(checkquest2(13057) || checkquest2(13058)) {
				mes "‐ウンチョウは無事なようだ。";
				mes "　他の冒険者の安否も確認しよう‐";
				delquest 13056;
				close2;
				warp "ecl_tdun01",13,61;
				end;
			}
			mes "‐3人とも無事のようだ。";
			mes "　フィリーに報告しよう‐";
...
ecl_tdun01,51,103,3	script	ニュオーズ#0	625,{
	mes "‐派手な格好をした男性がいる‐";
	close2;
	warp "ecl_tdun01a",53,103;
	end;
}

ecl_tdun01a,51,103,3	script	ニュオーズ#1	625,{
	if(ECL_8QUE == 4) {
		if(checkquest2(13058)) {
			cutin "nines04",2;
			mes "[ニュオーズ]";
			mes "もしかして……人間なのか？";
			next;
			...
			mes "私が飢え死ぬ前に。";
			next;
			if(checkquest2(13056) || checkquest2(13057)) {
				mes "‐ニュオーズは無事なようだ。";
				mes "　他の冒険者の安否も確認しよう‐";
				delquest 13058;
				close2;
				warp "ecl_tdun01",53,103;
				end;
			}
			mes "‐3人とも無事のようだ。";
			mes "　フィリーに報告しよう‐";
	...
	if(ECL_8QUE == 7) {
		if(checkquest2(13063)) {
			if(!(checkquest2(13063) & 0x4)) {
				cutin "nines03",2;
				mes "[ニュオーズ]";
				mes "まだ処理できないのかい？";
				mes "もう外に出たいから";
	...
	if(ECL_8QUE == 10) {
		if((checkquest2(13062) && checkquest2(13062) & 0x2 == 0) && (checkquest2(13064) && checkquest2(13064) & 0x2 == 0) && (checkquest2(13066) && checkquest2(13066) & 0x2 == 0)) {
			cutin "nines02",2;
			mes "[ニュオーズ]";
			mes "心配しなくていいよ！";
		...
		case 1:
			...
			mes "心優しいラフィネだよね。";
			mes "心配ないと伝えてくれ。";
			if((!checkquest2(13061) && !checkquest2(13062)) || checkquest2(13062) & 0x2) {
				next;
				cutin "nines04",2;
				mes "[ニュオーズ]";
				mes "ところで……。";
			...
			else if((!checkquest2(13063) && !checkquest2(13064)) || checkquest2(13064) & 0x2) {
				next;
				mes "[ニュオーズ]";
				mes "私の前をジャマするホコリを";
				mes "何とかすれば大丈夫そうだな……。";
			}
			else if((!checkquest2(13065) && !checkquest2(13066)) || checkquest2(13066) & 0x2) {
				next;
				mes "[ニュオーズ]";
				mes "お腹も満たしたし";
				mes "塔から出るのは難しくないね。";
		...
		case 2:
			if(checkquest2(13062)) {
				if(checkquest2(13062) & 0x2 == 0) {
					cutin "nines02",2;
					mes "[ニュオーズ]";
					mes "君が用意してくれたにくは";
					mes "本当に美味しかったよ。";
		...
		case 3:
			if(checkquest2(13064)) {
				if(checkquest2(13064) & 0x2 == 0) {
					cutin "nines02", 2;
					mes "[ニュオーズ]";
					mes "今は大丈夫だよ。";
					mes "このくらいなら問題ないからね。";
		...
		case 4:
			if(checkquest2(13066)) {
				if(checkquest2(13066) & 0x2 == 0) {
					// 未調査
				}
				close2;
				cutin "nines04",255;
...
// ECL_9QUE -> 0～
//------------------------------------------------------------
ecl_fild01,196,93,5	script	塔の案内人#biftower	443,{
	mes "[塔の案内人]";
	mes "今、3階から4階は通行止めでね。";
...
ecl_tdun04,23,27,5	script	出口案内人#biftower	443,{
	mes "[出口案内人]";
	mes "残念だけど、ここから";
	mes "3階には降りられないよ。";
	mes "もしこの塔から出たいなら";
...
ecl_tdun04,26,39,1	script	プロフェッサーワーム	627,{
	switch(ECL_9QUE) {
	case 0:
		mes "[プロフェッサーワーム]";
		mes "忙しい、忙しいよ！　あー忙しい。";
...
ecl_tdun04,39,23,4	script	壁に書かれたメモ#1	844,{
	if(ECL_9QUE == 4) {
		if(ECL_9QUE_sub & 0x1F == 0x1F) {
			mes "‐全ての壁をチェックした。";
...
ecl_tdun04,35,31,4	script	壁に書かれたメモ#2	844,{
	if(ECL_9QUE == 4) {
		if(ECL_9QUE_sub & 0x1F == 0x1F) {
			mes "‐全ての壁をチェックした。";
			mes "　プロフェッサーワームの元に戻ろう‐";
...
ecl_tdun04,28,43,4	script	壁に書かれたメモ#3	844,{
	if(ECL_9QUE == 4) {
		if(ECL_9QUE_sub & 0x1F == 0x1F) {
			mes "‐全ての壁をチェックした。";
			mes "　プロフェッサーワームの元に戻ろう‐";
...
ecl_tdun04,38,37,4	script	壁に書かれたメモ#4	844,{
	if(ECL_9QUE == 4) {
		if(ECL_9QUE_sub & 0x1F == 0x1F) {
			mes "‐全ての壁をチェックした。";
			mes "　プロフェッサーワームの元に戻ろう‐";
...
ecl_tdun04,24,31,4	script	壁に書かれたメモ#5	844,{
	if(ECL_9QUE == 4) {
		if(ECL_9QUE_sub & 0x1F == 0x1F) {
			mes "‐全ての壁をチェックした。";
			mes "　プロフェッサーワームの元に戻ろう‐";
...
ecl_tdun01,27,80,5	script	日記カエル3号#worm	614,{
	if(ECL_9QUE == 6) {
		mes "‐カエルがいる。";
		mes "　プロフェッサーワームの投げた";
		mes "　カエルのようだ。";
...
ecl_tdun01a,27,80,5	script	日記カエル3号#copyworm	614,{
	if(ECL_9QUE == 6) {
		mes "[日記カエル3号]";
		mes "プロフェッサーワームが";
		mes "私をここに投げました。";
...
ecl_tdun01,23,79,4	script	日記カエル6号#worm	614,{
	if(ECL_9QUE == 7) {
		mes "‐カエルがいる。";
		mes "　プロフェッサーワームの投げた";
		mes "　カエルのようだ。";
...
ecl_tdun01a,23,79,4	script	日記カエル6号#copyworm	614,{
	if(ECL_9QUE == 7) {
		if(checkquest2(1225)) {
			if(checkquest2(1225) & 0x4) {
				mes "[日記カエル6号]";
				mes "おお。";
...
ecl_fild01,173,95,7	script	日記カエル30号#worm	614,{
	if(ECL_9QUE == 8) {
		if(checkquest2(1227)) {
