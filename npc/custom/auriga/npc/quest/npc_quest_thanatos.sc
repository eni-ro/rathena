...
//==============================================================================
//赤のカギ
tha_t03,67,70,0	script	機械の装置#tt1	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
	...
	mes "‐覆っている力に向かって、";
	mes "^nItemID^" +getequipid2(4);
	mes "を思いっきり振り下ろした‐";
	next;
	mes "‐すると、^nItemID^" +getequipid2(4);
	mes "と覆っていた力がぶつかり、";
	mes "バシッ!!っという音と共に";
	mes "光が消えた‐";
	next;
...
//黄のカギ
tha_t04,195,195,0	script	機械の装置#tt2	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
...
//青のカギ
tha_t05,101,37,0	script	機械の装置#tt3	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
	...
	mes "何も表示されていない";
	mes "緑色の画面がある‐";
	switch(getareausers("tha_t05",101,37,106,42)) {
	case 0:
		mes "‐それ以外には、";
		mes "特に変わった点はない‐";
		close;
...
//緑のカギ
tha_t06,43,152,0	script	機械の装置#tt4	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
...
//黒のカギ
tha_t09,19,158,0	script	機械の装置#tt5	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
...
//赤魔力石
tha_t05,218,116,0	script	封印#tt2	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
...
//黄魔力石
tha_t07,113,129,0	script	封印#tt4	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
...
//青魔力石
tha_t04,150,44,0	script	封印#tt1	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
...
//緑魔力石
tha_t10,129,159,0	script	封印#tt5	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
...
//黒魔力石
tha_t06,226,230,0	script	封印#tt3	111,{
	if(checkitemblank() == 0) {
		mes "‐所持アイテムの種類数が多いため";
		mes "アイテムを受けとることができません‐";
		mes "‐所持アイテムを減らしてから、再度";
...
//赤の石像
tha_t12,96,58,0	script	石像#tt1	111,{
	if($@THA_1SEAL == 12) {
		mes "‐石像が、直視できない程、";
		mes "強烈な光を放っている上、";
		mes "手を触れることができない程、";
...
//黄の石像
tha_t12,161,58,0	script	石像#tt4	111,{
	if($@THA_1SEAL == 12) {
		mes "‐石像が、直視できない程、";
		mes "強烈な光を放っている上、";
		mes "手を触れることができない程、";
...
//青の石像
tha_t12,104,18,0	script	石像#tt2	111,{
	if($@THA_1SEAL == 12) {
		mes "‐石像が、直視できない程、";
		mes "強烈な光を放っている上、";
		mes "手を触れることができない程、";
...
//黒の石像
tha_t12,128,86,0	script	石像#tt3	111,{
	if($@THA_1SEAL == 12) {
		mes "‐石像が、直視できない程、";
		mes "強烈な光を放っている上、";
		mes "手を触れることができない程、";
...
//緑の石像
tha_t12,154,18,0	script	石像#tt5	111,{
	if($@THA_1SEAL == 12) {
		mes "‐石像が、直視できない程、";
		mes "強烈な光を放っている上、";
		mes "手を触れることができない程、";
...
//苦悩の封印
thana_boss,202,75,0	script	模様#tt2	111,3,3,{
	end;
OnTouch:
	if($@THA_2SEAL&0x1)
		end;
	...
	delitem 7436,1;
	monster "thana_boss",202,75,"苦悩",1712,1,"#ttDeath::OnKilled1";
	close;
}

//悲しみの封印
thana_boss,217,167,0	script	模様#tt1	111,3,3,{
	end;
OnTouch:
	if($@THA_2SEAL&0x2)
		end;
	...
	delitem 7437,1;
	monster "thana_boss",217,167,"悲しみ",1711,1,"#ttDeath::OnKilled1";
	close;
}

//絶望の封印
thana_boss,62,171,0	script	模様#tt4	111,3,3,{
	end;
OnTouch:
	if($@THA_2SEAL&0x4)
		end;
	...
	delitem 7439,1;
	monster "thana_boss",62,171,"絶望",1710,1,"#ttDeath::OnKilled1";
	close;
}

//憎悪の封印
thana_boss,80,76,0	script	模様#tt3	111,3,3,{
	end;
OnTouch:
	if($@THA_2SEAL&0x8)
		end;
	...
	delitem 7438,1;
	monster "thana_boss",80,76,"憎悪",1709,1,"#ttDeath::OnKilled1";
	close;
}

//タナトスの封印
thana_boss,141,218,0	script	模様#tt5	111,3,3,{
	end;
OnTouch:
	if($@THA_1SEAL > 9)
		end;
	...
	mes "‐そして、模様が強烈な光を放った‐";
	set $@THA_1SEAL,10;
	monster "thana_boss",139,215,"憎悪",1709,1,"#ttDeath::OnKilled2";
	monster "thana_boss",139,220,"絶望",1710,1,"#ttDeath::OnKilled2";
	monster "thana_boss",144,220,"悲しみ",1711,1,"#ttDeath::OnKilled2";
	monster "thana_boss",144,215,"苦悩",1712,1,"#ttDeath::OnKilled2";
	close;
}

thana_boss,1,1,0	script	#ttDeath	-1,{
	end;
OnKilled1:
	set $@THA_1SEAL,$@THA_1SEAL+1;
	end;
OnKilled2:
	set .@mob,getmapmobs("thana_boss","#ttDeath::OnKilled2");
	if(.@mob < 1) {
		set $@THA_1SEAL,11;
		monster "thana_boss",135,129,"魔剣士タナトスの思念体",1708,1,"#ttDeath::OnThanaKilled";
	}
	end;
OnThanaKilled:
	initnpctimer;
