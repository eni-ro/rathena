...
ac_cl_area,85,37,4	script	ガルド	122,{
...
pay_fild03,209,141,4	script	看板	835,{
	mes "‐北西= プロンテラ方面";
	mes "‐北= フェイヨン方面";
	mes "‐東= アルベルタ";
	mes "‐西= モロク方面";
...
pay_fild03,209,143,4	script	ホルンの研究ボックス	888,{
...
pay_fild04,350,330,4	script	#AC_PORING	1002,{}
pay_fild04,350,329,4	script	ポリン先生	111,{
...
pay_fild02,105,242,4	script	#AC_WOLF	1107,{}
pay_fild02,105,241,4	script	ウルフ先生	111,{
...
pay_fild02,129,186,0	script	掘り返したような跡#ACTEST03		111,{
...
//prt_fild05,367,205,0				script	AC_TEST04#ROUTE01	139,1,1,{ //プロ西でタッチ
...
//	end;
//}
prt_fild05,105,372,0				script	AC_TEST04#ROUTE02	139,5,4,{ //プロ西左上WP手前でタッチ
...
prt_fild05,292,377,0				script	AC_TEST04#ROUTE03	139,5,5,{ //プロ西右上WP手前でタッチ
	if(AC_RANK!=3 || AC_RANKTEST!=3) end;
	viewpoint 1,105,381,20,0xFFFF00;
	mes "[" + strcharinfo(0) + "]";
	mes "あれ？";
...
mjolnir_09,37,244,0					script	AC_TEST04#ROUTE04	139,5,5,{ //プロ←↑の←ワープ手前でタッチ
...
prt_fild00,152,250,0				script	ドラッブ先生	139,4,4,{
// ガルドがドラップというが、
...
prt_fild00,28,124,0					script	AC_TEST04#ROUTE05	139,5,5,{
	if(AC_RANK!=3 || AC_RANKTEST<5 || AC_RANKTEST>6) end;
	//お弁当わたしたか確認
	if(AC_RANKTEST==5){
		//未調査 撮り忘れ。でもこんな感じだった
...
geffen,213,119,0					script	AC_TEST04#ROUTE06	139,1,1,{
...
mjolnir_09,100,365,4	script	ホルンの研究ボックス	888,{
...
mjolnir_09,284,345,4	script	看板#ACTEST501	858,{
...
mjolnir_09,309,282,4	script	看板#ACTEST502	858,{
...
mjolnir_09,100,310,4	script	看板#ACTEST503	858,{
...
pay_fild08,167,332,4		script	#AC_HORONG	1129,{}
pay_fild08,167,331,4		script	ホロン先生	111,{
...
mjolnir_06,226,183,4		script	#AC_BEETLE	1494,{}
mjolnir_06,226,182,4		script	ビートル先生	111,{
...
moc_fild18,211,95,4		script	#AC_HORN	1128,{}
moc_fild18,211,94,4		script	？？？	111,{
...
//98:プロ内西口自動会話
//99:ガルドに報告完了
pay_gld,273,307,4		script	行商人ヤニク	89,{
...
//東WP前とおせんぼ3人組
moc_fild02,370,272,4	script	盗賊男#AC_TST07_03	930,10,10,{
...
moc_fild02,373,278,4	script	盗賊男#AC_TST07_01	931,{
	callfunc "盗賊FUNC#AC_TST07";
}
moc_fild02,370,279,4	script	盗賊女#AC_TST07_02	919,{
	if(AC_RANK!=6 || AC_RANKTEST<4 || AC_RANKTEST>6){
		mes "[盗賊女]";
		mes "なによアンタ。";
		mes " ";
...
//中州とおせんぼ
moc_fild02,270,268,4	script	盗賊男#AC_TST07_04	930,3,5,{
	callfunc "盗賊FUNC#AC_TST07";
OnTouch:
	callfunc "盗賊FUNC2#AC_TST07";
}
//南西ルートとおせんぼ
moc_fild02,91,98,4	duplicate(盗賊男#AC_TST07_04)	盗賊男#AC_TST07_05	930,5,10
//荷物ルートとおせんぼ
moc_fild02,203,290,4	duplicate(盗賊男#AC_TST07_04)	盗賊男#AC_TST07_06	934,10,5

//北西ルートとおせんぼ
moc_fild02,78,210,4		script	盗賊男#AC_TST07_07	930,10,5,{
...
//捕まったときの場所（自動会話用）
moc_fild02,153,312,0	script	#AC_TST07_08	139,3,3,{
OnTouch:
	if(AC_RANK!=6) end;
	switch(AC_RANKTEST){
	case 3:
...
//盗み聞き自動会話
moc_fild02,147,302,0	script	#AC_TST07_09	139,5,5,{
OnTouch:
...
//おかしらに話しかけてる人
moc_fild02,163,294,7	script	盗賊男#AC_TST07_11	943,9,9,{
	if(AC_RANK!=6 || AC_RANKTEST<4 || AC_RANKTEST>6){
		mes "[" + strnpcinfo(1) + "]";
		mes "なんだお前？";
		mes " ";
...
moc_fild02,165,294,4	duplicate(盗賊男#AC_TST07_11)	おかしら#AC_TST07_12	939
...
moc_fild02,234,314,4	script	盗賊男#荷物番	945,5,5,{
...
moc_fild02,234,313,4	script	荷物#AC_TST07	111,{
...
moc_fild02,67,337,0		script	#AC_TST07_13	139,11,5,{
OnTouch:
	if(AC_RANK!=6 || AC_RANKTEST<4 || AC_RANKTEST>6) end;
	if(AC_RANKTEST==6){
		mes "[" + strcharinfo(0) + "]";
...
moc_fild02,92,337,0		duplicate(#AC_TST07_13)	#AC_TST07_14	139,11,5

moc_fild01,190,38,0		script	#AC_TSTVP7_15	139,8,8,{
...
moc_fild01,28,242,0		script	#AC_TSTVP7_16	139,5,2,{
	if(AC_RANK!=6 || (AC_RANKTEST!=7 && AC_RANKTEST!=8)) end;
	if(AC_RANKTEST==7){
		mes "[" + strcharinfo(0) + "]";
		mes "撮影をしなくちゃ。";
...
prt_fild09,304,193,4	script	ミシュラン先生	101,{
...
prt_fild09,39,255,0		script	#AC_TSTVP7_17	1080,{}
prt_fild09,39,254,0		script	草#AC_TSTVP7_18	111,{
	mes "‐草が生えている‐";
...
prt_fild09,227,368,0		script	#AC_TSTVP7_19	139,7,7,{
...
prt_fild09,50,260,0		script	#AC_TSTVP7_20	139,10,10,{
	if(AC_RANK!=6 || AC_RANKTEST!=11) end;
	mes "‐茂みから音が聞こえる……‐";
	next;
	mes "‐茂みからモンスターが現れた！‐";
	close2;
	set .@dummy, getmapxy(.@dummy$,.@x,.@y,BL_PC);
	areamonster "prt_fild09",.@x-3,.@y-3,.@x +3,.@y+3,"--ja--",1002,3;
	set AC_RANKTEST,12;
	end;
}
prt_fild07,248,370,0	script	#AC_TSTVP7_21	139,5,5,{
...
// ミニマップ表示処理のところに移動。
//prt_fild05,367,205,0	script	#AC_TSTVP7_22	139,5,5,{ //プロ西入り口手前
...
// 未調査。 通ろうとすると追い返すらしい。
prt_fild05,371,123,4	script	ガラの悪そうな男	943,{
	mes "[ガラの悪そうな男]";
	mes "ぐおー。";
	mes "ぐおー。";
	next;
...
prontera,26,203,0	script	#AC_TSTVP7_22	139,5,5,{ //プロ到着
