...
// プロンテラ
prt_in,244,135,0	script	旅館従業員	53,{
	mes "[従業員セミ]";
	mes "いらっしゃいませ！";
	mes "旅館「ネンカラス」本館にようこそ～。";
	mes "お客様、何の御用ですか？";
	callfunc "TownInn",1,"従業員セミ","prt_in",238,131,247,104;
	close;
}

prt_in,61,141,4	script	旅館従業員	94,{
	mes "[従業員アルマ]";
	mes "いらっしゃいませ！";
	mes "旅館「ネンカラス」別館にようこそ～。";
	mes "お客様、何の御用ですか？";
	callfunc "TownInn",2,"従業員アルマ","prt_in",63,136,60,166;
	close;
}

// アインブロック
ein_in01,206,224,3	script	ホテル職員	855,{
	mes "[ホテル職員]";
	mes "ようこそいらっしゃいました。";
	mes "当ホテルは、清潔、親切、";
	mes "笑顔をモットーに、";
	...
	callfunc "TownInn",3,"ホテル職員","ein_in01",201,223,272,167;
	close;
}

// アルデバラン
aldeba_in,92,58,2	script	旅館従業員	53,{
	mes "[従業員リリム]";
	mes "いらっしゃいませ。";
	mes "何をお手伝いしましょうか？";
	callfunc "TownInn",0,"従業員リリム","aldeba_in",93,50,92,112;
	close;
}

// (新)フェイヨン
payon_in01,132,62,2	script	旅館従業員	53,{
	mes "[従業員アキ]";
	mes "あ、お客さん";
	mes "こちらはフェイヨン旅館です。";
	mes "何をお手伝いしましょうか？";
	callfunc "TownInn",0,"従業員アキ","payon_in01",135,62,132,11;
	close;
}

// モロク
//morocc_in,147,141,2	script	旅館従業員	53,{
//	mes "[従業員ハーシャ]";
//	mes "いらっしゃいませ！";
//	mes "何をお手伝いしましょうか？";
//	callfunc "TownInn",0,"従業員ハーシャ","morocc_in",142,139,173,135;
//	close;
//}

//morocc_in,78,100,4	script	旅館従業員	53,{
//	mes "[従業員マナル]";
//	mes "いらっしゃいませ！";
//	mes "何をお手伝いしましょうか？";
//	callfunc "TownInn",0,"従業員マナル","morocc_in",78,95,78,95;
//	close;
//}

// アルベルタ
alberta_in,32,142,2	script	旅館従業員	53,{
	mes "[従業員ジェニー]";
	mes "いらっしゃいませ。";
	mes "こちらは旅館フィッシャーマンです。";
	mes "何をお手伝いしましょうか？";
	callfunc "TownInn",0,"従業員ジェニー","alberta_in",25,142,16,105;
	close;
}

// ゲフェン
geffen_in,70,64,3	script	旅館従業員	53,{
	mes "[従業員セナ]";
	mes "いらっしゃいませ。";
	mes "こちらはゲフェン唯一の";
	mes "旅館イフリートです。";
	mes "何をお手伝いしましょうか？";
	callfunc "TownInn",0,"従業員セナ","geffen_in",70,60,31,31;
	close;
}

//リヒタルゼン
//　functionは使わない
lhz_in02,230,284,4	script	ホテル従業員	86,{
	mes "[ホテル従業員]";
	mes "ようこそ！　世界最高のホテル、";
	mes "ロイヤルドラゴンです。";
	mes "客室数、各種サービスなど、";
...
//フィゲル
hu_in01,246,107,3	script	旅館職員	53,{
	mes "[旅館職員]";
	mes "いらっしゃいませ～";
	mes "うちの旅館は";
	mes "旅行客のためにいつもきれいで";
...
//ラヘル
ra_in01,376,69,4	script	ホテル職員	931,{
	mes "[ホテル職員]";
	mes "女神フレイヤ様の御加護が";
	mes "共にあらん事を……";
	mes "フレイヤ様の果てしない愛の様に";
...
//ベインス
ve_in,157,219,5	script	旅館の主人	709,{
	mes "[旅館の主人]";
	mes "こんにちは！";
	mes "ベインスで一番涼しい旅館へ";
	mes "ようこそ！";
...
//ブラジリス
bra_in01,27,24,3	script	ホテル管理人	478,{
	mes "[ホテル管理人]";
	mes "最高級の家具でおもてなし！";
	mes "滞在中の幸せな時間をお約束する、";
	mes "ブラジリスホテルへようこそ!!";
