...
// shop
//------------------------------------------------------------
har_in01,34,84,3	shop	道具屋#rockridge00	68,611:-1,645:-1,656:-1,601:-1,602:-1,1065:-1
har_in01,19,86,4	shop	武器屋#rockridge01	67,13154:-1,13155:-1,13102:-1,13200:-1,13221:-1,13222:-1,13228:-1,13229:-1,13230:-1,13231:-1,13232:-1
har_in01,16,86,4	script	防具屋#rockridge02	50,{
	// 未実装
	mes "[防具屋]";
	mes "今日は定休日です。";
	mes "働くときは働き、";
...
//------------------------------------------------------------
// ロックリッジ <-> キワワ砂漠01
harboro1,362,206,0	script	harboro1_rockrdg1	45,1,1,{
	if(BaseLevel < 130) {
		donpcevent "自警団員#harboro1::OnTalk";
		end;
	}
	warp "rockrdg1",37,246;
	end;
}

harboro1,360,209,3	script	自警団員#harboro1	10220,{
	mes "[自警団員]";
	mes "この先は危険です。";
	mes "BaseLv130以上の方のみ";
	mes "お通ししています。";
...
// 保安官事務室 <-> 留置所
har_in01,34,28,0	script	harin01_harin01_01	45,1,1,{
	if(ROCKRIDGE_1QUE < 6) {
		mes "[イヴォカ・スクーディー]";
		mes "勝手に入らないでください。";
		mes "そこは留置場です。";
...
har_in01,99,30,0	warp	harin01_harin01_02	1,1,har_in01,34,31

// ロックリッジ <-> ロックリッジ地下街
harboro1,324,124,7	script	ジョー	571,{
	mes "[ジョー]";
	mes "……。";
	next;
	mes "[ジョー]";
...
// キワワ砂漠02 <-> ロックリッジ鉱山 01
rockrdg2,304,350,0	script	rockrdg2_rockmi1_01	45,1,1,{
	if(BaseLevel < 160) {
...
rockrdg2,301,349,3	script	自警団員#rockrdg2	10220,{
	mes "[自警団員]";
	mes "この先は危険です。";
	mes "BaseLv160以上の方のみ";
	mes "お通ししています。";
...
// 旅館
//------------------------------------------------------------
harboro1,156,215,5	script	旅館の主#rockridge	46,{
	mes "[旅館の主]";
	mes "いらっしゃいませ。";
	mes "旅館「怠けたフクロウ」です。";
	next;
...
//------------------------------------------------------------
//TODO
harboro1,291,200,5	script	大陸案内員#harboro1	10218,{
	cutin "rock_cact02",2;
	mes "[大陸案内員]";
	mes "やあ異邦人さん。";
	mes "この大陸を案内してほしいのか？";
...
// 案内要員
//------------------------------------------------------------
harboro1,356,211,5	script	案内要員#rockridge01	10193,{
	mes "[保安官助手]";
	mes "西部の乾いた風が吹く";
	mes "ロックリッジにようこそ！";
	mes "私は保安官助手で";
...
harboro1,80,211,3	duplicate(案内要員#rockridge01)	案内要員#rockridge02	10193

//============================================================
// 看板
//------------------------------------------------------------
harboro1,91,211,3	script	#rockno01	111,{
	mes "[中央通り　表示板]";
	mes "中央通りを東に行くと、";
...
harboro1,299,211,3	script	#rockno02	111,{
	mes "[広場　表示板]";
	mes "ロックリッジ広場では";
...
// ロックリッジNPC
//------------------------------------------------------------
harboro1,228,170,3	script	風来の猫#rkrgtwn	553,5,5,{
	mes "[風来の猫]";
	mes "保安官事務室とは";
	mes "いったいどこにあるんだ！";
	mes "私のお金、おかねええええ！";
...
harboro1,188,123,3	script	座っている旅人#srdg02	881,{
	mes "[座っている旅人]";
	mes "私、決心した！";
	mes "自警団に入る！";
	next;
...
harboro1,184,123,5	script	旅人#srdg02	567,{
	mes "[座っている旅人]";
	mes "鉱山を越えて";
	mes "もっと遠くまで行ってみるか？";
	next;
...
harboro1,211,115,5	script	作業者#srdg01	808,{
	mes "[作業者]";
	mes "こんなことがありえるんですか？";
	mes "何もしないまま何日が過ぎたのか";
	mes "わかっていますか？";
...
harboro1,213,117,3	script	作業者#srdg02	54,{
	mes "[作業者]";
	mes "今日もまた作業が出来ないまま";
	mes "帰ることになりそうです。";
	next;
...
harboro1,214,115,3	script	作業者#srdg03	52,{
	mes "[作業者]";
	mes "今のこの状態を";
	mes "解決する考えはあるんですか？";
	next;
...
harboro1,211,113,7	script	作業班長#srdg01	952,{
	mes "[作業者]";
	mes "作業はいつ始まりますか？";
	next;
	mes "[作業者]";
...
harboro1,146,264,3	script	屑鉄収集家#srdg01	896,{
	mes "[屑鉄収集家]";
	mes "なぜ屑鉄が無い？";
	mes "汽車が襲われた時に";
	mes "少しくらい落ちたのがあるだろう？";
...
harboro1,144,262,7	script	屑鉄収集家#srdg02	996,{
	mes "[屑鉄収集家]";
	mes "家に帰りたい……。";
	mes "お金を稼げると聞いたから";
	mes "来てみたらこの有様だ……。";
...
harboro1,303,179,3	script	痩せた羊#srdg01	890,{}

harboro1,305,178,5	script	剛毛の羊#srdg01	890,{}

harboro1,299,179,7	script	元気のない羊#srdg01	890,{}

harboro1,297,178,5	script	寝ている羊#srdg01	890,{}

harboro1,301,175,7	script	羊飼い#srdg01	726,{
...
harboro1,104,132,5	script	素早い子１号#srdg01	955,{}

harboro1,104,130,5	script	稲妻#srdg01	955,{}

harboro1,102,133,7	script	素早い子２号#srdg01	955,{}
...
harboro1,187,236,3	script	訪問客#srdg01	690,{
	mes "[訪問客]";
	mes "飲食店に人がいないな……。";
	next;
...
harboro1,182,236,5	script	訪問客#srdg02	688,{
	mes "[訪問客]";
	mes "あの犬はどうしてこっちを";
	mes "見てるんだ？";
	next;
...
harboro1,282,201,3	script	ロックリッジタイガー#sr	554,{
	emotion 45;
	end;
}

harboro1,86,218,3	script	ウェルチー#rockwn01	634,5,5,{
	mes "[ウェルチー]";
	mes "ロックリッジは初めてですか？";
	mes "私も一昨日着いたばかりです。";
	mes "風の音が全然違いますね。";
...
harboro1,88,217,3	script	イディス・リッチー#rock	703,{
...
harboro1,85,208,7	script	リレンド・ウェンキンス#	778,5,5,{
	mes "[リレンド・ウェンキンス]";
	mes "乾杯！";
	mes "私たちの偉大な町に乾杯！";
	next;
...
harboro1,84,200,5	script	デルバート・レイク#rock	848,{
	mes "[デルバート・レイク]";
	mes "ここで成功して大金を持って";
	mes "家に帰るんだ！";
	mes "あまりにも興奮し過ぎて";
...
harboro1,80,204,7	script	エルシー#rockwn05	96,5,5,{
	mes "[エルシー]";
	mes "うわー！　すごく綺麗！";
	next;
...
harboro1,86,210,4	script	カルメン・オニール#rock	102,{
	mes "[カルメン・オニール]";
	mes "麦飲料はいつ飲んでも美味いな！";
	next;
	mes "[リレンド・ウェンキンス]";
...
harboro1,81,205,1	script	モティマー#rockwn07	828,5,5,{
	mes "[モティマー]";
	mes "記念品売ります～記念品～。";
	mes "ロックリッジに来た喜びを";
	mes "家族、友達、恋人にも";
...
harboro1,98,211,3	script	ロレッター#rockwn08	641,5,5,{
...
harboro1,100,211,3	script	ドロレス#rockwn09	79,{
	mes "[ドロレス]";
	mes "礼拝堂は心の中にあります。";
	mes "だけど神様は暖かいベッドと";
	mes "美味しい食卓にも";
...
harboro1,101,210,3	script	モリス#rockwn10	60,{
	mes "[モリス]";
	mes "歳を取るにつれて、";
	mes "外で言葉を伝えるのも";
	mes "だんだん辛くなってきました。";
...
harboro1,87,207,1	script	酔った猫#rockwn11	561,{
	mes "[リレンド・ウェンキンス]";
	mes "私たちは！　ロックリッジの！";
	mes "偉大な！　開拓民!!　うおおお！";
	next;
...
harboro1,79,224,5	script	マイルスウィズナー#rock	881,{
	mes "[マイルスウィズナー]";
	mes "姉さんが次の船に乗って来るので";
	mes "待っているところです。";
	mes "私の方が先に基盤を作って";
...
harboro1,75,211,1	script	ゼヴァーディー#rockwn13	82,5,5,{
	mes "[ゼヴァーディー]";
	mes "ロックリッジにようこそ！";
	mes "チャンスの地、ロックリッジで";
...
harboro1,75,219,3	script	エイリーン#rockwn14	96,5,5,{
	mes "[エイリーン]";
	mes "ロックリッジへいらっしゃった";
	mes "冒険者様を歓迎しますよ～！";
	mes "あなたにとって、";
...
harboro1,83,221,3	script	マフアカヤ#rockwn15	10225,{
	mes "[マフアカヤ]";
	mes "私たちの町では彼ら開拓者たちを";
	mes "嫌っている者も少なくない。";
	mes "だけどイパリ、よーく聞いてくれ。";
...
harboro1,82,221,3	script	明るいイパリ#rockwn16	10226,5,5,{
	mes "[明るいイパリ]";
	mes "お爺ちゃんは凄くカッコいいです！";
...
harboro1,93,201,1	script	ローランドバーツ#rockwn	10203,{
	mes "[ローランドバーツ]";
	mes "この町は我々が作った";
	mes "自警団が守っています。";
	mes "ワープ保安官の下で";
...
harboro1,85,195,1	script	コンスタンス#rockwn18	850,5,5,{
	mes "[コンスタンス]";
	mes "あ！　あんた冒険者だろう？";
	mes "あの人を止めておくれ！";
	next;
...
harboro1,73,206,5	script	ワルターグリーンワルド#	486,{
	mes "[ワルターグリーンワルド]";
	mes "こんな遠くまで来たのには";
	mes "何か目的があるんでしょうね？";
	mes "目的を全部成しとげて、";
...
harboro1,94,237,3	script	コルデル#rockn01	573,{
	mes "[コルデル]";
	mes "汽車駅を見ていると";
	mes "なぜか嬉しくなります。";
	mes "町の象徴みたいなものですから。";
...
harboro1,100,77,4	script	メイベル#rockn02	102,{
	mes "[メイベル]";
	mes "ロックリッジは海辺の町です。";
	mes "昔は……いや、";
	mes "実を言うと今も海と戦っています。";
...
harboro1,229,64,3	script	ローズ・メリウェバー#ro	850,{
	mes "[ローズ・メリウェバー]";
	mes "うんざりする海水！";
	mes "干拓と建物補修が終わらないよ！";
	close;
...
harboro1,290,104,5	script	エズニャー#rockn04	553,{
	mes "[エズニャー]";
	mes "ここにある建物のほとんどは";
	mes "一階が地下に埋まってて、";
	mes "地上に出ている部分は";
...
harboro1,241,200,5	script	ガンマン・ポシー#rockn0	900,{
	mes "[ガンマン・ポシー]";
	mes "武器が欲しいのか？";
	mes "ここでは銃を取り扱っている。";
	next;
...
harboro1,311,53,5	script	ジョイス・レスリー#rock	90,{
	mes "[ジョイス・レスリー]";
	mes "町を埋める前から海岸に近い家は";
	mes "地盤が緩くなっていました。";
	mes "結局この家はこんな姿に……。";
...
harboro1,321,237,5	script	ルビナ・アドラー#rockn0	882,{
...
harboro1,280,195,3	script	ルーカス・リーチ#rockn0	828,{
	mes "[ルーカス・リーチ]";
	mes "まさか本当に地下から";
	mes "幽霊が出たりしないよね？";
	mes "逆に凄い宝があるかもしれない。";
...
harboro1,168,216,3	script	ヒールリアード#rockn09	698,{
	mes "[ヒールリアード]";
	mes "仕事が足りないのにも関わらず";
	mes "冒険者に仕事をやるのは不当だよ。";
	next;
...
harboro1,130,237,3	script	ドック作業監督#rockn10	712,{
	mes "[ドック作業監督]";
	mes "鉱山で掘り出した鉱物は";
	mes "汽車に積んですぐこっちに運ぶ。";
	mes "そして鉱山に戻る汽車には";
...
harboro1,126,236,7	script	ジェイダー#rockn11	881,{
	mes "[ジェイダー]";
	mes "あ……もう動けない。";
	mes "全身がバラバラになりそうだ。";
	mes "汽車が頻繁に来ようが来まいが";
...
harboro1,128,233,7	script	ロコスリチー#rockn12	642,{
	mes "[ロコスリチー]";
...
harboro1,130,232,7	script	ポトニャス#rockn13	545,{
	mes "[ポトニャス]";
	mes "ロックリッジに来れば";
	mes "簡単に金持ちになれると聞いて、";
	mes "私もロックリッジに来たにゃん！";
...
harboro1,74,259,3	script	イエローマックコディ#ro	633,{
	mes "[イエローマックコディ]";
	mes "雨風と海水、外にいる連中から";
	mes "貨物を守るこの仕事は私の誇りだ！";
	next;
...
harboro1,233,215,3	script	ウォルフレードセイガン#	881,{
	mes "[ウォルフレードセイガン]";
	mes "最近、牛賊団のせいで";
	mes "保安官が忙しくなり、";
...
harboro1,231,212,7	script	エーデルペピナー#rockn1	879,{
	mes "[エーデルペピナー]";
...
harboro1,278,195,5	script	キャロラ・パス#rockn17	879,{
	mes "[キャロラ・パス]";
	mes "噂は聞きました？";
	mes "最近地下に……";
	mes "オバケが出るらしいですよ！";
...
harboro1,312,173,8	script	懸賞金ハンター#rockn18	700,{
	mes "[懸賞金ハンター]";
	mes "何を見てるんだ？";
	mes "ああ、牛賊団のやつらには";
	mes "かなりの懸賞金がかかっている。";
...
harboro1,229,212,7	script	ハーマン・ファーレンド#	778,{
	mes "[ハーマン・ファーレンド]";
	mes "あ、ここが保安官事務室で";
	mes "間違いありませんか？";
	mes "並ばないといけないんですか？";
...
harboro1,130,158,3	script	アクハ#rockn19	10222,{
	mes "[アクハ]";
	mes "お爺ちゃんが";
	mes "異邦人の町に連れて行かれたら";
	mes "棘が全部引き抜かれるって";
...
harboro1,132,157,3	script	ナハリ#rockn19	10226,{
	mes "[ナハリ]";
	mes "ここは不思議な町ですね。";
	mes "とても高くて大きな木の家がある。";
	mes "海でも木は育つけど……";
...
harboro1,274,214,5	script	白い木の枝#rockn19	10228,5,5,{
	mes "[白い木の枝]";
	mes "アクハちゃん、ナハリちゃん……。";
	mes "どこに行ってしまったのかしら。";
	next;
...
// ロックリッジ室内NPC
//------------------------------------------------------------
har_in01,24,69,3	script	穏やかな夫人#rockridge0	74,{
	mes "[穏やかな夫人]";
	mes "情熱あふれている";
	mes "冒険者様なのですね。";
	close;
...
// ロックリッジ地下街NPC
//------------------------------------------------------------
harboro2,57,239,3	script	失業者#srdg01	85,{
	mes "[失業者]";
	mes "あそこのモンスターが";
	mes "見えますか？";
	mes "排水管を塞いでるんです。";
...
harboro2,258,117,3	script	派遣シスター#srdg02	79,{
	mes "[派遣シスター]";
	mes "びっくりしましたか？";
	mes "こんな所に人が住んでいて。";
	mes "上に住んでいる人たちは";
...
harboro2,67,191,5	script	匂いマニア#srdg01	749,{
	mes "[匂いマニア]";
	mes "くんくん……！";
	mes "ここの匂い、良いと思いませんか？";
...
harboro2,142,155,7	script	牛賊団#srdg01	10230,{
	mes "[牛賊団]";
	mes "なんだ？";
	mes "牛賊団を見るのは初めてか？";
	next;
...
harboro2,144,156,1	script	牛賊団#srdg02	10232,{
	mes "[牛賊団]";
	mes "ここは公式には存在しない町。";
	mes "こういう一部の者だけが";
	mes "知っている場所がいくつかあるが、";
...
harboro2,125,196,3	script	子ども#srdg01	914,{
	mes "[子ども]";
...
harboro2,123,195,5	script	お母さん#srdg01	53,{
	mes "[母さん]";
	mes "ちゃんとご飯を食べさせたのは";
	mes "いつだったかしら……。";
	next;
...
harboro2,120,265,3	script	お爺ちゃん#srdg01	945,{
	mes "[お爺ちゃん]";
	mes "ん？　誰だ？";
	mes "チャーリーなのか？";
	next;
...
harboro2,118,264,5	script	お婆ちゃん#srdg01	863,{
	mes "[お婆ちゃん]";
	mes "ここは本当に変わらないね。";
	next;
	mes "[お爺ちゃん]";
...
// キワワ砂漠 01 NPC
//------------------------------------------------------------
rockrdg1,285,96,3	script	睨みつける鷲#rockc01	10219,{
	mes "[睨みつける鷲]";
	mes "水害と戦っていた異邦人は";
	mes "結局は家を明け渡したらしい。";
	mes "そのまま帰ると思っていたが、";
...
rockrdg1,331,111,3	script	フアニタス#rockc02	10222,5,5,{
	mes "[フアニタス]";
	mes "私はコヨーテ狩りが";
	mes "一番上手い冒険者だ！";
	mes "100匹捕まえるんだ！";
...
rockrdg1,327,109,5	script	素早いサソリ#rockc03	10226,{
	mes "[素早いサソリ]";
	mes "私たちも冒険者様みたいに";
	mes "コヨーテを捕まえたいのに。";
	next;
...
rockrdg1,328,112,5	script	カリンタス#rockc04	10226,{
	mes "[カリンタス]";
...
rockrdg1,330,104,3	script	無愛想な蛇#rockc05	10218,{
	mes "[無愛想な蛇]";
...
rockrdg1,310,48,3	script	エレクター#rockc06	10222,{
	mes "[エレクター]";
	mes "エレクターはですね、";
	mes "大きくなって町で一番頑丈な";
	mes "網を作る職人になります！";
...
rockrdg1,299,82,3	script	タリアテル#rockc07	10222,{
	mes "[タリアテル]";
	mes "私は旅がとても好きです。";
	mes "ルーンミッドガッツ大陸や";
	mes "その周辺の都市などを旅するのが";
...
rockrdg1,297,84,7	script	タネスカ#rockc08	549,{
	mes "[タネスカ]";
	mes "この楽器はこれ単体でも";
	mes "素晴らしい工芸品です。";
	mes "頑丈な革の仕上げ、";
...
rockrdg1,308,49,5	script	柔らかい羽根#rockc09	10228,{
	mes "[柔らかい羽根]";
	mes "ほほほ……";
	mes "この町の漁網には";
	mes "すべて私が手を加えてあるの。";
...
rockrdg1,287,95,3	script	リティス#rockc10	10227,{
	mes "[リティス]";
	mes "お爺さんの言いたいことも";
	mes "理解は出来ます。その心も。";
	next;
...
rockrdg1,297,111,3	script	ロイタネン#rockc10	727,{
	mes "[ロイタネン]";
	mes "あれ、またキャクター族の町だ。";
	mes "また道に迷ったみたい……。";
	next;
...
// ROCKRIDGE_1QUE -> 0～17
//------------------------------------------------------------
alberta,240,103,5	script	カラムプッチ#alberta	709,3,3,{
	if(ROCKRIDGE_1QUE == 0) {
		mes "[カラムプッチ]";
		mes "そこの冒険者さん。";
		mes "我々ピンクローズ社が発見した";
...
harboro1,60,215,5	script	カラムプッチ#harboro1	709,{
	mes "[カラムプッチ]";
	mes "アルベルタに戻るか？";
	next;
...
har_in01,20,30,5	script	アイアット・ワープ#har_	10211,{
	switch(ROCKRIDGE_1QUE) {
	case 0:
	case 1:
		cutin "rock_worp",0;
...
har_in01,14,24,5	script	イヴォカ・スクーディー::イヴォカ#rock01	10212,{
	switch(ROCKRIDGE_1QUE) {
	case 7:
		cutin "rock_iboka_all",2;
		mes "[イヴォカ・スクーディー]";
...
rockrdg1,156,302,7	script	イヴォカ・スクーディー::イヴォカ#rock02	10212,{
	end;
OnInit:
...
rockrdg1,153,303,5	script	アイアット・ワープ#revt	10211,{
	if(ROCKRIDGE_1QUE != 5) {
		cutin "rock_worp",0;
		mes "[アイアット・ワープ]";
		mes "作戦は成功だ。";
...
rockrdg1,160,306,3	script	ジョニー・ジェイムス#re	10213,{
	end;
OnInit:
	cloakonnpc strnpcinfo(0);
	end;
...
rockrdg1,156,306,5	script	キャクター族のガンマン::ガンマン#rock01	10212,{
	end;
OnInit:
	cloakonnpc strnpcinfo(0);
	end;
...
rockrdg1,164,306,3	script	キャクター族のガンマン::ガンマン#rock02	10212,{
	end;
OnInit:
	cloakonnpc strnpcinfo(0);
	end;
...
rockrdg1,161,302,1	script	キャクター族のガンマン::ガンマン#rock03	10212,{
	end;
OnInit:
	cloakonnpc strnpcinfo(0);
	end;
...
rockrdg1,168,306,3	script	アルバート・フォード#re	10214,{
	end;
OnInit:
	cloakonnpc strnpcinfo(0);
	end;
...
har_in01,89,26,5	script	ジョニー・ジェイムス#ha	10213,{
	switch(ROCKRIDGE_1QUE) {
	case 8:
...
har_in01,88,22,6	script	イヴォカ・スクーディー::イヴォカ#rock03	10212,{
	if(ROCKRIDGE_1QUE == 9) {
		cutin "rock_iboka_all",0;
		mes "[イヴォカ・スクーディー]";
		mes "（思っていた以上に";
...
harboro1,288,193,5	script	ショーン・マッカーディ#	10215,{
	switch(ROCKRIDGE_1QUE) {
	case 10:
		mes "[ショーン・マッカーディ]";
		mes "あなたが次期市長を噂される";
...
rockrdg2,347,216,5	script	ショーン・マッカーディ#	10215,{
	...
	if(ROCKRIDGE_1QUE == 13) {
		...
		mes "　向かった‐";
		close2;
		warp "rockrdg2",281,306;
		end;
	}
}

rockmi2,10,86,5	script	ショーン・マッカーディ#	10215,{
	if(ROCKRIDGE_1QUE == 11) {
		mes "[ショーン・マッカーディ]";
...
rockrdg2,279,313,3	script	ポッコリと穴の開いた岩#	10042,{
	if(ROCKRIDGE_1QUE == 13) {
		mes "‐ジョニーが言っていた";
		mes "　隠れ家の岩のようだ‐";
		next;
...
rockrdg2,282,310,3	script	アルバート・フォード#ro	10214,{
	if(ROCKRIDGE_1QUE == 13) {
		mes "[アルバート・フォード]";
		mes "お前はロックリッジの！";
		mes "何故この暗号を知っている！";
...
// 排水パイプ掃除クエストNPC
//-------------------------------------------------------
harboro1,138,157,5	script	ドノバン	854,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[ドノバン]";
		mes "本土から渡って来た";
		mes "冒険者さんですよね？";
...
// 困りもののワンちゃんクエストNPC
//-------------------------------------------------------
harboro1,347,65,3	script	ミズ・マックフィー#rock	74,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[ミズ・マックフィー]";
		mes "こんにちは。冒険者さん。";
		mes "牛賊団のせいで町は大変なんです。";
	...
	if(checkquest2(1321) || checkquest2(1323) || checkquest2(1324) || checkquest2(1325) || checkquest2(1326) || checkquest2(1327)) {
		mes "[ミズ・マックフィー]";
		mes "チョロンちゃんは";
		mes "大人しくしていれば";
		mes "本当に可愛いのに……。";
...
harboro1,345,61,3	script	チョロンちゃん	81,{
	if(checkquest2(1329) && checkquest2(1329)&2 == 0) {	// クールタイム中
		mes "‐どこかコヨーテに似た";
		mes "　姿をしている子犬がいる";
		mes "　ぐっすり寝ているようだ。";
		mes "　そっとしておこう‐";
...
harboro1,344,61,5	script	ミスター・マックフィー#	98,{
	if(checkquest2(1321)) {
		mes "[ミスター・マックフィー]";
		mes "私たちは町の中を調べます。";
		mes "冒険者様は町の外をお願いします。";
...
rockrdg1,36,250,5	script	ミスター・マックフィー	98,{
	if(checkquest2(1321)) {
		mes "[ミスター・マックフィー]";
		mes "妻が言うには、";
	...
	if(checkquest2(1323) || checkquest2(1324) || checkquest2(1325) || checkquest2(1326) || checkquest2(1327)) {
		mes "[ミスター・マックフィー]";
		mes "チョロンちゃんの毛が";
		mes "生え変わる時期らしく、";
		mes "最近すごく毛が抜けるんです。";
		mes "チョロンちゃんが掘った穴なら";
		mes "近くに白い毛があるはずです。";
		if(checkquest2(1323)) viewpoint 1,100,230,1,0x00FF00;
		else if(checkquest2(1324)) viewpoint 1,58,195,1,0x00FF00;
		else if(checkquest2(1325)) viewpoint 1,71,149,1,0x00FF00;
		else if(checkquest2(1326)) viewpoint 1,109,60,1,0x00FF00;
		else if(checkquest2(1327)) viewpoint 1,191,101,1,0x00FF00;
		next;
		mes "[ミスター・マックフィー]";
		mes "まだ幼いのでそれほど遠くには";
		mes "行っていないと思います。";
...
rockrdg1,170,233,3	script	穴#rkdqgd1	550,{
	mes "‐穴がある。";
	mes "　中には湿った土があるだけだ‐";
	close;
}

rockrdg1,183,143,3	script	穴#rkdqgd2	550,{
	mes "‐穴がある。";
	mes "　中には湿った土があるだけだ‐";
	close;
}

rockrdg1,215,72,3	script	穴#rkdqgd3	550,{
	mes "‐穴がある。";
	mes "　中には湿った土があるだけだ‐";
	close;
}

rockrdg1,43,145,3	script	穴#rkq1321	550,{
	set .@quest,substr2(strnpcinfo(2),3,7);
...
rockrdg1,100,230,3	duplicate(穴#rkq1321)	穴#rkq1323	550
rockrdg1,58,195,3	duplicate(穴#rkq1321)	穴#rkq1324	550
rockrdg1,71,149,3	duplicate(穴#rkq1321)	穴#rkq1325	550
rockrdg1,109,60,3	duplicate(穴#rkq1321)	穴#rkq1326	550
rockrdg1,191,101,3	duplicate(穴#rkq1321)	穴#rkq1327	550

//=======================================================
// 異国の商人クエストNPC
//-------------------------------------------------------
harboro1,216,262,7	script	巨商のラクダ#1	938,{}
harboro1,210,262,7	script	巨商のラクダ#2	938,{}
harboro1,197,262,7	script	巨商のラクダ#3	938,{}
harboro1,192,262,7	script	巨商のラクダ#4	938,{}
harboro1,223,261,1	script	巨商のラクダ#5	938,{}
harboro1,227,263,1	script	巨商のラクダ#6	938,{}
harboro1,237,256,3	script	巨商のラクダ#7	938,{}
harboro1,234,259,3	script	巨商のラクダ#8	938,{}
harboro1,229,258,6	script	巨商のラクダ#9	938,{}
harboro1,225,257,6	script	巨商のラクダ#10	938,{}
harboro1,238,258,3	script	巨商のラクダ#11	938,{}
harboro1,236,252,6	script	巨商のラクダ#12	938,{}

harboro1,226,255,3	script	巨商のラクダ#13	938,{
	mes "[ラクダ]";
	mes "ぶううう……。";
	close;
}

harboro1,227,260,3	script	巨商のラクダ#14	938,{
	mes "[ラクダ]";
	mes "ぶるぶる～。";
	close;
}

harboro1,232,258,6	script	巨商のラクダ#15	938,{
	mes "[ラクダ]";
	mes "ぶううう～～。";
	close;
}

harboro1,235,255,6	script	巨商のラクダ#16	938,{
	mes "[ラクダ]";
	mes "ぶるぶる～。";
	close;
}
...
harboro1,231,251,4	script	商人の箱	10005,{
	donpcevent "アブラハム・フーディン::OnTalk1";
	end;
}

harboro1,231,254,3	script	アブラハム・フーディン	58,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[アブラハム・フーディン]";
		mes "私は異国の商人、";
	...
	if(checkquest2(12411)) {
		if(checkquest2(12411) & 0x2 == 0) {
			mes "[アブラハム・フーディン]";
			mes "お～う、";
			mes "今はこれ以上取引しませんよ～。";
			mes "また後で来て下さいね～。";
...
harboro1,352,196,5	script	空腹の労働者#2	98,{}
harboro1,352,193,5	script	空腹の労働者#3	855,{}
harboro1,352,190,5	script	空腹の労働者#4	100,{}
...
harboro1,352,184,5	script	空腹の労働者#6	99,{}
harboro1,352,181,5	script	空腹の労働者#7	846,{}
...
harboro1,352,175,5	script	空腹の労働者#9	99,{}
harboro1,352,172,5	script	空腹の労働者#10	98,{}
...
harboro1,353,166,5	script	空腹の労働者#12	99,{}
...
harboro1,357,163,3	script	給食担当	886,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[給食担当]";
		mes "おい、邪魔をしないでくれ！";
		mes "牛賊団が暴れているせいで";
	...
	if(checkquest2(12382)) {
		if(checkquest2(12382)&2 == 0) {
			mes "[給食担当]";
			mes "とりあえずヤマは越えたようだ。";
			mes "また頼むぞ。";
			close;
	...
	if(checkquest2(12383)) {
		set .@quest,12383;
		set .@itemid,516;
		set .@count,160;
	}
	else if(checkquest2(12384)) {
		set .@quest,12384;
		set .@itemid,517;
		set .@count,60;
	}
	else if(checkquest2(12385)) {
		set .@quest,12385;
		set .@itemid,515;
		set .@count,160;
	}
	else if(checkquest2(12386)) {
		//TODO
	}
	else if(checkquest2(12387)) {
		set .@quest,12387;
		set .@itemid,535;
		set .@count,160;
	}
	else if(checkquest2(12388)) {
		set .@quest,12388;
		set .@itemid,581;
		set .@count,60;
	}
...
// 治安維持活動クエストNPC
//-------------------------------------------------------
harboro1,346,157,6	script	労働意欲に溢れる求職者::rockridge_ev01	732,{}
harboro1,347,155,6	script	労働意欲に溢れる求職者::rockridge_ev02	733,{}
harboro1,349,157,6	script	労働意欲に溢れる求職者::rockridge_ev03	734,{}
harboro1,351,154,7	script	労働意欲に溢れる求職者::rockridge_ev04	735,{}
harboro1,348,148,7	script	労働意欲に溢れる求職者::rockridge_ev05	753,{}
harboro1,353,156,6	script	労働意欲に溢れる求職者::rockridge_ev06	755,{}
harboro1,347,151,7	script	労働意欲に溢れる求職者::rockridge_ev07	732,{}
harboro1,354,149,7	script	労働意欲に溢れる求職者::rockridge_ev08	733,{}
harboro1,345,149,7	script	労働意欲に溢れる求職者::rockridge_ev09	734,{}
harboro1,352,150,7	script	労働意欲に溢れる求職者::rockridge_ev10	735,{}
harboro1,350,149,7	script	労働意欲に溢れる求職者::rockridge_ev11	753,{}
harboro1,354,153,7	script	労働意欲に溢れる求職者::rockridge_ev12	732,{}

harboro1,352,154,0	script	#r_q1	139,5,5,{
	//クエスト中は発生しない
	//受注時にランダム発言
OnTouch:
	switch(rand(6)) {
...
harboro1,357,155,3	script	鋼鉄自警団初級受付	880,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[鋼鉄自警団初級受付]";
		mes "最近、牛賊団の活動が";
		mes "活発になってきている。";
	...
	if(checkquest2(12390)) {
		if(checkquest2(12390) & 0x2 == 0) {
			mes "[鋼鉄自警団初級受付]";
...
harboro1,357,152,3	script	鋼鉄自警団上級受付	884,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[鋼鉄自警団上級受付]";
		mes "最近、牛賊団の活動が";
		mes "活発になってきている。";
	...
	if(checkquest2(12398)) {
		if(checkquest2(12398) & 0x2 == 0) {
			mes "[鋼鉄自警団上級受付]";
			mes "次の依頼まではもう少しかかりそうだ。";
			mes "また後で来てくれ。";
			close;
...
// 配管整備作業クエストNPC
//-------------------------------------------------------
harboro1,347,133,2	script	おびえている熟練工#1	870,{}
harboro1,344,133,2	script	おびえている熟練工#2	85,{}
harboro1,340,137,3	script	おびえている熟練工#3	826,{}
harboro1,338,132,2	script	おびえている熟練工#4	854,{}
harboro1,343,137,3	script	おびえている熟練工#5	88,{}
harboro1,342,135,2	script	おびえている熟練工#6	870,{}
harboro1,344,142,3	script	おびえている熟練工#7	709,{}
harboro1,341,131,2	script	おびえている熟練工#8	826,{}
harboro1,338,141,3	script	おびえている熟練工#9	855,{}
harboro1,347,137,3	script	おびえている熟練工#10	88,{}
harboro1,341,141,3	script	おびえている熟練工#11	826,{}
harboro1,338,136,3	script	おびえている熟練工#12	870,{}

harboro1,341,136,0	script	#r_q2	139,5,5,{
	//クエスト中は発生しない
	//受注時にランダム発言
OnTouch:
	switch(rand(6)) {
...
harboro1,333,138,6	script	ジェイミー	861,{
	mes "[ジェイミー]";
	mes "ちょっかい出すのは";
	mes "やめてくれませんか？";
	mes "私は所長の専属秘書なんですよ。";
...
harboro1,334,135,6	script	淡水化施設管理所長	853,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[淡水化施設管理所長]";
		mes "牛賊団に施設を襲われたら";
		mes "ひとたまりもない。";
	...
	if(checkquest2(12404)) {
		if(checkquest2(12404)&2 == 0) {
			mes "[淡水化施設管理所長]";
			mes "疲れていないのか？";
			mes "今すぐ整備する必要はないぞ。";
			close;
...
harboro2,52,261,3	script	赤い配管#rockridge1	10042,{
	if(checkquest2(12405)&1 && checkquest2(12405)&8 == 0) {
		misceffect 101;
		...
		initnpctimer;
		hideonnpc;
		if(checkquest2(12405)&8 && checkquest2(12406)&8 && checkquest2(12407)&8 && checkquest2(12408)&8)
			setquest 12409;
		end;
	}
	mes "‐整備された配管がある‐";
...
harboro2,54,216,3	script	青い配管#rockridge2	10043,{
	if(checkquest2(12406)&1 && checkquest2(12406)&8 == 0) {
		misceffect 101;
		progressbar "FFFF00",3;
		misceffect 18;
		compquest 12406;
...
harboro2,59,243,3	script	黄色い配管#rockridge3	10044,{
	if(checkquest2(12407)&1 && checkquest2(12407)&8 == 0) {
		misceffect 101;
		progressbar "FFFF00",3;
		misceffect 18;
		compquest 12407;
...
harboro2,71,200,3	script	白い配管#rockridge4	10046,{
	if(checkquest2(12408)&1 && checkquest2(12408)&8 == 0) {
		misceffect 101;
		progressbar "FFFF00",3;
		misceffect 18;
		compquest 12408;
...
harboro2,73,102,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge5	10042
harboro2,74,173,3	duplicate(青い配管#rockridge2)	青い配管#rockridge6	10043
harboro2,86,160,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge7	10044
harboro2,89,213,3	duplicate(白い配管#rockridge4)	白い配管#rockridge8	10046
harboro2,89,223,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge9	10042
harboro2,89,234,3	duplicate(青い配管#rockridge2)	青い配管#rockridge10	10043
harboro2,92,124,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge11	10044
harboro2,94,106,3	duplicate(白い配管#rockridge4)	白い配管#rockridge12	10046
harboro2,97,209,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge13	10042
harboro2,106,233,3	duplicate(青い配管#rockridge2)	青い配管#rockridge14	10043
harboro2,108,112,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge15	10044
harboro2,117,197,3	duplicate(白い配管#rockridge4)	白い配管#rockridge16	10046
harboro2,120,116,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge17	10042
harboro2,121,157,3	duplicate(青い配管#rockridge2)	青い配管#rockridge18	10043
harboro2,140,115,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge19	10044
harboro2,146,95,3	duplicate(白い配管#rockridge4)	白い配管#rockridge20	10046
harboro2,148,128,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge21	10042
harboro2,151,123,3	duplicate(青い配管#rockridge2)	青い配管#rockridge22	10043
harboro2,158,151,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge23	10044
harboro2,161,163,3	duplicate(白い配管#rockridge4)	白い配管#rockridge24	10046
harboro2,169,125,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge25	10042
harboro2,170,224,3	duplicate(青い配管#rockridge2)	青い配管#rockridge26	10043
harboro2,177,134,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge27	10044
harboro2,180,114,3	duplicate(白い配管#rockridge4)	白い配管#rockridge28	10046
harboro2,181,155,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge29	10042
harboro2,187,113,3	duplicate(青い配管#rockridge2)	青い配管#rockridge30	10043
harboro2,207,121,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge31	10044
harboro2,211,49,3	duplicate(白い配管#rockridge4)	白い配管#rockridge32	10046
harboro2,221,234,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge33	10042
harboro2,224,199,3	duplicate(青い配管#rockridge2)	青い配管#rockridge34	10043
harboro2,226,69,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge35	10044
harboro2,230,102,3	duplicate(白い配管#rockridge4)	白い配管#rockridge36	10046
harboro2,240,83,3	duplicate(赤い配管#rockridge1)	赤い配管#rockridge37	10042
harboro2,244,161,3	duplicate(青い配管#rockridge2)	青い配管#rockridge38	10043
harboro2,266,129,3	duplicate(黄色い配管#rockridge3)	黄色い配管#rockridge39	10044
harboro2,291,44,3	duplicate(白い配管#rockridge4)	白い配管#rockridge40	10046

//=======================================================
// 花火大会の準備クエストNPC
//-------------------------------------------------------
harboro2,164,80,5	script	デモン#srdg01	798,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[デモン]";
		mes "危険だからあっちに行ってろ。";
		next;
	...
	if(checkquest2(14673)) {
		if(checkquest2(14673)&2 == 0) {
			mes "[デモン]";
			mes "もう来たの？";
			mes "その気持ちはありがたいけど、";
	...
	if(checkquest2(14672)) {
		if(checkquest2(14672)&4 == 0 || countitem(25277) < 10 || countitem(6213) < 1) {
			mes "[デモン]";
			mes "^0000cd猛毒の粉10個、黒色火薬1個^000000と";
			mes "^0000cdガスターを15匹退治^000000だ。";
			mes "わかったな。";
...
harboro2,167,82,3	script	ミッドナイト#srdg01	10231,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[ミッドナイト]";
		mes "なにを見ている？";
...
harboro2,166,80,5	script	燃え残った痕跡#srdg01	649,{}
harboro2,165,77,5	script	作業道具#srdg01	10024,{}
harboro2,164,78,5	script	作業道具#srdg02	10025,{}
harboro2,166,78,5	script	作業道具#srdg03	10026,{}

//=======================================================
// 原住民の頼みクエストNPC
//-------------------------------------------------------
rockrdg1,262,90,7	script	うずくまった馬#rr	10217,{
	cutin "rock_cact01",2;
	mes "[うずくまった馬]";
	mes "調子はどうだ？";
	mes "太陽と大地の祝福が";
...
// 荒野の厄介者クエストNPC
//-------------------------------------------------------
rockrdg1,341,133,3	script	キャクターロン#rrrem01	10220,{
	if(ROCKRIDGE_1QUE < 16) {
		cutin "rock_cact03",2;
		mes "[キャクターロン]";
		mes "みかけない異邦人ね。";
	...
	if(checkquest2(16079)) {
		if(checkquest2(16079) & 0x2 == 0) {
			cutin "rock_cact03",2;
			mes "[キャクターロン]";
			mes "仕事には必ず休憩が必要です。";
			mes "仕事に没頭し続けると";
	...
	if(checkquest2(16080)) {
		if(checkquest2(16080) & 0x4) {
			cutin "rock_cact03",2;
			mes "[キャクターロン]";
			mes "お疲れ様でした。";
			mes "疲れていませんか？";
	...
	if(checkquest2(16078)) {
		if(checkquest2(16078) & 0x4 && countitem(25246) >= 5) {
			mes "[チビレクター]";
			mes "アガベ味ジュースなの？";
			mes "ジュース持って来てくれたの？";
			mes "食べる！　レクター今食べる！";
		...
		mes "^0000CDコヨーテ30匹^000000を退治です。";
		mes "どうかよろしくお願いします。";
		if(checkquest2(16088) == 0) {
			if(checkquest2(16083) == 0)
				viewpoint 1,146,164,1,0xFFFF00;
			if(checkquest2(16087) == 0)
				viewpoint 1,305,200,2,0xFFFF00;
			if(checkquest2(16085) == 0)
				viewpoint 1,195,183,3,0xFFFF00;
			if(checkquest2(16082) == 0)	// ??
				viewpoint 1,182,124,4,0xFFFF00;
			if(checkquest2(16084) == 0)
				viewpoint 1,286,247,5,0xFFFF00;
			if(checkquest2(16086) == 0)
				viewpoint 1,202,246,6,0xFFFF00;
			if(checkquest2(16081) == 0)	// ??
				viewpoint 1,149,103,7,0xFFFF00;
		}
		close2;
		cutin "rock_cact03",255;
...
rockrdg1,339,134,3	script	チビレクター#rrrem02	10222,{
	if(!checkquest2(16079)) {
		mes "[チビレクター]";
		mes "アガベ味ジュース、";
		mes "買って来るって言ったのに……。";
...
rockrdg1,146,164,1	script	荒野のキャクターピン#rr	10218,{
	mes "[荒野のキャクターピン]";
	mes "荒野を歩くキャクター族が珍しいか？";
	mes "あいにくこっちは忙しいんだ。";
	mes "用が無いなら行ってもいいか？";
	if(!checkquest2(16078) || checkquest2(16083) || checkquest2(16088))
		close;
	next;
	menu "アガベ味ジュースについて聞く",-;
	mes "[荒野のキャクターピン]";
	...
	viewpoint 2,1,1,1,0xFFFFFF;
	if( (
		checkquest2(16081) + checkquest2(16082) +
		checkquest2(16083) + checkquest2(16084) +
		checkquest2(16085) + checkquest2(16086) +
		checkquest2(16087)
	) == 40) {
		next;
		mes "‐アガベ味ジュースを5個見つけた。";
...
rockrdg1,305,200,3	script	キャクター少女#rrem04	10226,{
	mes "[キャクター少女]";
	mes "……見知らぬ人、";
	mes "近寄らないで。暴れるわよ。";
	emotion 7,"キャクター少女#rrem04";
	if(!checkquest2(16078) || checkquest2(16087) || checkquest2(16088))
		close;
	next;
	menu "アガベ味ジュースについて聞く",-;
	mes "[キャクター少女]";
...
rockrdg1,195,183,3	script	好奇心旺盛なコヨーテ#rr	3739,{}

rockrdg1,195,182,0	script	#好奇心旺盛なコヨーテ01	139,7,7,{
	end;
OnTouch:
	if(!checkquest2(16078) || checkquest2(16085) || checkquest2(16088))
		end;
	mes "‐コヨーテが何かを咥えながら";
	mes "　遊ぶのに夢中になっている。";
	mes "　キャクターロンさんが無くした";
...
rockrdg1,182,124,3	script	怪しい砂山#rrem01	557,{
	if(!checkquest2(16078) || checkquest2(16081) || checkquest2(16088)) {
		mes "‐何か袋が埋まっている。";
		mes "　ただのゴミのようだ‐";
		close;
	}
...
rockrdg1,286,247,3	script	怪しい砂山#rrem02	557,{
	if(!checkquest2(16078) || checkquest2(16084) || checkquest2(16088)) {
		mes "‐何か袋が埋まっている。";
		mes "　ただのゴミのようだ‐";
		close;
	}
...
rockrdg1,202,246,3	script	怪しい砂山#rrem03	557,{
	if(!checkquest2(16078) || checkquest2(16086) || checkquest2(16088)) {
		mes "‐何か袋が埋まっている。";
		mes "　ただのゴミのようだ‐";
		close;
	}
...
rockrdg1,149,103,3	script	怪しい砂山#rrem04	557,{
	if(!checkquest2(16078) || checkquest2(16082) || checkquest2(16088)) {
		mes "‐何か袋が埋まっている。";
		mes "　ただのゴミのようだ‐";
		close;
	}
...
rockrdg2,295,328,5	script	病弱なガスト#rockdaily	10231,{
	if(ROCKRIDGE_1QUE < 16) {
		mes "[ガスト]";
		mes "ふう、遠くから見るだけでも";
		mes "もう鼻が痒くて……";
