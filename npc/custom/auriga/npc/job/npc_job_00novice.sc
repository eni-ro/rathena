...
new_1-1,53,111,0	script	#start_jp	139,1,1,{
OnTouch:
	if(CHANGE_NV & 0x1 == 0) {
...
new_1-1,53,114,4	script	ファラ	727,{
	mes "[ファラ]";
	mes "ミッドガルド大陸へようこそ！";
	mes "…あなたは別の世界から来た";
	mes "冒険の使命を受けた方ね。";
	...
	mes "あなたの活躍、期待してるわよ！";
	set CHANGE_NV,0;
	savepoint "ac_cl_room",44,32;
	warp "ac_cl_room",44,32;
	end;
}

new_1-1,51,105,0	script	#nv_s1	139,11,0,{
OnTouch:
	if(CHANGE_NV & 0x2 == 0) {
		mes "-こっちは行き止まりのようだ-";
		emotion 0,"";
...
new_1-1,48,77,0	script	#nv_s2	139,6,1,{
OnTouch:
	mes "-果てしなく広がる海が見える-";
	mes "-潮の香りがする-";
	emotion 2,"";
...
new_1-1,57,124,0	script	#nv_n1	139,10,0,{
OnTouch:
	if(CHANGE_NV & 0x4 == 0) {
		mes "-こっちは行き止まりのようだ-";
		emotion 0,"";
...
new_1-1,67,154,0	script	#nv_n2	139,10,1,{
OnTouch:
	mes "-果てしなく広がる海が見える-";
	mes "-穏やかな風が吹き抜けている-";
	emotion 2,"";
...
new_1-1,67,112,0	script	#nv_e	139,0,2,{
OnTouch:
	warp "new_1-1",53,111;
	end;
}

new_1-2,38,182,3	script	冒険者アカデミー案内係#	47,{
	mes "[冒険者アカデミー案内係]";
	mes "おや？";
	mes "　";
	mes "まだ修練場に残っている方が";
...
//==============================================================
new_1-1,66,114,0	script	看板	111,{
	mes "^FF0000=================================^000000";
...
//==============================================================
new_1-1,144,116,2	script	警備員	105,{
	mes "[初心者修練場警備員]";
	mes "ようこそ！初心者修練場へ！";
	mes "城の中に入りますと";
	mes "初心者修練場があります。";
...
new_1-1,144,107,2	script	警備員	105,{
	if(rand(2)) {
		mes "[初心者修練場警備員]";
		mes "よく来たな！";
		mes "初心者修練場への来場を歓迎する！";
...
new_1-2,100,29,4	script	初心者修練場受付要員	86,{
	mes "[初心者修練場受付要員]";
	mes "いらっしゃいませ。";
...
new_1-2,99,105,3	script	インターフェース教官	751,{
	if(CHANGE_NV &0x10 == 0) {
		mes "[教官クリス]";
		mes "初めてお目にかかりますね。";
		mes "受講証を見せていただけますか？";
...
//==============================================================
new_1-2,83,111,3	script	スキル教官	753,{
	if(CHANGE_NV &0x20 == 0) {
		mes "[教官サイ]";
		mes strcharinfo(0)+ "！";
		mes "いい名だ！";
...
//==============================================================
new_1-2,115,111,3	script	アイテム教官	726,{
	if(CHANGE_NV &0x40 == 0) {
		mes "[教官アリス]";
		mes "こんにちはー！";
		mes "初めまして、かな？";
...
//==============================================================
new_1-2,118,108,3	script	カプラ職員	117,{
	mes "[カプラ職員]";
	mes "いらっしゃいませ。";
	mes "私は初心者の方へ";
	mes "ご案内するために";
...
//==============================================================
new_1-2,121,101,2	script	案内要員	105,{
	mes "[案内要員]";
	mes "私たち案内要員は街の入口で";
	mes "建物などの位置情報について";
	mes "ご案内しています。";
...
new_1-2,161,182,6	script	インターフェース講師	92,{
	mes "[エドウィン]";
	mes "私はインターフェースについて";
	mes "詳しく教えている講師よ。";
	mes "さ、知りたい項目を選んでね。";
...
//==============================================================
new_1-2,182,182,3	script	ステータス講師	754,{
	mes "[ゼルリオット]";
	mes "世に初めの一歩を踏み出す";
	mes "冒険者ですね。";
	mes "私ゼルリオットはあなたの";
...
//==============================================================
new_1-2,184,172,2	script	スキル講師	47,{
	emotion 30;
	mes "[ピッチジュダス]";
	mes "ようこそ！";
	mes "首が抜けそうになるほど";
...
new_1-2,17,182,5	script	進行要員	84,{
...
//==============================================================
new_1-2,38,182,3	script	受付要員	92,{
	if(CHANGE_NV &0x200 == 0) {
		mes "[ケーン]";
		mes "戦闘の基本すら知らない状態で";
		mes "実習をなさるおつもりですか？";
...
new_1-2,28,185,3	shop	いも売り娘	90,516:-1
...
new_1-3,95,30,4	duplicate(NoviceTraining)	訓練所要員#0	84
new_2-3,95,30,4	duplicate(NoviceTraining)	訓練所要員#1	84
new_3-3,95,30,4	duplicate(NoviceTraining)	訓練所要員#1	84
new_4-3,95,30,4	duplicate(NoviceTraining)	訓練所要員#2	84
new_5-3,95,30,4	duplicate(NoviceTraining)	訓練所要員#2	84
...
new_1-3,96,174,3	duplicate(NoviceManager)	試験監督	85
new_2-3,96,174,3	duplicate(NoviceManager)	試験監督	85
new_3-3,96,174,3	duplicate(NoviceManager)	試験監督	85
new_4-3,96,174,3	duplicate(NoviceManager)	試験監督	85
new_5-3,96,174,3	duplicate(NoviceManager)	試験監督	85
...
new_1-4,91,22,3	script	職業教官	57,{
	mes "[ブルース]";
	mes "ここまで来るのは本当に大変";
	mes "だったでしょう。ご苦労様でした。";
...
//==============================================================
new_1-4,100,29,4	script	適性検査官	46,{
