...
// 専用装備精練NPC
//------------------------------------------------------------
dali02,139,87,3	script	道楽裁縫師#refine	70,{
	mes "[道楽裁縫師]";
	mes "私は裁縫師をしています。";
	mes "私に飛行船で入手できる装備を";
	mes "渡して頂ければ";
	...
	case 1: set .@itemid,getequipid2(2); set .@menu,2; break;
	case 2: set .@itemid,getequipid2(5); set .@menu,5; break;
...
// 専用装備交換NPC
//------------------------------------------------------------
dali02,133,87,3	script	飛行船愛好家#sell	755,{
	mes "[飛行船愛好家]";
	mes "ここでは飛行船装備の";
	mes "買取や交換を行っています。";
	mes "私、好きなんです！飛行船装備！";
	...
	case 2:
		...
		switch(select(
			...
			(getequipid2(5)!=0? "^nItemID^" +getequipid2(5): "肩にかける物-[装備していない]"),
			(getequipid2(6)!=0? "^nItemID^" +getequipid2(6): "靴-[装備していない]"),
			(getequipid2(12)!=0? "^nItemID^" +getequipid2(12): "衣装‐上‐[装備していない]")
		)) {
		case 1: if(getequipid2(2) == 15158 && .@menu == 2) set .@i,2; break;
		case 2: if(getequipid2(5) == 20791 && .@menu == 2) set .@i,5; break;
		case 3: if(getequipid2(6) == 22086 && .@menu == 2) set .@i,6; break;
		case 4: if(getequipid2(12) == 19914 && .@menu == 1) set .@i,12; break;
		}
		if(.@i == 0) {
			mes "[飛行船愛好家]";
			mes "対象装備を装備していません。";
		...
		// 以下未調査
		if(.@menu == 2 && getequiprefinerycnt2(.@i) < 7) {
			mes "[飛行船愛好家]";
			mes "対象装備の精練値が足りませんね。";
			mes "^ff0000+7以上の";
...
// ダンジョン生成NPC
//------------------------------------------------------------
dali02,136,79,3	script	探検家リオン#air1	945,{
	mes "[探検家リオン]";
	mes "私がここ数日間";
	mes "この場所を調べてみた結果、";
	mes "ここにはある飛行船の記憶が";
...
dali02,142,81,3	script	次元移動機#sara	10007,{
	if(BaseLevel < 70) {
	...
	if(checkquest2(15050)) {
		if(!(checkquest2(15050)&2) || !(checkquest2(120205)&2)) {
			mes "‐この先は入場してから1回目の";
...
// 飛行船襲撃
//------------------------------------------------------------
1@air1,1,1,0	script	#HeroAirManager	139,{
OnStart:
	if(.flag)
		end;
	set .flag,1;
...
1@air1,217,67,3	script	船長ペルロック#air1	873,{
	switch(HEROAIR_1QUE) {
	case 0:
		if(checkquest2(120200)&8) {
			mes "‐ケイオスとアイリスが";
			mes "　船長らしき人物と話をしている‐";
			next;
...
1@air1,248,54,0	script	warp1#air1	45,2,2,{
	hideonnpc getmdnpcname("warp1#air1");
	donpcevent getmdnpcname("mob#air1")+ "::OnStart";
	warp getmdmapname("1@air1"),91,68;
	end;
}

1@air1,215,67,5	script	アイリス#air1	666,{
	if(HEROAIR_1QUE == 0) {
		cutin "h_iris02.bmp", 2;
		mes "[アイリス]";
		mes "こんなに高い空を飛べるなんて、";
...
1@air1,214,66,5	script	ケイオス#air1	683,{
	if(HEROAIR_1QUE == 0) {
		cutin "h_chaos02.bmp", 2;
		mes "[ケイオス]";
		mes "…………。";
...
1@air1,235,57,5	script	フェンリル#air1	664,{
	if(HEROAIR_1QUE == 0) {
...
1@air1,240,57,3	script	ロキ#air1	512,{
	if(HEROAIR_1QUE == 0) {
		cutin "ep14_roki02.bmp", 2;
		mes "[ロキ]";
		mes "……。";
...
1@air1,213,75,5	script	ワイバーン#air1	2146,{}
1@air1,218,78,3	script	ワイバーンキッド#1air1	3185,{}
1@air1,208,78,5	script	レッサーワイバーン#1air	3186,{}
1@air1,200,78,5	script	スカイロータージャイロ::スカイジャイロ#1air1	1392,{}
1@air1,223,78,3	script	スカイロータージャイロ::スカイジャイロ#1air2	1392,{}
1@air1,236,57,3	script	スカイグレムリン#1air1	844,{}
1@air1,239,57,5	script	スカイグレムリン#2air1	844,{}
1@air1,230,50,5	script	スカイグレムリン#3air1	844,{}
1@air1,226,62,3	script	スカイグレムリン#4air1	844,{}
1@air1,241,48,3	script	スカイグレムリン#5air1	844,{}
1@air1,225,40,7	script	スカイグレムリン#6air1	844,{}
1@air1,236,48,7	script	スカイグレムリン#7air1	844,{}
1@air1,224,66,5	script	スカイグレムリン#8air1	844,{}

1@air1,58,197,3	script	旅行客#1air1	887,{
	mes "[旅行客]";
	mes "……五月蝿いなあ……Zzz……。";
	mes "静かにしてくれ……。";
	mes "誰だよ、うなり声上げてるの……。";
...
1@air1,49,169,5	script	旅行客#2air1	887,{
	mes "[旅行客]";
	mes "……くうう……ぐうう……。 ";
	mes "……はっ。";
	mes "寝息と、腹の虫がコラボした……。";
...
1@air1,42,205,3	script	小さな国の王#air1	956,{
	mes "[小さな国の王]";
	mes "……ううむ。 ";
	mes "流石に故郷のベットほど";
	mes "寝心地はよくないな……むにゃ。";
...
1@air1,43,191,4	script	王の護衛兵#1air1	105,{
	mes "[王の護衛兵]";
	mes "どんな事があっても";
...
1@air1,39,191,4	script	王の護衛兵#2air1	105,{
	mes "[王の護衛兵]";
	mes "どんな事があっても";
...
1@air1,93,193,3	script	飛行船乗務員#1air1	852,{
	if(HEROAIR_1QUE < 3) {
		mes "[飛行船乗務員]";
		mes "ここは機関室に行く入口だ。";
		mes "ここに入って来れないように";
...
1@air1,22,182,7	script	飛行船乗務員#2air1	852,{
	if(HEROAIR_1QUE < 3) {
		mes "[飛行船乗務員]";
		mes "ううう、モンスターが多すぎる！";
...
1@air1,120,62,3	script	旅行中の騎士#air1	733,{
	mes "[旅行中の騎士]";
	mes "何なんだこいつらは……。";
	mes "私が全部切ってしまおうか？";
	mes "……いや、金にもならないなら";
...
1@air1,95,47,3	script	倒れた酔っ払い#air1	887,{
	mes "[倒れた酔っ払い]";
	mes "うああ……揺れる……！";
	mes "揺れるのは、私の";
	mes "恋心だけにしてくれ……むにゃ。";
...
1@air1,75,71,5	script	食事中のお金持ち#air1_0	55,{
	mes "[食事中のお金持ち]";
	mes "な、なんだこの怪物たちは?!";
	mes "私の大事な食事の時間の";
	mes "邪魔をするとは！";
...
1@air1,61,88,5	script	無賃乗車した吟遊詩人#ai	51,{
	mes "[無賃乗車した吟遊詩人]";
	mes "ゴージャス～！";
	mes "ファンタスティック～!!";
...
1@air1,46,61,5	script	飛行船食堂支配人#air1_0	61,{
	mes "[飛行船食堂支配人]";
	mes "凶悪な姿をしていますが、";
	mes "あのモンスターたちも";
...
1@air1,28,67,5	script	ギャンブラーマグイー#ai	853,{
	mes "[ギャンブラーマグイー]";
	mes "おい！　カードに触るな！";
	mes "ルールを守れ！";
	next;
...
1@air2,120,62,3	script	旅行中の騎士#air2	733,{
	mes "[旅行中の騎士]";
	mes "爆発する！　飛ぶんだ……。";
	mes "あの向こうに見える飛行船に";
	mes "飛び移るんだあああ!!";
...
1@air2,95,47,3	script	倒れた酔っ払い#air2	887,{
	mes "[倒れた酔っ払い]";
	mes "揺れに続いて……";
	mes "なんだか煙たい……。";
	mes "どうなってんだ？";
...
1@air2,75,71,5	script	食事中の金持ち#air2	55,{
	mes "[食事中の金持ち]";
	mes "助けてくれ!!";
	mes "金ならいくらでも出す！　お願いだ！";
	mes "私をここから脱出させてくれ!!";
...
1@air2,61,88,5	script	無賃乗車した吟遊詩人#ai	51,{
	mes "[無賃乗車した吟遊詩人]";
	mes "ゴージャス～ファンタスティック～♪";
	mes "爆発する船も素晴らしい～♪";
	mes "ヒャッホーイ♪";
...
1@air2,46,61,5	script	飛行船食堂支配人#air2_0	61,{
	mes "[飛行船食堂支配人]";
	mes "この船が……落ちるのか……";
	mes "私はこの船と運命を共にします。";
	mes "この船と私は……ひとつですから！";
...
1@air2,28,67,5	script	ギャンブラーマグイー#ai	853,{
	mes "[ギャンブラーマグイー]";
	mes "ギャンブラーの血が滾る!!";
...
1@air1,1,1,0	script	mob#air1	139,{
OnStart:
	areamonster getmdmapname("1@air1"),77,57,82,65,"スカイビホルダー",3184,3,getmdnpcname("mob#air1")+ "::OnKilled1";
	areamonster getmdmapname("1@air1"),77,57,82,65,"スカイロータージャイロ",3182,2,getmdnpcname("mob#air1")+ "::OnKilled1";
	end;
OnKilled1:
	set .@count,getmapmobs(getmdmapname("1@air1"),getmdnpcname("mob#air1")+ "::OnKilled1");
	if(.@count > 0)
		end;
	announce "12時方向に敵の気配を感じた!!", 0x9, 0xffff00, 0x190, 12, 0, 0;
	areamonster getmdmapname("1@air1"),61,77,68,85,"スカイビホルダー",3184,5,getmdnpcname("mob#air1")+ "::OnKilled2";
	areamonster getmdmapname("1@air1"),61,77,68,85,"スカイロータージャイロ",3182,3,getmdnpcname("mob#air1")+ "::OnKilled2";
	end;
OnKilled2:
	set .@count,getmapmobs(getmdmapname("1@air1"),getmdnpcname("mob#air1")+ "::OnKilled2");
	if(.@count > 0)
		end;
	announce "9時方向に敵の気配を感じた!!", 0x9, 0xffff00, 0x190, 12, 0, 0;
	areamonster getmdmapname("1@air1"),20,60,28,66,"スカイビホルダー",3184,3,getmdnpcname("mob#air1")+ "::OnKilled3";
	areamonster getmdmapname("1@air1"),20,60,28,66,"スカイロータージャイロ",3182,3,getmdnpcname("mob#air1")+ "::OnKilled3";
	end;
OnKilled3:
	set .@count,getmapmobs(getmdmapname("1@air1"),getmdnpcname("mob#air1")+ "::OnKilled3");
	if(.@count > 0)
		end;
...
1@air1,1,1,0	script	mob#air2	139,{
OnStart:
	areamonster getmdmapname("1@air1"),108,185,114,192,"スカイグレムリン",3183,3,getmdnpcname("mob#air2")+ "::OnKilled1";
	areamonster getmdmapname("1@air1"),108,185,114,192,"レッサーワイバーン",3186,3,getmdnpcname("mob#air2")+ "::OnKilled1";
	end;
OnKilled1:
	set .@count,getmapmobs(getmdmapname("1@air1"),getmdnpcname("mob#air2")+ "::OnKilled1");
	if(.@count > 0)
		end;
	announce "9時方向に敵の気配を感じた!!", 0x9, 0xffff00, 0x190, 12, 0, 0;
	areamonster getmdmapname("1@air1"),60,185,68,192,"スカイグレムリン",3183,3,getmdnpcname("mob#air2")+ "::OnKilled2";
	areamonster getmdmapname("1@air1"),60,185,68,192,"レッサーワイバーン",3186,3,getmdnpcname("mob#air2")+ "::OnKilled2";
	end;
OnKilled2:
	set .@count,getmapmobs(getmdmapname("1@air1"),getmdnpcname("mob#air2")+ "::OnKilled2");
	if(.@count > 0)
		end;
	announce "9時方向に敵の気配を感じた!!", 0x9, 0xffff00, 0x190, 12, 0, 0;
	areamonster getmdmapname("1@air1"),18,185,26,191,"スカイグレムリン",3183,3,getmdnpcname("mob#air2")+ "::OnKilled3";
	areamonster getmdmapname("1@air1"),18,185,26,191,"レッサーワイバーン",3186,3,getmdnpcname("mob#air2")+ "::OnKilled3";
	end;
OnKilled3:
	set .@count,getmapmobs(getmdmapname("1@air1"),getmdnpcname("mob#air2")+ "::OnKilled3");
	if(.@count > 0)
		end;
...
1@air1,93,188,5	script	スカイグレムリン#2aair1	844,{
	end;
OnStart:
OnTimer4000:
	initnpctimer;
...
1@air1,88,189,5	script	アイリス#2air1	666,{
	switch(HEROAIR_1QUE) {
	case 1:
		if(checkquest2(120200)&8) {
			mes "‐ケイオスとアイリスが";
...
1@air1,88,187,5	script	ケイオス#2air1	683,{
	if(HEROAIR_1QUE == 1) {
		cutin "h_chaos02.bmp", 2;
		mes "[ケイオス]";
		mes "アイリス！　大丈夫か？";
...
1@air2,1,1,0	script	mob#air3	139,{
OnStart:
	areamonster getmdmapname("1@air2"),109,59,115,66,"ワイバーンキッド",3185,3,getmdnpcname("mob#air3")+ "::OnKilled1";
	areamonster getmdmapname("1@air2"),109,59,115,66,"スカイビホルダー",3184,3,getmdnpcname("mob#air3")+ "::OnKilled1";
	end;
OnKilled1:
	set .@count,getmapmobs(getmdmapname("1@air2"),getmdnpcname("mob#air3")+ "::OnKilled1");
	if(.@count > 0)
		end;
	announce "6時方向に敵の気配を感じた!!", 0x9, 0xffff00, 0x190, 12, 0, 0;
	areamonster getmdmapname("1@air2"),60,35,70,45,"ワイバーンキッド",3185,3,getmdnpcname("mob#air3")+ "::OnKilled2";
	areamonster getmdmapname("1@air2"),60,35,70,45,"スカイビホルダー",3184,3,getmdnpcname("mob#air3")+ "::OnKilled2";
	end;
OnKilled2:
	set .@count,getmapmobs(getmdmapname("1@air2"),getmdnpcname("mob#air3")+ "::OnKilled2");
	if(.@count > 0)
		end;
	announce "9時方向に敵の気配を感じた!!", 0x9, 0xffff00, 0x190, 12, 0, 0;
	areamonster getmdmapname("1@air2"),20,60,30,70,"ワイバーンキッド",3185,3,getmdnpcname("mob#air3")+ "::OnKilled3";
	areamonster getmdmapname("1@air2"),20,60,30,70,"スカイビホルダー",3184,3,getmdnpcname("mob#air3")+ "::OnKilled3";
	end;
OnKilled3:
	set .@count,getmapmobs(getmdmapname("1@air2"),getmdnpcname("mob#air3")+ "::OnKilled3");
	if(.@count > 0)
		end;
...
1@air1,103,200,0	warp	warp3a#air1	2,2,1@air2,104,72
1@air1,103,176,0	warp	warp3b#air1	2,2,1@air2,104,52

1@air2,1,1,0	script	firecontrol#air	139,{
OnStart:
	initnpctimer;
	end;
OnTimer1000:
...
1@air2,113,52,0	script	fire1#air2	139,{}
1@air2,115,68,0	script	fire2#air2	139,{}
1@air2,96,58,0	script	fire3#air2	139,{}
1@air2,90,75,0	script	fire4#air2	139,{}
1@air2,92,51,0	script	fire5#air2	139,{}
1@air2,77,42,0	script	fire6#air2	139,{}
1@air2,69,77,0	script	fire7#air2	139,{}
1@air2,50,49,0	script	fire8#air2	139,{}
1@air2,44,61,0	script	fire9#air2	139,{}
1@air2,31,53,0	script	fire10#air2	139,{}
1@air2,24,74,0	script	fire11#air2	139,{}
1@air2,43,45,0	script	fire12#air2	139,{}
1@air2,73,65,0	script	fire13#air2	139,{}
1@air2,53,72,0	script	fire14#air2	139,{}
1@air2,82,62,0	script	fire15#air2	139,{}
1@air2,234,70,0	script	fire21#air2	139,{}
1@air2,247,64,0	script	fire22#air2	139,{}
1@air2,230,33,0	script	fire23#air2	139,{}
1@air2,200,52,0	script	fire24#air2	139,{}
1@air2,227,39,0	script	fire25#air2	139,{}
1@air2,223,50,0	script	fire26#air2	139,{}
1@air2,208,67,0	script	fire27#air2	139,{}
1@air2,208,39,0	script	fire28#air2	139,{}
1@air2,238,70,0	script	fire29#air2	139,{}
1@air2,238,32,0	script	fire30#air2	139,{}

1@air2,88,67,0	warp	warp4a#air2	2,2,1@air2,247,53

1@air2,213,75,5	script	ワイバーン#air2	2146,{}

1@air2,235,59,3	script	ワイバーン#2air2	2146,{}
1@air2,235,49,3	script	ワイバーン#3air2	2146,{}
1@air2,218,78,3	script	ワイバーンキッド#1air2	3185,{}
1@air2,208,78,5	script	レッサーワイバーン#2air	3186,{}
1@air2,200,78,5	script	スカイロータージャイロ	1392,{}
1@air2,223,78,3	script	スカイロータージャイロ	1392,{}
1@air2,236,57,3	script	スカイグレムリン#1air2	844,{}
1@air2,239,57,5	script	スカイグレムリン#2air2	844,{}
1@air2,230,50,5	script	スカイグレムリン#3air2	844,{}
1@air2,226,62,3	script	スカイグレムリン#4air2	844,{}
1@air2,241,48,3	script	スカイグレムリン#5air2	844,{}
1@air2,225,40,7	script	スカイグレムリン#6air2	844,{}
1@air2,236,48,7	script	スカイグレムリン#7air2	844,{}
1@air2,224,66,5	script	スカイグレムリン#8air2	844,{}

1@air2,229,56,5	script	ロキ#air2	512,{
	cutin "ep14_roki02.bmp", 2;
	mes "[ロキ]";
	mes "次から次へと……面倒なやつらだ。";
	close2;
...
1@air2,229,54,5	script	フェンリル#air2	664,{
	if(checkquest2(120200)&8) {
		mes "‐フェンリルがモンスターと";
		mes "　戦っている‐";
		next;
...
1@air2,241,54,3	script	アイリス#air2	666,{
	cutin "h_iris01.bmp", 2;
	mes "[アイリス]";
...
1@air2,232,51,5	script	アイリス#2air2	666,{
	if(checkquest2(120200)&8) {
		mes "‐アイリスがスカイグレムリンと";
		mes "　戦っている‐";
		next;
...
1@air2,1,1,0	script	mob#air4	139,{
OnStart:
	monster getmdmapname("1@air2"),235,49,"ワイバーン",3187,1,getmdnpcname("mob#air4")+ "::OnKilled";
	end;
OnKilled:
...
1@air2,1,1,0	script	callboss#air	139,{
OnStart1:
	monster getmdmapname("1@air2"),247,51,"怒りの船長ペルロック",3188,1,getmdnpcname("callboss#air")+ "::OnKilled";
	end;
OnStart2:
	monster getmdmapname("1@air2"),247,51,"暴走した船長ペルロック",3181,1,getmdnpcname("callboss#air")+ "::OnKilled";
	end;
OnKilled:
	hideoffnpc getmdnpcname("ケイオス#air2");
	hideoffnpc getmdnpcname("船長ペルロック#2air2");
...
1@air2,247,51,3	script	船長ペルロック#air2	873,{
	cutin "fly_felrock2.bmp", 2;
	mes "[船長ペルロック]";
	mes "船を荒らす不届きもの達め！";
	mes "私の武器で葬ってやろう!!";
...
1@air2,243,58,3	script	船長ペルロック#2air2	873,{
	cutin "fly_felrock2.bmp", 2;
	mes "[船長ペルロック]";
	mes "私の船を……!!";
	mes "ゆるせん!!!!";
...
1@air2,239,58,5	script	ケイオス#air2	683,{
...
1@air2,244,73,0	script	warp5a#air2	45,1,1,{
	mes "‐ここから時の通路へ戻れそうだ。";
	mes "　時の通路へ戻りますか？‐";
	next;
