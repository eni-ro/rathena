...
prt_monk,59,247,4	script	修行僧	120,6,2,{
	if(Job == Job_Monk) {
		mes "[都護府員]";
		mes "聖カピートリナ修道院にいらした";
		mes "ことを歓迎します。";
...
prt_monk,251,255,4	script	童巴	79,{
	switch(CHANGE_MO) {
	default:
		mes "[童巴]";
		mes "私たちモンクは、";
...
prt_monk,57,179,0	script	富年	110,{
	switch(CHANGE_MO) {
	default:
		mes "[富年]";
		mes "ハァァァァ！";
...
prt_monk,199,169,3	script	守門将	746,{
	mes "[守門将張力]";
	mes "こちらは";
	mes "モンク転職試験場です。";
	next;
...
monk_test,329,61,3	script	助教	753,{
	switch(CHANGE_MO) {
	default:
		mes "[馬周]";
...
job_monk,225,180,0	script	助教	89,{
...
monk_test,386,388,4	script	助教	110,{
	mes "[見習いモンク]";
	mes "よくいらっしゃいました。";
	mes "ここは自分を試す試練の場。";
	next;
...
monk_test,82,385,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,83,384,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,83,385,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,82,390,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,82,391,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,83,390,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,83,391,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,38,387,0	duplicate(#MO_Abyss)	落とし穴	139,0,1
monk_test,38,389,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,39,387,0	duplicate(#MO_Abyss)	落とし穴	139,0,1
monk_test,39,389,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,11,158,0	duplicate(#MO_Abyss)	落とし穴	139,1,0
monk_test,13,158,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,11,159,0	duplicate(#MO_Abyss)	落とし穴	139,1,0
monk_test,13,159,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,11,30,0	duplicate(#MO_Abyss)	落とし穴	139,3,0
monk_test,15,30,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,11,31,0	duplicate(#MO_Abyss)	落とし穴	139,3,0
monk_test,15,31,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,70,11,0	duplicate(#MO_Abyss)	落とし穴	139,0,1
monk_test,70,13,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,71,11,0	duplicate(#MO_Abyss)	落とし穴	139,0,1
monk_test,71,13,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,186,11,0	duplicate(#MO_Abyss)	落とし穴	139,2,3
monk_test,189,11,0	duplicate(#MO_Abyss)	落とし穴	139,0,3
monk_test,387,42,0	duplicate(#MO_Abyss)	落とし穴	139,1,0
monk_test,387,43,0	duplicate(#MO_Abyss)	落とし穴	139,1,0
monk_test,389,42,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,389,43,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,387,164,0	duplicate(#MO_Abyss)	落とし穴	139,1,0
monk_test,387,165,0	duplicate(#MO_Abyss)	落とし穴	139,1,0
monk_test,389,164,0	duplicate(#MO_Abyss)	落とし穴	139,0,0
monk_test,389,165,0	duplicate(#MO_Abyss)	落とし穴	139,0,0

//==========================================
// 三次試験（駆魔修行）
//------------------------------------------

monk_test,319,139,4	script	斗門	52,{
	switch(CHANGE_MO) {
	default:
		mes "[斗門]";
		mes "静かにしなさい……";
...
monk_test,88,91,4	script	試験監督#MO_Test	52,{
	mes "[斗門]";
	mes "さて、駆魔修行の準備は";
	mes "整ったかな？";
	next;
...
monk_test,82,85,1	duplicate(試験監督#MO_Test)	試験監督#MO_Test1	95
monk_test,95,85,4	duplicate(試験監督#MO_Test)	試験監督#MO_Test2	79

//==============================================================
monk_test,140,181,0	script	#MO_Test1-1	139,1,1,{
	monster "monk_test",140,181,"ゾンビ",1015,4;
	end;
}

monk_test,150,164,0	script	#MO_Test1-2	139,1,1,{
	monster "monk_test",150,164,"ゾンビ",1015,4;
	end;
}

monk_test,158,192,0	script	#MO_Test1-3	139,1,1,{
	monster "monk_test",158,192,"マミー",1041,1;
	end;
}

monk_test,134,291,0	script	#MO_Test2-1	139,1,1,{
	monster "monk_test",134,291,"ゾンビ",1015,4;
	end;
}

monk_test,144,277,0	script	#MO_Test2-2	139,1,1,{
	monster "monk_test",144,277,"ゾンビ",1015,4;
	end;
}

monk_test,149,268,0	script	#MO_Test2-3	139,1,1,{
	monster "monk_test",149,268,"ゾンビ",1015,5;
	end;
}

monk_test,249,277,0	script	#MO_Test3-1	139,1,1,{
	monster "monk_test",249,277,"ゾンビ",1015,4;
	end;
}

monk_test,252,284,0	script	#MO_Test3-2	139,1,1,{
	monster "monk_test",252,284,"マミー",1041,1;
	end;
}

monk_test,264,292,0	script	#MO_Test3-3	139,1,1,{
	monster "monk_test",264,292,"マミー",1041,1;
	end;
}
