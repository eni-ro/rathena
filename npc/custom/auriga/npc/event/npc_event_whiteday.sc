...
prt_in,41,40,3	script	アルル=オルレアン	86,{
	if((Weight*100/Maxweight) >= 90) {
		mes "-所持アイテムの重量が多いため";
		mes "アイテムを受けとることができません-";
		mes "-所持アイテムを減らしてから、再度";
...
aldebaran,155,88,3	script	訝しい少女	729,{
	if((Weight*100/Maxweight) >= 90) {
		mes "-所持アイテムの重量が多いため";
		mes "アイテムを受けとることができません-";
		mes "-所持アイテムを減らしてから、再度";
...
pay_fild01,216,118,0	duplicate(WhitedayNavi#0)	WhitedayNavi#1	139,3,3
pay_fild03,373,69,0		duplicate(WhitedayNavi#0)	WhitedayNavi#2	139,3,3
pay_fild08,43,77,0		duplicate(WhitedayNavi#0)	WhitedayNavi#3	139,3,3
...
pay_fild01,216,118,0	duplicate(茂み#NYMPH)	茂み#1	111
pay_fild01,176,120,0	duplicate(茂み#NYMPH)	茂み#2	111
pay_fild01,192,212,0	duplicate(茂み#NYMPH)	茂み#3	111
pay_fild03,158,80,0		duplicate(茂み#NYMPH)	茂み#4	111
pay_fild03,351,106,0	duplicate(茂み#NYMPH)	茂み#5	111
pay_fild03,194,212,0	duplicate(茂み#NYMPH)	茂み#6	111
pay_fild08,222,183,0	duplicate(茂み#NYMPH)	茂み#7	111
pay_fild08,237,349,0	duplicate(茂み#NYMPH)	茂み#8	111
pay_fild08,61,345,0		duplicate(茂み#NYMPH)	茂み#9	111


/* 旧ホワイトデー
alberta,188,64,4	script	お菓子商人	91,{
	mes "[メイプル=シュガー]";
	mes "いらっしゃいませ！";
	mes "美味しいお菓子はいかがですか？";
	mes "お師匠様……じゃなくて……";
