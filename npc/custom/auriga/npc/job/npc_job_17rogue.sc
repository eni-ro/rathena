...
in_rogue,363,122,4	script	ローグギルド員	747,{
	if(Upper == UPPER_HIGH) {
		mes "[マキ]";
		mes "あら？あんた、";
		mes "昔に私と会ったこと無いかい？";
...
in_rogue,376,23,2	script	スミスラト	57,{
	switch(CHANGE_RG) {
	case 0:
	case 1:
		mes "[スミスラト]";
...
//==============================================================
in_rogue,177,109,2	script	アントニオ Jr	88,{
	if(Job == Job_Rogue) {
		mes "[アントニオJr.]";
		mes "ここまで何しに？";
		mes "せっかくだから休んでいきな。";
...
//==============================================================
in_rogue,272,135,2	script	ヘルマンソン Jr	85,{
	if(Job == Job_Rogue) {
		//未調査
		close;
	}
...
//==============================================================
in_rogue,244,39,5	script	アラガム Jr	99,{
	if(Job == Job_Rogue) {
		mes "[アラガムJr.]";
		mes "うん？何の用か？";
		mes "せっかくだから休んでいきなさい。";
...
//==============================================================
in_rogue,160,34,2	script	ホルグレン Jr	85,{
	if(Job == Job_Rogue) {
		mes "[アントニオJr.]";
		mes "よう、何の用だい？";
		mes "せっかくだから休んでいきなよ。";
