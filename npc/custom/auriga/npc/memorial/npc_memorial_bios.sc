...
// ダンジョン生成NPC
//------------------------------------------------------------
moro_cav,45,60,5	script	調査隊員	419,{
	if(!(checkquest2(15006) & 0x8)) {	// 初回会話
		mes "[調査隊員]";
		mes "ここはモロク復活を防ぐ連合軍の";
		mes "最前線です。";
		mes "私は調査隊により発見された";
...
moro_cav,50,63,5	script	黄色い種#bios	844,{
	if(!(checkquest2(15006) & 0x8)) {	// 初回会話
		mes "[調査隊員]";
		mes "ここはモロク復活を防ぐ連合軍の";
		mes "最前線です。";
	...
	if((checkquest2(15005)&0x2 == 0 || checkquest2(118927)&0x2 == 0) && checkquest2(15007)&0x2) {
		mes "‐この先は入場してから1回目の";
	...
	if(checkquest2(15005) & 0x2) {
		delquest 15005;
		delquest 15007;
	}
	if(checkquest2(118927) & 0x2)
		delquest 118927;
...
// ビオスの島
//------------------------------------------------------------
1@dth1,84,90,0	script	#BARRICADE_bios1_1	1905,{}
1@dth1,84,91,0	script	#BARRICADE_bios1_2	1905,{}
1@dth1,84,92,0	script	#BARRICADE_bios1_3	1905,{}
1@dth1,84,93,0	script	#BARRICADE_bios1_4	1905,{}
1@dth1,84,94,0	script	#BARRICADE_bios1_5	1905,{}
1@dth1,84,95,0	script	#BARRICADE_bios1_6	1905,{}
1@dth1,84,96,0	script	#BARRICADE_bios1_7	1905,{}
1@dth1,84,97,0	script	#BARRICADE_bios1_8	1905,{}

1@dth1,1,1,0	script	BiosControl	139,{
OnStart:
	if(.flag)
		end;
	set .flag,1;
	...
	areasetcell getmdmapname("1@dth1"),84,90,85,97,1;
	areasetcell getmdmapname("1@dth2"),150,126,151,133,1;

	set .@map$,getmdmapname("1@dth1");
...
1@dth1,71,97,3	script	ジェイス#bios1	467,{
	mes "[ジェイス]";
	mes "……ジェイスだ。";
	next;
	mes "[ジェイス]";
...
OnStart:
	...
	areasetcell getmdmapname("1@dth1"),84,90,85,97,0;
	sleep 3000;
...
1@dth1,67,97,0	script	#会話用ダミー1	139,10,10,{
	mes "‐誰が来ている？‐";
	next;
	set .@menu,select(
		(ASH_6QUE == 14 || ASH_6QUE == 15? "アジフとイグリドだ": "？？？"),
...
1@dth1,60,96,5	script	司令官アジフ#bios1	459,{
...
1@dth1,60,93,5	script	教官長イグリド#bios1	751,{
	mes "[イグリド]";
	mes "まったく……。";
	mes "兄貴は何を考えてるんだ。";
	close;
}
1@dth1,60,96,5	script	キド#bios1	884,{
	mes "[キド]";
	mes "ここから先は何があるかわからない。";
	mes "気を抜くんじゃないぞ。";
	close;
}
1@dth1,60,93,5	script	リーン#bios1	885,{
	mes "[リーン]";
	mes "この島、何か嫌な感じがする。";
	mes "何が起こるかわからないから";
	mes "気を付けてね。";
...
1@dth1,60,96,5	script	連合軍事務官#bios1	754,{
	mes "[セルザン]";
	mes "ほ、本当は怖いですけど";
	mes "私も何かお役にたちたいんです！";
	close;
}
1@dth1,60,93,5	script	リョースン#bios1	748,{
	mes "[リョースン]";
	mes "どどど、どうしてこんなことに……。";
	mes "ああ、逃げ出したい……。";
	close;
}
1@dth1,58,95,5	script	ヒュー#bios1	868,{
	mes "[ヒュー]";
	mes "は、はは、まさか最前線に来るとは";
	mes "予想外でしたよ。";
	close;
}
1@dth1,58,92,5	script	ヘンジヌ#bios1	931,{
	mes "[ヘンジヌ]";
	mes "種に入ったら島に出るなんて";
	mes "こりゃあ、まいっ種";
	mes "なんてね";
...
1@dth1,60,96,5	script	ヒシエ#bios1	623,{
	cutin "hisie01.bmp", 2;
	mes "[ヒシエ]";
	mes "こうしている間にもカルは……";
	mes "先を急ごう！";
...
1@dth1,60,93,5	script	エイヴァント#bios1	618,{
	cutin "avant01.bmp", 2;
	mes "[エイヴァント]";
	mes "ククク、私に何か用かな？";
	mes "実験体になりたいなら";
...
1@dth1,60,96,5	script	大臣ヘスランタ#bios1	451,{
...
1@dth1,60,93,5	script	先発隊長アバランチェ#b1	450,{
	mes "[アバランチェ]";
	mes "この先に待ち構えるのは";
	mes "並大抵の相手ではないでしょう。";
	mes "先発隊長の名にかけて";
...
1@dth1,326,103,0	script	warp1#bios1	45,1,1,{
	warp getmdmapname("1@dth2"),17,93;
	end;
}

1@dth2,150,126,0	script	#BARRICADE_bios2_1	1905,{}
1@dth2,150,127,0	script	#BARRICADE_bios2_2	1905,{}
1@dth2,150,128,0	script	#BARRICADE_bios2_3	1905,{}
1@dth2,150,129,0	script	#BARRICADE_bios2_4	1905,{}
1@dth2,150,130,0	script	#BARRICADE_bios2_5	1905,{}
1@dth2,150,131,0	script	#BARRICADE_bios2_6	1905,{}
1@dth2,150,132,0	script	#BARRICADE_bios2_7	1905,{}
1@dth2,150,133,0	script	#BARRICADE_bios2_8	1905,{}

1@dth2,1,1,0	script	#bios2_mobdead1	139,{
OnStart:
	monster getmdmapname("1@dth2"),145,130,"生者のオークウォリアー",3013,5,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	monster getmdmapname("1@dth2"),144,130,"生者のデザートウルフ",3014,4,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	monster getmdmapname("1@dth2"),143,130,"生者のフェン",3015,4,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	monster getmdmapname("1@dth2"),103,124,"生者のオークウォリアー",3013,5,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	monster getmdmapname("1@dth2"),102,124,"生者のデザートウルフ",3014,3,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	monster getmdmapname("1@dth2"),101,124,"生者のフェン",3015,3,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	monster getmdmapname("1@dth2"),119,160,"生者のオークウォリアー",3013,5,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	monster getmdmapname("1@dth2"),118,160,"生者のデザートウルフ",3014,4,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	monster getmdmapname("1@dth2"),117,160,"生者のフェン",3015,4,getmdnpcname("#bios2_mobdead1")+ "::OnKilled";
	end;
OnKilled:
	initnpctimer;
	end;
OnTimer500:
	stopnpctimer;
	set .@count,getmapmobs(getmdmapname("1@dth2"),getmdnpcname("#bios2_mobdead1")+ "::OnKilled");
	if(.@count == 10)
		...
		areasetcell getmdmapname("1@dth2"),150,126,151,133,0;
...
1@dth2,1,1,0	script	#bios2_mobdead2	139,{
OnStart:
	announce "ブリド : くそっ！　奥もモンスターだらけだ。全て倒すしかないのか！", 0x9, 0xffff00;
	monster getmdmapname("1@dth2"),203,132,"生者のオークウォリアー",3013,5,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),202,132,"生者のデザートウルフ",3014,3,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),201,132,"生者のフェン",3015,3,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),229,126,"生者のオークウォリアー",3013,5,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),228,126,"生者のデザートウルフ",3014,4,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),227,126,"生者のフェン",3015,4,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),267,104,"生者のオークウォリアー",3013,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),268,104,"生者のフェン",3015,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),269,104,"生者のオークウォリアー",3013,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),270,103,"生者のデザートウルフ",3014,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),270,104,"生者のフェン",3015,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),272,102,"生者のフェン",3015,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),273,102,"生者のデザートウルフ",3014,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),273,103,"生者のデザートウルフ",3014,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),274,102,"生者のオークウォリアー",3013,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),275,103,"生者のフェン",3015,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),276,103,"生者のデザートウルフ",3014,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),278,105,"生者のオークウォリアー",3013,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	monster getmdmapname("1@dth2"),281,104,"生者のオークウォリアー",3013,1,getmdnpcname("#bios2_mobdead2")+ "::OnKilled";
	end;
OnKilled:
	initnpctimer;
	end;
OnTimer500:
	stopnpctimer;
	set .@count,getmapmobs(getmdmapname("1@dth2"),getmdnpcname("#bios2_mobdead2")+ "::OnKilled");
	if(.@count == 10)
		announce "ブリド : まだ10匹のモンスターが残っているぞ！", 0x9, 0xffff00;
	else if(.@count == 5)
		announce "ブリド : 残りのモンスターはあと5匹、もう少しだ！", 0x9, 0xffff00;
...
1@dth2,67,97,0	script	start1#bios2	139,5,5,{
...
1@dth2,67,97,0	script	BC用#bios2	139,{
OnStart:
	sleep 3000;
...
1@dth2,326,103,0	script	warp1#bios2	45,1,1,{
	warp getmdmapname("1@dth3"),45,68;
	end;
}

1@dth3,62,80,3	script	死者のオークゾンビ#11bi	3016,{}
1@dth3,64,80,3	script	死者のオークゾンビ#12bi	3016,{}
1@dth3,66,80,3	script	死者のオークゾンビ#13bi	3016,{}
1@dth3,68,80,3	script	死者のオークゾンビ#14bi	3016,{}
1@dth3,72,80,3	script	死者のオークゾンビ#15bi	3016,{}
1@dth3,74,80,3	script	死者のオークゾンビ#16bi	3016,{}
1@dth3,76,80,3	script	死者のオークゾンビ#17bi	3016,{}
1@dth3,78,80,3	script	死者のオークゾンビ#18bi	3016,{}
1@dth3,62,86,3	script	死者のオークゾンビ#21bi	3016,{}
1@dth3,64,86,3	script	死者のオークゾンビ#22bi	3016,{}
1@dth3,66,86,3	script	死者のオークゾンビ#23bi	3016,{}
1@dth3,68,86,3	script	死者のオークゾンビ#24bi	3016,{}
1@dth3,72,86,3	script	死者のオークゾンビ#25bi	3016,{}
1@dth3,74,86,3	script	死者のオークゾンビ#26bi	3016,{}
1@dth3,76,86,3	script	死者のオークゾンビ#27bi	3016,{}
1@dth3,78,86,3	script	死者のオークゾンビ#28bi	3016,{}
1@dth3,62,92,3	script	死者のオークゾンビ#31bi	3016,{}
1@dth3,64,92,3	script	死者のオークゾンビ#32bi	3016,{}
1@dth3,66,92,3	script	死者のオークゾンビ#33bi	3016,{}
1@dth3,68,92,3	script	死者のオークゾンビ#34bi	3016,{}
1@dth3,72,92,3	script	死者のオークゾンビ#35bi	3016,{}
1@dth3,74,92,3	script	死者のオークゾンビ#36bi	3016,{}
1@dth3,76,92,3	script	死者のオークゾンビ#37bi	3016,{}
1@dth3,78,92,3	script	死者のオークゾンビ#38bi	3016,{}

1@dth3,72,74,3	script	ジェイス#bios3	467,{
...
1@dth3,70,67,3	script	死神アンク#bios3	3029,{}
1@dth3,64,74,5	script	ブリド#bios3	468,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 10) {
		if(getnpctimer(1)) {
			mes "[ブリド]";
	...
	if(checkquest2(116513)==0) {
		setquest 116513;
		compquest 116513;
	}
	if(checkquest2(96430) & 0x8)
		getitem 6684, 1;
	if(checkquest2(201720)==0)
		setquest 201720;
	if(BIOS_1QUE==0)
		set BIOS_1QUE,.users;
	warp "moro_cav",45,63;
...
1@dth3,66,72,0	script	#bios3_mobdead	139,{
OnStart:
	set .@mdmap$,getmdmapname("1@dth3");
...
OnKilled1:
	set .@count,getmapmobs(getmdmapname("1@dth3"),getmdnpcname("#bios3_mobdead")+ "::OnKilled1");
	if(.@count > 0) end;
	sleep 500;
...
OnKilled2:
	set .@count,getmapmobs(getmdmapname("1@dth3"),getmdnpcname("#bios3_mobdead")+ "::OnKilled2");
	if(.@count > 0) end;
	sleep 500;
...
OnKilled3:
	set .@count,getmapmobs(getmdmapname("1@dth3"),getmdnpcname("#bios3_mobdead")+ "::OnKilled3");
	if(.@count > 0) end;
	...
	sleep 1500;
	hideonnpc getmdnpcname("死神アンク#bios3");
	set .mob_id,callmonster(getmdmapname("1@dth3"),70,67,"死神アンク",3029,getmdnpcname("#bios3_mobdead")+ "::OnBossKilled");
	if(.@flag >= 13) {
		set .@mobhp,getunitdata(.mob_id,UMOB_HP);
...
OnBossKilled:
	...
	set getvariableofnpc(.users,getmdnpcname("ブリド#bios3")),getmapusers(getmdmapname("1@dth3"));
	end;
}
1@dth3,66,72,0	script	#bios3_talkshow	139,{
OnStart:
	setnpcdisplay getmdnpcname("ジェイス#bios3"),10035;
	setnpcdisplay getmdnpcname("ブリド#bios3"),10036;
	hideoffnpc getmdnpcname("死神アンク#bios3");
...
1@dth3,66,72,5	script	司令官アジフ#bios3	459,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 20) {
		cutin "ep13_captin_edq.bmp", 2;
		mes "[アジフ]";
...
1@dth3,66,72,5	script	キド#bios3	884,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 10) {
...
1@dth3,66,72,5	script	ヒシエ#bios3	623,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 20) {
		cutin "hisie01.bmp", 2;
		mes "[ヒシエ]";
...
1@dth3,66,72,5	script	大臣ヘスランタ#bios3	451,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 20) {
		cutin "ep13_heslanta.bmp", 2;
		mes "[ヘスランタ]";
...
1@dth3,70,72,3	script	教官長イグリド#bios3	751,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 20) {
		mes "[イグリド]";
		mes "伊達に傭兵はやってないぜ！";
...
1@dth3,70,72,3	script	リーン#bios3	885,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 20) {
...
1@dth3,70,72,3	script	エイヴァント#bios3	618,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 20) {
		cutin "avant01.bmp", 2;
		mes "[エイヴァント]";
...
1@dth3,70,72,3	script	先発隊長アバランチェ#b3	450,{
	set .@flag,getvariableofnpc(.flag,getmdnpcname("ブリド#bios1"));
	if(.@flag < 20) {
		mes "[アバランチェ]";
		mes "ヘスランタ様には";
...
1@dth3,69,67,0	script	freeze#bios3	139,30,30,{
	sc_start SC_Freeze,17500,1;
	end;
}

1@dth3,1,1,0	script	talkshow#bios3	139,{
OnStart:
	initnpctimer;
