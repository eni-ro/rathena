...
// Shop
//------------------------------------------------------------
jawaii,186,174,2	shop	アイスクリーム商人	85,536:-1,536:-1,536:-1,536:-1,536:-1,536:-1,536:-1

//============================================================
// イズルード⇔ジャワイ既婚者転送NPC
//------------------------------------------------------------
izlude,171,185,4	script	新婚コンパニオン	71,{
	mes "[ウェディングハッピー]";
...
jawaii,239,112,7	script	船員::イズルード#Jawaii	100,{
	mes "[船員]";
...
jawaii,122,263,5	duplicate(イズルード#Jawaii)	船員::アルベルタ#Jawaii	100

//============================================================
// プロンテラ⇔ジャワイ未婚者転送NPC
//------------------------------------------------------------
prt_in,173,13,4	script	お客さん	86,{
	if(PartnerId) {
		mes "[ハンス]";
		mes "…………うん？";
		next;
...
prt_in,170,14,0	script	お客さん	89,{
	mes "[バチュカ]";
	mes "……";
	mes "ゴクッゴクッ……";
	mes "くあああ!!うまい!!";
...
// ジャワイNPC
//------------------------------------------------------------
jawaii,240,146,6	script	ジャワイ住民	724,{
	mes "[ワイワイ]";
	mes "ジャワイへようこそ！";
	mes "結婚と言えばやっぱり";
	mes "新婚旅行をは欠かせないですよね。";
...
jawaii,165,121,2	script	ジャワイ住民	724,{
	mes "[ワニワニ]";
	mes "ジャワイ～。";
	mes "ああ～幸せな島～。";
	mes "素晴らしいとこですよ～。";
...
jawaii,220,235,4	script	ジャワイ住民	724,{
	mes "[ザワザワ]";
	mes "ジャワイで一番きれいな場所は";
	mes "さあ、どこでしょう？";
	mes "そう、それはこのすぐ北にある";
...
jawaii,168,247,6	script	ジャワイ住民	724,{
	mes "[ワザワザ]";
	mes "宿屋は西の方に集まっています。";
	mes "宿ごとに趣が異なりますので";
	mes "お好きな宿をお選びください。";
...
jawaii,188,218,4	script	秘密酒場のお嬢さん	80,{
	mes "[お嬢さん]";
	mes "あらあら、お客さん～。";
	mes "ここから先は軽い気持ちで";
	mes "行かない方がいいですよ！";
...
// 新婚時代の思い出販売NPC
//------------------------------------------------------------
jawaii,214,168,5	script	新婚コンパニオン	71,{
	mes "[ウェディングハッピー]";
	mes "ご旅行はいかがです～？";
	mes "このジャワイほど新婚旅行に";
	mes "ぴったりな場所はないでしょう？";
...
// 宿泊施設NPC
//------------------------------------------------------------
jawaii,141,200,4	script	従業員	798,{
	mes "[アルロワ]";
	mes "あの……";
	mes "こちらはスイートルームです。";
	mes "ぜ、是非、来てください。";
...
jawaii,108,199,5	script	従業員	74,{
	mes "[パーインオレン]";
	mes "ようこそ。";
	mes "こちらはアンティークルームです。";
	mes "古風で素晴らしいお部屋ですよ。";
...
jawaii,107,189,6	script	従業員	93,{
	mes "[シャルキラニア]";
	mes "……ハニールームです。";
	mes "宿泊料は1000Zenyです。";
	next;
...
jawaii,112,173,0	script	従業員	93,{
	mes "[ラクスラニア]";
	mes "シャルキ……";
	mes "そんな顔してたら駄目じゃないの。";
	mes "もう少し愛想良くしなさいよ。";
...
// 秘密酒場NPC
//------------------------------------------------------------
jawaii_in,28,96,0	script	JawaiiWaitress	139,3,3,{
...
jawaii_in,28,96,0	script	JawaiiWaitress#dummy	724,{	//同一セル封鎖ためのダミー
	end;
OnInit:
	hideonnpc;
	end;
...
jawaii_in,25,94,0	script	従業員::JawaiiWaitress00	724,{
	mes "[従業員トリト]";
	mes "ジャワイの酒場へようこそ～！";
	next;
	if(PartnerId) {
...
jawaii_in,25,96,0	script	従業員::JawaiiWaitress01	724,{
	mes "[従業員パイ]";
	mes "ジャワイの酒場へようこそ～！";
	next;
	if(PartnerId) {
...
jawaii_in,25,98,0	script	従業員::JawaiiWaitress02	724,{
	mes "[従業員ボビ]";
	mes "ジャワイの酒場へようこそ～！";
	next;
	if(PartnerId) {
...
jawaii_in,25,100,0	script	従業員::JawaiiWaitress03	724,{
	mes "[従業員イト]";
	mes "ジャワイの酒場へようこそ～！";
	next;
	if(PartnerId) {
...
jawaii_in,30,94,4	script	従業員::JawaiiWaitress04	724,{
	mes "[従業員ルカ]";
	mes "ジャワイの酒場へようこそ～！";
	next;
	if(PartnerId) {
...
jawaii_in,30,96,4	script	従業員::JawaiiWaitress05	724,{
	mes "[従業員ケン]";
	mes "ジャワイの酒場へようこそ～！";
	next;
	if(PartnerId) {
...
jawaii_in,30,98,4	script	従業員::JawaiiWaitress06	724,{
	mes "[従業員アマド]";
	mes "ジャワイの酒場へようこそ～！";
	next;
	if(PartnerId) {
...
jawaii_in,30,100,4	script	従業員::JawaiiWaitress07	724,{
	mes "[従業員ビア]";
	mes "ジャワイの酒場へようこそ～！";
	next;
	if(PartnerId) {
...
jawaii_in,43,115,0	script	お客さん	97,{
	if(PartnerId) {
		mes "[ブル]";
		mes "……幸せそうだな。";
		mes "その気持ちを忘れるなよ！";
...
jawaii_in,41,106,2	script	お客さん	98,{
	if(PartnerId) {
		mes "[ガイ]";
		mes "……チッ。";
		mes "貴様はどうなんだ?!";
...
jawaii_in,15,104,2	script	従業員	80,{
	if(PartnerId) {
		emotion 30;
		mes "[従業員]";
		mes "いらっしゃいませ。";
...
jawaii_in,28,124,2	script	バーテンダー	46,{
	mes "[バーテンダー]";
	mes "いらっしゃいませ。";
	mes "お客さん、何になさいますか？";
	next;
