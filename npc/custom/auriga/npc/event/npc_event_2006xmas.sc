...
//==============================================================================
xmas_in,87,91,6	script	カプラディフォルテー	117,{
	cutin "kafra_01",2;
	mes "[カプラディフォルテー]";
	mes "いらっしゃいませ";
	mes "カプラサービスは";
...
xmas_in,87,89,6	script	カプラテーリング	116,{
	cutin "kafra_02",2;
	mes "[カプラテーリング]";
...
xmas_in,87,87,6	script	カプラソリン	115,{
	cutin "kafra_03",2;
	mes "[カプラソリン]";
	mes "こんにちは";
	mes "カプラ出張スペシャルサービス";
...
xmas_in,112,86,4	script	カプラビニット	114,{
	cutin "kafra_04",2;
	mes "[カプラビニット]";
	mes "こんにちは、カプラサービスです。";
...
xmas_in,97,99,4	script	カプラグラリス	113,{
	cutin "kafra_05",2;
	callfunc "KafraMain",1,0x102,0,0,0,0,0,0,100,0;
	end;
}

xmas_in,87,102,0	script	カプラＷ	112,{
	cutin "kafra_06",2;
...
// ロバートメイの発明品
//==============================================================
xmas_in,93,97,0	script	ロバートメイ	873,{
	mes "[ロバートメイ]";
	mes "笑いものにされたお前の鼻♪";
	mes "夜になるほど光ってる鼻♪";
	next;
...
// 再襲！ソロ軍団
//==============================================================
prontera,155,285,3	script	エンジョイ#Xmas	753,{
	switch(XMAS_1EVE) {
	case 0:
		mes "[エンジョイ]";
		mes "いきなりだが質問だ。";
...
prontera,155,237,0	script	手紙#Xmas1	844,3,3,{
	if(XMAS_1EVE < 2) {
		mes "-手紙が落ちている-";
		close;
	}
...
prontera,188,177,4	script	ハッピー	869,{
	if(XMAS_1EVE <= 3) {
		emotion 28;
		mes "[ハッピー]";
		mes "今年も！　今年までも！";
...
prontera,62,339,3	script	メリー	875,{
	if(XMAS_1EVE <= 4) {
		mes "[メリー]";
		mes "ペコちゃん、ペコちゃん。";
		mes "今日はどこを走ってみようか？";
...
prontera,163,66,7	script	クリス	748,{
	if(XMAS_1EVE <= 5) {
		mes "[クリス]";
		mes "ハーブを！　ポーションを！";
		mes "ソロでもランカーになれるって";
...
prontera,35,209,5	script	マス	881,{
	if(XMAS_1EVE <= 6) {
		emotion 23,"";
		mes "[マス]";
		mes "…………";
...
prt_fild05,355,254,0	script	手紙#Xmas2	844,3,3,{
	if(XMAS_1EVE < 7) {
		mes "-手紙が落ちている-";
		close;
	}
...
prt_fild05,101,160,0	script	飛び石#Xmas	139,3,3,{
	if(XMAS_1EVE != 8)
		end;
	mes "[" +strcharinfo(0)+ "]";
	mes "^0000FF水と森が出会う場所";
...
prt_fild05,101,161,4		script	エンジョイ#Xmas	753,{
	if(XMAS_1EVE == 9) {
		mes "[エンジョイ]";
		mes "見よ……いまだソロの立場は狭い。";
		mes "だが！　ソロであろうと、";
...
OnTimer3000:
	...
	monster "prt_fild05",117,154,.name$+"の挫折",1062,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",117,155,.name$+"の爆弾",1062,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",117,156,.name$+"の苦悩",1062,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",117,157,.name$+"の妬み",1062,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",117,158,.name$+"の絶望",1062,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",118,154,.name$+"の怒り",1246,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",118,155,.name$+"の恨み",1246,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",118,156,.name$+"の呪い",1246,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",118,157,.name$+"の傷心",1246,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",118,158,.name$+"の憎悪",1246,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",119,154,.name$+"のむせび",1245,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",119,155,.name$+"の孤独",1245,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",119,156,.name$+"の闇",1245,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",119,157,.name$+"の裁き",1245,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",119,158,.name$+"の嫉妬",1245,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",120,154,.name$+"の憂鬱",1244,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",120,155,.name$+"の癇癪",1244,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",120,156,.name$+"の囁き",1244,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",120,157,.name$+"の泣き叫び",1244,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",120,158,.name$+"の悪夢",1244,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",121,154,.name$+"の八つ当たり",1588,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",121,155,.name$+"の悲しみ",1588,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",121,156,.name$+"の攻撃",1588,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",121,157,.name$+"の影",1588,1,"エンジョイ#Xmas::OnKilled";
	monster "prt_fild05",121,158,.name$+"の後悔",1588,1,"エンジョイ#Xmas::OnKilled";
	end;
OnTimer6000:
...
OnTimer180000:
	...
	killmonster "prt_fild05","エンジョイ#Xmas::OnKilled";
	hideoffnpc;
	end;
OnKilled:	//ダミーイベント
	end;
...
prt_fild05,97,164,5		script	ハッピー#Xmas	869,{}
prt_fild05,103,163,4	script	メリー#Xmas	875,{}
prt_fild05,103,159,1	script	クリス#Xmas	748,{}
prt_fild05,97,159,0		script	マス#Xmas	881,{}

//==============================================================
// 不気味な卵……
//==============================================================
xmas,152,290,3	script	ポウ	716,{
	switch(XMAS_2EVE) {
	case 0:
		mes "[ポウ]";
		mes "えい！";
...
prontera,226,306,3	script	ホーリー	79,{
	if(XMAS_2EVE != 2) {
		misceffect 75;
		mes "[ホーリー]";
		mes "楽しいこの日がやってきた♪";
...
// サンタクロースに代わって
//==============================================================
prontera,156,268,3	script	サンタクロース	718,{
	switch(XMAS_3EVE) {
	case 0:
		mes "[サンタクロース]";
		mes "ホーホーホー";
...
prt_fild01,141,363,3	script	アンズ	96,{
	if(XMAS_3EVE == 6) {
		mes "[アンズ]";
		mes "とっっっても素敵なプレゼント！";
		mes "本当にありがとう!!";
	...
	mes "サンタさんからのプレゼントだよ。";
	next;
	if(getequipid2(1) != 5136 || getequipid2(10) != 2241) {
		mes "[アンズ]";
		mes "……あのねぇ……";
		mes "サンタクロースっていうのはね……";
		next;
...
payon,242,282,3	script	レイシ	703,{
	if(XMAS_3EVE == 6) {
		mes "[レイシ]";
		mes "本当に……嬉しい……";
		mes "これからも……";
...
alb2trea,110,99,0	script	デーマリー	706,{
	if(XMAS_3EVE == 6) {
		mes "[デーマリー]";
		mes "もっと釣竿欲しいからな！";
		mes "これからも良い子でいるよ！";
...
xmas_in,109,109,3	script	イシル	887,{
	switch(XMAS_4EVE) {
	case 0:
	case 1:
		mes "[イシル]";
...
xmas,138,140,0	script	レッドニア	873,{
	switch(XMAS_4EVE) {
	case 0:
	case 1:
	case 2:
...
xmas,119,155,5	script	ジョイユ	878,{
	if(Sex == 0) {
		if(XMAS_4EVE < 6) {
			mes "[ジョイユ]";
			mes "こんなに寒い日に、";
...
// ルイーゼのサンタ帽
//==============================================================
xmas_in,89,92,4	script	ルイーゼ	714,{
	mes "[アーティスト・ルイーゼ]";
	mes "ねぇねぇ。";
	mes "あの赤い布製の三角帽";
	mes "「サンタのぼうし」のデザインって";
