...
// 案内員
//------------------------------------------------------------
geffen_in,109,170,2	script	ギルド関係者	726,{
	mes "[ブラックスミスギルド関係者]";
	mes "こんにちは、";
	mes "ブラックスミスギルドを";
	mes "尋ねて来たのですか？";
...
// 受付および転職
//------------------------------------------------------------
//geffen_in,110,169,2	script	ギルド員	731,{
ein_in01,18,28,4	script	ギルド員	731,{
	if(Upper == UPPER_HIGH) {
		mes "[アルトアイゼン]";
		mes "君、君、";
		mes "ここがどこなのかわかって";
...
// 一次試験（筆記および武器製造）
//------------------------------------------------------------
//alberta_in,174,22,4	script	ブラックスミスギルド員	63,{
ein_in01,201,27,4	script	ブラックスミスギルド員	63,{
	mes "[ゲッシュ]";
	mes "熱血!!俺は熱血ブラックスミス";
	mes "ゲッシュだ！よろしく！";
	next;
...
// 二次試験（配達）
//------------------------------------------------------------
morocc,27,112,4	script	ヒュッケ	725,{
	switch(CHANGE_BS) {
	case 9:
		if(countitem(1219)) {
...
//izlude,69,181,4	script	グロン	734,{
lighthalzen,209,80,4	script	グロン	734,{
	switch(CHANGE_BS) {
	case 11:
		if(countitem(1119)) {
			mes "[グロン]";
...
//comodo,158,342,4	script	ビスマルク	118,{
hugel,168,183,4	script	ビスマルク	118,{
	switch(CHANGE_BS) {
	case 12:
		if(countitem(1122)) {
			mes "[ビスマルク]";
...
// 三次試験（最終試問）
//------------------------------------------------------------
//morocc,95,133,4	script	ブラックスミスギルド員	726,{
ein_in01,24,41,4	script	ブラックスミスギルド員	726,{
	switch(CHANGE_BS) {
	default:
		//mes "[ミットマイヤ]";
		//mes "はぁ… モロクはいつも";
...
// 精錬用品販売員
//------------------------------------------------------------
ein_in,38,29,4	script	ポールスパナ	63,{
