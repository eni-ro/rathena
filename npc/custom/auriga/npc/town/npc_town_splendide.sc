...
// 猫の手職員
//------------------------------------------------------------
spl_fild02,373,240,4	script	猫の手職員	421,{
	if(CATHAND_POINT == 0) {
		mes "[猫の手職員]";
...
// スプレンディッド商人
//------------------------------------------------------------
spl_in01,110,326,5	script	スプレンディッド商人	439,{
...
// スプレンディッド住人
//------------------------------------------------------------
splendide,159,164,3	script	妖精の兵士	461,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精]";
...
splendide,229,54,3	script	少女のような妖精	439,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[少女のような妖精]";
...
splendide,89,235,5	script	少女のような妖精	446,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[少女のような妖精]";
...
splendide,245,243,3	script	妖精の兵士	462,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精の兵士]";
...
splendide,230,142,3	script	少女のような妖精	439,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[少女のような妖精]";
...
splendide,274,203,3	script	少年のような妖精	444,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[少年のような妖精]";
...
splendide,275,141,3	script	妖精の兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精の兵士]";
...
splendide,224,230,3	script	少女のような妖精	440,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[少女のような妖精]";
...
splendide,223,36,3	script	妖精の兵士	462,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精の兵士]";
...
splendide,305,129,3	script	気楽な妖精	436,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[気楽な妖精]";
...
splendide,142,315,3	script	妖精の兵士	462,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精の兵士]";
...
splendide,181,107,5	script	妖精の兵士	462,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精の兵士]";
...
splendide,188,76,5	script	兵士	461,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
...
splendide,201,76,3	script	兵士	461,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "SeAshLu　Di　YurDiebTing";
		mes "Ee　VeModTur　No";
...
splendide,207,97,5	script	妖精	443,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精]";
		mes "sehrVa";
...
splendide,210,95,3	script	妖精	442,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精]";
...
spl_in01,190,314,5	script	保安担当官	461,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[保安担当官]";
		mes "GothremuAman　Ha";
		mes "DimDielNuff";
...
spl_in01,281,329,3	script	保安担当官	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[保安担当官]";
		mes "AnduVeldRe　Ko";
		mes "VeldReFulo　S";
...
spl_in01,172,225,3	script	放浪詩人	51,{
...
spl_in01,182,213,1	script	休憩中の妖精	438,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[休憩中の妖精]";
...
spl_in01,181,218,5	script	休憩中の妖精	446,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "‐目を閉じたまま演奏を聴いている‐";
		next;
		mes "[休憩中の妖精]";
...
spl_in01,161,213,7	script	食事中の妖精	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[食事中の妖精]";
		mes "NothFarLu　Ra...?";
		mes "RuffYur..!";
...
spl_in01,162,202,5	script	メモ中の妖精	436,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[メモ中の妖精]";
		mes "TiTalLars　Ur";
...
spl_in01,167,207,7	script	無言の妖精	445,{
	mes "‐向こうにいる詩人の";
	mes "　演奏に聴き入っている。";
	mes "　邪魔しないでおこう‐";
	close;
...
spl_in01,180,201,3	script	妖精の兵士	461,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[妖精の兵士]";
...
spl_in01,189,207,3	script	従業員	439,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[従業員妖精]";
		mes "VeldAnoWeh　Or";
		mes "TurWos";
...
spl_in01,154,207,5	script	従業員	440,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[従業員]";
...
spl_in01,122,314,5	script	指揮官	461,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "NorVerNuff　Ee　Re....";
		next;
...
spl_in01,122,311,1	script	兵士	447,{
	if(!equippeditem(2782) || YGG_1QUE < 100) {
		mes "[兵士]";
		mes "NorVerNuff　Ee　Re";
		next;
