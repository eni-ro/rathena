...
prt_church,16,41,4	script	司教	60,{
	if(Upper == UPPER_HIGH) {
		mes "[トーマス司教]";
		mes "生まれ変わり、新たな人生を";
		mes "歩む方ですね？";
...
job_prist,24,187,4	script	タフな神父::PR_Timer	110,{
	if(.flag) {	//挑戦中のロック
		mes "[ピーター神父]";
		mes "あ…ちょっと待ってくれ。";
		mes "今他のアコライトが修練中だ。";
...
//==============================================================
job_prist,168,45,4	script	デビルチ	1109,5,0,{
	end;
OnTouch:
	if(Job != Job_Acolyte) {
		mes "[デビルチ]";
...
//==============================================================
job_prist,168,75,4	script	ドッペルゲンガー	1046,5,0,{
	end;
OnTouch:
	if(Job != Job_Acolyte) {
		mes "[ドッペルゲンガー]";
...
//==============================================================
job_prist,168,115,4	script	ダークロード	1272,5,0,{
	end;
OnTouch:
	if(Job != Job_Acolyte) {
		mes "[ダークロード]";
...
//==============================================================
job_prist,168,150,4	script	バフォメット	736,5,0,{
	end;
OnTouch:
	if(Job != Job_Acolyte) {
		mes "[バフォメット]";
...
//第一段階
OnEvent0:
	monster "job_prist",24,52,"不徳",1015,1,"PR_Summon::OnKilled";
	monster "job_prist",18,52,"不忠",1015,1,"PR_Summon::OnKilled";
	monster "job_prist",30,51,"妬み",1015,1,"PR_Summon::OnKilled";
	end;
OnEvent1:
	monster "job_prist",21,62,"怒り",1015,1,"PR_Summon::OnKilled";
	monster "job_prist",27,62,"怨根",1015,1,"PR_Summon::OnKilled";
	end;
OnEvent2:
	monster "job_prist",24,72,"傲慢",1015,1,"PR_Summon::OnKilled";
	monster "job_prist",18,72,"情欲",1015,1,"PR_Summon::OnKilled";
	monster "job_prist",30,72,"怠情",1015,1,"PR_Summon::OnKilled";
	end;
OnEvent3:
	monster "job_prist",21,82,"貪食",1015,1,"PR_Summon::OnKilled";
	monster "job_prist",27,82,"貧欲",1015,1,"PR_Summon::OnKilled";
	end;
OnEvent4:
	monster "job_prist",24,92,"絶望",1015,1,"PR_Summon::OnKilled";
	monster "job_prist",18,92,"不信",1015,1,"PR_Summon::OnKilled";
	monster "job_prist",30,92,"恐怖",1015,1,"PR_Summon::OnKilled";
	end;
//第三段階
OnEvent5:
	monster "job_prist",90,55,"アモーズ",1041,1;
	monster "job_prist",105,54,"アマシス",1041,1;
	end;
OnEvent6:
	monster "job_prist",90,70,"メネト",1041,1;
	monster "job_prist",105,70,"アハマド",1041,1;
	end;
OnEvent7:
	monster "job_prist",90,85,"メネス",1041,1;
	monster "job_prist",105,85,"ネペス",1041,1;
	end;
OnKilled:
	set .count,.count+1;
	end;
...
prt_church,27,24,4	script	修道女	79,{
	if(Upper == UPPER_HIGH) {
		mes "[セシル修道女]";
		mes "あなたは転生されていますので";
		mes "ここでは転職案内できません。";
